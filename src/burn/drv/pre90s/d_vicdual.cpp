...
{
	{0x08, 0xff, 0xff, 0x10, nullptr},
	{0x09, 0xff, 0xff, 0x07, nullptr},
...
static INT32 MemIndex()
{
	...
	Next += (0x0008 + 0x100) * sizeof(UINT32); // + 0x100 - nsub

	AllRam = Next;

	DrvZ80RAM = Next;
	Next += 0x001000; // safari
	DrvVidRAM = Next;
	Next += 0x001000;
...
static void HeiankyoSoundWrite2(UINT16 port, UINT8 data)
{
	...
	if (Low & 0x10 && !PLAYING(1))
	{
		// note: also played when hero death.
...
static INT32 DrvInit(INT32 romsize, INT32 rambase, INT32 has_z80ram, void (__fastcall *wp)(UINT16, UINT8),
                     UINT8 (__fastcall *rp)(UINT16), void (*z80_cb)(), void (*rom_cb)())
{
	BurnAllocMemIndex();
...
static void nsub_gradient(UINT8 x, UINT8 y, UINT8& bg)
{
	const UINT8 grad[] = {
		...
		0xff, 0x43, 0x43, 0x43, 0x44, 0x44, 0x44, 0x45, 0x45, 0x45, 0x46, 0x46, 0x46, 0x47,
		0x47, 0x47, 0x48, 0x48, 0x48, 0x49, 0x49, 0x49, 0x4a, 0x4a, 0x4a, 0x4b, 0x4b, 0x4b, 0x4c, 0x4c, 0x4c, 0x4d,
		0x4d, 0x4d, 0x4e, 0x4e, 0x4e, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
		0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x12, 0x12, 0x12, 0x12, 0x12,
		0x12, 0x12, 0x12, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x14, 0x14, 0x14, 0x14, 0x14,
		0x15, 0x15, 0x15, 0x15, 0x16, 0x16, 0x16, 0x17, 0x17, 0x17, 0x18, 0x18, 0x19, 0x19, 0x1a, 0x1b, 0x1c, 0x1d,
		0x1e, 0x1e, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff
	};
	...
	switch (grad[x] & 0xf0)
	{
	case 0x10: bg = 0x10 | (grad[x] & 0x0f);
		break;
	case 0x40: bg = 0x20 | (grad[x] & 0x0f);
		break;
	}
}
...
{
	return DrvInit(0x4000, 0x8000, 0, depthch_write_port, depthch_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvDepthch = {
	"depthch", nullptr, nullptr, "depthch", "1977",
	...
	nullptr, depthchRomInfo, depthchRomName, nullptr, nullptr, depthchSampleInfo, depthchSampleName, DepthchInputInfo,
	DepthchDIPInfo,
...
struct BurnDriverD BurnDrvDepthcho = {
	"depthcho", "depthch", nullptr, "depthch", "1977",
	...
	nullptr, depthchoRomInfo, depthchoRomName, nullptr, nullptr, depthchSampleInfo, depthchSampleName, DepthchInputInfo,
	DepthchDIPInfo,
	DepthchInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
struct BurnDriverD BurnDrvSubhunt = {
	"subhunt", "depthch", nullptr, "depthch", "1977",
	"Sub Hunter (Gremlin / Taito)\0", "No sound", "Gremlin (Taito license)", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, subhuntRomInfo, subhuntRomName, nullptr, nullptr, depthchSampleInfo, depthchSampleName, DepthchInputInfo,
	DepthchDIPInfo,
	DepthchInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
{
	return DrvInit(0x4000, 0x8000, 0, invho2_write_port, invho2_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvInvho2 = {
	"invho2", nullptr, nullptr, "invinco", "1979",
	...
	nullptr, invho2RomInfo, invho2RomName, nullptr, nullptr, invdsSampleInfo, invdsSampleName, Invho2InputInfo,
	Invho2DIPInfo,
...
{
	return DrvInit(0x4000, 0xc000, 1, safari_write_port, safari_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvSafari = {
	"safari", nullptr, nullptr, nullptr, "1977",
	"Safari (set 1)\0", "No sound", "Gremlin", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, safariRomInfo, safariRomName, nullptr, nullptr, nullptr, nullptr, SafariInputInfo, SafariDIPInfo,
...
struct BurnDriverD BurnDrvSafaria = {
	"safaria", "safari", nullptr, nullptr, "1977",
	...
	nullptr, safariaRomInfo, safariaRomName, nullptr, nullptr, nullptr, nullptr, SafariInputInfo, SafariDIPInfo,
	SafariInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
{
	return DrvInit(0x4000, 0x8000, 0, frogs_write_port, frogs_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvFrogs = {
	"frogs", nullptr, nullptr, "frogs", "1978",
	"Frogs\0", "No sound", "Gremlin", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, frogsRomInfo, frogsRomName, nullptr, nullptr, frogsSampleInfo, frogsSampleName, FrogsInputInfo,
	FrogsDIPInfo,
...
{
	return DrvInit(0x4000, 0x8000, 0, alphaho_write_port, alphaho_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvAlphaho = {
	"alphaho", nullptr, nullptr, nullptr, "19??",
	...
	nullptr, alphahoRomInfo, alphahoRomName, nullptr, nullptr, nullptr, nullptr, AlphahoInputInfo, AlphahoDIPInfo,
...
{
	return DrvInit(0x4000, 0x8000, 0, heiankyo_write_port, heiankyo_read_port, nullptr, heiankyo_callback);
}

struct BurnDriver BurnDrvHeiankyo = {
	"heiankyo", nullptr, nullptr, "heiankyo", "1979",
	"Heiankyo Alien\0", nullptr, "Denki Onkyo", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, heiankyoRomInfo, heiankyoRomName, nullptr, nullptr, heiankyoSampleInfo, heiankyoSampleName,
	HeiankyoInputInfo, HeiankyoDIPInfo,
...
{
	return DrvInit(0x4000, 0x8000, 0, pulsar_write_port, pulsar_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvPulsar = {
	"pulsar", nullptr, nullptr, "pulsar", "1981",
	"Pulsar\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, pulsarRomInfo, pulsarRomName, nullptr, nullptr, pulsarSampleInfo, pulsarSampleName, PulsarInputInfo,
	PulsarDIPInfo,
...
{
	return DrvInit(0x2000, 0xc000, 0, digger_write_port, digger_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvDigger = {
	"digger", nullptr, nullptr, nullptr, "1980",
	"Digger\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, diggerRomInfo, diggerRomName, nullptr, nullptr, nullptr, nullptr, DiggerInputInfo, DiggerDIPInfo,
...
{
	return DrvInit(0x4000, 0x8000, 0, invds_write_port, invds_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvInvds = {
	"invds", nullptr, nullptr, "invinco", "1979",
	"Invinco / Deep Scan\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, invdsRomInfo, invdsRomName, nullptr, nullptr, invdsSampleInfo, invdsSampleName, InvdsInputInfo,
	InvdsDIPInfo,
...
{
	return DrvInit(0x4000, 0xc000, 0, invinco_write_port, invinco_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvInvinco = {
	"invinco", nullptr, nullptr, "invinco", "1979",
	"Invinco\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, invincoRomInfo, invincoRomName, nullptr, nullptr, invdsSampleInfo, invdsSampleName, InvincoInputInfo,
	InvincoDIPInfo,
...
{
	return DrvInit(0x4000, 0x8000, 0, samurai_write_port, samurai_read_port, samurai_map, nullptr);
}

struct BurnDriver BurnDrvSamurai = {
	"samurai", nullptr, nullptr, nullptr, "1980",
	...
	nullptr, samuraiRomInfo, samuraiRomName, nullptr, nullptr, nullptr, nullptr, SamuraiInputInfo, SamuraiDIPInfo,
	SamuraiInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};

struct BurnDriver BurnDrvSamuraij = {
	"samuraij", "samurai", nullptr, nullptr, "1980",
	...
	GBF_SCRFIGHT, 0,
	nullptr, samuraijRomInfo, samuraijRomName, nullptr, nullptr, nullptr, nullptr, SamuraiInputInfo, SamuraiDIPInfo,
	SamuraiInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
{
	return DrvInit(0x4000, 0x8000, 0, tranqgun_write_port, tranqgun_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvTranqgun = {
	"tranqgun", nullptr, nullptr, "tranqgun", "1980",
	"Tranquillizer Gun\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, tranqgunRomInfo, tranqgunRomName, nullptr, nullptr, tranqgunSampleInfo, tranqgunSampleName,
	TranqgunInputInfo, nullptr,
...
{
	return DrvInit(0x2000, 0xc000, 0, headon_write_port, headon_read_port, nullptr, nullptr);
}

struct BurnDriver BurnDrvHeadon = {
	"headon", nullptr, nullptr, nullptr, "1979",
	"Head On (2 players)\0", "No sound", "Gremlin", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, headonRomInfo, headonRomName, nullptr, nullptr, nullptr, nullptr, HeadonInputInfo, HeadonDIPInfo,
...
struct BurnDriver BurnDrvHeadon1 = {
	"headon1", "headon", nullptr, nullptr, "1979",
	...
	nullptr, headon1RomInfo, headon1RomName, nullptr, nullptr, nullptr, nullptr, HeadonInputInfo, HeadonDIPInfo,
	HeadonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvHeadons = {
	"headons", "headon", nullptr, nullptr, "1979",
	...
	nullptr, headonsRomInfo, headonsRomName, nullptr, nullptr, nullptr, nullptr, HeadonInputInfo, HeadonDIPInfo,
	HeadonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvHeadonsa = {
	"headonsa", "headon", nullptr, nullptr, "1979",
	...
	nullptr, headonsaRomInfo, headonsaRomName, nullptr, nullptr, nullptr, nullptr, HeadonInputInfo, HeadonDIPInfo,
	HeadonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvHocrash = {
	"hocrash", "headon", nullptr, nullptr, "1979",
	"Crash (bootleg of Head On)\0", "No sound", "bootleg (Fraber)", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, hocrashRomInfo, hocrashRomName, nullptr, nullptr, nullptr, nullptr, HeadonInputInfo, HeadonDIPInfo,
	HeadonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvHeadonmz = {
	"headonmz", "headon", nullptr, nullptr, "1979",
	"Head On (bootleg, alt maze)\0", "No sound", "bootleg", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, headonmzRomInfo, headonmzRomName, nullptr, nullptr, nullptr, nullptr, HeadonInputInfo, HeadonDIPInfo,
	HeadonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
{
	return DrvInit(0x4000, 0x8000, 0, headonn_write_port, headonn_read_port, nullptr, nullptr);
}

struct BurnDriver BurnDrvHeadonn = {
	"headonn", "headon", nullptr, nullptr, "1979",
	"Head On N\0", "No sound", "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RACING, 0,
	nullptr, headonnRomInfo, headonnRomName, nullptr, nullptr, nullptr, nullptr, HeadonnInputInfo, HeadonnDIPInfo,
...
{
	return DrvInit(0x4000, 0x8000, 0, headon_write_port, supcrash_read_port, nullptr, nullptr);
}

struct BurnDriver BurnDrvSupcrash = {
	"supcrash", "headon", nullptr, nullptr, "1979",
	"Super Crash (bootleg of Head On)\0", "No sound", "bootleg (VGG)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, supcrashRomInfo, supcrashRomName, nullptr, nullptr, nullptr, nullptr, SupcrashInputInfo, SupcrashDIPInfo,
...
struct BurnDriver BurnDrvStartrks = {
	"startrks", "nostromo", nullptr, nullptr, "198?",
	...
	nullptr, startrksRomInfo, startrksRomName, nullptr, nullptr, nullptr, nullptr, HeadonInputInfo, StartrksDIPInfo,
	HeadonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvNostromo = {
	"nostromo", nullptr, nullptr, nullptr, "198?",
	"Nostromo\0", "No sound", "bootleg", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, nostromoRomInfo, nostromoRomName, nullptr, nullptr, nullptr, nullptr, HeadonInputInfo, StartrksDIPInfo,
	HeadonInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
{
	return DrvInit(0x4000, 0x8000, 0, brdrline_write_port, brdrline_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvBrdrline = {
	"brdrline", nullptr, nullptr, "brdrline", "1981",
	"Borderline\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, brdrlineRomInfo, brdrlineRomName, nullptr, nullptr, brdrlineSampleInfo, brdrlineSampleName,
	BrdrlineInputInfo, BrdrlineDIPInfo,
...
struct BurnDriverD BurnDrvBrdrlins = {
	"brdrlins", "brdrline", nullptr, "brdrline", "1981",
	...
	nullptr, brdrlinsRomInfo, brdrlinsRomName, nullptr, nullptr, brdrlineSampleInfo, brdrlineSampleName,
	BrdrlineInputInfo, BrdrlineDIPInfo,
	BrdrlineInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
struct BurnDriverD BurnDrvBrdrlinb = {
	"brdrlinb", "brdrline", nullptr, "brdrline", "1981",
	"Borderline (Karateco bootleg)\0", "No sound", "bootleg (Karateco)", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, brdrlinbRomInfo, brdrlinbRomName, nullptr, nullptr, brdrlineSampleInfo, brdrlineSampleName,
	BrdrlineInputInfo, BrdrlineDIPInfo,
	BrdrlineInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
struct BurnDriverD BurnDrvStarrkr = {
	"starrkr", "brdrline", nullptr, "brdrline", "1981",
	"Star Raker\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, starrkrRomInfo, starrkrRomName, nullptr, nullptr, brdrlineSampleInfo, brdrlineSampleName, StarrkrInputInfo,
	StarrkrDIPInfo,
	BrdrlineInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
struct BurnDriverD BurnDrvBrdrlinet = {
	"brdrlinet", "brdrline", nullptr, "tranqgun", "1981",
	...
	nullptr, brdrlinetRomInfo, brdrlinetRomName, nullptr, nullptr, tranqgunSampleInfo, tranqgunSampleName,
	TranqgunInputInfo, nullptr,
	TranqgunInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
{
	return DrvInit(0x4000, 0x8000, 0, spacetrk_write_port, spacetrk_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvSpacetrk = {
	"spacetrk", nullptr, nullptr, nullptr, "1980",
	"Space Trek (upright)\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, spacetrkRomInfo, spacetrkRomName, nullptr, nullptr, nullptr, nullptr, SpacetrkInputInfo, SpacetrkDIPInfo,
...
struct BurnDriverD BurnDrvSpacetrkc = {
	"spacetrkc", "spacetrk", nullptr, nullptr, "1980",
	"Space Trek (cocktail)\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, spacetrkcRomInfo, spacetrkcRomName, nullptr, nullptr, nullptr, nullptr, SpacetrkcInputInfo,
	SpacetrkcDIPInfo,
	SpacetrkInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
{
	INT32 rc = DrvInit(0x4000, 0x8000, 0, carnival_write_port, carnival_read_port, nullptr, nullptr);
	if (!rc)
	{
		CarnivalSoundInit();
	}
...
struct BurnDriver BurnDrvCarnival = {
	"carnival", nullptr, nullptr, "carnival", "1980",
	"Carnival (upright, AY8912 music)\0", nullptr, "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, carnivalRomInfo, carnivalRomName, nullptr, nullptr, carnivalSampleInfo, carnivalSampleName,
	CarnivalInputInfo, CarnivalDIPInfo,
...
{
	return DrvInit(0x4000, 0x8000, 0, headon_write_port, carnivalh_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvCarnivalh = {
	"carnivalh", "carnival", nullptr, "carnival", "1980",
	...
	GBF_VERSHOOT, 0,
	nullptr, carnivalhRomInfo, carnivalhRomName, nullptr, nullptr, carnivalSampleInfo, carnivalSampleName,
	CarnivalhInputInfo, nullptr,
...
struct BurnDriverD BurnDrvCarnivalha = {
	"carnivalha", "carnival", nullptr, "carnival", "1980",
	"Carnival (Head On hardware, set 2)\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, carnivalhaRomInfo, carnivalhaRomName, nullptr, nullptr, carnivalSampleInfo, carnivalSampleName,
	CarnivalhInputInfo, nullptr,
	CarnivalhInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCarnivalc = {
	"carnivalc", "carnival", nullptr, "carnival", "1980",
	"Carnival (cocktail)\0", nullptr, "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, carnivalcRomInfo, carnivalcRomName, nullptr, nullptr, carnivalSampleInfo, carnivalSampleName,
	CarnivalcInputInfo, CarnivalcDIPInfo,
	CarnivalInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvVerbena = {
	"verbena", "carnival", nullptr, "carnival", "1980",
	"Verbena (bootleg of Carnival)\0", nullptr, "bootleg (Cocamatic)", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, verbenaRomInfo, verbenaRomName, nullptr, nullptr, carnivalSampleInfo, carnivalSampleName,
	CarnivalcInputInfo, CarnivalcDIPInfo,
	CarnivalInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
{
	return DrvInit(0x8000, 0x8000, 0, carhntds_write_port, carhntds_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvCarhntds = {
	"carhntds", nullptr, nullptr, nullptr, "1979",
	"Car Hunt / Deep Scan (France)\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, carhntdsRomInfo, carhntdsRomName, nullptr, nullptr, nullptr, nullptr, CarhntdsInputInfo, CarhntdsDIPInfo,
...
struct BurnDriverD BurnDrvInvcarht = {
	"invcarht", nullptr, nullptr, nullptr, "1979",
	"Invinco / Car Hunt (Germany)\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, invcarhtRomInfo, invcarhtRomName, nullptr, nullptr, nullptr, nullptr, CarhntdsInputInfo, CarhntdsDIPInfo,
	CarhntdsInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
{
	return DrvInit(0x2000, 0xc000, 0, headon2_write_port, headon2_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvHeadon2 = {
	"headon2", nullptr, nullptr, nullptr, "1979",
	"Head On 2\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, headon2RomInfo, headon2RomName, nullptr, nullptr, nullptr, nullptr, Headon2InputInfo, Headon2DIPInfo,
...
{
	return DrvInit(0x2000, 0xc000, 0, headon2_write_port, car2_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvHeadon2s = {
	"headon2s", "headon2", nullptr, nullptr, "1979",
	"Head On 2 (Sidam bootleg)\0", "No sound", "bootleg (Sidam)", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, headon2sRomInfo, headon2sRomName, nullptr, nullptr, nullptr, nullptr, Headon2InputInfo, Headon2DIPInfo,
...
struct BurnDriverD BurnDrvCar2 = {
	"car2", "headon2", nullptr, nullptr, "1979",
	"Car 2 (bootleg of Head On 2)\0", "No sound", "bootleg (RZ Bologna)", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, car2RomInfo, car2RomName, nullptr, nullptr, nullptr, nullptr, Headon2InputInfo, Headon2DIPInfo,
	Headon2sInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	256, 224, 4, 3
};
...
{
	return DrvInit(0x2000, 0xc000, 0, sspaceat_write_port, sspaceat_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvSspaceat = {
	"sspaceat", nullptr, nullptr, nullptr, "1979",
	"Space Attack (upright set 1)\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, sspaceatRomInfo, sspaceatRomName, nullptr, nullptr, nullptr, nullptr, SspaceatInputInfo, SspaceatDIPInfo,
...
struct BurnDriverD BurnDrvSspaceat2 = {
	"sspaceat2", "sspaceat", nullptr, nullptr, "1979",
	"Space Attack (upright set 2)\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, sspaceat2RomInfo, sspaceat2RomName, nullptr, nullptr, nullptr, nullptr, SspaceatInputInfo, SspaceatDIPInfo,
	SspaceatInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
struct BurnDriverD BurnDrvSspaceat3 = {
	"sspaceat3", "sspaceat", nullptr, nullptr, "1979",
	"Space Attack (upright set 3)\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, sspaceat3RomInfo, sspaceat3RomName, nullptr, nullptr, nullptr, nullptr, SspaceatInputInfo, SspaceatDIPInfo,
	SspaceatInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
struct BurnDriverD BurnDrvSspaceatc = {
	"sspaceatc", "sspaceat", nullptr, nullptr, "1979",
	"Space Attack (cocktail)\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, sspaceatcRomInfo, sspaceatcRomName, nullptr, nullptr, nullptr, nullptr, SspaceatInputInfo, SspaceatDIPInfo,
	SspaceatInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 8,
	224, 256, 3, 4
};
...
{
	return DrvInit(0x4000, 0x8000, 0, sspacaho_write_port, sspacaho_read_port, nullptr, nullptr);
}

struct BurnDriverD BurnDrvSspacaho = {
	"sspacaho", nullptr, nullptr, nullptr, "1979",
	"Space Attack / Head On\0", "No sound", "Sega", "Vic Dual",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, sspacahoRomInfo, sspacahoRomName, nullptr, nullptr, nullptr, nullptr, SspacahoInputInfo, SspacahoDIPInfo,
...
{
	is_nsub = 1;
	INT32 rc = DrvInit(0x4000, 0xc000, 0, nsub_write_port, nsub_read_port, nullptr, nsub_callback);
...
struct BurnDriver BurnDrvNsub = {
	"nsub", nullptr, nullptr, "nsub", "1980",
	"N-Sub (upright)\0", nullptr, "Sega", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, nsubRomInfo, nsubRomName, nullptr, nullptr, nsubSampleInfo, nsubSampleName, NsubInputInfo, nullptr,
