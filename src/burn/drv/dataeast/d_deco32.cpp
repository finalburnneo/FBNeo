...
static INT32 (*pStartDraw)() = nullptr;
static INT32 (*pDrawScanline)(INT32) = nullptr;
...
{
	{0x20, 0xff, 0xff, 0xff, nullptr},
	{0x21, 0xff, 0xff, 0x7f, nullptr},
	{0x22, 0xff, 0xff, 0xff, nullptr},
	{0x23, 0xff, 0xff, 0x00, nullptr},
...
{
	{0x1a, 0xff, 0xff, 0xef, nullptr},
	{0x1b, 0xff, 0xff, 0x00, nullptr},
...
{
	{0x1c, 0xff, 0xff, 0x08, nullptr},
	{0x1d, 0xff, 0xff, 0x00, nullptr},
...
{
	{0x0e, 0xff, 0xff, 0xfe, nullptr},
	{0x0f, 0xff, 0xff, 0x00, nullptr},
	{0x10, 0xff, 0xff, 0x04, nullptr},
...
void deco32_z80_sound_init(UINT8* rom, UINT8* ram)
{
	...
	MSM6295Init(0, (32220000 / 32) / 132, true);
	MSM6295Init(1, (32220000 / 16) / 132, true);
...
static void (*raster1_irq_cb)(INT32 param) = nullptr;
static void (*raster2_irq_cb)(INT32 param) = nullptr;
static void (*vblank_irq_cb)(INT32 param) = nullptr;
static void (*lightgun_irq_cb)(INT32 param) = nullptr;
...
static void deco_irq_scanline_callback(INT32 y)
{
	if (raster_irq_scanline > 0 && raster_irq_scanline < 240 && y == (raster_irq_scanline - 1))
	{
		if (!raster_irq_masked)
		{
			...
			{
			case 1/*RASTER1_IRQ*/: if (raster1_irq_cb) raster1_irq_cb(ASSERT_LINE);
				break;
			case 0/*RASTER2_IRQ*/: if (raster2_irq_cb) raster2_irq_cb(ASSERT_LINE);
				break;
			}
		}
	}
...
static void fghthist_write_long(UINT32 address, UINT32 data)
{
	...
	switch (address & ~3)
	{
	case 0x1201fc: deco32_soundlatch_write(data);
		return;
...
static INT32 MemIndex()
{
	...
	if (game_select == 2 || game_select == 3) // nslasher, tattass
	{
		...
		Next += nScreenWidth * nScreenHeight * sizeof(INT16);
		pTempDraw[1] = (UINT16*)Next;
		Next += nScreenWidth * nScreenHeight * sizeof(INT16);
		pTempDraw[2] = (UINT16*)Next;
		Next += nScreenWidth * nScreenHeight * sizeof(INT16);
		pTempDraw[3] = (UINT16*)Next;
		Next += nScreenWidth * nScreenHeight * sizeof(INT16);
	}

	if (game_select == 4) // dragngun
	{
		pTempSprite = (UINT32*)Next;
		Next += nScreenWidth * nScreenHeight * sizeof(UINT32);
	}
...
static INT32 DragngunCommonInit(INT32 has_z80, UINT32 speedhack)
{
	...
	MSM6295Init(2, (32220000 / 32) / 132, true);
...
static INT32 DrvExit()
{
	...
	raster1_irq_cb = nullptr;
	raster2_irq_cb = nullptr;
	vblank_irq_cb = nullptr;
	lightgun_irq_cb = nullptr;
	has_ace = 0;
	speedhack_address = 0;

	pStartDraw = nullptr;
	pDrawScanline = nullptr;
...
static void DrvPaletteUpdate()
{
	...
	for (INT32 i = 0; i < 0x2000 / 4; i++)
	{
		...
		if (i > 255 && has_ace == 1)
		{
			b = static_cast<UINT8>((float)b + (((float)ptb - (float)b) * (float)psb / 255.0f));
			g = static_cast<UINT8>((float)g + (((float)ptg - (float)g) * (float)psg / 255.0f));
			r = static_cast<UINT8>((float)r + (((float)ptr - (float)r) * (float)psr / 255.0f));
		}
...
static INT32 (*m_pri_cb)(INT32, INT32) = nullptr;
static INT32 (*m_col_cb)(INT32) = nullptr;

#if defined FBNEO_DEBUG
extern int counter; // dink debug stuff, to be removed when driver 100%.  (or slightly less)
#endif

static void draw_sprites_common(UINT16* bitmap, UINT8* ram, UINT8* gfx, INT32 colbase, INT32 /*transp*/,
                                INT32 sizewords, bool invert_flip, INT32 m_raw_shift, INT32 m_alt_format, INT32 layerID)
{
	INT32 m_y_offset = 0;
	INT32 m_x_offset = 0;
...

				{
					...
					if (game_select == 2)
					{
						...
						if (layerID && (sprite == 0x3cd || sprite == 0x3d0) && !(colour & 0x80))
							colour |= (BURN_ENDIAN_SWAP_INT32(ace_ram[0]) == 0x17) ? 0xa0 : 0xc0;
						// black message boxes (ace_ram[0] == 0x10), shadow on character selection screen (ace_ram[0] == 0x17)
						...
						{
							colour &= ~0x20;
							// level 5 mid-boss "hole in plane" wrong priority (doesn't show up until after character goes through the hole w/o this)
						}
						else if (layerID && (sprite >= 0x7a0 && sprite <= 0x829))
						...
						{
							{
								{
									if (m_pri_cb)
										deco16_draw_prio_sprite(bitmap, gfx, (sprite - multi * inc) & 0xffff,
										                        (colour << m_raw_shift) + colbase, x, ypos, fx, fy,
										                        pri);
									else if (fy)
									{
										if (fx)
										{
											Render16x16Tile_Mask_FlipXY_Clip(
												bitmap, (sprite - multi * inc) & 0xffff, x, ypos, colour, m_raw_shift,
												0, colbase, gfx);
										}
										else
										{
									...
									else
									{
										...
										{
											Render16x16Tile_Mask_Clip(bitmap, (sprite - multi * inc) & 0xffff, x, ypos,
											                          colour, m_raw_shift, 0, colbase, gfx);
										}
									}
								}
								...
								{
									if (m_pri_cb)
										deco16_draw_prio_sprite(bitmap, gfx, ((sprite - multi * inc) - mult2) & 0xffff,
										                        (colour << m_raw_shift) + colbase,
										                        !flipscreen ? x - 16 : x + 16, ypos, fx, fy, pri);
									else if (fy)
									{
										if (fx)
										{
											Render16x16Tile_Mask_FlipXY_Clip(
												bitmap, ((sprite - multi * inc) - mult2) & 0xffff,
												!flipscreen ? x - 16 : x + 16, ypos, colour, m_raw_shift, 0, colbase,
												gfx);
										}
										else
										{
									...
									else
									{
										...
										{
											Render16x16Tile_Mask_Clip(bitmap, ((sprite - multi * inc) - mult2) & 0xffff,
											                          !flipscreen ? x - 16 : x + 16, ypos, colour,
											                          m_raw_shift, 0, colbase, gfx);
										}
									}
								}
							}
					...
					{
						{
							if (m_pri_cb)
							{
								...
								{
									deco16_draw_prio_sprite(bitmap, gfx, sprite + yy + h * xx,
									                        (colour << m_raw_shift) + colbase, x + mult * (w - xx),
									                        ypos, fx, fy, pri);
								}
							...
							else
							{
								...
								if ((ypos < nScreenHeight) && (ypos >= (0 - 16)))
								// if it's not rendering the last couple lines somewhere, remove this.
								{
									if (fy)
									{
										if (fx)
										{
											Render16x16Tile_Mask_FlipXY_Clip(
												bitmap, sprite + yy + h * xx, x + mult * (w - xx), ypos, colour,
												m_raw_shift, 0, colbase, gfx);
										}
										else
										{
									...
									else
									{
										...
										{
											Render16x16Tile_Mask_Clip(bitmap, sprite + yy + h * xx, x + mult * (w - xx),
											                          ypos, colour, m_raw_shift, 0, colbase, gfx);
										}
									}
								}
...
static INT32 CaptavenDrawScanline(INT32 line)
{
	...
	if (global_priority & 1)
	{
		...
		if (nBurnLayer & 4) deco16_draw_layer_by_line(lastline, line, 2, pTransDraw,
		                                              2 | DECO16_LAYER_CAPTAVEN | DECO16_LAYER_8BITSPERPIXEL);
	}
	else
	{
		if (nBurnLayer & 4) deco16_draw_layer_by_line(lastline, line, 2, pTransDraw,
		                                              1 | DECO16_LAYER_CAPTAVEN | DECO16_LAYER_8BITSPERPIXEL);
...
static INT32 CaptavenDraw()
{
	...
	if (nSpriteEnable & 1) draw_sprites_common(nullptr, DrvSprBuf, DrvGfxROM3, 0, 0, 0x400, false, 4, 1, 0);
...
static INT32 FghthistDraw()
{
	...
	if (nSpriteEnable & 1) draw_sprites_common(nullptr, DrvSprBuf, DrvGfxROM3, 0x400, 0xf, 0x800, true, 4, 0, 0);
	...
	if (game_select == 2)
	{
		for (INT32 y = 0; y < nScreenHeight; y++)
		{
			for (INT32 x = 0; x < nScreenWidth; x++)
			{
				...
				dest[x] = (pxl) ? color | pxl : 0x300;
				// color at 0x300 is better for bg fill @ 8bpp mode. fixes green background on dataeast screen and ending scenes.
				prio[x] = priority;
			}
			src0 += nScreenWidth;
			src1 += nScreenWidth;
...
static void mixDualAlphaSprites(INT32 mixAlphaTilemap, INT32 drawAlphaTilemap)
{
	...
	for (INT32 y = 0; y < nScreenHeight; y++)
	{
		...
		auto destLine32 = (UINT32*)pBurnDraw;
		auto destLine16 = (UINT16*)pBurnDraw;
		...
		for (INT32 x = 0; x < nScreenWidth; x++)
		{
			...
			if (priColAlphaPal1 & 0xff)
			{
				if (alpha1)
				{
					if (pri1 == 0 && (((priColAlphaPal0 & 0xff) == 0 || ((pri0 & 0x3) != 0 && (pri0 & 0x3) != 1 && (pri0
						& 0x3) != 2))))
					{
						if ((global_priority & 1) == 0 || ((global_priority & 1) == 1 && tilemapPri[x] < 4) || ((
							global_priority & 1) == 1 && mixAlphaTilemap))
						{
							// usually "shadows" under characters (nslasher)
							if (depth == 32)
								destLine32[x] = alphablend32(destLine32[x],
								                             pal1[(priColAlphaPal1 & 0xff) + (granularity1 * col1)],
								                             0x80);
							else if (depth == 16)
								destLine16[x] = alphablend16(destLine16[x],
								                             pal1[(priColAlphaPal1 & 0xff) + (granularity1 * col1)],
								                             0x80);
							else if (depth == 15)
								destLine16[x] = alphablend15(destLine16[x],
								                             pal1[(priColAlphaPal1 & 0xff) + (granularity1 * col1)],
								                             0x80);
						}
					}
					else if ((pri1 >= 2) || (pri1 == 1 && ((priColAlphaPal0 & 0xff) == 0 || ((pri0 & 0x3) != 0 && (pri0
						& 0x3) != 1 && (pri0 & 0x3) != 2))))
					{
						INT32 alpha = 0x7f;

						if (game_select == 2 && (pri1 == 1 || pri1 == 3))
						{
							// nslasher: carriage buggy wheels behind / in front of object
							auto m_ace_ram = (UINT32*)DrvAceRAM;
							alpha = (mixAlphaTilemap)
								        ? ((BURN_ENDIAN_SWAP_INT32(m_ace_ram[0x17 + (((priColAlphaPal1&0xf0)>>4)/2)])) *
									        8) - 1
								        : 0x7f;
							if (alpha < 0)
								alpha = 0;
...
static INT32 NslasherDraw()
{
	...
	else
	{
		...
		{
			if (nBurnLayer & 2) deco16_draw_layer(1, pTransDraw, 2);
			if (nBurnLayer & 4) deco16_draw_layer(2, (has_alpha) ? pTempDraw[2] : pTransDraw,
			                                      4 + (has_alpha ? DECO16_LAYER_OPAQUE : 0));
			draw_alpha_tmap = (has_alpha && deco16_layer_enabled(2));
		}
		else
		{
			if (nBurnLayer & 4) deco16_draw_layer(2, pTransDraw, 2);
			if (nBurnLayer & 2) deco16_draw_layer(1, (has_alpha) ? pTempDraw[2] : pTransDraw,
			                                      4 + (has_alpha ? DECO16_LAYER_OPAQUE : 0));
...
static void dragngun_drawgfxzoom(UINT32 code, UINT32 color, INT32 flipx, INT32 flipy, INT32 sx, INT32 sy,
                                 INT32 scalex, INT32 scaley, INT32 sprite_screen_width, INT32 sprite_screen_height,
                                 UINT8 alpha, INT32 priority, INT32 depth)
{
	...
	for (INT32 offs = 0; offs < 0x800; offs += 8)
	{
		...
		for (INT32 y = 0; y < h; y++)
		{
			...
			for (INT32 x = 0; x < w; x++)
			{
				...
				if (sprite >= 0x3e44 && sprite <= 0x3f03 && priority_orig == 1)
					// dragon-fire masking effect for titlescreen
					priority = 1;
				else priority = 7;
				...
				dragngun_drawgfxzoom(sprite, color, fx, fy, xpos >> 16, (ypos >> 16) - 8, zoomx, zoomy,
				                     ((xpos + (zoomx << 4)) >> 16) - (xpos >> 16),
				                     ((ypos + (zoomy << 4)) >> 16) - (ypos >> 16), alpha, priority, depth);
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[2] = {
		static_cast<INT32>((double)7000000 / 57.799650), static_cast<INT32>((double)deco16_sound_cpuclock / 57.799650)
	};
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		if (pDrawScanline != nullptr && i >= 7 && raster_irq) pDrawScanline(i - 7);

		if (i == 8) deco16_vblank = 0;

		if (i == 248)
		{
			if (pDrawScanline != nullptr)
			{
				pDrawScanline(i - 8);
	...
	if (pBurnDraw && pDrawScanline == nullptr)
	{
		BurnDrvRedraw();
	}
...
static INT32 DrvBSMTFrame()
{
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		if (bsmt_in_reset == 0)
		{
			...
			if (nCurrentFrame & 1)
			{
				// needs 8.43 firq's per frame, to simplify, we'll do an extra firq every other frame.
...
struct BurnDriver BurnDrvCaptaven = {
	"captaven", nullptr, nullptr, nullptr, "1991",
	"Captain America and The Avengers (Asia Rev 1.4)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, captavenRomInfo, captavenRomName, nullptr, nullptr, nullptr, nullptr, CaptavenInputInfo, CaptavenDIPInfo,
...
struct BurnDriver BurnDrvCaptavena = {
	"captavena", "captaven", nullptr, nullptr, "1991",
	"Captain America and The Avengers (Asia Rev 1.0)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, captavenaRomInfo, captavenaRomName, nullptr, nullptr, nullptr, nullptr, CaptavenInputInfo, CaptavenDIPInfo,
	CaptavenInit, DrvExit, DrvFrame, CaptavenDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvCaptavene = {
	"captavene", "captaven", nullptr, nullptr, "1991",
	"Captain America and The Avengers (UK Rev 1.4)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, captaveneRomInfo, captaveneRomName, nullptr, nullptr, nullptr, nullptr, CaptavenInputInfo, CaptavenDIPInfo,
	CaptavenInit, DrvExit, DrvFrame, CaptavenDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvCaptavenu = {
	"captavenu", "captaven", nullptr, nullptr, "1991",
	"Captain America and The Avengers (US Rev 1.9)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, captavenuRomInfo, captavenuRomName, nullptr, nullptr, nullptr, nullptr, CaptavenInputInfo, CaptavenDIPInfo,
	CaptavenInit, DrvExit, DrvFrame, CaptavenDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvCaptavenuu = {
	"captavenuu", "captaven", nullptr, nullptr, "1991",
	"Captain America and The Avengers (US Rev 1.6)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, captavenuuRomInfo, captavenuuRomName, nullptr, nullptr, nullptr, nullptr, CaptavenInputInfo,
	CaptavenDIPInfo,
	CaptavenInit, DrvExit, DrvFrame, CaptavenDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvCaptavenua = {
	"captavenua", "captaven", nullptr, nullptr, "1991",
	"Captain America and The Avengers (US Rev 1.4)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, captavenuaRomInfo, captavenuaRomName, nullptr, nullptr, nullptr, nullptr, CaptavenInputInfo,
	CaptavenDIPInfo,
	CaptavenInit, DrvExit, DrvFrame, CaptavenDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvCaptavenj = {
	"captavenj", "captaven", nullptr, nullptr, "1991",
	"Captain America and The Avengers (Japan Rev 0.2)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, captavenjRomInfo, captavenjRomName, nullptr, nullptr, nullptr, nullptr, CaptavenInputInfo, CaptavenDIPInfo,
	CaptavenInit, DrvExit, DrvFrame, CaptavenDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvFghthist = {
	"fghthist", nullptr, nullptr, nullptr, "1993",
	"Fighter's History (World ver 43-09, DE-0395-1 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, fghthistRomInfo, fghthistRomName, nullptr, nullptr, nullptr, nullptr, FghthistInputInfo, FghthistDIPInfo,
...
struct BurnDriver BurnDrvFghthista = {
	"fghthista", "fghthist", nullptr, nullptr, "1993",
	"Fighter's History (World ver 43-07, DE-0380-2 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, fghthistaRomInfo, fghthistaRomName, nullptr, nullptr, nullptr, nullptr, FghthistInputInfo, FghthistDIPInfo,
...
struct BurnDriver BurnDrvFghthistb = {
	"fghthistb", "fghthist", nullptr, nullptr, "1993",
	"Fighter's History (World ver 43-05, DE-0380-2 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, fghthistbRomInfo, fghthistbRomName, nullptr, nullptr, nullptr, nullptr, FghthistInputInfo, FghthistDIPInfo,
...
struct BurnDriver BurnDrvFghthistu = {
	"fghthistu", "fghthist", nullptr, nullptr, "1993",
	"Fighter's History (US ver 42-09, DE-0396-0 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, fghthistuRomInfo, fghthistuRomName, nullptr, nullptr, nullptr, nullptr, FghthistInputInfo, FghthistDIPInfo,
...
struct BurnDriver BurnDrvFghthistua = {
	"fghthistua", "fghthist", nullptr, nullptr, "1993",
	"Fighter's History (US ver 42-06, DE-0395-1 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, fghthistuaRomInfo, fghthistuaRomName, nullptr, nullptr, nullptr, nullptr, FghthistInputInfo,
	FghthistDIPInfo,
...
struct BurnDriver BurnDrvFghthistub = {
	"fghthistub", "fghthist", nullptr, nullptr, "1993",
	"Fighter's History (US ver 42-05, DE-0395-1 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, fghthistubRomInfo, fghthistubRomName, nullptr, nullptr, nullptr, nullptr, FghthistInputInfo,
	FghthistDIPInfo,
...
struct BurnDriver BurnDrvFghthistuc = {
	"fghthistuc", "fghthist", nullptr, nullptr, "1993",
	"Fighter's History (US ver 42-03, DE-0380-2 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, fghthistucRomInfo, fghthistucRomName, nullptr, nullptr, nullptr, nullptr, FghthistInputInfo,
	FghthistDIPInfo,
...
struct BurnDriver BurnDrvFghthistj = {
	"fghthistj", "fghthist", nullptr, nullptr, "1993",
	"Fighter's History (Japan ver 41-07, DE-0395-1 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, fghthistjRomInfo, fghthistjRomName, nullptr, nullptr, nullptr, nullptr, FghthistInputInfo, FghthistDIPInfo,
	FghthistInit, DrvExit, DrvFrame, FghthistDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvFghthistja = {
	"fghthistja", "fghthist", nullptr, nullptr, "1993",
	"Fighter's History (Japan ver 41-05, DE-0380-2 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, fghthistjaRomInfo, fghthistjaRomName, nullptr, nullptr, nullptr, nullptr, FghthistInputInfo,
	FghthistDIPInfo,
...
struct BurnDriver BurnDrvFghthistjb = {
	"fghthistjb", "fghthist", nullptr, nullptr, "1993",
	"Fighter's History (Japan ver 41-04, DE-0380-1 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, fghthistjbRomInfo, fghthistjbRomName, nullptr, nullptr, nullptr, nullptr, FghthistInputInfo,
	FghthistDIPInfo,
...
struct BurnDriver BurnDrvNslasher = {
	"nslasher", nullptr, nullptr, nullptr, "1994",
	"Night Slashers (Korea Rev 1.3, DE-0397-0 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, nslasherRomInfo, nslasherRomName, nullptr, nullptr, nullptr, nullptr, NslasherInputInfo, NslasherDIPInfo,
...
struct BurnDriver BurnDrvNslasherj = {
	"nslasherj", "nslasher", nullptr, nullptr, "1994",
	"Night Slashers (Japan Rev 1.2, DE-0397-0 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, nslasherjRomInfo, nslasherjRomName, nullptr, nullptr, nullptr, nullptr, NslasherInputInfo, NslasherDIPInfo,
...
struct BurnDriver BurnDrvNslashers = {
	"nslashers", "nslasher", nullptr, nullptr, "1994",
	"Night Slashers (Over Sea Rev 1.2, DE-0397-0 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, nslashersRomInfo, nslashersRomName, nullptr, nullptr, nullptr, nullptr, NslasherInputInfo, NslasherDIPInfo,
	NslasherInit, DrvExit, DrvZ80Frame, NslasherDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvNslasheru = {
	"nslasheru", "nslasher", nullptr, nullptr, "1994",
	"Night Slashers (US Rev 1.2, DE-0395-1 PCB)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, nslasheruRomInfo, nslasheruRomName, nullptr, nullptr, nullptr, nullptr, NslasherInputInfo, NslasherDIPInfo,
...
struct BurnDriver BurnDrvTattass = {
	"tattass", nullptr, nullptr, nullptr, "1994",
	"Tattoo Assassins (US prototype, Mar 14 1995)\0", nullptr, "Data East Pinball", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_PROTOTYPE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, tattassRomInfo, tattassRomName, nullptr, nullptr, nullptr, nullptr, TattassInputInfo, TattassDIPInfo,
...
struct BurnDriver BurnDrvTattassa = {
	"tattassa", "tattass", nullptr, nullptr, "1994",
	"Tattoo Assassins (Asia prototype, Mar 14 1995)\0", nullptr, "Data East Pinball", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, tattassaRomInfo, tattassaRomName, nullptr, nullptr, nullptr, nullptr, TattassInputInfo, TattassDIPInfo,
	TattassInit, DrvExit, DrvBSMTFrame, NslasherDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvDragngun = {
	"dragngun", nullptr, nullptr, nullptr, "1993",
	"Dragon Gun (US)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SHOOT, 0,
	nullptr, dragngunRomInfo, dragngunRomName, nullptr, nullptr, nullptr, nullptr, DragngunInputInfo, DragngunDIPInfo,
...
struct BurnDriver BurnDrvDragngunj = {
	"dragngunj", "dragngun", nullptr, nullptr, "1993",
	"Dragon Gun (Japan)\0", nullptr, "Data East Corporation", "DECO 32",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SHOOT, 0,
	nullptr, dragngunjRomInfo, dragngunjRomName, nullptr, nullptr, nullptr, nullptr, DragngunInputInfo, DragngunDIPInfo,
	DragngunInit, DrvExit, DrvFrame, DragngunDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
