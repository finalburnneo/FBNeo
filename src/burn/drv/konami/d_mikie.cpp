...
static struct BurnDIPInfo MikieDIPList[] =
{
	...
	{0x01, 0xff, 0xff, 0x7b, nullptr},
	{0x02, 0xff, 0xff, 0xfc, nullptr},
...
static void draw_sprites()
{
	for (INT32 offs = 0; offs < 0x90; offs += 4)
	{
		...
		int code = (DrvSprRAM[offs + 2] & 0x3f) + ((DrvSprRAM[offs + 2] & 0x80) >> 1) + ((DrvSprRAM[offs + 2] & 0x40) <<
			2) + ((attr & 0x40) << 1);
...
struct BurnDriver BurnDrvMikie = {
	"mikie", nullptr, nullptr, nullptr, "1984",
	"Mikie\0", nullptr, "Konami", "GX469",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_ACTION, 0,
	nullptr, mikieRomInfo, mikieRomName, nullptr, nullptr, nullptr, nullptr, MikieInputInfo, MikieDIPInfo,
...
struct BurnDriver BurnDrvMikiej = {
	"mikiej", "mikie", nullptr, nullptr, "1984",
	"Shinnyuushain Tooru-kun\0", nullptr, "Konami", "GX469",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI,
	GBF_ACTION, 0,
	nullptr, mikiejRomInfo, mikiejRomName, nullptr, nullptr, nullptr, nullptr, MikieInputInfo, MikieDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvMikiehs = {
	"mikiehs", "mikie", nullptr, nullptr, "1984",
	"Mikie (High School Graffiti)\0", nullptr, "Konami", "GX469",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI,
	GBF_ACTION, 0,
	nullptr, mikiehsRomInfo, mikiehsRomName, nullptr, nullptr, nullptr, nullptr, MikieInputInfo, MikieDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 256, 3, 4
};
