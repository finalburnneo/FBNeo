		...
		if (priority == prio)
		{
			...
			for (INT32 y = 0; y <= sizey; y++)
			{
				for (INT32 x = 0; x <= sizex; x++)
				{
					...
					DrawGfxMaskTile(0, 3, code, ((sx + 16 * x) & 0x1ff) - 71,
					                ((sy + 16 * y) & 0xff) + 1 + (*flipscreen ? -32 : 0), flipx, flipy, color >> 1,
					                0xf);
				}
			}
		}
...
struct BurnDriver BurnDrvAliensec = {
	"aliensec", nullptr, nullptr, nullptr, "1985",
	"Alien Sector\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, aliensecRomInfo, aliensecRomName, nullptr, nullptr, nullptr, nullptr, BaradukeInputInfo, BaradukeDIPInfo,
...
struct BurnDriver BurnDrvBaraduke = {
	"baraduke", "aliensec", nullptr, nullptr, "1985",
	"Baraduke\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, baradukeRomInfo, baradukeRomName, nullptr, nullptr, nullptr, nullptr, BaradukeInputInfo, BaradukeDIPInfo,
	AlienInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMetrocrs = {
	"metrocrs", nullptr, nullptr, nullptr, "1985",
	"Metro-Cross (set 1)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, metrocrsRomInfo, metrocrsRomName, nullptr, nullptr, nullptr, nullptr, BaradukeInputInfo, MetrocrsDIPInfo,
...
struct BurnDriver BurnDrvMetrocrsa = {
	"metrocrsa", "metrocrs", nullptr, nullptr, "1985",
	"Metro-Cross (set 2)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, metrocrsaRomInfo, metrocrsaRomName, nullptr, nullptr, nullptr, nullptr, BaradukeInputInfo, MetrocrsDIPInfo,
	MetroInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
