...
static struct BurnDIPInfo TubepDIPList[] =
{
	...
	{0x10, 0xff, 0xff, 0x6e, nullptr},
	{0x11, 0xff, 0xff, 0x7e, nullptr},
...
{
	{0x15, 0xff, 0xff, 0x7e, nullptr},
	{0x16, 0xff, 0xff, 0x7e, nullptr},
...
static void draw_sprite()
{
	...
	for (UINT32 YDOT = 0; (YDOT ^ YSize) != 0x00; YDOT++)
	{
		...
		for (UINT32 XDOT = 0; (XDOT ^ XSize) != 0x00; XDOT++)
		{
			...
			if (!((ls283_gh8 & 256) | (ls283_ij8 & 256)))
			/* skip wrapped sprite area - PAL12L6 (PLA019 in Roller Jammer schematics)*/
			{
...
{
	return static_cast<INT64>(static_cast<double>(ZetTotalCycles()) * nSoundRate / 2496000);
}
...
static void TubepPaletteInit()
{
	...
	for (INT32 i = 0; i < 256; i++)
	{
		for (INT32 sh = 0; sh < 0x40; sh++)
		{
			...
			INT32 r = static_cast<INT32>(out + 0.5);

			out = 0.0;
			for (INT32 c = 0; c < 3 * 6; c++) out += weights_g[c] * bits_g[c];
			INT32 g = static_cast<INT32>(out + 0.5);

			out = 0.0;
			for (INT32 c = 0; c < 2 * 6; c++) out += weights_b[c] * bits_b[c];
			INT32 b = static_cast<INT32>(out + 0.5);
	...
	UINT32 v = scanline;
	{
		...
		for (UINT32 h = 0 * 8; h < 32 * 8; h++)
		{
			...
			else
			{
				...
				UINT32 romB_addr = (((h >> 1) & 0x3f) ^ ((h & 0x80) ? 0x00 : 0x3f)) | (((v & 0x7f) ^ (
					(v & 0x80) ? 0x00 : 0x7f)) << 6);
		...
		for (UINT32 h = 0 * 8; h < 32 * 8; h++)
		{
			...
			else
			{
				...
				else
				{
					...
					color_bank = (pal14h4_pin13 & ((bg_data & 0x08) >> 3) & ((bg_data & 0x04) >> 2) & (((bg_data & 0x02)
							>> 1) ^ 1) & (bg_data & 0x01))
						| (pal14h4_pin18 & ((bg_data & 0x08) >> 3) & ((bg_data & 0x04) >> 2) & ((bg_data & 0x02) >> 1) &
							((bg_data & 0x01) ^ 1))
						| (pal14h4_pin19);
...
struct BurnDriver BurnDrvTubep = {
	"tubep", nullptr, nullptr, nullptr, "1984",
	"Tube Panic\0", nullptr, "Nichibutsu / Fujitek", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, tubepRomInfo, tubepRomName, nullptr, nullptr, nullptr, nullptr, TubepInputInfo, TubepDIPInfo,
...
struct BurnDriver BurnDrvTubepb = {
	"tubepb", "tubep", nullptr, nullptr, "1984",
	"Tube Panic (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, tubepbRomInfo, tubepbRomName, nullptr, nullptr, nullptr, nullptr, TubepInputInfo, TubepbDIPInfo,
...
struct BurnDriver BurnDrvRjammer = {
	"rjammer", nullptr, nullptr, nullptr, "1984",
	"Roller Jammer\0", nullptr, "Nichibutsu / Alice", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, rjammerRomInfo, rjammerRomName, nullptr, nullptr, nullptr, nullptr, RjammerInputInfo, RjammerDIPInfo,
