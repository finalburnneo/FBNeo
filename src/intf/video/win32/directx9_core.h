...
#ifdef UNICODE
extern HRESULT (WINAPI* _D3DXCreateEffectFromResource)(LPDIRECT3DDEVICE9, HMODULE, LPCWSTR, const D3DXMACRO*,
...
#ifdef UNICODE
extern HRESULT (WINAPI* _D3DXCreateEffectFromFile)(LPDIRECT3DDEVICE9, LPCWSTR, const D3DXMACRO*, LPD3DXINCLUDE, DWORD,
...
extern HRESULT (WINAPI* _D3DXLoadSurfaceFromMemory)(LPDIRECT3DSURFACE9, const PALETTEENTRY*, const RECT*, LPCVOID,
                                                    D3DFORMAT, UINT, const PALETTEENTRY*, const RECT*, DWORD, D3DCOLOR);

// D3DXCompileShaderFromResource
#ifdef UNICODE
extern HRESULT (WINAPI* _D3DXCompileShaderFromResource)(HMODULE, LPCWSTR, const D3DXMACRO*, LPD3DXINCLUDE, LPCSTR,
                                                        LPCSTR, DWORD, LPD3DXBUFFER*, LPD3DXBUFFER*,
                                                        LPD3DXCONSTANTTABLE*);
#else
...
#ifdef UNICODE
extern HRESULT (WINAPI* _D3DXCompileShaderFromFile)(LPCWSTR, const D3DXMACRO*, LPD3DXINCLUDE, LPCSTR, LPCSTR, DWORD,
...
// D3DXCreateFont
#ifdef UNICODE
extern HRESULT (WINAPI* _D3DXCreateFont)(LPDIRECT3DDEVICE9, INT, UINT, UINT, UINT, BOOL, DWORD, DWORD, DWORD, DWORD,
                                         LPCWSTR, LPD3DXFONT*);
#else
