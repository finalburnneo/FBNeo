...
static void draw_sprites()
{
	for (INT32 offs = 0x30 - 2; offs >= 0; offs -= 2)
	{
		...
		RenderTileTranstab(pTransDraw, DrvGfxROM0, code, color * 16, 0, 240 - sx, sy - 16, flipx, flipy, 16, 16,
		                   DrvColPROM + 0x20);
	}
}
...
struct BurnDriver BurnDrvRocnrope = {
	"rocnrope", nullptr, nullptr, nullptr, "1983",
	"Roc'n Rope\0", nullptr, "Konami", "GX364",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_PLATFORM, 0,
	nullptr, rocnropeRomInfo, rocnropeRomName, nullptr, nullptr, nullptr, nullptr, RocnropeInputInfo, RocnropeDIPInfo,
...
struct BurnDriver BurnDrvRocnropek = {
	"rocnropek", "rocnrope", nullptr, nullptr, "1983",
	"Roc'n Rope (Kosuka)\0", nullptr, "Konami / Kosuka", "GX364",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI,
	GBF_PLATFORM, 0,
	nullptr, rocnropekRomInfo, rocnropekRomName, nullptr, nullptr, nullptr, nullptr, RocnropeInputInfo, RocnropeDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvRopeman = {
	"ropeman", "rocnrope", nullptr, nullptr, "1983",
	"Ropeman (bootleg of Roc'n Rope)\0", nullptr, "bootleg", "GX364",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_PLATFORM, 0,
	nullptr, ropemanRomInfo, ropemanRomName, nullptr, nullptr, nullptr, nullptr, RocnropeInputInfo, RocnropeDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 256, 3, 4
};
