...
static INT32 MemIndex()
{
	...
	DrvScrRegs = (UINT16*)Next;
	Next += 0x000004 * sizeof(INT16);
	DrvVidRegs = (UINT16*)Next;
	Next += 0x000001 * sizeof(INT16);
...
{
	auto ram = (UINT16*)(DrvVidRAM + layer * 0x2000);
	auto scroll = DrvScrRegs + layer * 2;
...
static void draw_bitmap()
{
	...
	for (INT32 y = 0; y < nScreenHeight; y++)
	{
		for (INT32 x = 0; x < nScreenWidth; x += 4)
		{
			...
			v = (s >> 12) & 0x0f;
			if (v != 15) dst[x + 0] = v + colorbase;
			v = (s >> 8) & 0x0f;
			if (v != 15) dst[x + 1] = v + colorbase;
			v = (s >> 4) & 0x0f;
			if (v != 15) dst[x + 2] = v + colorbase;
			v = (s >> 0) & 0x0f;
			if (v != 15) dst[x + 3] = v + colorbase;
		}
...
struct BurnDriver BurnDrvRabiolep = {
	"rabiolep", nullptr, nullptr, nullptr, "1987",
	"Rabio Lepus (Japan)\0", nullptr, "V-System Co.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, rabiolepRomInfo, rabiolepRomName, nullptr, nullptr, nullptr, nullptr, RpunchInputInfo, RabiolepDIPInfo,
...
struct BurnDriver BurnDrvRpunch = {
	"rpunch", "rabiolep", nullptr, nullptr, "1987",
	"Rabbit Punch (US)\0", nullptr, "V-System Co. (Bally/Midway/Sente license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, rpunchRomInfo, rpunchRomName, nullptr, nullptr, nullptr, nullptr, RpunchInputInfo, RpunchDIPInfo,
	rpunchInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	288, 216, 4, 3
};
...
struct BurnDriver BurnDrvSvolley = {
	"svolley", nullptr, nullptr, nullptr, "1989",
	"Super Volleyball (Japan)\0", nullptr, "V-System Co.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, svolleyRomInfo, svolleyRomName, nullptr, nullptr, nullptr, nullptr, RpunchInputInfo, SvolleyDIPInfo,
...
struct BurnDriver BurnDrvSvolleyk = {
	"svolleyk", "svolley", nullptr, nullptr, "1989",
	"Super Volleyball (Korea)\0", nullptr, "V-System Co.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, svolleykRomInfo, svolleykRomName, nullptr, nullptr, nullptr, nullptr, RpunchInputInfo, SvolleyDIPInfo,
...
struct BurnDriver BurnDrvSvolleyu = {
	"svolleyu", "svolley", nullptr, nullptr, "1989",
	"Super Volleyball (US, Data East license)\0", nullptr, "V-System Co. (Data East license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, svolleyuRomInfo, svolleyuRomName, nullptr, nullptr, nullptr, nullptr, RpunchInputInfo, SvolleyDIPInfo,
	svolleyInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	288, 216, 4, 3
};
...
struct BurnDriver BurnDrvSvolleyua = {
	"svolleyua", "svolley", nullptr, nullptr, "1989",
	"Super Volleyball (US)\0", nullptr, "V-System Co.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, svolleyuaRomInfo, svolleyuaRomName, nullptr, nullptr, nullptr, nullptr, RpunchInputInfo, SvolleyDIPInfo,
