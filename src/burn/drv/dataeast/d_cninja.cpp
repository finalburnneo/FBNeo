...
{
	{0x14, 0xff, 0xff, 0xbf, nullptr},
	{0x15, 0xff, 0xff, 0x7f, nullptr},
...
static void __fastcall cninja_main_write_word(UINT32 address, UINT16 data)
{
	...
	if (address >= 0x198000 && address <= 0x19bfff)
	{
		// edrandy
	...
	if (address >= 0x1bc000 && address <= 0x1bffff)
	{
		// cninja
...
static INT32 CninjablInit()
{
	...
	MSM6295Init(0, 1006875 / 132, true);
	MSM6295Init(1, 2013750 / 132, true);
...
static INT32 Robocop2Init()
{
	...
	deco16SoundInit(DrvHucROM, DrvHucRAM, static_cast<INT32>((double)4027500 * 57.79 / 60), 1, DrvYM2151WritePort, 0.45,
	                1006875, 0.75, 2013750, 0.50);
	BurnYM2203SetAllRoutes(0, 0.60, BURN_SND_ROUTE_BOTH);
...
{
	auto buffered_spriteram = (UINT16*)DrvSprBuf;
	...
	for (INT32 offs = 0x400 - 4; offs >= 0; offs -= 4)
	{
		...
		case 0x0000: pri = 0;
			break;
		case 0x4000: pri = 0xf0;
			break;
		case 0x8000: pri = 0xf0 | 0xcc;
			break;
		case 0xc000: pri = 0xf0 | 0xcc;
			break;
		}
		...
		while (multi >= 0)
		{
			deco16_draw_prio_sprite(pTransDraw, DrvGfxROM3, sprite - multi * inc, (color << 4) + 0x300, x + xoffset,
			                        y + mult * multi, flipx, flipy, pri);
...
static void cninjabl_draw_sprites()
{
	...
	for (offs = endoffs; offs >= 0; offs -= 4)
	{
		...
		while (multi >= 0)
		{
			deco16_draw_prio_sprite(pTransDraw, DrvGfxROM3, sprite - multi * inc, (colour << 4) + 0x300, x,
			                        y + mult * multi, fx, fy, pri);
	...
	while (offs != end)
	{
		...
		for (x = 0; x < w; x++)
		{
			for (y = 0; y < h; y++)
			{
				...
				deco16_draw_prio_sprite(pTransDraw, gfx, sprite + y + h * x, (colour << 4) + colbank,
				                        sx + x_mult * (w - x), sy + y_mult * (h - y), fx, fy, 0);
			}
		}
		offs += inc;
	}
...
static INT32 EdrandyDrawScanline(INT32 line)
{
	...
	if (nSpriteEnable & 1) deco16_draw_layer_by_line(lastline, line, 3, pTransDraw,
	                                                 DECO16_LAYER_PRIORITY(0x01) | DECO16_LAYER_OPAQUE);
...
static INT32 Robocop2DrawScanline(INT32 line)
{
	...
	else
	{
		...
		if (nSpriteEnable & 1) deco16_draw_layer_by_line(lastline, line, 3, pTransDraw,
		                                                 DECO16_LAYER_OPAQUE | DECO16_LAYER_PRIORITY(0x01));
	}

	if (deco16_priority & 8)
	{
		if (nSpriteEnable & 2) deco16_draw_layer_by_line(lastline, line, 1, pTransDraw, DECO16_LAYER_PRIORITY(0x02));
		if (nSpriteEnable & 4) deco16_draw_layer_by_line(lastline, line, 2, pTransDraw,
		                                                 DECO16_LAYER_PRIORITY(0x04) | layer_8bpp);
	}
	else
	{
		if (nSpriteEnable & 2) deco16_draw_layer_by_line(lastline, line, 2, pTransDraw,
		                                                 DECO16_LAYER_PRIORITY(0x02) | layer_8bpp);
		if (nSpriteEnable & 4) deco16_draw_layer_by_line(lastline, line, 1, pTransDraw, DECO16_LAYER_PRIORITY(0x04));
	}
...
static INT32 CninjaFrame()
{
	...
	INT32 nCyclesTotal[2] = {
		static_cast<INT32>((double)12000000 * 100 / nBurnFPS), static_cast<INT32>((double)4027500 * 100 / nBurnFPS)
	};
...
static INT32 Robocop2Frame()
{
	...
	INT32 nInterleave = 256; // scanlines
	INT32 nCyclesTotal[2] = {
		static_cast<INT32>((double)14000000 / 57.79965), static_cast<INT32>((double)4027500 / 57.79965)
	};
	INT32 nCyclesDone[2] = {nExtraCycles[0], nExtraCycles[1]};
...
static INT32 StoneageFrame()
{
	...
	INT32 nCyclesTotal[2] = {
		static_cast<INT32>((double)12000000 * 100 / nBurnFPS), static_cast<INT32>((double)3579545 * 100 / nBurnFPS)
	};
	INT32 nCyclesDone[2] = {nExtraCycles[0], nExtraCycles[1]};
...
struct BurnDriver BurnDrvCninja = {
	"cninja", nullptr, nullptr, nullptr, "1991",
	"Caveman Ninja (World ver 4)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, cninjaRomInfo, cninjaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, CninjaDIPInfo,
...
struct BurnDriver BurnDrvCninja1 = {
	"cninja1", "cninja", nullptr, nullptr, "1991",
	"Caveman Ninja (World ver 1)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, cninja1RomInfo, cninja1RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, CninjaDIPInfo,
	CninjaInit, DrvExit, CninjaFrame, CninjaDraw, DrvScan, &DrvRecalc, 0x800,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvCninjau = {
	"cninjau", "cninja", nullptr, nullptr, "1991",
	"Caveman Ninja (US ver 4)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, cninjauRomInfo, cninjauRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, CninjauDIPInfo,
	CninjaInit, DrvExit, CninjaFrame, CninjaDraw, DrvScan, &DrvRecalc, 0x800,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvJoemac = {
	"joemac", "cninja", nullptr, nullptr, "1991",
	"Tatakae Genshizin Joe & Mac (Japan ver 1)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, joemacRomInfo, joemacRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, CninjaDIPInfo,
	CninjaInit, DrvExit, CninjaFrame, CninjaDraw, DrvScan, &DrvRecalc, 0x800,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvStoneage = {
	"stoneage", "cninja", nullptr, nullptr, "1991",
	"Stoneage (bootleg of Caveman Ninja)\0", nullptr, "bootleg", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, stoneageRomInfo, stoneageRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, CninjaDIPInfo,
...
struct BurnDriver BurnDrvCninjabl = {
	"cninjabl", "cninja", nullptr, nullptr, "1991",
	"Caveman Ninja (bootleg)\0", nullptr, "bootleg", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, cninjablRomInfo, cninjablRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, CninjaDIPInfo,
...
struct BurnDriver BurnDrvMutantf = {
	"mutantf", nullptr, nullptr, nullptr, "1991",
	"Mutant Fighter (World ver EM-5)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, mutantfRomInfo, mutantfRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MutantfDIPInfo,
...
struct BurnDriver BurnDrvMutantf4 = {
	"mutantf4", "mutantf", nullptr, nullptr, "1991",
	"Mutant Fighter (World ver EM-4)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, mutantf4RomInfo, mutantf4RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MutantfDIPInfo,
	MutantfInit, DrvExit, MutantfFrame, MutantfDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvMutantf3 = {
	"mutantf3", "mutantf", nullptr, nullptr, "1991",
	"Mutant Fighter (World ver EM-3)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, mutantf3RomInfo, mutantf3RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MutantfDIPInfo,
	MutantfInit, DrvExit, MutantfFrame, MutantfDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvMutantf2 = {
	"mutantf2", "mutantf", nullptr, nullptr, "1991",
	"Mutant Fighter (World ver EM-2)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, mutantf2RomInfo, mutantf2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MutantfDIPInfo,
	MutantfInit, DrvExit, MutantfFrame, MutantfDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvMutantf1 = {
	"mutantf1", "mutantf", nullptr, nullptr, "1991",
	"Heroes (World ver EM-1)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, mutantf1RomInfo, mutantf1RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MutantfDIPInfo,
	MutantfInit, DrvExit, MutantfFrame, MutantfDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvDeathbrd = {
	"deathbrd", "mutantf", nullptr, nullptr, "1991",
	"Death Brade (Japan ver JM-3)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, deathbrdRomInfo, deathbrdRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MutantfDIPInfo,
	MutantfInit, DrvExit, MutantfFrame, MutantfDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvEdrandy = {
	"edrandy", nullptr, nullptr, nullptr, "1990",
	"The Cliffhanger - Edward Randy (World ver 3)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, edrandyRomInfo, edrandyRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, EdrandyDIPInfo,
...
struct BurnDriver BurnDrvEdrandy2 = {
	"edrandy2", "edrandy", nullptr, nullptr, "1990",
	"The Cliffhanger - Edward Randy (World ver 2)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, edrandy2RomInfo, edrandy2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, EdrandcDIPInfo,
	EdrandyInit, DrvExit, EdrandyFrame, EdrandyDraw, DrvScan, &DrvRecalc, 0x800,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvEdrandy1 = {
	"edrandy1", "edrandy", nullptr, nullptr, "1990",
	"The Cliffhanger - Edward Randy (World ver 1)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, edrandy1RomInfo, edrandy1RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, EdrandcDIPInfo,
	EdrandyInit, DrvExit, EdrandyFrame, EdrandyDraw, DrvScan, &DrvRecalc, 0x800,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvEdrandyj = {
	"edrandyj", "edrandy", nullptr, nullptr, "1990",
	"The Cliffhanger - Edward Randy (Japan ver 3)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, edrandyjRomInfo, edrandyjRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, EdrandcDIPInfo,
	EdrandyInit, DrvExit, EdrandyFrame, EdrandyDraw, DrvScan, &DrvRecalc, 0x800,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvRobocop2 = {
	"robocop2", nullptr, nullptr, nullptr, "1991",
	"Robocop 2 (Euro/Asia v0.10)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_RUNGUN, 0,
	nullptr, robocop2RomInfo, robocop2RomName, nullptr, nullptr, nullptr, nullptr, Robocop2InputInfo, Robocop2DIPInfo,
...
struct BurnDriver BurnDrvRobocop2u = {
	"robocop2u", "robocop2", nullptr, nullptr, "1991",
	"Robocop 2 (US v0.10)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_RUNGUN, 0,
	nullptr, robocop2uRomInfo, robocop2uRomName, nullptr, nullptr, nullptr, nullptr, Robocop2InputInfo, Robocop2DIPInfo,
	Robocop2Init, DrvExit, Robocop2Frame, Robocop2Draw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvRobocop2ua = {
	"robocop2ua", "robocop2", nullptr, nullptr, "1991",
	"Robocop 2 (US v0.05)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_RUNGUN, 0,
	nullptr, robocop2uaRomInfo, robocop2uaRomName, nullptr, nullptr, nullptr, nullptr, Robocop2InputInfo,
	Robocop2DIPInfo,
	Robocop2Init, DrvExit, Robocop2Frame, Robocop2Draw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvRobocop2j = {
	"robocop2j", "robocop2", nullptr, nullptr, "1991",
	"Robocop 2 (Japan v0.11)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_RUNGUN, 0,
	nullptr, robocop2jRomInfo, robocop2jRomName, nullptr, nullptr, nullptr, nullptr, Robocop2InputInfo, Robocop2DIPInfo,
	Robocop2Init, DrvExit, Robocop2Frame, Robocop2Draw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
