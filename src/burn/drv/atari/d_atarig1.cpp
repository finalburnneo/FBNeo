...
static UINT8 read_analog(INT32 port)
{
	...
	switch (port)
	{
	case 0: ret = ProcessAnalog(DrvAnalogPort0, 0, INPUT_DEADZONE, 0x00, 0xfe);
		break;
	case 1: ret = ProcessAnalog(DrvAnalogPort1, 0, INPUT_DEADZONE, 0x00, 0xfe);
		break;
	case 2: ret = ProcessAnalog(DrvAnalogPort2, 0, INPUT_DEADZONE | INPUT_LINEAR | INPUT_MIGHTBEDIGITAL, 0x00, 0xff);
		break;
	}
...
static INT32 MemIndex()
{
	...
	Next += 0x4000; // 0 - fff
	DrvPfRAM = Next;
	Next += 0x2000; // 4000 - 5fff
	DrvAlphaRAM = Next;
	Next += 0x1000; // 6000 - 6fff
...
static INT32 DrvGfxDecode()
{
	...
	auto extra = BurnMalloc(0x100000);
...
{
	static constexpr struct atarirle_desc modesc_hydra =
	{
	...
	static constexpr struct atarirle_desc modesc_pitfight =
	{
		0, // region where the GFX data lives
		256, // number of entries in sprite RAM
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[2] = {static_cast<INT32>(14318180 / 59.92), static_cast<INT32>(1789773 / 59.92)};
...
struct BurnDriver BurnDrvHydra = {
	"hydra", nullptr, nullptr, nullptr, "1990",
	"Hydra\0", nullptr, "Atari Games", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hydraRomInfo, hydraRomName, nullptr, nullptr, nullptr, nullptr, HydraInputInfo, HydraDIPInfo,
...
struct BurnDriver BurnDrvHydrap = {
	"hydrap", "hydra", nullptr, nullptr, "1990",
	"Hydra (prototype 5/14/90)\0", nullptr, "Atari Games", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hydrapRomInfo, hydrapRomName, nullptr, nullptr, nullptr, nullptr, HydraInputInfo, HydraDIPInfo,
...
struct BurnDriver BurnDrvPitfight = {
	"pitfight", nullptr, nullptr, nullptr, "1990",
	"Pit Fighter (rev 9)\0", nullptr, "Atari Games", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, pitfightRomInfo, pitfightRomName, nullptr, nullptr, nullptr, nullptr, PitfightInputInfo, PitfightDIPInfo,
...
struct BurnDriver BurnDrvPitfight3 = {
	"pitfight3", "pitfight", nullptr, nullptr, "1990",
	"Pit Fighter (rev 3)\0", nullptr, "Atari Games", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, pitfight3RomInfo, pitfight3RomName, nullptr, nullptr, nullptr, nullptr, PitfightInputInfo, PitfightDIPInfo,
