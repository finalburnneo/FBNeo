...
burning rubber background color bad



todo:
fix graphics
verify all clones & parents present and accounted for
-clocknchj
...
static struct BurnInputInfo DecocassInputList[] = {
	...
	{"P1 Button 6",		BIT_DIGITAL,	DrvJoy3 + 0,	"p1 fire 6"},
...
static struct BurnDIPInfo DecocassDIPList[]=
{
	...
	{0x15, 0x01, 0x30, 0x00, "MT (Big)"		},
	{0x15, 0x01, 0x30, 0x10, "invalid?"		},
	{0x15, 0x01, 0x30, 0x20, "invalid?"		},
	{0x15, 0x01, 0x30, 0x30, "MD (Small)"		},

	{0   , 0xfe, 0   ,    2, "Cabinet"		},
	{0x15, 0x01, 0x40, 0x00, "Upright"		},
	{0x15, 0x01, 0x40, 0x40, "Cocktail"		},

	{0   , 0xfe, 0   ,    6, "Country Code"		},
	{0x16, 0x01, 0xe0, 0xe0, "A"			},
	{0x16, 0x01, 0xe0, 0xc0, "B"			},
	{0x16, 0x01, 0xe0, 0xa0, "C"			},
	{0x16, 0x01, 0xe0, 0x80, "D"			},
	{0x16, 0x01, 0xe0, 0x60, "E"			},
	{0x16, 0x01, 0xe0, 0x40, "F"			},

	{0   , 0xfe, 0   ,    4, "Bios Version"		},
	{0x17, 0x01, 0x03, 0x00, "Japan A, Newer"	},
	{0x17, 0x01, 0x03, 0x01, "Japan A, Older"	},
	{0x17, 0x01, 0x03, 0x02, "USA B, Newer"		},
	{0x17, 0x01, 0x03, 0x03, "USA B, Older"		},
};
...
static struct BurnDIPInfo CmanhatDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    2, "Lives"		},
	{0x16, 0x01, 0x01, 0x01, "4"			},
	{0x16, 0x01, 0x01, 0x00, "6"			},
};
...
static struct BurnDIPInfo CterraniDIPList[]=
{
	...
	{0x16, 0x01, 0x06, 0x06, "3000"			},
	{0x16, 0x01, 0x06, 0x04, "5000"			},
	{0x16, 0x01, 0x06, 0x02, "7000"			},
...
static struct BurnDIPInfo CsuperasDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Bonus Life"		},
	{0x16, 0x01, 0x06, 0x00, "None"			},
	{0x16, 0x01, 0x06, 0x06, "20000"		},
	{0x16, 0x01, 0x06, 0x04, "30000"		},
	{0x16, 0x01, 0x06, 0x02, "40000"		},
...
static struct BurnDIPInfo CtislandDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Bonus Life"		},
	{0x16, 0x01, 0x06, 0x06, "15000"		},
	{0x16, 0x01, 0x06, 0x04, "20000"		},
	{0x16, 0x01, 0x06, 0x02, "25000"		},
	{0x16, 0x01, 0x06, 0x00, "30000"		},
};
...
static struct BurnDIPInfo Cocean1aDIPList[]=
{
	...
	{0x15, 0x01, 0x07, 0x07, "1"			},
	{0x15, 0x01, 0x07, 0x06, "2"			},
	{0x15, 0x01, 0x07, 0x05, "5"			},
	{0x15, 0x01, 0x07, 0x04, "10"			},
	{0x15, 0x01, 0x07, 0x03, "20"			},
	{0x15, 0x01, 0x07, 0x02, "30"			},
	{0x15, 0x01, 0x07, 0x01, "40"			},
	{0x15, 0x01, 0x07, 0x00, "50"			},

	{0   , 0xfe, 0   ,    2, "None"			},
	{0x15, 0x01, 0x08, 0x08, "Off"			},
	{0x15, 0x01, 0x08, 0x00, "None"			},

	{0   , 0xfe, 0   ,    4, "Key Switch Credit"	},
	{0x16, 0x01, 0x03, 0x03, "1 Coin 10 Credits"	},
	{0x16, 0x01, 0x03, 0x02, "1 Coin 20 Credits"	},
	{0x16, 0x01, 0x03, 0x01, "1 Coin 50 Credits"	},
	{0x16, 0x01, 0x03, 0x00, "1 Coin 100 Credits"	},

	{0   , 0xfe, 0   ,    2, "Game Select"		},
	{0x16, 0x01, 0x04, 0x04, "1 to 8 Lines"		},
	{0x16, 0x01, 0x04, 0x00, "Center Line"		},
	...
	{0   , 0xfe, 0   ,    2, "Pay Out %"		},
	{0x16, 0x01, 0x10, 0x10, "Payout 75%"		},
	{0x16, 0x01, 0x10, 0x00, "Payout 85%"		},
};
...
static struct BurnDIPInfo ClocknchDIPList[]=
{
	...
	{0x16, 0x01, 0x08, 0x08, "Slow"			},
	{0x16, 0x01, 0x08, 0x00, "Hard"			},
};
...
static struct BurnDIPInfo CexploreDIPList[]=
{
	...
	{0x16, 0x01, 0x10, 0x10, "Few"			},
	{0x16, 0x01, 0x10, 0x00, "Many"			},
};
...
static struct BurnDIPInfo CsweethtDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    2, "Music Weapons"	},
	{0x16, 0x01, 0x08, 0x00, "8"			},
	{0x16, 0x01, 0x08, 0x08, "5"			},
};
...
static struct BurnDIPInfo CmissnxDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Bonus Life"		},
	{0x16, 0x01, 0x06, 0x00, "None"			},
	{0x16, 0x01, 0x06, 0x06, "5000"			},
	{0x16, 0x01, 0x06, 0x04, "10000"		},
	{0x16, 0x01, 0x06, 0x02, "15000"		},
...
static struct BurnDIPInfo CbtimeDIPList[]=
{
	...
	{0x16, 0x01, 0x06, 0x04, "30000"		},
	{0x16, 0x01, 0x06, 0x02, "40000"		},
	{0x16, 0x01, 0x06, 0x00, "50000"		},

	{0   , 0xfe, 0   ,    2, "Enemies"		},
	{0x16, 0x01, 0x08, 0x08, "4"			},
	{0x16, 0x01, 0x08, 0x00, "6"			},
...
static struct BurnDIPInfo CburnrubDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Bonus Life"		},
	{0x16, 0x01, 0x06, 0x02, "20000"		},
	{0x16, 0x01, 0x06, 0x00, "30000"		},
	{0x16, 0x01, 0x06, 0x06, "Every 30000"		},
	{0x16, 0x01, 0x06, 0x04, "Every 70000"		},
...
static struct BurnDIPInfo CgraplopDIPList[]=
{
	...
	{0x16, 0x01, 0x06, 0x00, "None"			},
	{0x16, 0x01, 0x06, 0x06, "20000"		},
	{0x16, 0x01, 0x06, 0x04, "50000"		},
	{0x16, 0x01, 0x06, 0x02, "70000"		},

	{0   , 0xfe, 0   ,    2, "Number of Up Sign"	},
	{0x16, 0x01, 0x08, 0x08, "Few"			},
	{0x16, 0x01, 0x08, 0x00, "Many"			},
...
static struct BurnDIPInfo CnightstDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Bonus Life"		},
	{0x16, 0x01, 0x06, 0x06, "When Night Star Completed (First 2 Times)"		},
	{0x16, 0x01, 0x06, 0x04, "When Night Star Completed (First Time Only)"		},
	{0x16, 0x01, 0x06, 0x02, "Every 70000"		},
	{0x16, 0x01, 0x06, 0x00, "30000 Only"		},
...
static struct BurnDIPInfo CskaterDIPList[]=
{
	...
	{0x16, 0x01, 0x10, 0x10, "Small"		},
	{0x16, 0x01, 0x10, 0x00, "Large"		},
};
...
static struct BurnDIPInfo CpsoccerDIPList[]=
{
	...
	{0x16, 0x01, 0x06, 0x00, "None"			},
	{0x16, 0x01, 0x06, 0x06, "5"			},
	{0x16, 0x01, 0x06, 0x04, "10"			},
	{0x16, 0x01, 0x06, 0x02, "20"			},
...
static struct BurnDIPInfo CsdtenisDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Bonus Life"		},
	{0x16, 0x01, 0x06, 0x00, "None"			},
	{0x16, 0x01, 0x06, 0x06, "Every 1set"		},
	{0x16, 0x01, 0x06, 0x04, "Every 2set"		},
	{0x16, 0x01, 0x06, 0x02, "Every 3set"		},

	{0   , 0xfe, 0   ,    2, "Speed Level"		},
	{0x16, 0x01, 0x08, 0x08, "Low Speed"		},
	{0x16, 0x01, 0x08, 0x00, "High Speed"		},
...
static struct BurnDIPInfo CzeroizeDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    4, "Bonus Life"		},
	{0x16, 0x01, 0x06, 0x06, "None"			},
	{0x16, 0x01, 0x06, 0x04, "50000"		},
	{0x16, 0x01, 0x06, 0x02, "70000"		},
	{0x16, 0x01, 0x06, 0x00, "90000"		},
};
...
static struct BurnDIPInfo CscrtryDIPList[]=
{
	...
	{0x16, 0x01, 0x10, 0x10, "Timer decrease"	},
	{0x16, 0x01, 0x10, 0x00, "Timer infinity"	},
};
...
static struct BurnDIPInfo CfghticeDIPList[]=
{
	...
	{0x16, 0x01, 0x06, 0x04, "Very Easy"		},
	{0x16, 0x01, 0x06, 0x06, "Easy"			},
	{0x16, 0x01, 0x06, 0x00, "Difficult"		},
	{0x16, 0x01, 0x06, 0x02, "Very Difficult"	},

	{0   , 0xfe, 0   ,    2, "Enemy's Speed"	},
	{0x16, 0x01, 0x08, 0x08, "Normal"		},
	{0x16, 0x01, 0x08, 0x00, "Fast"			},
...
static struct BurnDIPInfo CbdashDIPList[]=
{
	...
	{0x16, 0x01, 0x18, 0x10, "Hard"			},
	{0x16, 0x01, 0x18, 0x08, "Harder"		},
	{0x16, 0x01, 0x18, 0x00, "Hardest"		},
};
