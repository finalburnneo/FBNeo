...
{
	{0x12, 0xff, 0xff, 0xf3, nullptr},
	{0x13, 0xff, 0xff, 0xf1, nullptr},
...
{
	{0x10, 0xff, 0xff, 0xfc, nullptr},
	{0x11, 0xff, 0xff, 0xf0, nullptr},
	{0x12, 0xff, 0xff, 0xf1, nullptr},
	{0x13, 0xff, 0xff, 0xf0, nullptr},
	{0x14, 0xff, 0xff, 0xe0, nullptr},
...
{
	return static_cast<INT32>((float)(nBurnSoundLen * (NSC8105TotalCycles() / (3072000.000 / 60))));
}
...
static INT32 MemIndex()
{
	...
	Next += 0x000400;
	DrvSprRAM = Next;
	Next += 0x000100; // 8820-887f
	DrvVidRegs = Next;
	Next += 0x000100; // 9800-981f scroll, 9880-989f spr2
...
static INT32 DrvInit(INT32 select)
{
	...
	AY8910SetPorts(0, nullptr, &ay8910_read_B, nullptr, &ay8910_write_B);
...
static INT32 DrvScan(INT32 nAction, INT32* pnMin)
{
	...
	if (nAction & ACB_NVRAM && (game_select < 2))
	{
		// friskyt nvram
		ba.Data = DrvNVRAM;
		ba.nLen = 0x0100;
...
struct BurnDriver BurnDrvFriskyt = {
	"friskyt", nullptr, nullptr, nullptr, "1981",
	"Frisky Tom (set 1)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, friskytRomInfo, friskytRomName, nullptr, nullptr, nullptr, nullptr, FriskytInputInfo, FriskytDIPInfo,
...
struct BurnDriver BurnDrvFriskyta = {
	"friskyta", "friskyt", nullptr, nullptr, "1981",
	"Frisky Tom (set 2)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, friskytaRomInfo, friskytaRomName, nullptr, nullptr, nullptr, nullptr, FriskytInputInfo, FriskytDIPInfo,
	friskytInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvFriskytb = {
	"friskytb", "friskyt", nullptr, nullptr, "1981",
	...
	nullptr, friskytbRomInfo, friskytbRomName, nullptr, nullptr, nullptr, nullptr, FriskytInputInfo, FriskytDIPInfo,
...
struct BurnDriver BurnDrvRadrad = {
	"radrad", nullptr, nullptr, nullptr, "1982",
	"Radical Radial (US)\0", nullptr, "Nichibutsu USA", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, radradRomInfo, radradRomName, nullptr, nullptr, nullptr, nullptr, RadradInputInfo, RadradDIPInfo,
...
struct BurnDriver BurnDrvRadradj = {
	"radradj", "radrad", nullptr, nullptr, "1983",
	"Radical Radial (Japan)\0", nullptr, "Logitec Corp.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, radradjRomInfo, radradjRomName, nullptr, nullptr, nullptr, nullptr, RadradInputInfo, RadradDIPInfo,
	radradInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvSeicross = {
	"seicross", nullptr, nullptr, nullptr, "1984",
	"Seicross (set 1)\0", nullptr, "Nichibutsu / Alice", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, seicrossRomInfo, seicrossRomName, nullptr, nullptr, nullptr, nullptr, SeicrossInputInfo, SeicrossDIPInfo,
...
struct BurnDriver BurnDrvSeicrossa = {
	"seicrossa", "seicross", nullptr, nullptr, "1984",
	"Seicross (set 2)\0", nullptr, "Nichibutsu / Alice", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, seicrossaRomInfo, seicrossaRomName, nullptr, nullptr, nullptr, nullptr, SeicrossInputInfo, SeicrossDIPInfo,
	seicrossInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvSectrzon = {
	"sectrzon", "seicross", nullptr, nullptr, "1984",
	"Sector Zone (set 1)\0", nullptr, "Nichibutsu / Alice", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, sectrzonRomInfo, sectrzonRomName, nullptr, nullptr, nullptr, nullptr, SeicrossInputInfo, SeicrossDIPInfo,
	seicrossInit, DrvExit, DrvFrame, DrvDraw, nullptr, &DrvRecalc, 0x40,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvSectrzont = {
	"sectrzont", "seicross", nullptr, nullptr, "1984",
	"Sector Zone (set 2, Tecfri hardware)\0", nullptr, "Nichibutsu / Alice", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_HORSHOOT, 0,
	nullptr, sectrzontRomInfo, sectrzontRomName, nullptr, nullptr, nullptr, nullptr, SeicrossInputInfo, SeicrossDIPInfo,
	seicrossInit, DrvExit, DrvFrame, DrvDraw, nullptr, &DrvRecalc, 0x40,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvSectrzona = {
	"sectrzona", "seicross", nullptr, nullptr, "1984",
	"Sector Zone (set 3)\0", nullptr, "Nichibutsu / Alice", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, sectrzonaRomInfo, sectrzonaRomName, nullptr, nullptr, nullptr, nullptr, SeicrossInputInfo, SeicrossDIPInfo,
	seicrossInit, DrvExit, DrvFrame, DrvDraw, nullptr, &DrvRecalc, 0x40,
	224, 256, 3, 4
};
