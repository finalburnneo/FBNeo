...
struct BurnDriver BurnDrvContra = {
	"contra", nullptr, nullptr, nullptr, "1987",
	"Contra (US / Asia, set 1)\0", nullptr, "Konami", "GX633",
	...
	nullptr, contraRomInfo, contraRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvContra1 = {
	"contra1", "contra", nullptr, nullptr, "1987",
	"Contra (US / Asia, set 2)\0", nullptr, "Konami", "GX633",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, contra1RomInfo, contra1RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 280, 3, 4
};
...
struct BurnDriver BurnDrvContrae = {
	"contrae", "contra", nullptr, nullptr, "1987",
	"Contra (US / Asia, set 3)\0", nullptr, "Konami", "GX633",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, contraeRomInfo, contraeRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvContraj = {
	"contraj", "contra", nullptr, nullptr, "1987",
	"Contra (Japan, set 1)\0", nullptr, "Konami", "GX633",
	L"\u9B42\u6597\u7F85 \u30B3\u30F3\u30C8\u30E9 (Japan, set 1)\0Contra\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, contrajRomInfo, contrajRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 280, 3, 4
};
...
struct BurnDriver BurnDrvContraj1 = {
	"contraj1", "contra", nullptr, nullptr, "1987",
	"Contra (Japan, set 2)\0", nullptr, "Konami", "GX633",
	L"\u9B42\u6597\u7F85 \u30B3\u30F3\u30C8\u30E9 (Japan, set 2)\0Contra\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, contraj1RomInfo, contraj1RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 280, 3, 4
};
...
struct BurnDriver BurnDrvGryzor = {
	"gryzor", "contra", nullptr, nullptr, "1987",
	"Gryzor (Set 1)\0", nullptr, "Konami", "GX633",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, gryzorRomInfo, gryzorRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, GryzorDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 280, 3, 4
};
...
struct BurnDriver BurnDrvGryzor1 = {
	"gryzor1", "contra", nullptr, nullptr, "1987",
	"Gryzor (Set 2)\0", nullptr, "Konami", "GX633",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, gryzor1RomInfo, gryzor1RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, GryzorDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 280, 3, 4
};
...
struct BurnDriver BurnDrvContrab = {
	"contrab", "contra", nullptr, nullptr, "1987",
	"Contra (bootleg)\0", nullptr, "bootleg", "GX633",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, contrabRomInfo, contrabRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvContrabj = {
	"contrabj", "contra", nullptr, nullptr, "1987",
	"Contra (Japan bootleg, set 1)\0", nullptr, "bootleg", "GX633",
	L"\u9B42\u6597\u7F85 \u30B3\u30F3\u30C8\u30E9 (Japan bootleg, set 1)\0Contra\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, contrabjRomInfo, contrabjRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	BootInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 280, 3, 4
};
...
struct BurnDriver BurnDrvContrabj1 = {
	"contrabj1", "contra", nullptr, nullptr, "1987",
	"Contra (Japan bootleg, set 2)\0", nullptr, "bootleg", "GX633",
	L"\u9B42\u6597\u7F85 \u30B3\u30F3\u30C8\u30E9 (Japan bootleg, set 2)\0Contra\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, contrabj1RomInfo, contrabj1RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	BootInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 280, 3, 4
};
