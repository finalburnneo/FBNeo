...
static UINT8 toypop_main_read(UINT16 address)
{
	...
	if ((address & 0xf000) == 0x7000 && (address_xor == 0x800))
	{
		// only toypop!
		master_irq_enable = 1;
		return 0;
...
static INT32 DrvInit(INT32 addr_xor)
{
	...
	namcoio_init(0, NAMCO58xx, nio0_i0, nio0_i1, nio0_i2, nio0_i3, nullptr, nullptr);
	namcoio_init(1, NAMCO56xx, nio1_i0, nio1_i1, nio1_i2, nio1_i3, nio1_o0, nullptr);
	namcoio_init(2, NAMCO56xx, nullptr, nio2_i1, nio2_i2, nio2_i3, nullptr, nullptr);
...
static void draw_bg_layer()
{
	...
	constexpr UINT32 src_base = 0x200 / 2;
	constexpr UINT32 src_pitch = 288 / 2;
	auto ram = (UINT16*)DrvBgVRAM;
...
static void draw_sprites()
{
	...
	constexpr UINT16 bank1 = 0x0800;
	constexpr UINT16 bank2 = 0x1000;
	...
	for (INT32 count = 0x780; count < 0x800; count += 2)
	{
		...
		for (INT32 yi = 0; yi < height; yi++)
		{
			for (INT32 xi = 0; xi < width; xi++)
			{
				...
				RenderTileTranstabOffset(pTransDraw, DrvGfxROM1, code, (color << 2), 0xff, x + xi * 16, y + yi * 16, fx,
				                         fy, 16, 16, DrvColPROM + 0x500, 0x200);
			}
		}
	}
}
...
struct BurnDriver BurnDrvLiblrabl = {
	"liblrabl", nullptr, nullptr, nullptr, "1983",
	"Libble Rabble\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, liblrablRomInfo, liblrablRomName, nullptr, nullptr, nullptr, nullptr, LiblrablInputInfo, LiblrablDIPInfo,
...
struct BurnDriver BurnDrvToypop = {
	"toypop", nullptr, nullptr, nullptr, "1986",
	"Toypop\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PUZZLE, 0,
	nullptr, toypopRomInfo, toypopRomName, nullptr, nullptr, nullptr, nullptr, ToypopInputInfo, ToypopDIPInfo,
