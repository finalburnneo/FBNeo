...
static INT32 DrvInit()
{
	...
	K051316Init(0, nullptr, DrvGfxROM2, 0x3ffff, divebomb_roz0_callback, 8, 0xff);
	K051316Init(1, nullptr, DrvGfxROM3, 0x3ffff, divebomb_roz1_callback, 8, 0xff);
...
static INT32 DrvDraw()
{
	...
	if (true && (nBurnLayer & 4)) GenericTilemapDraw(0, pTransDraw, 0);
...
struct BurnDriver BurnDrvDivebomb = {
	"divebomb", nullptr, nullptr, nullptr, "1989",
	"Kyuukoukabakugekitai - Dive Bomber Squad (Japan, prototype)\0", "bugs are normal!", "Konami", "GX840",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_PROTOTYPE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI,
	GBF_VERSHOOT, 0,
	nullptr, divebombRomInfo, divebombRomName, nullptr, nullptr, nullptr, nullptr, DivebombInputInfo, DivebombDIPInfo,
