...
static constexpr INT32 max_timers = 0x10;
...
{
	return (static_cast<double>(mhz) / 1000 * msec);
}

INT32 usec_to_cycles(INT32 mhz, double usec)
{
	return (static_cast<double>(mhz) / 1000000 * usec);
}

INT32 nsec_to_cycles(INT32 mhz, double nsec)
{
	return (static_cast<double>(mhz) / 1000000000 * nsec);
}
