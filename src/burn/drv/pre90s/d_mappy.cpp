...
static INT32 MappyInit()
{
	...
	namcoio_init(1, NAMCO58xx, nio1_i0, nio1_i1, nio1_i2, nio1_i3, nio1_o0, nullptr);
...
static INT32 MotosInit()
{
	...
	namcoio_init(0, NAMCO56xx, nio0_i0, nio0_i1, nio0_i2, nio0_i3, nullptr, nullptr);
	namcoio_init(1, NAMCO56xx, nio1_i0, nio1_i1, nio1_i2, nio1_i3, nio1_o0, nullptr);
...
static INT32 PacnpalInit()
{
	...
	namcoio_init(0, NAMCO56xx, nio0_i0, nio0_i1, nio0_i2, nio0_i3, nullptr, nullptr);
	namcoio_init(1, NAMCO59xx, nio1_i0, nio1_i1, nio1_i2, nio1_i3, nio1_o0, nullptr);
...
static INT32 PhozonInit()
{
	...
	namcoio_init(0, NAMCO58xx, nio0_i0, nio0_i1, nio0_i2, nio0_i3, nullptr, nullptr);
	namcoio_init(1, NAMCO56xx, nio1_i0b, nio1_i1, nio1_i2, nio1_i3, nio1_o0, nullptr);
...
static void mappy_draw_sprites(INT32 depth, INT32 priority)
{
	...
	for (INT32 offs = 0; offs < 0x80; offs += 2)
	{
		if ((ram2[offs + 1] & 2) == 0)
		{
			static constexpr UINT8 gfx_offs[2][2] =
			{
				{0, 1},
				{2, 3}
			};
			...
			for (INT32 y = 0; y <= sizey; y++)
			{
				for (INT32 x = 0; x <= sizex; x++)
				{
					...
					{
						RenderTileTranstab(pTransDraw, DrvGfxROM1, code, color + 0x100, 0xf, sx + 16 * x, sy + 16 * y,
						                   flipx, flipy, 16, 16, DrvColPROM + 0x020);
					}
				}
			}
		}
...
static void phozon_draw_sprites()
{
	...
	for (INT32 offs = 0; offs < 0x80; offs += 2)
	{
		if ((ram2[offs + 1] & 2) == 0)
		{
			static constexpr UINT8 size[4] = {1, 0, 3, 0};
			static constexpr UINT8 gfx_offs[4][4] =
			{
				{0, 1, 4, 5},
				{2, 3, 6, 7},
				{8, 9, 12, 13},
			...
			for (INT32 y = 0; y <= sizey; y++)
			{
				for (INT32 x = 0; x <= sizex; x++)
				{
					...
					RenderTileTranstab(pTransDraw, DrvGfxROM1, code, (color * 4) + 0x100, 0x0f, sx + 8 * x, sy + 8 * y,
					                   flipx, flipy, 8, 8, DrvColPROM + 0x300);
				}
			}
		}
	}
...
struct BurnDriver BurnDrvMappy = {
	"mappy", nullptr, nullptr, nullptr, "1983",
	"Mappy (US)\0", nullptr, "Namco", "Miscellaneous",
	...
	nullptr, mappyRomInfo, mappyRomName, nullptr, nullptr, nullptr, nullptr, MappyInputInfo, MappyDIPInfo,
...
struct BurnDriver BurnDrvMappyj = {
	"mappyj", "mappy", nullptr, nullptr, "1983",
	"Mappy (Japan)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, mappyjRomInfo, mappyjRomName, nullptr, nullptr, nullptr, nullptr, MappyInputInfo, MappyDIPInfo,
	MappyInit, DrvExit, DrvFrame, MappyDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvDigdug2 = {
	"digdug2", nullptr, nullptr, nullptr, "1985",
	"Dig Dug II (New Ver.)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE | GBF_ACTION, 0,
	nullptr, digdug2RomInfo, digdug2RomName, nullptr, nullptr, nullptr, nullptr, Digdug2InputInfo, Digdug2DIPInfo,
...
struct BurnDriver BurnDrvDigdug2o = {
	"digdug2o", "digdug2", nullptr, nullptr, "1985",
	"Dig Dug II (Old Ver.)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE | GBF_ACTION, 0,
	nullptr, digdug2oRomInfo, digdug2oRomName, nullptr, nullptr, nullptr, nullptr, Digdug2InputInfo, Digdug2DIPInfo,
	Digdug2Init, DrvExit, DrvFrame, MappyDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvTodruaga = {
	"todruaga", nullptr, nullptr, nullptr, "1984",
	"The Tower of Druaga (New Ver.)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, todruagaRomInfo, todruagaRomName, nullptr, nullptr, nullptr, nullptr, TodruagaInputInfo, TodruagaDIPInfo,
...
struct BurnDriver BurnDrvTodruagao = {
	"todruagao", "todruaga", nullptr, nullptr, "1984",
	"The Tower of Druaga (Old Ver.)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, todruagaoRomInfo, todruagaoRomName, nullptr, nullptr, nullptr, nullptr, TodruagaInputInfo, TodruagaDIPInfo,
	Digdug2Init, DrvExit, DrvFrame, MappyDraw, DrvScan, &DrvRecalc, 0x500,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvTodruagas = {
	"todruagas", "todruaga", nullptr, nullptr, "1984",
	"The Tower of Druaga (Sidam)\0", nullptr, "bootleg? (Sidam)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, todruagasRomInfo, todruagasRomName, nullptr, nullptr, nullptr, nullptr, TodruagaInputInfo, TodruagaDIPInfo,
	Digdug2Init, DrvExit, DrvFrame, MappyDraw, DrvScan, &DrvRecalc, 0x500,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvMotos = {
	"motos", nullptr, nullptr, nullptr, "1985",
	"Motos\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, motosRomInfo, motosRomName, nullptr, nullptr, nullptr, nullptr, MotosInputInfo, MotosDIPInfo,
...
struct BurnDriver BurnDrvSuperpac = {
	"superpac", nullptr, nullptr, nullptr, "1982",
	"Super Pac-Man\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, superpacRomInfo, superpacRomName, nullptr, nullptr, nullptr, nullptr, SuperpacInputInfo, SuperpacDIPInfo,
...
struct BurnDriver BurnDrvSuperpacm = {
	"superpacm", "superpac", nullptr, nullptr, "1982",
	"Super Pac-Man (Midway)\0", nullptr, "Namco (Bally Midway license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, superpacmRomInfo, superpacmRomName, nullptr, nullptr, nullptr, nullptr, SuperpacInputInfo, SuperpacDIPInfo,
	SuperpacInit, DrvExit, DrvFrame, SuperpacDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvPacnpal = {
	"pacnpal", nullptr, nullptr, nullptr, "1983",
	"Pac & Pal\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, pacnpalRomInfo, pacnpalRomName, nullptr, nullptr, nullptr, nullptr, PacnpalInputInfo, PacnpalDIPInfo,
...
struct BurnDriver BurnDrvPacnpal2 = {
	"pacnpal2", "pacnpal", nullptr, nullptr, "1983",
	"Pac & Pal (older)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, pacnpal2RomInfo, pacnpal2RomName, nullptr, nullptr, nullptr, nullptr, PacnpalInputInfo, PacnpalDIPInfo,
	PacnpalInit, DrvExit, DrvFrame, SuperpacDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvPacnchmp = {
	"pacnchmp", "pacnpal", nullptr, nullptr, "1983",
	"Pac-Man & Chomp Chomp\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, pacnchmpRomInfo, pacnchmpRomName, nullptr, nullptr, nullptr, nullptr, PacnpalInputInfo, PacnpalDIPInfo,
	PacnpalInit, DrvExit, DrvFrame, SuperpacDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGrobda = {
	"grobda", nullptr, nullptr, nullptr, "1984",
	"Grobda (New Ver.)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, grobdaRomInfo, grobdaRomName, nullptr, nullptr, nullptr, nullptr, GrobdaInputInfo, GrobdaDIPInfo,
...
struct BurnDriver BurnDrvGrobda2 = {
	"grobda2", "grobda", nullptr, nullptr, "1984",
	"Grobda (Old Ver. set 1)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, grobda2RomInfo, grobda2RomName, nullptr, nullptr, nullptr, nullptr, GrobdaInputInfo, GrobdaDIPInfo,
	GrobdaInit, DrvExit, DrvFrame, SuperpacDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGrobda3 = {
	"grobda3", "grobda", nullptr, nullptr, "1984",
	"Grobda (Old Ver. set 2)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, grobda3RomInfo, grobda3RomName, nullptr, nullptr, nullptr, nullptr, GrobdaInputInfo, GrobdaDIPInfo,
	GrobdaInit, DrvExit, DrvFrame, SuperpacDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvPhozon = {
	"phozon", nullptr, nullptr, nullptr, "1983",
	"Phozon (Japan)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PUZZLE, 0,
	nullptr, phozonRomInfo, phozonRomName, nullptr, nullptr, nullptr, nullptr, PhozonInputInfo, PhozonDIPInfo,
...
struct BurnDriver BurnDrvPhozons = {
	"phozons", "phozon", nullptr, nullptr, "1983",
	"Phozon (Sidam)\0", nullptr, "Namco (Sidam license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PUZZLE, 0,
	nullptr, phozonsRomInfo, phozonsRomName, nullptr, nullptr, nullptr, nullptr, PhozonInputInfo, PhozonDIPInfo,
	PhozonInit, DrvExit, DrvFrame, PhozonDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
