...
// Street Fighter II': Prime (Ver 0.73, Hack)
// Modified by Zero800
// https://sf2prime.github.io/

static struct BurnRomInfo Sf2primeRomDesc[] = {
	{ "sf2pr.03",		0x080000, 0x26ccedec, CPS2_PRG_68K | BRF_ESS | BRF_PRG },
	{ "sf2pr.04",		0x080000, 0x59cd077b, CPS2_PRG_68K | BRF_ESS | BRF_PRG },
	{ "sf2pr.05",		0x080000, 0x6066037b, CPS2_PRG_68K | BRF_ESS | BRF_PRG },
	{ "sf2pr.06",		0x080000, 0x759890d3, CPS2_PRG_68K | BRF_ESS | BRF_PRG },
#if 0
	...
	{ "sf2pr.13m",		0x800000, 0x6bfc4dff, CPS2_GFX | BRF_GRA },
	{ "sf2pr.15m",		0x800000, 0x3bfda169, CPS2_GFX | BRF_GRA },
	{ "sf2pr.17m",		0x800000, 0x081470b1, CPS2_GFX | BRF_GRA },
	{ "sf2pr.19m",		0x800000, 0x1214f11c, CPS2_GFX | BRF_GRA },
...
struct BurnDriver BurnDrvCpsSf2prime = {
	...
	"Street Fighter II': Prime (Ver 0.73, Hack)\0", NULL, "Zero800", "CPS2",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_HISCORE_SUPPORTED, 2, HARDWARE_CAPCOM_CPS2, GBF_VSFIGHT, FBF_SF,
