...
static struct BurnInputInfo GalivanInputList[] = {
...
STDINPUTINFO(Galivan)

static struct BurnInputInfo DangarInputList[] = {
	{"P1 Coin", BIT_DIGITAL, DrvJoy3 + 2, "p1 coin"},
	{"P1 Start", BIT_DIGITAL, DrvJoy3 + 0, "p1 start"},
	{"P1 Up", BIT_DIGITAL, DrvJoy1 + 0, "p1 up"},
	{"P1 Down", BIT_DIGITAL, DrvJoy1 + 1, "p1 down"},
...
static struct BurnDIPInfo GalivanDIPList[] =
{
	...
	{0x00, 0x01, 0x0c, 0x0c, "20k and every 60k"},
	{0x00, 0x01, 0x0c, 0x08, "50k and every 60k"},
	{0x00, 0x01, 0x0c, 0x04, "20k and every 90k"},
	{0x00, 0x01, 0x0c, 0x00, "50k and every 90k"},
	...
	{0, 0xfe, 0, 4, "Coin B"},
	{0x01, 0x01, 0x0c, 0x00, "3 Coins 1 Credits"},
	{0x01, 0x01, 0x0c, 0x04, "2 Coins 3 Credits"},
	{0x01, 0x01, 0x0c, 0x0c, "1 Coin  3 Credits"},
	{0x01, 0x01, 0x0c, 0x08, "1 Coin  6 Credits"},
...
static struct BurnDIPInfo DangarDIPList[] =
{
	...
	{0, 0xfe, 0, 4, "Coin B"},
	{0x01, 0x01, 0x0c, 0x04, "2 Coins 1 Credits"},
	{0x01, 0x01, 0x0c, 0x0c, "1 Coin  1 Credits"},
	{0x01, 0x01, 0x0c, 0x00, "2 Coins 3 Credits"},
	{0x01, 0x01, 0x0c, 0x08, "1 Coin  2 Credits"},
	...
	{0x01, 0x01, 0xc0, 0xc0, "No"},
	{0x01, 0x01, 0xc0, 0x80, "3 Times"},
	{0x01, 0x01, 0xc0, 0x40, "5 Times"},
	{0x01, 0x01, 0xc0, 0x00, "99 Times"},
...
static struct BurnDIPInfo NinjemakDIPList[] =
{
	...
	{0x01, 0xff, 0xff, 0x7c, nullptr},
	{0x02, 0xff, 0xff, 0x02, nullptr},
...
{
	return static_cast<INT64>(ZetTotalCycles()) * nSoundRate / 4000000;
}
...
static INT32 DrvInit(INT32 game)
{
	...
	BurnYM3526Init(4000000, nullptr, &DrvYM3526SynchroniseStream, 1);
...
static INT32 DrvFrame()
{
...

	{
		...
		ProcessJoystick(&DrvInputs[0], 0, 0, 1, 2, 3, INPUT_CLEAROPPOSITES | INPUT_ISACTIVELOW);
		ProcessJoystick(&DrvInputs[1], 0, 0, 1, 2, 3, INPUT_CLEAROPPOSITES | INPUT_ISACTIVELOW);
	}
...
struct BurnDriver BurnDrvGalivan = {
	"galivan", nullptr, nullptr, nullptr, "1985",
	"Cosmo Police Galivan (12/26/1985)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, galivanRomInfo, galivanRomName, nullptr, nullptr, nullptr, nullptr, GalivanInputInfo, GalivanDIPInfo,
...
struct BurnDriver BurnDrvGalivan2 = {
	"galivan2", "galivan", nullptr, nullptr, "1985",
	"Cosmo Police Galivan (12/16/1985)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PLATFORM, 0,
	nullptr, galivan2RomInfo, galivan2RomName, nullptr, nullptr, nullptr, nullptr, GalivanInputInfo, GalivanDIPInfo,
	galivanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvGalivan3 = {
	"galivan3", "galivan", nullptr, nullptr, "1985",
	"Cosmo Police Galivan (12/11/1985)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PLATFORM, 0,
	nullptr, galivan3RomInfo, galivan3RomName, nullptr, nullptr, nullptr, nullptr, GalivanInputInfo, GalivanDIPInfo,
	galivanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDangar = {
	"dangar", nullptr, nullptr, nullptr, "1986",
	"Ufo Robo Dangar (4/09/1987)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, dangarRomInfo, dangarRomName, nullptr, nullptr, nullptr, nullptr, DangarInputInfo, DangarDIPInfo,
	galivanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDangara = {
	"dangara", "dangar", nullptr, nullptr, "1986",
	"Ufo Robo Dangar (12/1/1986)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, dangaraRomInfo, dangaraRomName, nullptr, nullptr, nullptr, nullptr, DangarInputInfo, DangarDIPInfo,
	// dangar2
	galivanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDangarb = {
	"dangarb", "dangar", nullptr, nullptr, "1986",
	"Ufo Robo Dangar (9/26/1986, bootleg set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, dangarbRomInfo, dangarbRomName, nullptr, nullptr, nullptr, nullptr, DangarInputInfo, DangarbDIPInfo,
	// Dangar2
	galivanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDangarj = {
	"dangarj", "dangar", nullptr, nullptr, "1986",
	"Ufo Robo Dangar (9/26/1986, Japan)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, dangarjRomInfo, dangarjRomName, nullptr, nullptr, nullptr, nullptr, DangarInputInfo, DangarbDIPInfo,
	// Dangar2
	galivanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDangarbt = {
	"dangarbt", "dangar", nullptr, nullptr, "1986",
	"Ufo Robo Dangar (9/26/1986, bootleg set 2)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, dangarbtRomInfo, dangarbtRomName, nullptr, nullptr, nullptr, nullptr, DangarInputInfo, DangarbDIPInfo,
	// Dangar2
	galivanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvNinjemak = {
	"ninjemak", nullptr, nullptr, nullptr, "1986",
	"Ninja Emaki (US)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, ninjemakRomInfo, ninjemakRomName, nullptr, nullptr, nullptr, nullptr, ninjemakInputInfo, NinjemakDIPInfo,
...
struct BurnDriver BurnDrvYouma = {
	"youma", "ninjemak", nullptr, nullptr, "1986",
	"Youma Ninpou Chou (Japan)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT,
	0,
	nullptr, youmaRomInfo, youmaRomName, nullptr, nullptr, nullptr, nullptr, ninjemakInputInfo, YoumaDIPInfo,
	ninjemakInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvYouma2 = {
	"youma2", "ninjemak", nullptr, nullptr, "1986",
	"Youma Ninpou Chou (Japan, alt)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT,
	0,
	nullptr, youma2RomInfo, youma2RomName, nullptr, nullptr, nullptr, nullptr, ninjemakInputInfo, YoumaDIPInfo,
	ninjemakInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
...
struct BurnDriverD BurnDrvYoumab = {
	"youmab", "ninjemak", nullptr, nullptr, "1986",
	"Youma Ninpou Chou (Game Electronics bootleg, set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	0 | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT,
	0,
	nullptr, youmabRomInfo, youmabRomName, nullptr, nullptr, nullptr, nullptr, ninjemakInputInfo, YoumaDIPInfo,
	ninjemakInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
...
struct BurnDriverD BurnDrvYoumab2 = {
	"youmab2", "ninjemak", nullptr, nullptr, "1986",
	"Youma Ninpou Chou (Game Electronics bootleg, set 2)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	0 | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT,
	0,
	nullptr, youmab2RomInfo, youmab2RomName, nullptr, nullptr, nullptr, nullptr, ninjemakInputInfo, YoumaDIPInfo,
	ninjemakInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1180,
	224, 256, 3, 4
};
