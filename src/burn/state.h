...
#define ACB_CPS3_CRAM	 (128)

#define ACB_FULLSCAN	(ACB_NVRAM | ACB_MEMCARD | ACB_MEMORY_RAM | ACB_DRIVER_DATA | ACB_CPS3_CRAM)
#define ACB_FULLSCANL	(ACB_NVRAM | ACB_MEMCARD | ACB_MEMORY_RAM | ACB_DRIVER_DATA)
