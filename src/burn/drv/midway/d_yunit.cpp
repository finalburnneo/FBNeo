...
// Mortal Kombat (Yawdim bootleg, set 2, alternate)

static struct BurnRomInfo mkyawdim2aRomDesc[] = {
	{ "yawdim.u167",									0x010000, 0x16da7efb, 1 | BRF_PRG | BRF_ESS }, //  0 Z80 Code (sound)
...
STD_ROM_PICK(mkyawdim2a)
STD_ROM_FN(mkyawdim2a)

struct BurnDriver BurnDrvMkyawdim2a = {
	"mkyawdim2a", "mk", NULL, NULL, "1992",
	"Mortal Kombat (Yawdim bootleg, set 2, alternate)\0", NULL, "bootleg (Yawdim)", "Y Unit",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	NULL, mkyawdim2aRomInfo, mkyawdim2aRomName, NULL, NULL, NULL, NULL, Mkla4InputInfo, Mkla4DIPInfo,
	Mkyawdim2Init, DrvExit, YawdimFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
