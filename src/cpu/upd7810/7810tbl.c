...
const struct opcode_s op48[256] =
{
...
/* prefix 4C */
const struct opcode_s op4C[256] =
{
...
/* prefix 4D */
const struct opcode_s op4D[256] =
{
...
/* prefix 60 */
const struct opcode_s op60[256] =
{
...
/* prefix 64 */
const struct opcode_s op64[256] =
{
...
/* prefix 70 */
const struct opcode_s op70[256] =
{
...
/* prefix 74 */
const struct opcode_s op74[256] =
{
...
/* main opcodes */
const struct opcode_s opXX_7810[256] =
{
...
const struct opcode_s opXX_7807[256] =
{
	{NOP,           1, 4, 4,L0|L1}, /* 00: 0000 0000                                */
	{LDAW_wa,       2,10,10,L0|L1}, /* 01: 0000 0001 oooo oooo                      */
	{INX_SP,        1, 7, 7,L0|L1}, /* 02: 0000 0010                                */
...
const struct opcode_s op48_7801[256] =
{
	/* 0x00 - 0x1F */
...
const struct opcode_s op4C_7801[256] =
{
	/* 0x00 - 0x1F */
...
/* prefix 4D */
const struct opcode_s op4D_7801[256] =
{
	/* 0x00 - 0x1F */
...
/* prefix 60 */
const struct opcode_s op60_7801[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
...
/* prefix 64 */
const struct opcode_s op64_7801[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
...
/* prefix 70 */
const struct opcode_s op70_7801[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
...
/* prefix 74 */
const struct opcode_s op74_7801[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
...
const struct opcode_s opXX_7801[256] =
{
	/* 0x00 - 0x1F */
...
const struct opcode_s op48_78c05[256] =
{
	/* 0x00 - 0x1F */
	{SKIT_F0,       2, 8, 8,L0|L1}, {SKIT_FT0,      2, 8, 8,L0|L1},
...
const struct opcode_s op4C_78c05[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
...
/* prefix 4D */
const struct opcode_s op4D_78c05[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
...
/* prefix 60 */
const struct opcode_s op60_78c05[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
...
/* prefix 64 */
const struct opcode_s op64_78c05[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
...
/* prefix 70 */
const struct opcode_s op70_78c05[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
...
/* prefix 74 */
const struct opcode_s op74_78c05[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
	{illegal2,      2, 8, 8,L0|L1}, {illegal2,      2, 8, 8,L0|L1},
...
const struct opcode_s opXX_78c05[256] =
{
	/* 0x00 - 0x1F */
	{NOP,           1, 4, 4,L0|L1}, {HALT,          1, 6, 6,L0|L1},
	{INX_SP,        1, 7, 7,L0|L1}, {DCX_SP,        1, 7, 7,L0|L1},
...
const struct opcode_s op48_78c06[256] =
{
	/* 0x00 - 0x1F */
...
const struct opcode_s op4C_78c06[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
...
/* prefix 4D */
const struct opcode_s op4D_78c06[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
...
/* prefix 60 */
const struct opcode_s op60_78c06[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
...
/* prefix 64 */
const struct opcode_s op64_78c06[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
...
/* prefix 70 */
const struct opcode_s op70_78c06[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
...
/* prefix 74 */
const struct opcode_s op74_78c06[256] =
{
	/* 0x00 - 0x1F */
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
	{illegal2,      2,12,12,L0|L1}, {illegal2,      2,12,12,L0|L1},
...
const struct opcode_s opXX_78c06[256] =
{
	/* 0x00 - 0x1F */
