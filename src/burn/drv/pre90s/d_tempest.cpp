...
{
	DIP_OFFSET(0x11)
	{0x00, 0xff, 0xff, 0x10, nullptr},
	{0x01, 0xff, 0xff, 0x07, nullptr},
	{0x02, 0xff, 0xff, 0x00, nullptr},
	{0x03, 0xff, 0xff, 0x00, nullptr},
	{0x04, 0xff, 0xff, 0x10, nullptr},
	{0x05, 0xff, 0xff, 0x00, nullptr},
...
{
	constexpr INT32 reso_list[3] = {640, 1024, 1080};
	INT32 Width, Height;
...
static INT32 MemIndex()
{
	...
	DrvVecROM = Next;
	Next += 0x001000; // must(!) come after DrvVecRAM
...
struct BurnDriver BurnDrvTempest = {
	"tempest", nullptr, nullptr, nullptr, "1980",
	"Tempest (rev 3, Revised Hardware)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, tempestRomInfo, tempestRomName, nullptr, nullptr, nullptr, nullptr, TempestInputInfo, TempestDIPInfo,
...
struct BurnDriver BurnDrvTempest1r = {
	"tempest1r", "tempest", nullptr, nullptr, "1980",
	"Tempest (rev 1, Revised Hardware)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, tempest1rRomInfo, tempest1rRomName, nullptr, nullptr, nullptr, nullptr, TempestInputInfo, TempestDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40 * 256,
	480, 640, 3, 4
};
...
struct BurnDriver BurnDrvTempest3 = {
	"tempest3", "tempest", nullptr, nullptr, "1980",
	"Tempest (rev 3)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, tempest3RomInfo, tempest3RomName, nullptr, nullptr, nullptr, nullptr, TempestInputInfo, TempestDIPInfo,
...
struct BurnDriver BurnDrvTempest2 = {
	"tempest2", "tempest", nullptr, nullptr, "1980",
	"Tempest (rev 2)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, tempest2RomInfo, tempest2RomName, nullptr, nullptr, nullptr, nullptr, TempestInputInfo, TempestDIPInfo,
	DrvInitSmall, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40 * 256,
	480, 640, 3, 4
};
...
struct BurnDriver BurnDrvTempest1 = {
	"tempest1", "tempest", nullptr, nullptr, "1980",
	"Tempest (rev 1)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, tempest1RomInfo, tempest1RomName, nullptr, nullptr, nullptr, nullptr, TempestInputInfo, TempestDIPInfo,
	DrvInitSmall, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40 * 256,
	480, 640, 3, 4
};
...
struct BurnDriver BurnDrvTemptube = {
	"temptube", "tempest", nullptr, nullptr, "1980",
	"Tempest Tubes\0", nullptr, "hack (Duncan Brown)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, temptubeRomInfo, temptubeRomName, nullptr, nullptr, nullptr, nullptr, TempestInputInfo, TempestDIPInfo,
	DrvInitSmall, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40 * 256,
	480, 640, 3, 4
};
...
struct BurnDriver BurnDrvTemped = {
	"temped", "tempest", nullptr, nullptr, "2000",
	"TempEd\0", nullptr, "hack", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HACK, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, tempedRomInfo, tempedRomName, nullptr, nullptr, nullptr, nullptr, TempestInputInfo, TempestDIPInfo,
	DrvInitSmall, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40 * 256,
	480, 640, 3, 4
};
...
struct BurnDriver BurnDrvTempall = {
	"tempall", "tempest", nullptr, nullptr, "2000",
	"Tempest All Levels\0", nullptr, "hack", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HACK, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, tempallRomInfo, tempallRomName, nullptr, nullptr, nullptr, nullptr, TempestInputInfo, TempestDIPInfo,
	DrvInitSmall, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40 * 256,
	480, 640, 3, 4
};
...
struct BurnDriver BurnDrvTemptwst = {
	"temptwst", "tempest", nullptr, nullptr, "2000",
	"Tempest Twisted\0", nullptr, "Twisty", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HACK, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, temptwstRomInfo, temptwstRomName, nullptr, nullptr, nullptr, nullptr, TempestInputInfo, TempestDIPInfo,
	DrvInitSmall, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40 * 256,
	480, 640, 3, 4
};
...
struct BurnDriver BurnDrvVbrakout = {
	"vbrakout", "tempest", nullptr, nullptr, "1999",
	"Vector Breakout [h]\0", nullptr, "Clay Cowgill", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HACK, 2, HARDWARE_MISC_PRE90S,
	GBF_BREAKOUT | GBF_VECTOR, 0,
	nullptr, vbrakoutRomInfo, vbrakoutRomName, nullptr, nullptr, nullptr, nullptr, TempestInputInfo, TempestDIPInfo,
