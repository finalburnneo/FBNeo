...
static tilemap_callback(bg)
{
	...
	TILE_SET_INFO(0, code, ((attr & 0x40) >> 4) | ((attr & 0x20) >> 5) | ((attr & 0x10) >> 3),
	              TILE_GROUP((attr >> 3) & 1));
}
...
struct BurnDriver BurnDrvTankbust = {
	"tankbust", nullptr, nullptr, nullptr, "1985",
	...
	nullptr, tankbustRomInfo, tankbustRomName, nullptr, nullptr, nullptr, nullptr, TankbustInputInfo, TankbustDIPInfo,
