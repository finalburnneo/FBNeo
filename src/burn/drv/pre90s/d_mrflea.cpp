...
static INT32 MemIndex()
{
	...
	DrvZ80RAM1 = Next;
	Next += 0x000200;
	DrvVidRAM = (UINT16*)Next;
	Next += 0x000400 * sizeof(UINT16);
	DrvPalRAM = Next;
	Next += 0x000100;
	DrvSprRAM = Next;
	Next += 0x000100;
...
struct BurnDriver BurnDrvmrflea = {
	"mrflea", nullptr, nullptr, nullptr, "1982",
	"The Amazing Adventures of Mr. F. Lea\0", nullptr, "Pacific Novelty", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 1, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, mrfleaRomInfo, mrfleaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
