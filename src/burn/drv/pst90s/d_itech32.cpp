...
{
	TB_TYPE0 = 0,
	// shufshot, wcbowl, wcbowl165, wcbowl161, wcbowl16, wcbowl140, wcbowldx
	TB_TYPE1,
	// wcbowl15, wcbowl14, wcbowl13, wcbowl13j, wcbowl12, wcbowl11
	TB_TYPE2,
	// gt3d
	TB_TYPE3,
	// gt*"S"
...
static void itech32copy()
{
	for (INT32 y = 0; y < nScreenHeight; y++)
	{
		...
		if (itech32_planes > 1)
		{
			UINT16* src2 = &videoplane[1][compute_safe_address(
				VIDEO_DISPLAY_XORIGIN2 + VIDEO_DISPLAY_XSCROLL2, VIDEO_DISPLAY_YORIGIN2 + VIDEO_DISPLAY_YSCROLL2 + y)];
...
static void __fastcall timekill_main_write_word(UINT32 address, UINT16 data)
{
	...
	case 0x050000:
	case 0x050001:
		palette_intensity = static_cast<double>(data & 0xff) / static_cast<double>(0x60);
		return;
...
static UINT32 __fastcall common32_main_read_long(UINT32 address)
{
	...
	if (is_shoottv)
	{
		switch (address)
		{
		case 0x183000: SekSetIRQLine(6, CPU_IRQSTATUS_NONE);
			return 0;
		case 0x183800: SekSetIRQLine(5, CPU_IRQSTATUS_NONE);
			return 0;
...
static INT32 MemIndex()
{
	...
	video_regs = (UINT16*)Next;
	Next += 0x00080;

	// keep this here!!!
	Drv68KRAM = Next;
	Next += 0x010000; // +4 for cheap hack
...
static INT32 DrvGetRoms(bool bLoad)
{
	...
	for (INT32 i = 0; !BurnDrvGetRomName(&pRomName, i, 0); i++)
	{
		...
		if ((ri.nType & BRF_PRG) && (ri.nType & 0x0f) == 1)
		{
			...
			if ((ti.nType & BRF_PRG) && (ti.nType & 0xf) == 1)
			{
				// 32-BIT
				if (bLoad)
				{
		...
		if ((ri.nType & BRF_SND) && (ri.nType & 0x0c) == 4)
		{
			//4-7
...
static void CommonSoundInit()
{
	...
	ES5506Init(16000000, DrvSndROM0, DrvSndROM1, DrvSndROM2, DrvSndROM3, nullptr);
...
static INT32 TimekillInit()
{
	...
	TimeKeeperInit(TIMEKEEPER_M48T02, nullptr); // not on this hardware (32-bit only!)
...
static INT32 Common16BitInit()
{
	...
	for (INT32 i = 0; i < 0x800000; i += 0x80000)
	{
		// mirrors
...
static INT32 Common32BitInit(UINT32 prot_addr, INT32 plane_num, INT32 color_bank_flip)
{
	...
	TimeKeeperInit(TIMEKEEPER_M48T02, nullptr);
	BurnWatchdogInit(DrvDoReset, 180);
...
static void PaletteUpdate16()
{
	...
	for (INT32 i = 0; i < BurnDrvGetPaletteEntries() * 2; i += 2)
	{
		...
		r = static_cast<UINT8>(r * palette_intensity);
		g = static_cast<UINT8>(g * palette_intensity);
		b = static_cast<UINT8>(b * palette_intensity);
...
struct BurnDriver BurnDrvTimekill = {
	"timekill", nullptr, nullptr, nullptr, "1992",
	"Time Killers (v1.32)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, timekillRomInfo, timekillRomName, nullptr, nullptr, nullptr, nullptr, TimekillInputInfo, TimekillDIPInfo,
...
struct BurnDriver BurnDrvTimekill132i = {
	"timekill132i", "timekill", nullptr, nullptr, "1992",
	"Time Killers (v1.32I)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, timekill132iRomInfo, timekill132iRomName, nullptr, nullptr, nullptr, nullptr, TimekillInputInfo,
	TimekillDIPInfo,
	TimekillInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvTimekill131 = {
	"timekill131", "timekill", nullptr, nullptr, "1992",
	"Time Killers (v1.31)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, timekill131RomInfo, timekill131RomName, nullptr, nullptr, nullptr, nullptr, TimekillInputInfo,
	TimekillDIPInfo,
	TimekillInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvTimekill121 = {
	"timekill121", "timekill", nullptr, nullptr, "1992",
	"Time Killers (v1.21)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, timekill121RomInfo, timekill121RomName, nullptr, nullptr, nullptr, nullptr, TimekillInputInfo,
	TimekillDIPInfo,
	TimekillInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvTimekill121a = {
	"timekill121a", "timekill", nullptr, nullptr, "1992",
	"Time Killers (v1.21, alternate ROM board)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, timekill121aRomInfo, timekill121aRomName, nullptr, nullptr, nullptr, nullptr, TimekillInputInfo,
	TimekillDIPInfo,
	TimekillInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvTimekill120 = {
	"timekill120", "timekill", nullptr, nullptr, "1992",
	"Time Killers (v1.20)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, timekill120RomInfo, timekill120RomName, nullptr, nullptr, nullptr, nullptr, TimekillInputInfo,
	TimekillDIPInfo,
	TimekillInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvTimekill100 = {
	"timekill100", "timekill", nullptr, nullptr, "1992",
	"Time Killers (v1.00)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, timekill100RomInfo, timekill100RomName, nullptr, nullptr, nullptr, nullptr, TimekillInputInfo,
	TimekillDIPInfo,
	TimekillInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvBloodstm = {
	"bloodstm", nullptr, nullptr, nullptr, "1994",
	"Blood Storm (v2.22)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, bloodstmRomInfo, bloodstmRomName, nullptr, nullptr, nullptr, nullptr, BloodstmInputInfo, BloodstmDIPInfo,
...
struct BurnDriver BurnDrvBloodstm221 = {
	"bloodstm221", "bloodstm", nullptr, nullptr, "1994",
	"Blood Storm (v2.21)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, bloodstm221RomInfo, bloodstm221RomName, nullptr, nullptr, nullptr, nullptr, BloodstmInputInfo,
	BloodstmDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvBloodstm220 = {
	"bloodstm220", "bloodstm", nullptr, nullptr, "1994",
	"Blood Storm (v2.20)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, bloodstm220RomInfo, bloodstm220RomName, nullptr, nullptr, nullptr, nullptr, BloodstmInputInfo,
	BloodstmDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvBloodstm210 = {
	"bloodstm210", "bloodstm", nullptr, nullptr, "1994",
	"Blood Storm (v2.10)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, bloodstm210RomInfo, bloodstm210RomName, nullptr, nullptr, nullptr, nullptr, BloodstmInputInfo,
	BloodstmDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvBloodstm110 = {
	"bloodstm110", "bloodstm", nullptr, nullptr, "1994",
	"Blood Storm (v1.10)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, bloodstm110RomInfo, bloodstm110RomName, nullptr, nullptr, nullptr, nullptr, BloodstmInputInfo,
	BloodstmDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvBloodstm104 = {
	"bloodstm104", "bloodstm", nullptr, nullptr, "1994",
	"Blood Storm (v1.04)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, bloodstm104RomInfo, bloodstm104RomName, nullptr, nullptr, nullptr, nullptr, BloodstmInputInfo,
	BloodstmDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvHardyard = {
	"hardyard", nullptr, nullptr, nullptr, "1993",
	"Hard Yardage (v1.20)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hardyardRomInfo, hardyardRomName, nullptr, nullptr, nullptr, nullptr, HardyardInputInfo, HardyardDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvHardyard11 = {
	"hardyard11", "hardyard", nullptr, nullptr, "1993",
	"Hard Yardage (v1.10)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hardyard11RomInfo, hardyard11RomName, nullptr, nullptr, nullptr, nullptr, HardyardInputInfo,
	HardyardDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvHardyard10 = {
	"hardyard10", "hardyard", nullptr, nullptr, "1993",
	"Hard Yardage (v1.00)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hardyard10RomInfo, hardyard10RomName, nullptr, nullptr, nullptr, nullptr, HardyardInputInfo,
	HardyardDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvPairs = {
	"pairs", nullptr, nullptr, nullptr, "1994",
	"Pairs (V1.2, 09/30/94)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, pairsRomInfo, pairsRomName, nullptr, nullptr, nullptr, nullptr, PairsInputInfo, PairsDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvPairsa = {
	"pairsa", "pairs", nullptr, nullptr, "1994",
	"Pairs (V1, 09/07/94)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, pairsaRomInfo, pairsaRomName, nullptr, nullptr, nullptr, nullptr, PairsInputInfo, PairsDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvPairsred = {
	"pairsred", nullptr, nullptr, nullptr, "1994",
	"Pairs Redemption (V1.0, 10/25/94)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, pairsredRomInfo, pairsredRomName, nullptr, nullptr, nullptr, nullptr, PairsInputInfo, PairsDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvHotmemry = {
	"hotmemry", "pairs", nullptr, nullptr, "1994",
	"Hot Memory (V1.2, Germany, 12/28/94)\0", nullptr, "Incredible Technologies (Tuning license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hotmemryRomInfo, hotmemryRomName, nullptr, nullptr, nullptr, nullptr, PairsInputInfo, PairsDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvHotmemry11 = {
	"hotmemry11", "pairs", nullptr, nullptr, "1994",
	"Hot Memory (V1.1, Germany, 11/30/94)\0", nullptr, "Incredible Technologies (Tuning license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hotmemry11RomInfo, hotmemry11RomName, nullptr, nullptr, nullptr, nullptr, PairsInputInfo, PairsDIPInfo,
	Common16BitInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvWcbowldx = {
	"wcbowldx", "wcbowl", nullptr, nullptr, "1999",
	"World Class Bowling Deluxe (v2.00)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowldxRomInfo, wcbowldxRomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowldxDIPInfo,
...
struct BurnDriver BurnDrvWcbowl140 = {
	"wcbowl140", "wcbowl", nullptr, nullptr, "1997",
	"World Class Bowling Tournament (v1.40)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl140RomInfo, wcbowl140RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowldxDIPInfo,
...
struct BurnDriver BurnDrvWcbowl130 = {
	"wcbowl130", "wcbowl", nullptr, nullptr, "1997",
	"World Class Bowling Tournament (v1.30)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl130RomInfo, wcbowl130RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowloDIPInfo,
	Wcbowl140Init, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvWcbowl = {
	"wcbowl", nullptr, nullptr, nullptr, "1995",
	"World Class Bowling (v1.66)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowlRomInfo, wcbowlRomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowlnDIPInfo,
...
struct BurnDriver BurnDrvWcbowl165 = {
	"wcbowl165", "wcbowl", nullptr, nullptr, "1995",
	"World Class Bowling (v1.65)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl165RomInfo, wcbowl165RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowloDIPInfo,
	WcbowlInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvWcbowl161 = {
	"wcbowl161", "wcbowl", nullptr, nullptr, "1995",
	"World Class Bowling (v1.61)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl161RomInfo, wcbowl161RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowloDIPInfo,
	WcbowlInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvWcbowl16 = {
	"wcbowl16", "wcbowl", nullptr, nullptr, "1995",
	"World Class Bowling (v1.6)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl16RomInfo, wcbowl16RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowloDIPInfo,
	WcbowlInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvWcbowl15 = {
	"wcbowl15", "wcbowl", nullptr, nullptr, "1995",
	"World Class Bowling (v1.5)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl15RomInfo, wcbowl15RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowlDIPInfo,
...
struct BurnDriver BurnDrvWcbowl14 = {
	"wcbowl14", "wcbowl", nullptr, nullptr, "1995",
	"World Class Bowling (v1.4)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl14RomInfo, wcbowl14RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowlDIPInfo,
	Wcbowl_16B_Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvWcbowl13 = {
	"wcbowl13", "wcbowl", nullptr, nullptr, "1995",
	"World Class Bowling (v1.3)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl13RomInfo, wcbowl13RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowlDIPInfo,
	Wcbowl_16B_Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvWcbowl13j = {
	"wcbowl13j", "wcbowl", nullptr, nullptr, "1995",
	"World Class Bowling (v1.3J, Japan)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl13jRomInfo, wcbowl13jRomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowljDIPInfo,
	Wcbowl_16B_Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvWcbowl12 = {
	"wcbowl12", "wcbowl", nullptr, nullptr, "1995",
	"World Class Bowling (v1.2)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl12RomInfo, wcbowl12RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowlDIPInfo,
	Wcbowl_16B_Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvWcbowl11 = {
	"wcbowl11", "wcbowl", nullptr, nullptr, "1995",
	"World Class Bowling (v1.1)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl11RomInfo, wcbowl11RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowlDIPInfo,
	Wcbowl_16B_Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvWcbowl10 = {
	"wcbowl10", "wcbowl", nullptr, nullptr, "1995",
	"World Class Bowling (v1.0)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wcbowl10RomInfo, wcbowl10RomName, nullptr, nullptr, nullptr, nullptr, WcbowlInputInfo, WcbowlDIPInfo,
	Wcbowl_16B_Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriverX BurnDrvDrivedge = {
	"drivedge", nullptr, nullptr, nullptr, "1994",
	"Driver's Edge (v1.6)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, drivedgeRomInfo, drivedgeRomName, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
	//DrivedgeInputInfo, DrivedgeDIPInfo,
...
struct BurnDriver BurnDrvSftm = {
	"sftm", nullptr, nullptr, nullptr, "1995",
	"Street Fighter: The Movie (v1.12)\0", nullptr, "Capcom / Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, sftmRomInfo, sftmRomName, nullptr, nullptr, nullptr, nullptr, SftmInputInfo, SftmDIPInfo,
...
struct BurnDriver BurnDrvSftm111 = {
	"sftm111", "sftm", nullptr, nullptr, "1995",
	"Street Fighter: The Movie (v1.11)\0", nullptr, "Capcom / Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, sftm111RomInfo, sftm111RomName, nullptr, nullptr, nullptr, nullptr, SftmInputInfo, SftmDIPInfo,
...
struct BurnDriver BurnDrvSftm110 = {
	"sftm110", "sftm", nullptr, nullptr, "1995",
	"Street Fighter: The Movie (v1.10)\0", nullptr, "Capcom / Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, sftm110RomInfo, sftm110RomName, nullptr, nullptr, nullptr, nullptr, SftmInputInfo, SftmDIPInfo,
	Sftm110Init, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvSftmj114 = {
	"sftmj114", "sftm", nullptr, nullptr, "1995",
	"Street Fighter: The Movie (v1.14N, Japan)\0", nullptr, "Capcom / Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, sftmj114RomInfo, sftmj114RomName, nullptr, nullptr, nullptr, nullptr, SftmInputInfo, SftmDIPInfo,
	SftmInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvSftmj112 = {
	"sftmj112", "sftm", nullptr, nullptr, "1995",
	"Street Fighter: The Movie (v1.12N, Japan)\0", nullptr, "Capcom / Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, sftmj112RomInfo, sftmj112RomName, nullptr, nullptr, nullptr, nullptr, SftmInputInfo, SftmDIPInfo,
	SftmInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvShoottv = {
	"shoottv", nullptr, nullptr, nullptr, "199?",
	"Must Shoot TV (prototype)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_SHOOT, 0,
	nullptr, shoottvRomInfo, shoottvRomName, nullptr, nullptr, nullptr, nullptr, ShoottvInputInfo, ShoottvDIPInfo,
...
struct BurnDriver BurnDrvPubball = {
	"pubball", nullptr, nullptr, nullptr, "1996",
	"Power Up Baseball (prototype)\0", nullptr, "Midway / Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_SPORTSMISC, 0,
	nullptr, pubballRomInfo, pubballRomName, nullptr, nullptr, nullptr, nullptr, PubballInputInfo, PubballDIPInfo,
...
struct BurnDriver BurnDrvShufshot = {
	"shufshot", nullptr, nullptr, nullptr, "1997",
	"Shuffleshot (v1.40)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, shufshotRomInfo, shufshotRomName, nullptr, nullptr, nullptr, nullptr, ShufshotInputInfo, ShufshotDIPInfo,
...
struct BurnDriver BurnDrvShufshot139 = {
	"shufshot139", "shufshot", nullptr, nullptr, "1997",
	"Shuffleshot (v1.39)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, shufshot139RomInfo, shufshot139RomName, nullptr, nullptr, nullptr, nullptr, ShufshotInputInfo,
	ShufshotDIPInfo,
	ShufshotInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvShufshot138 = {
	"shufshot138", "shufshot", nullptr, nullptr, "1997",
	"Shuffleshot (v1.38)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, shufshot138RomInfo, shufshot138RomName, nullptr, nullptr, nullptr, nullptr, ShufshotInputInfo,
	ShufshotDIPInfo,
	ShufshotInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvShufshot137 = {
	"shufshot137", "shufshot", nullptr, nullptr, "1997",
	"Shuffleshot (v1.37)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, shufshot137RomInfo, shufshot137RomName, nullptr, nullptr, nullptr, nullptr, ShufshotInputInfo,
	ShufshtoDIPInfo,
	ShufshotInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvShufshot135 = {
	"shufshot135", "shufshot", nullptr, nullptr, "1997",
	"Shuffleshot (v1.35)\0", nullptr, "Strata/Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, shufshot135RomInfo, shufshot135RomName, nullptr, nullptr, nullptr, nullptr, ShufshotInputInfo,
	ShufshtoDIPInfo,
	ShufshotInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 256, 4, 3
};
...
struct BurnDriver BurnDrvGt3d = {
	"gt3d", nullptr, nullptr, nullptr, "1995",
	"Golden Tee 3D Golf (v1.93N)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dRomInfo, gt3dRomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
...
struct BurnDriver BurnDrvGt3ds192 = {
	"gt3ds192", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf (v1.92S)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3ds192RomInfo, gt3ds192RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
...
struct BurnDriver BurnDrvGt3dl192 = {
	"gt3dl192", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf (v1.92L)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dl192RomInfo, gt3dl192RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
...
struct BurnDriver BurnDrvGt3dl191 = {
	"gt3dl191", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf (v1.91L)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dl191RomInfo, gt3dl191RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
	Gt3d1192Init, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt3dl19 = {
	"gt3dl19", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf (v1.9L)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dl19RomInfo, gt3dl19RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
	Gt3d1192Init, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt3dv18 = {
	"gt3dv18", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf (v1.8)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dv18RomInfo, gt3dv18RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
	Gt3d_2_Init, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt3dv17 = {
	"gt3dv17", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf (v1.7)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dv17RomInfo, gt3dv17RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
	Gt3d_2_Init, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt3dv16 = {
	"gt3dv16", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf (v1.6)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dv16RomInfo, gt3dv16RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
	Gt3d_2_Init, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt3dv15 = {
	"gt3dv15", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf (v1.5)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dv15RomInfo, gt3dv15RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
	Gt3d_2_Init, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt3dv14 = {
	"gt3dv14", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf (v1.4)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dv14RomInfo, gt3dv14RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
	Gt3d_2_Init, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt3dt231 = {
	"gt3dt231", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf Tournament (v2.31)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dt231RomInfo, gt3dt231RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
...
struct BurnDriver BurnDrvGt3dt211 = {
	"gt3dt211", "gt3d", nullptr, nullptr, "1995",
	"Golden Tee 3D Golf Tournament (v2.11)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt3dt211RomInfo, gt3dt211RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt3dDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt97 = {
	"gt97", nullptr, nullptr, nullptr, "1997",
	"Golden Tee '97 (v1.30)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt97RomInfo, gt97RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt97DIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt97v122 = {
	"gt97v122", "gt97", nullptr, nullptr, "1997",
	"Golden Tee '97 (v1.22)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt97v122RomInfo, gt97v122RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt97oDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt97v121 = {
	"gt97v121", "gt97", nullptr, nullptr, "1997",
	"Golden Tee '97 (v1.21)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt97v121RomInfo, gt97v121RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt97oDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt97s121 = {
	"gt97s121", "gt97", nullptr, nullptr, "1997",
	"Golden Tee '97 (v1.21S)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt97s121RomInfo, gt97s121RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt97sDIPInfo,
...
struct BurnDriver BurnDrvGt97v120 = {
	"gt97v120", "gt97", nullptr, nullptr, "1997",
	"Golden Tee '97 (v1.20)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt97v120RomInfo, gt97v120RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt97oDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt97t243 = {
	"gt97t243", "gt97", nullptr, nullptr, "1997",
	"Golden Tee '97 Tournament (v2.43)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt97t243RomInfo, gt97t243RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt97oDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt97t240 = {
	"gt97t240", "gt97", nullptr, nullptr, "1997",
	"Golden Tee '97 Tournament (v2.40)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt97t240RomInfo, gt97t240RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt97oDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt98 = {
	"gt98", nullptr, nullptr, nullptr, "1998",
	"Golden Tee '98 (v1.10)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt98RomInfo, gt98RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, AamaDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt98v100 = {
	"gt98v100", "gt98", nullptr, nullptr, "1998",
	"Golden Tee '98 (v1.00)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt98v100RomInfo, gt98v100RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt98DIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt98s100 = {
	"gt98s100", "gt98", nullptr, nullptr, "1998",
	"Golden Tee '98 (v1.00S)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt98s100RomInfo, gt98s100RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt98sDIPInfo,
	Gt3dSverInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt98t303 = {
	"gt98t303", "gt98", nullptr, nullptr, "1998",
	"Golden Tee '98 Tournament (v3.03)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt98t303RomInfo, gt98t303RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt98sDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt98t302 = {
	"gt98t302", "gt98", nullptr, nullptr, "1998",
	"Golden Tee '98 Tournament (v3.02)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt98t302RomInfo, gt98t302RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt98sDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGtdiamond = {
	"gtdiamond", "gt98", nullptr, nullptr, "1998",
	"Golden Tee Diamond Edition Tournament (v3.05T ELC)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gtdiamondRomInfo, gtdiamondRomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt98sDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt99 = {
	"gt99", nullptr, nullptr, nullptr, "1999",
	"Golden Tee '99 (v1.00)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt99RomInfo, gt99RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, AamaDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt99s100 = {
	"gt99s100", "gt99", nullptr, nullptr, "1999",
	"Golden Tee '99 (v1.00S)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt99s100RomInfo, gt99s100RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, S_verDIPInfo,
	Gt3dSverInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt99t400 = {
	"gt99t400", "gt99", nullptr, nullptr, "1999",
	"Golden Tee '99 Tournament (v4.00)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt99t400RomInfo, gt99t400RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt98sDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGtroyal = {
	"gtroyal", "gt99", nullptr, nullptr, "1999",
	"Golden Tee Royal Edition Tournament (v4.02T EDM)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gtroyalRomInfo, gtroyalRomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt98sDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt2k = {
	"gt2k", nullptr, nullptr, nullptr, "2000",
	"Golden Tee 2K (v1.00)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt2kRomInfo, gt2kRomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, AamaDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt2kp100 = {
	"gt2kp100", "gt2k", nullptr, nullptr, "2000",
	"Golden Tee 2K (v1.00) (alt protection)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt2kp100RomInfo, gt2kp100RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, AamaDIPInfo,
...
struct BurnDriver BurnDrvGt2ks100 = {
	"gt2ks100", "gt2k", nullptr, nullptr, "2000",
	"Golden Tee 2K (v1.00S)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt2ks100RomInfo, gt2ks100RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, S_verDIPInfo,
	Gt3dSverInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGt2kt500 = {
	"gt2kt500", "gt2k", nullptr, nullptr, "2000",
	"Golden Tee 2K Tournament (v5.00)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gt2kt500RomInfo, gt2kt500RomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt98sDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGtsupreme = {
	"gtsupreme", "gt2k", nullptr, nullptr, "2002",
	"Golden Tee Supreme Edition Tournament (v5.10T ELC S)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gtsupremeRomInfo, gtsupremeRomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, Gt98sDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGtclassc = {
	"gtclassc", nullptr, nullptr, nullptr, "2001",
	"Golden Tee Classic (v1.00)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gtclasscRomInfo, gtclasscRomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, AamaDIPInfo,
	Gt3dAmaaInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
...
struct BurnDriver BurnDrvGtclasscp = {
	"gtclasscp", "gtclassc", nullptr, nullptr, "2001",
	"Golden Tee Classic (v1.00) (alt protection)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gtclasscpRomInfo, gtclasscpRomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, AamaDIPInfo,
...
struct BurnDriver BurnDrvGtclasscs = {
	"gtclasscs", "gtclassc", nullptr, nullptr, "2001",
	"Golden Tee Classic (v1.00S)\0", nullptr, "Incredible Technologies", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, gtclasscsRomInfo, gtclasscsRomName, nullptr, nullptr, nullptr, nullptr, Gt3dInputInfo, S_verDIPInfo,
	Gt3dSverInit, DrvExit, DrvFrame, DrvDraw32, DrvScan, &DrvRecalc, 0x8000,
	384, 240, 4, 3
};
