...
static INT32 DrvInit()
{
	...
	AY8910SetPorts(0, &AY8910_0_port0, nullptr, nullptr, nullptr);
	AY8910SetPorts(1, &AY8910_1_port0, nullptr, nullptr, nullptr);
...
static void draw_sprites()
{
	for (INT32 offs = 0x200 - 4; offs >= 0; offs -= 4)
	{
		...
		if (sy == 0 || sy == 0xff || (sx < 0x40 && DrvSprRAM[offs + 2] & 0x10) || (sx >= 0xc0 && ~DrvSprRAM[offs + 2] &
			0x10))
			continue;
...
struct BurnDriver BurnDrvAmbush = {
	"ambush", nullptr, nullptr, nullptr, "1983",
	"Ambush\0", nullptr, "Tecfri", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, ambushRomInfo, ambushRomName, nullptr, nullptr, nullptr, nullptr, AmbushInputInfo, AmbushDIPInfo,
...
struct BurnDriver BurnDrvAmbushj = {
	"ambushj", "ambush", nullptr, nullptr, "1983",
	"Ambush (Japan)\0", nullptr, "Tecfri (Nippon Amuse license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, ambushjRomInfo, ambushjRomName, nullptr, nullptr, nullptr, nullptr, AmbushInputInfo, AmbushDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvAmbushh = {
	"ambushh", "ambush", nullptr, nullptr, "1983",
	"Ambush (hack?)\0", nullptr, "Tecfri", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, ambushhRomInfo, ambushhRomName, nullptr, nullptr, nullptr, nullptr, AmbushInputInfo, AmbushDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvAmbushv = {
	"ambushv", "ambush", nullptr, nullptr, "1983",
	"Ambush (Volt Electronics)\0", nullptr, "Tecfri (Volt Electronics license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, ambushvRomInfo, ambushvRomName, nullptr, nullptr, nullptr, nullptr, AmbushInputInfo, AmbushDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	256, 224, 4, 3
};
