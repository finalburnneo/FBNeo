...
static INT32 DrvInit()
{
	...
	deco16Init(1, 0, 1);
	deco16_set_graphics(DrvGfxROM0, 0x100000 * 2, DrvGfxROM1, 0x100000 * 2, nullptr, 0);
	...
	deco16SoundInit(DrvHucROM, DrvHucRAM, 2685000, 0, nullptr, 0.15, 1006875, 0.50, 0, 0);
...
static void draw_sprites()
{
	...
	for (INT32 offs = 0; offs < 0x400; offs += 4)
	{
		...
		while (multi >= 0)
		{
			Draw16x16MaskTile(pTransDraw, code - multi * inc, sx, (sy + mult * multi) - 8, flipx, flipy, color, 4, 0,
			                  0x200, DrvGfxROM2);
...
struct BurnDriver BurnDrvDietgo = {
	"dietgo", nullptr, nullptr, nullptr, "1992",
	"Diet Go Go (Euro v1.1 1992.09.26 v3)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, dietgoRomInfo, dietgoRomName, nullptr, nullptr, nullptr, nullptr, DietgoInputInfo, DietgoDIPInfo,
...
struct BurnDriver BurnDrvDietgoe = {
	"dietgoe", "dietgo", nullptr, nullptr, "1992",
	"Diet Go Go (Euro v1.1 1992.09.26 v2)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, dietgoeRomInfo, dietgoeRomName, nullptr, nullptr, nullptr, nullptr, DietgoInputInfo, DietgoDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvDietgoea = {
	"dietgoea", "dietgo", nullptr, nullptr, "1992",
	"Diet Go Go (Euro v1.1 1992.08.04)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, dietgoeaRomInfo, dietgoeaRomName, nullptr, nullptr, nullptr, nullptr, DietgoInputInfo, DietgoDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvDietgou = {
	"dietgou", "dietgo", nullptr, nullptr, "1992",
	"Diet Go Go (USA v1.1 1992.09.26)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, dietgouRomInfo, dietgouRomName, nullptr, nullptr, nullptr, nullptr, DietgoInputInfo, DietgoDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvDietgoj = {
	"dietgoj", "dietgo", nullptr, nullptr, "1992",
	"Diet Go Go (Japan v1.1 1992.09.26)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, dietgojRomInfo, dietgojRomName, nullptr, nullptr, nullptr, nullptr, DietgoInputInfo, DietgoDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	320, 240, 4, 3
};
