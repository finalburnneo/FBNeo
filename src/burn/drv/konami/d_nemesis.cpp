...
static void (*palette_write)(INT32) = nullptr;
...
static struct BurnDIPInfo SalamandDIPList[] =
{
	DIP_OFFSET(0x12)
	{0x00, 0xff, 0xff, 0xff, nullptr},
	{0x01, 0xff, 0xff, 0x42, nullptr},
	{0x02, 0xff, 0xff, 0x0e, nullptr},
...
static struct BurnDIPInfo TwinbeeDIPList[] =
{
	DIP_OFFSET(0x12)
	{0x00, 0xff, 0xff, 0xff, nullptr},
	{0x01, 0xff, 0xff, 0x56, nullptr},
	{0x02, 0xff, 0xff, 0xfd, nullptr},
	{0x03, 0xff, 0xff, 0x00, nullptr},
...
static INT32 MemIndex()
{
	...
	m68k_irq_enable = Next;
	Next += 0x000001;
	m68k_irq_enable2 = Next;
	Next += 0x000001;
	m68k_irq_enable4 = Next;
	Next += 0x000001;
	tilemap_flip_x = Next;
	Next += 0x000001;
	tilemap_flip_y = Next;
	...
	mcu_control = (UINT16*)Next;
	Next += 0x00004 * sizeof(UINT16);
...
static void NemesisSoundInit(INT32 konamigtmode)
{
	...
	AY8910SetPorts(0, &nemesis_AY8910_0_portA, nullptr, nullptr, nullptr);
	AY8910SetPorts(1, nullptr, nullptr, &k005289_control_A_write, &k005289_control_B_write);
...
{
	auto vram = (UINT16*)vidram;
	auto cram = (UINT16*)colram;
	...
	for (INT32 priority = 256 - 1; priority >= 0; priority--)
	{
		for (INT32 address = (0x1000 / 2) - 8; address >= 0; address -= 8)
		{
			...
			if (zoom != 0xff || code != 0)
			{
				...
				RenderZoomedPrioSprite(pTransDraw, DrvCharRAMExp, code, color * 16, 0, sx, sy - 16, flipx, flipy, w, h,
				                       zoom, zoom, 0xffcc);
			}
		}
	}
...
static INT32 DrvDraw()
{
	if (DrvRecalc)
	{
		if (palette_write != nullptr)
		{
			for (INT32 i = 0; i < 0x2000; i += 2)
			{
				// a little hackish, but works for salamander & nemesis palette types
				palette_write(i);
			}
...
static void spinner_update(INT32 tweakaddr)
{
	...
	if (DrvDial1 + INCREMENT < target)
	{
		// go "right" in blocks of "INCREMENT"
		DrvDial1 += INCREMENT;
	}
	else if (DrvDial1 < target)
	{
		// take care of remainder
		DrvDial1++;
	}
	else if (DrvDial1 - INCREMENT > target)
	{
		// go "left" in blocks of "INCREMENT"
		DrvDial1 -= INCREMENT;
	}
	else if (DrvDial1 > target)
	{
...
struct BurnDriver BurnDrvNemesis = {
	"nemesis", nullptr, nullptr, nullptr, "1985",
	"Nemesis (ROM version)\0", nullptr, "Konami", "GX400",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_HORSHOOT, 0,
	nullptr, nemesisRomInfo, nemesisRomName, nullptr, nullptr, nullptr, nullptr, NemesisInputInfo, NemesisDIPInfo,
...
struct BurnDriver BurnDrvNemesisuk = {
	"nemesisuk", "nemesis", nullptr, nullptr, "1985",
	"Nemesis (World?, ROM version)\0", nullptr, "Konami", "GX400",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_HORSHOOT, 0,
	nullptr, nemesisukRomInfo, nemesisukRomName, nullptr, nullptr, nullptr, nullptr, NemesisInputInfo, NemesisDIPInfo,
	NemesisInit, DrvExit, NemesisFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvKonamigt = {
	"konamigt", nullptr, nullptr, nullptr, "1985",
	"Konami GT\0", nullptr, "Konami", "GX561",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_RACING, 0,
	nullptr, konamigtRomInfo, konamigtRomName, nullptr, nullptr, nullptr, nullptr, KonamigtInputInfo, KonamigtDIPInfo,
...
struct BurnDriver BurnDrvSalamand = {
	"salamand", nullptr, nullptr, nullptr, "1986",
	"Salamander (version D)\0", nullptr, "Konami", "GX587",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_HORSHOOT, 0,
	nullptr, salamandRomInfo, salamandRomName, nullptr, nullptr, nullptr, nullptr, SalamandInputInfo, SalamandDIPInfo,
...
struct BurnDriver BurnDrvSalamandj = {
	"salamandj", "salamand", nullptr, nullptr, "1986",
	"Salamander (version J)\0", nullptr, "Konami", "GX587",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_HORSHOOT, 0,
	nullptr, salamandjRomInfo, salamandjRomName, nullptr, nullptr, nullptr, nullptr, SalamandInputInfo, SalamandDIPInfo,
	SalamandInit, DrvExit, SalamandFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvLifefrce = {
	"lifefrce", "salamand", nullptr, nullptr, "1986",
	"Lifeforce (US)\0", nullptr, "Konami", "GX587",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_HORSHOOT, 0,
	nullptr, lifefrceRomInfo, lifefrceRomName, nullptr, nullptr, nullptr, nullptr, SalamandInputInfo, SalamandDIPInfo,
	SalamandInit, DrvExit, SalamandFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvLifefrcej = {
	"lifefrcej", "salamand", nullptr, nullptr, "1987",
	"Lifeforce (Japan)\0", nullptr, "Konami", "GX587",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_HORSHOOT, 0,
	nullptr, lifefrcejRomInfo, lifefrcejRomName, nullptr, nullptr, nullptr, nullptr, LifefrcejInputInfo,
	LifefrcejDIPInfo,
	SalamandInit, DrvExit, SalamandFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvTwinbee = {
	"twinbee", nullptr, nullptr, nullptr, "1985",
	"TwinBee (ROM version)\0", nullptr, "Konami", "GX412",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, twinbeeRomInfo, twinbeeRomName, nullptr, nullptr, nullptr, nullptr, TwinbeeInputInfo, TwinbeeDIPInfo,
...
struct BurnDriver BurnDrvGradius = {
	"gradius", "nemesis", nullptr, nullptr, "1985",
	"Gradius (Japan, ROM version)\0", nullptr, "Konami", "GX456",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_HORSHOOT, 0,
	nullptr, gradiusRomInfo, gradiusRomName, nullptr, nullptr, nullptr, nullptr, GradiusInputInfo, GradiusDIPInfo,
	Gx400Init, DrvExit, Gx400Frame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvGwarrior = {
	"gwarrior", nullptr, nullptr, nullptr, "1985",
	"Galactic Warriors\0", nullptr, "Konami", "GX578",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_VSFIGHT, 0,
	nullptr, gwarriorRomInfo, gwarriorRomName, nullptr, nullptr, nullptr, nullptr, GwarriorInputInfo, GwarriorDIPInfo,
	Gx400Init, DrvExit, Gx400Frame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvRf2 = {
	"rf2", "konamigt", nullptr, nullptr, "1985",
	"Konami RF2 - Red Fighter\0", nullptr, "Konami", "GX561",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_RACING, 0,
	nullptr, rf2RomInfo, rf2RomName, nullptr, nullptr, nullptr, nullptr, KonamigtInputInfo, KonamigtDIPInfo,
...
struct BurnDriver BurnDrvBlkpnthr = {
	"blkpnthr", nullptr, nullptr, nullptr, "1987",
	"Black Panther\0", nullptr, "Konami", "GX604",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_SCRFIGHT, 0,
	nullptr, blkpnthrRomInfo, blkpnthrRomName, nullptr, nullptr, nullptr, nullptr, BlkpnthrInputInfo, BlkpnthrDIPInfo,
...
struct BurnDriver BurnDrvCitybomb = {
	"citybomb", nullptr, nullptr, nullptr, "1987",
	"City Bomber (World)\0", nullptr, "Konami", "GX787",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_SHOOT, 0,
	nullptr, citybombRomInfo, citybombRomName, nullptr, nullptr, nullptr, nullptr, CitybombInputInfo, CitybombDIPInfo,
...
struct BurnDriver BurnDrvCitybombj = {
	"citybombj", "citybomb", nullptr, nullptr, "1987",
	"City Bomber (Japan)\0", nullptr, "Konami", "GX787",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80,
	GBF_SHOOT, 0,
	nullptr, citybombjRomInfo, citybombjRomName, nullptr, nullptr, nullptr, nullptr, CitybombInputInfo, CitybombDIPInfo,
	CitybombInit, DrvExit, CitybombFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvKittenk = {
	"kittenk", nullptr, nullptr, nullptr, "1988",
	"Kitten Kaboodle\0", nullptr, "Konami", "GX712",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_PUZZLE, 0,
	nullptr, kittenkRomInfo, kittenkRomName, nullptr, nullptr, nullptr, nullptr, NyanpaniInputInfo, NyanpaniDIPInfo,
...
struct BurnDriver BurnDrvNyanpani = {
	"nyanpani", "kittenk", nullptr, nullptr, "1988",
	"Nyan Nyan Panic (Japan)\0", nullptr, "Konami", "GX712",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_PUZZLE, 0,
	nullptr, nyanpaniRomInfo, nyanpaniRomName, nullptr, nullptr, nullptr, nullptr, NyanpaniInputInfo, NyanpaniDIPInfo,
	NyanpaniInit, DrvExit, CitybombFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvHcrash = {
	"hcrash", nullptr, nullptr, nullptr, "1987",
	"Hyper Crash (version D)\0", nullptr, "Konami", "GX790",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_RACING, 0,
	nullptr, hcrashRomInfo, hcrashRomName, nullptr, nullptr, nullptr, nullptr, HcrashInputInfo, HcrashDIPInfo,
...
struct BurnDriver BurnDrvHcrashc = {
	"hcrashc", "hcrash", nullptr, nullptr, "1987",
	"Hyper Crash (version C)\0", nullptr, "Konami", "GX790",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_RACING, 0,
	nullptr, hcrashcRomInfo, hcrashcRomName, nullptr, nullptr, nullptr, nullptr, HcrashInputInfo, HcrashDIPInfo,
	HcrashInit, DrvExit, HcrashFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvBubsys = {
	"bubsys", nullptr, nullptr, nullptr, "1985",
	"Bubble System BIOS\0", nullptr, "Konami", "Bios Only",
	nullptr, nullptr, nullptr, nullptr,
	BDF_BOARDROM, 2, HARDWARE_KONAMI_68K_Z80, GBF_BIOS, 0,
	nullptr, bubsysRomInfo, bubsysRomName, nullptr, nullptr, nullptr, nullptr, BubsysInputInfo, BubsysDIPInfo,
...
struct BurnDriver BurnDrvGradiusb = {
	"gradiusb", nullptr, "bubsys", nullptr, "1985",
	"Gradius (Bubble System)\0", nullptr, "Konami", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_KONAMI_68K_Z80, GBF_HORSHOOT, 0,
	nullptr, gradiusbRomInfo, gradiusbRomName, nullptr, nullptr, nullptr, nullptr, BubsysInputInfo, BubsysDIPInfo,
	BubsysInit, DrvExit, Gx400Frame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvTwinbeeb = {
	"twinbeeb", nullptr, nullptr, nullptr, "1985",
	"TwinBee (Bubble System)\0", nullptr, "Konami", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_KONAMI_68K_Z80, GBF_VERSHOOT, 0,
	nullptr, twinbeebRomInfo, twinbeebRomName, nullptr, nullptr, nullptr, nullptr, BubsysInputInfo, BubsysDIPInfo,
