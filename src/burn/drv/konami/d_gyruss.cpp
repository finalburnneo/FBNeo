...
static INT32 MemIndex()
{
	...
	interrupt_enable0 = Next;
	Next += 0x000001;
	interrupt_enable1 = Next;
	Next += 0x000001;
...
static INT32 DrvPaletteInit()
{
	...
	for (INT32 i = 0; i < 0x20; i++)
	{
		...
		UINT8 r = static_cast<INT32>(double((bit0 * 33 + bit1 * 70 + bit2 * 151) + 0.5));

		bit0 = (color_prom[i] >> 3) & 0x01;
		bit1 = (color_prom[i] >> 4) & 0x01;
		bit2 = (color_prom[i] >> 5) & 0x01;
		UINT8 g = static_cast<INT32>(double((bit0 * 33 + bit1 * 70 + bit2 * 151) + 0.5));

		bit0 = (color_prom[i] >> 6) & 0x01;
		bit1 = (color_prom[i] >> 7) & 0x01;
		UINT8 b = static_cast<INT32>(double((bit0 * 78 + bit1 * 151) + 0.5));
...
static INT32 DrvInit()
{
	...
	AY8910SetPorts(0, nullptr, nullptr, nullptr, &AY8910_0_portBwrite);
	AY8910SetPorts(1, nullptr, nullptr, nullptr, &AY8910_1_portBwrite);
	AY8910SetPorts(2, AY8910_3_portA, nullptr, nullptr, nullptr);
...
static void draw_8x16_tile_line(INT32 sx, INT32 sy, INT32 color, UINT8* gfx_base, INT32 code, INT32 flipx, INT32 flipy,
                                INT32 line)
{
	line -= 16;
...
struct BurnDriver BurnDrvGyruss = {
	"gyruss", nullptr, nullptr, nullptr, "1983",
	"Gyruss\0", nullptr, "Konami", "GX347",
	...
	nullptr, gyrussRomInfo, gyrussRomName, nullptr, nullptr, nullptr, nullptr, GyrussInputInfo, GyrussDIPInfo,
...
struct BurnDriver BurnDrvGyrussce = {
	"gyrussce", "gyruss", nullptr, nullptr, "1983",
	"Gyruss (Centuri)\0", nullptr, "Konami (Centuri license)", "GX347",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, gyrussceRomInfo, gyrussceRomName, nullptr, nullptr, nullptr, nullptr, GyrussInputInfo, GyrussceDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x140,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvGyrussb = {
	"gyrussb", "gyruss", nullptr, nullptr, "1983",
	"Gyruss (bootleg?)\0", nullptr, "bootleg?", "GX347",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, gyrussbRomInfo, gyrussbRomName, nullptr, nullptr, nullptr, nullptr, GyrussInputInfo, GyrussDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x140,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvVenus = {
	"venus", "gyruss", nullptr, nullptr, "1983",
	"Venus (bootleg of Gyruss)\0", nullptr, "bootleg", "GX347",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, venusRomInfo, venusRomName, nullptr, nullptr, nullptr, nullptr, GyrussInputInfo, GyrussDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x140,
	224, 256, 3, 4
};
