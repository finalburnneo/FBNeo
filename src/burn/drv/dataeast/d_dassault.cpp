...
{
	{0x1e, 0xff, 0xff, 0xff, nullptr},
	{0x1f, 0xff, 0xff, 0x7f, nullptr},
	...
	for (INT32 bank = 0; bank < 2; bank++)
	{
		for (INT32 offs = 0x800 - 4; offs >= 0; offs -= 4)
		{
			...
			if (bank == 0)
			{
				...
				{
				case 0xc000: pmask = 0x01;
					break;
				case 0x8000: pmask = 0x08;
					break;
				case 0x4000: pmask = 0x20;
					break;
				case 0x0000: pmask = 0x80;
					break;
				}
			}
			else
			{
				...
				{
				case 0x0001: pmask = 0x10;
					break;
				case 0x0002:
				case 0x0003:
				case 0x0000: pmask = 0x40;
					break;
				}
			...
			while (multi >= 0)
			{
				if (!bpp)
				{
					...
					if (alpha != 0xff && (nCurrentFrame % 3) == 2)
					{
						// only draw every third frame
						multi--;
						continue;
					}

					deco16_draw_prio_sprite(pTransDraw, gfx, sprite - multi * inc, (color << 4) + coloff, x,
					                        y + mult * multi, flipx, flipy, pmask, 1 << bank);
				}
				else
				{
					deco16_draw_alphaprio_sprite(DrvPalette, gfx, sprite - multi * inc, (color << 4) + coloff, x,
					                             y + mult * multi, flipx, flipy, pmask, 1 << bank, alpha);
				}
...
struct BurnDriver BurnDrvThndzone = {
	"thndzone", nullptr, nullptr, nullptr, "1991",
	"Thunder Zone (World, Rev 1)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_RUNGUN, 0,
	nullptr, thndzoneRomInfo, thndzoneRomName, nullptr, nullptr, nullptr, nullptr, ThndzoneInputInfo, ThndzoneDIPInfo,
...
struct BurnDriver BurnDrvThndzonea = {
	"thndzonea", "thndzone", nullptr, nullptr, "1991",
	"Thunder Zone (World)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_RUNGUN, 0,
	nullptr, thndzoneaRomInfo, thndzoneaRomName, nullptr, nullptr, nullptr, nullptr, ThndzoneInputInfo, ThndzoneDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvThndzone4 = {
	"thndzone4", "thndzone", nullptr, nullptr, "1991",
	"Thunder Zone (World 4 Players)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_RUNGUN, 0,
	nullptr, thndzone4RomInfo, thndzone4RomName, nullptr, nullptr, nullptr, nullptr, ThndzoneInputInfo, ThndzoneDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvThndzonej = {
	"thndzonej", "thndzone", nullptr, nullptr, "1991",
	"Thunder Zone (Japan)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_RUNGUN, 0,
	nullptr, thndzonejRomInfo, thndzonejRomName, nullptr, nullptr, nullptr, nullptr, ThndzoneInputInfo, ThndzoneDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvDassault = {
	"dassault", "thndzone", nullptr, nullptr, "1991",
	"Desert Assault (US)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_RUNGUN, 0,
	nullptr, dassaultRomInfo, dassaultRomName, nullptr, nullptr, nullptr, nullptr, ThndzoneInputInfo, DassaultDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvDassault4 = {
	"dassault4", "thndzone", nullptr, nullptr, "1991",
	"Desert Assault (US 4 Players)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_RUNGUN, 0,
	nullptr, dassault4RomInfo, dassault4RomName, nullptr, nullptr, nullptr, nullptr, ThndzoneInputInfo,
	Dassault4DIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	320, 240, 4, 3
};
