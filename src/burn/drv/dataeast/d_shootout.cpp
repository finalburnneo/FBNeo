...
{
	if (ym2203portainit == 0)
	{
		// first thing written here on YM2203Reset() is 0xff, causes problems.
		ym2203portainit = 1;
		return;
	}
		...
		if (attributes & 0x01)
		{
			if (m_bFlicker || (attributes & 0x02) == 0)
			{
				...
				if (attributes & 0x10)
				{
					...
					RenderPrioSprite(pTransDraw, DrvGfxROM1, number, 0x40, 0, vx, vy - 8, flipx, flipy, 16, 16,
					                 priority_mask);
...
struct BurnDriver BurnDrvShootout = {
	"shootout", nullptr, nullptr, nullptr, "1985",
	"Shoot Out (US)\0", nullptr, "Data East USA", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SHOOT, 0,
	nullptr, shootoutRomInfo, shootoutRomName, nullptr, nullptr, nullptr, nullptr, ShootoutInputInfo, ShootoutDIPInfo,
...
struct BurnDriver BurnDrvShootoutj = {
	"shootoutj", "shootout", nullptr, nullptr, "1985",
	"Shoot Out (Japan)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SHOOT, 0,
	nullptr, shootoutjRomInfo, shootoutjRomName, nullptr, nullptr, nullptr, nullptr, ShootoutInputInfo, ShootoujDIPInfo,
...
struct BurnDriver BurnDrvShootoutb = {
	"shootoutb", "shootout", nullptr, nullptr, "1985",
	"Shoot Out (Korean Bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SHOOT, 0,
	nullptr, shootoutbRomInfo, shootoutbRomName, nullptr, nullptr, nullptr, nullptr, ShootoutInputInfo, ShootoujDIPInfo,
