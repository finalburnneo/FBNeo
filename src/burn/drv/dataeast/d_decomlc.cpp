...
static void decomlc_write_byte(UINT32 address, UINT8 data)
{
	...
	case 0x500000:
		YMZ280BSetRoute(BURN_SND_YMZ280B_YMZ280B_ROUTE_1, (255.00 - data) / 255.00,
		                (game_select == 2) ? BURN_SND_ROUTE_BOTH : BURN_SND_ROUTE_LEFT);
		YMZ280BSetRoute(BURN_SND_YMZ280B_YMZ280B_ROUTE_2, (255.00 - data) / 255.00,
		                (game_select == 2) ? BURN_SND_ROUTE_BOTH : BURN_SND_ROUTE_RIGHT);
		return;
...
static INT32 CommonArmInit(INT32 game)
{
		...
		case 0: // skull fang
			{
				...
				DrvGfxROM0 = BurnMalloc(((0xc00000/6)*8));
		...
		case 1: // Stadium Hero '96 
			{
				...
				DrvGfxROM0 = BurnMalloc(((0x1800000/6)*8));
		...
		case 3: // Avengers In Galactic Storm
			{
				...
				DrvGfxROM0 = BurnMalloc(((0x1800000/4)*8));
	...
	YMZ280BSetRoute(
		BURN_SND_YMZ280B_YMZ280B_ROUTE_1, 1.00, (game_select == 2) ? BURN_SND_ROUTE_BOTH : BURN_SND_ROUTE_LEFT);
	YMZ280BSetRoute(
		BURN_SND_YMZ280B_YMZ280B_ROUTE_2, 1.00, (game_select == 2) ? BURN_SND_ROUTE_BOTH : BURN_SND_ROUTE_RIGHT);
...
static void mlc_drawgfxzoomline(UINT16* dest, UINT8* pri, INT32* clip, UINT32 code1, UINT32 code2, UINT32 color,
                                INT32 flipx, INT32 sx,
                                INT32 transparent_color, INT32 use8bpp, INT32 scalex, INT32 srcline, INT32 shadowMode)
{
	if (!scalex) return;

	auto m_irq_ram = (UINT32*)DrvIRQRAM;
...
static void draw_sprites(INT32 scanline)
{
	...
	INT32 clip[4];
	auto mlc_spriteram = (UINT16*)DrvSprBuf;
	auto m_mlc_clip_ram = (UINT32*)DrvClipRAM;
	auto m_mlc_vram = (UINT32*)DrvVRAM;
	auto m_irq_ram = (UINT32*)DrvIRQRAM;

	for (offs = 0; offs < (0x3000 / 4); offs += 8)
	{
		use8bppMode = (offs + 8 < (0x3000 / 4)) && (mlc_spriteram[offs + 8 + 1] & 0x1000) && (mlc_spriteram[offs + 8 +
			0] & 0x8000);
		if (use8bppMode)
			offs += 8;
		...
		for (bx = 0; bx < w; bx++)
		{
			...
			mlc_drawgfxzoomline(dest, pri, clip, tile, tile2, color + colorOffset, fx, realxbase, 0, use8bppMode,
			                    (xscale), srcline, shadowMode);
		}
	}
...
struct BurnDriver BurnDrvAvengrgs = {
	"avengrgs", nullptr, nullptr, nullptr, "1995",
	"Avengers In Galactic Storm (US/Europe 1.0)\0", nullptr, "Data East Corporation", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, avengrgsRomInfo, avengrgsRomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
...
struct BurnDriver BurnDrvAvengrgsj = {
	"avengrgsj", "avengrgs", nullptr, nullptr, "1995",
	"Avengers In Galactic Storm (Japan 1.2)\0", nullptr, "Data East Corporation", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, avengrgsjRomInfo, avengrgsjRomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
	AvengrgsInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvAvengrgsbh = {
	"avengrgsbh", "avengrgs", nullptr, nullptr, "2022",
	"Avengers In Galactic Storm (Playable Boss, Hack)\0", nullptr, "hack", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK, 4, HARDWARE_PREFIX_DATAEAST, GBF_VSFIGHT, 0,
	nullptr, avengrgsbhRomInfo, avengrgsbhRomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
	AvengrgsInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvSkullfng = {
	"skullfng", nullptr, nullptr, nullptr, "1996",
	"Skull Fang (Europe 1.13)\0", nullptr, "Data East Corporation", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST, GBF_VERSHOOT, 0,
	nullptr, skullfngRomInfo, skullfngRomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
...
struct BurnDriver BurnDrvSkullfngj = {
	"skullfngj", "skullfng", nullptr, nullptr, "1996",
	"Skull Fang - Kuhga Gaiden (Japan 1.09)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST,
	GBF_VERSHOOT, 0,
	nullptr, skullfngjRomInfo, skullfngjRomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
	SkullfngInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvSkullfnga = {
	"skullfnga", "skullfng", nullptr, nullptr, "1996",
	"Skull Fang - Kuhga Gaiden (Asia 1.13)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_DATAEAST,
	GBF_VERSHOOT, 0,
	nullptr, skullfngaRomInfo, skullfngaRomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
	SkullfngInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvStadhr96 = {
	"stadhr96", nullptr, nullptr, nullptr, "1996",
	"Stadium Hero '96 (Europe, EAJ)\0", nullptr, "Data East Corporation", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, stadhr96RomInfo, stadhr96RomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
...
struct BurnDriver BurnDrvStadhr96u = {
	"stadhr96u", "stadhr96", nullptr, nullptr, "1996",
	"Stadium Hero '96 (USA, EAH)\0", nullptr, "Data East Corporation", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, stadhr96uRomInfo, stadhr96uRomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
	Stadhr96Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvStadhr96j = {
	"stadhr96j", "stadhr96", nullptr, nullptr, "1996",
	"Stadium Hero '96 (Japan, EAD)\0", nullptr, "Data East Corporation", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, stadhr96jRomInfo, stadhr96jRomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
	Stadhr96Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvStadhr96j2 = {
	"stadhr96j2", "stadhr96", nullptr, nullptr, "1996",
	"Stadium Hero '96 (Japan?, EAE)\0", nullptr, "Data East Corporation", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, stadhr96j2RomInfo, stadhr96j2RomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
	Stadhr96Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvHoops96 = {
	"hoops96", nullptr, nullptr, nullptr, "1996",
	"Hoops '96 (Europe/Asia 2.0)\0", nullptr, "Data East Corporation", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, hoops96RomInfo, hoops96RomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
...
struct BurnDriver BurnDrvHoops95 = {
	"hoops95", "hoops96", nullptr, nullptr, "1995",
	"Hoops (Europe/Asia 1.7)\0", nullptr, "Data East Corporation", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, hoops95RomInfo, hoops95RomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
	Hoops96Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvDdream95 = {
	"ddream95", "hoops96", nullptr, nullptr, "1995",
	"Dunk Dream '95 (Japan 1.4, EAM)\0", nullptr, "Data East Corporation", "DECO MLC",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, ddream95RomInfo, ddream95RomName, nullptr, nullptr, nullptr, nullptr, MlcInputInfo, nullptr,
	Hoops96Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
