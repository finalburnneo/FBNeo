...
static struct BurnDIPInfo TceptorDIPList[] =
{
	...
	{0x0b, 0xff, 0xff, 0xfb, nullptr},
	{0x0c, 0xff, 0xff, 0x04, nullptr},
...
static UINT8 tceptor_m6809_read(UINT16 address)
{
	...
	case 0x4f01: // pedal (accel)
		if (DrvAnalogPort2 == -1 /* 0xffff */)
		{
			// digital button mapped to accel
...
static INT32 MemIndex()
{
	...
	DrvBitmap = (UINT16*)Next;
	Next += 320 * 256 * sizeof(INT16);
...
{
	auto mem1 = (UINT16*)(DrvSprBuf + 0x000);
	auto mem2 = (UINT16*)(DrvSprBuf + 0x100);
	INT32 need_mask = 0;
	...
	for (INT32 i = 0x100 - 2; i >= 0; i -= 2)
	{
		...
		if (pri == sprite_priority && scalex && scaley)
		{
			...
			RenderZoomedPrioTranstabSprite(pTransDraw, gfx, code, (color * 16) + 0x400, 0xff, x, y, flipx, flipy, tsize,
			                               tsize, scalex, scaley, DrvColPROM + 0xc00, 1 << pri);
		}
	}
	...
	if (need_mask)
	{
		...
		{
			if (pTransDraw[i] == 0x063f)
			{
				//should be 0x3fe.  0x63f??
...
static INT32 DrvDraw()
{
	...
	if (nBurnLayer & 4)
	{
		GenericTilesSetClip(-1, nScreenWidth - 1, -1, -1);
		// c45 uses namcos2-style (0 based) clipping. we need to account for that.
		c45RoadDraw();
		GenericTilesClearClip();
	}
...
struct BurnDriver BurnDrvTceptor = {
	"tceptor", nullptr, nullptr, nullptr, "1986",
	"Thunder Ceptor\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, tceptorRomInfo, tceptorRomName, nullptr, nullptr, nullptr, nullptr, TceptorInputInfo, TceptorDIPInfo,
...
struct BurnDriver BurnDrvTceptor2 = {
	"tceptor2", "tceptor", nullptr, nullptr, "1986",
	"3-D Thunder Ceptor II\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, tceptor2RomInfo, tceptor2RomName, nullptr, nullptr, nullptr, nullptr, TceptorInputInfo, TceptorDIPInfo,
