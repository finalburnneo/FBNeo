	...
	for (INT32 offs = 0; offs < 0x400; offs += 4)
	{
		...
		while (multi >= 0)
		{
			if (fy)
			{
				if (fx)
				{
					Render16x16Tile_Mask_FlipXY_Clip(pTransDraw, sprite - multi * inc, x, (y + mult * multi) - 8,
					                                 colour, 4, 0, 0x200, DrvGfxROM2);
				}
				else
				{
					Render16x16Tile_Mask_FlipY_Clip(pTransDraw, sprite - multi * inc, x, (y + mult * multi) - 8, colour,
					                                4, 0, 0x200, DrvGfxROM2);
				}
			}
			else
			{
				if (fx)
				{
					Render16x16Tile_Mask_FlipX_Clip(pTransDraw, sprite - multi * inc, x, (y + mult * multi) - 8, colour,
					                                4, 0, 0x200, DrvGfxROM2);
				}
				else
				{
					Render16x16Tile_Mask_Clip(pTransDraw, sprite - multi * inc, x, (y + mult * multi) - 8, colour, 4, 0,
					                          0x200, DrvGfxROM2);
				}
			}
...
struct BurnDriver BurnDrvPktgaldx = {
	"pktgaldx", nullptr, nullptr, nullptr, "1992",
	"Pocket Gal Deluxe (Euro v3.00)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, pktgaldxRomInfo, pktgaldxRomName, nullptr, nullptr, nullptr, nullptr, PktgaldxInputInfo, PktgaldxDIPInfo,
...
struct BurnDriver BurnDrvPktgaldxj = {
	"pktgaldxj", "pktgaldx", nullptr, nullptr, "1993",
	"Pocket Gal Deluxe (Japan v3.00)\0", nullptr, "Data East Corporation (Nihon System license)", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, pktgaldxjRomInfo, pktgaldxjRomName, nullptr, nullptr, nullptr, nullptr, PktgaldxInputInfo, PktgaldxDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvPktgaldxa = {
	"pktgaldxa", "pktgaldx", nullptr, nullptr, "1992",
	"Pocket Gal Deluxe (Asia v3.00)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, pktgaldxaRomInfo, pktgaldxaRomName, nullptr, nullptr, nullptr, nullptr, PktgaldxInputInfo, PktgaldxDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 240, 4, 3
};
...
struct BurnDriverD BurnDrvPktgaldxb = {
	"pktgaldxb", "pktgaldx", nullptr, nullptr, "1992",
	"Pocket Gal Deluxe (Euro v3.00, bootleg)\0", nullptr, "bootleg", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, pktgaldxbRomInfo, pktgaldxbRomName, nullptr, nullptr, nullptr, nullptr, PktgaldxInputInfo, PktgaldxDIPInfo,
