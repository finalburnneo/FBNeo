...
static INT32 DrvGfxDecode()
{
	...
	for (INT32 i = 0; i < 4; i++)
	{
		GfxDecode(0x0080, 3, 16, 16, Plane2, XOffs2, YOffs2, 0x100, tmp + (i * 0x4000),
		          DrvGfxROM[2] + 0x0000 + (i * 0x10000));
		GfxDecode(0x0080, 3, 16, 16, Plane3, XOffs2, YOffs2, 0x100, tmp + (i * 0x4000),
		          DrvGfxROM[2] + 0x8000 + (i * 0x10000));
	}
...
static void draw_sprites()
{
	for (INT32 offs = 0; offs < 0x200; offs += 4)
	{
		...
		if (attr & 0x10)
		{
			Draw16x16MaskTile(pTransDraw, code + 1, sx, sy + (flipscreen ? -24 : 8), flipx, flipy, color, 3, 0, 0x40,
			                  DrvGfxROM[1]);
		}
	}
}
...
static INT32 DrvFrame()
{
...

	{
		...
		{
			M6502SetIRQLine((bootleg_type == 2 || bootleg_type == 3) ? CPU_IRQLINE_NMI : CPU_IRQLINE_IRQ,
			                CPU_IRQSTATUS_ACK);
		}
...
struct BurnDriver BurnDrvExprraid = {
	"exprraid", nullptr, nullptr, nullptr, "1986",
	"Express Raider (World, Rev 4)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, exprraidRomInfo, exprraidRomName, nullptr, nullptr, nullptr, nullptr, ExprraidInputInfo, ExprraidDIPInfo,
...
struct BurnDriver BurnDrvExprraidu = {
	"exprraidu", "exprraid", nullptr, nullptr, "1986",
	"Express Raider (US, rev 5)\0", nullptr, "Data East USA", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, exprraiduRomInfo, exprraiduRomName, nullptr, nullptr, nullptr, nullptr, ExprraidInputInfo, ExprraidDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvExprraidi = {
	"exprraidi", "exprraid", nullptr, nullptr, "1986",
	"Express Raider (Italy)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, exprraidiRomInfo, exprraidiRomName, nullptr, nullptr, nullptr, nullptr, ExprraidInputInfo, ExprraidDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvWexpress = {
	"wexpress", "exprraid", nullptr, nullptr, "1986",
	"Western Express (Japan, rev 4)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, wexpressRomInfo, wexpressRomName, nullptr, nullptr, nullptr, nullptr, ExprraidInputInfo, ExprraidDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvWexpressb1 = {
	"wexpressb1", "exprraid", nullptr, nullptr, "1986",
	"Western Express (bootleg set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, wexpressb1RomInfo, wexpressb1RomName, nullptr, nullptr, nullptr, nullptr, ExprraidInputInfo,
	ExprraidDIPInfo,
...
struct BurnDriver BurnDrvWexpressb2 = {
	"wexpressb2", "exprraid", nullptr, nullptr, "1986",
	"Western Express (bootleg set 2)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, wexpressb2RomInfo, wexpressb2RomName, nullptr, nullptr, nullptr, nullptr, ExprraidInputInfo,
	ExprraidDIPInfo,
...
struct BurnDriver BurnDrvWexpressb3 = {
	"wexpressb3", "exprraid", nullptr, nullptr, "1986",
	"Western Express (bootleg set 3)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, wexpressb3RomInfo, wexpressb3RomName, nullptr, nullptr, nullptr, nullptr, ExprraidInputInfo,
	ExprraidDIPInfo,
