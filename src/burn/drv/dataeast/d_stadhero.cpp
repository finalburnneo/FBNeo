...
static INT32 DrvInit()
{
	...
	MSM6295Init(0, 1056000 / MSM6295_PIN7_HIGH, true);
			...
			for (INT32 y = 0; y < h; y++)
			{
				if (!flash || (nCurrentFrame & 1))
				{
					Draw16x16MaskTile(pTransDraw, (code - y * incy) & 0xfff, sx + (mult * x), (sy + (mult * y)) - 8,
					                  flipx, flipy, color, 4, 0, 0x100, DrvGfxROM2);
				}
			}
		}
	}
...
static INT32 DrvDraw()
{
	...
	bac06_draw_layer(DrvVidRAM, DrvVidCtrl, nullptr, nullptr, DrvGfxROM0, 0, 0xfff, DrvGfxROM1, 0x200, 0x7ff, 2, 1);
...
struct BurnDriver BurnDrvStadhero = {
	"stadhero", nullptr, nullptr, nullptr, "1988",
	"Stadium Hero (Japan)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, stadheroRomInfo, stadheroRomName, nullptr, nullptr, nullptr, nullptr, StadheroInputInfo, StadheroDIPInfo,
