...
static UINT8* Drv6280ROM = nullptr;
static UINT8* Drv6502ROM = nullptr;
static UINT8* DrvGfxROM0 = nullptr;
static UINT8* DrvGfxROM1 = nullptr;
static UINT8* DrvGfxROM2 = nullptr;
static UINT8* DrvPf1RAM = nullptr;
static UINT8* DrvPf2RAM = nullptr;
static UINT8* DrvPf1Scr = nullptr;
static UINT8* DrvPf2Scr = nullptr;
static UINT8* DrvSprRAM = nullptr;
static UINT8* DrvPalRAM = nullptr;
static UINT8* Drv6280RAM = nullptr;
static UINT8* Drv6502RAM = nullptr;
static UINT8* DrvSprBuf = nullptr;
static UINT8* DrvPfCtrl[2] = {nullptr, nullptr};

static UINT8* soundlatch = nullptr;
static UINT8* flipscreen = nullptr;
...
static void Dec0SoundInit()
{
	...
	MSM6295Init(0, 1024188 / 132, true);
	...
	while (offs < 0x800)
	{
		...
		for (INT32 x = 0; x < w; x++)
		{
			if (enable && (!flash || (nCurrentFrame & 1)))
			{
				...
				for (INT32 y = 0; y < h; y++)
				{
					Draw16x16MaskTile(pTransDraw, code - y * incy, sx + (mult * x), sy + (mult * y) - 8, flipx, flipy,
					                  color, 4, 0, gfx_config[1], DrvGfxROM1);
				}
			}
...
struct BurnDriver BurnDrvActfancr = {
	"actfancr", nullptr, nullptr, nullptr, "1989",
	"Act-Fancer Cybernetick Hyper Weapon (World revision 3)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_HORSHOOT, 0,
	nullptr, actfancrRomInfo, actfancrRomName, nullptr, nullptr, nullptr, nullptr, ActfancrInputInfo, ActfancrDIPInfo,
...
struct BurnDriver BurnDrvActfancr1 = {
	"actfancr1", "actfancr", nullptr, nullptr, "1989",
	"Act-Fancer Cybernetick Hyper Weapon (World revision 1)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_HORSHOOT, 0,
	nullptr, actfancr1RomInfo, actfancr1RomName, nullptr, nullptr, nullptr, nullptr, ActfancrInputInfo, ActfancrDIPInfo,
	ActfanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvActfancr2 = {
	"actfancr2", "actfancr", nullptr, nullptr, "1989",
	"Act-Fancer Cybernetick Hyper Weapon (World revision 2)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_HORSHOOT, 0,
	nullptr, actfancr2RomInfo, actfancr2RomName, nullptr, nullptr, nullptr, nullptr, ActfancrInputInfo, ActfancrDIPInfo,
	ActfanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvActfancrj = {
	"actfancrj", "actfancr", nullptr, nullptr, "1989",
	"Act-Fancer Cybernetick Hyper Weapon (Japan revision 1)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_HORSHOOT, 0,
	nullptr, actfancrjRomInfo, actfancrjRomName, nullptr, nullptr, nullptr, nullptr, ActfancrInputInfo, ActfancrDIPInfo,
	ActfanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvTriothep = {
	"triothep", nullptr, nullptr, nullptr, "1989",
	"Trio The Punch - Never Forget Me... (World)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, triothepRomInfo, triothepRomName, nullptr, nullptr, nullptr, nullptr, TriothepInputInfo, TriothepDIPInfo,
...
struct BurnDriver BurnDrvTriothepj = {
	"triothepj", "triothep", nullptr, nullptr, "1989",
	"Trio The Punch - Never Forget Me... (Japan)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SCRFIGHT, 0,
	nullptr, triothepjRomInfo, triothepjRomName, nullptr, nullptr, nullptr, nullptr, TriothepInputInfo, TriothepDIPInfo,
	TriothepInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	256, 240, 4, 3
};
