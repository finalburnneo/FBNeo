...
static struct BurnDIPInfo MetlfrzrDIPList[] =
{
	...
	{0x12, 0x01, 0x38, 0x08, "1 Coin  5 Credits"},
	...
	{0x13, 0x01, 0x03, 0x02, "A"},
	{0x13, 0x01, 0x03, 0x03, "B"},
	{0x13, 0x01, 0x03, 0x01, "C"},
	{0x13, 0x01, 0x03, 0x00, "D"},
...
static void draw_bg_layer() // Ripped directly from MAME, very ugly!
{
	...
	for (INT32 count = 0; count < 32 * 33; count++)
	{
		...
		UINT16 tile = DrvVidRAM[tile_base * 2 + 0] + ((DrvVidRAM[tile_base * 2 + 1] & 0xf0) << 4) + (fg_tilebank *
			0x1000);
...
struct BurnDriver BurnDrvMetlfrzr = {
	"metlfrzr", nullptr, nullptr, nullptr, "1989",
	"Metal Freezer (Japan)\0", nullptr, "Seibu Kaihatsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, metlfrzrRomInfo, metlfrzrRomName, nullptr, nullptr, nullptr, nullptr, MetlfrzrInputInfo, MetlfrzrDIPInfo,
