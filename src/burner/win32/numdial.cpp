...
static INT_PTR CALLBACK DefInpProc(HWND hDlg, UINT Msg, WPARAM wParam, LPARAM)
{
	...
	case WM_INITDIALOG:
		nRet = nAudSegCount;
		SetWindowText(hDlg, FBNLoadStringEx(hAppInst, IDS_NUMDIAL_NUM_FRAMES, true));
...
{
	FBNDialogBox(hAppInst, MAKEINTRESOURCE(IDD_VALUE), hScrnWnd, (DLGPROC)DefInpProc);
...
void GammaDialog()
{
	FBNDialogBox(hAppInst, MAKEINTRESOURCE(IDD_GAMMA), hScrnWnd, (DLGPROC)GammaProc);
}
			...
			case EN_UPDATE:
				{
					if (nExitStatus == 0)
					{
						...
						if (bValid)
						{
							...
							// Set slider to current value
							SendDlgItemMessage(hDlg, IDC_SCANLINE_SLIDER, TBM_SETPOS, (WPARAM)true,
							                   (LPARAM)nVidScanIntensity);
			...
			case TB_TOP:
				{
					if (nExitStatus == 0)
					{
						...
						// Update the contents of the edit control
						nVidScanIntensity = SendDlgItemMessage(hDlg, IDC_SCANLINE_SLIDER, TBM_GETPOS, (WPARAM)0,
						                                       (LPARAM)0);
...
void ScanlineDialog()
{
	FBNDialogBox(hAppInst, MAKEINTRESOURCE(IDD_SCANLINE), hScrnWnd, (DLGPROC)ScanlineProc);
}
	...
	case WM_INITDIALOG:
		{
			...
			SendDlgItemMessage(hDlg, IDC_PHOSPHOR_2_SLIDER, TBM_SETPOS, (WPARAM)true,
			                   (LPARAM)nVidFeedbackOverSaturation);
			...
			case EN_UPDATE:
				{
					if (nExitStatus == 0)
					{
						...
						case IDC_PHOSPHOR_1_EDIT:
							if (SendDlgItemMessage(hDlg, IDC_PHOSPHOR_1_EDIT, WM_GETTEXTLENGTH, (WPARAM)0, (LPARAM)0) <
								16)
							{
							...
							if (bValid)
							{
								...
								// Set slider to current value
								SendDlgItemMessage(hDlg, IDC_PHOSPHOR_1_SLIDER, TBM_SETPOS, (WPARAM)true,
								                   (LPARAM)nVidFeedbackIntensity);
							}
							break;
						case IDC_PHOSPHOR_2_EDIT:
							if (SendDlgItemMessage(hDlg, IDC_PHOSPHOR_2_EDIT, WM_GETTEXTLENGTH, (WPARAM)0, (LPARAM)0) <
								16)
							{
			...
			case TB_TOP:
				{
					if (nExitStatus == 0)
					{
						...
						case IDC_PHOSPHOR_1_SLIDER:
							nVidFeedbackIntensity = SendDlgItemMessage(hDlg, IDC_PHOSPHOR_1_SLIDER, TBM_GETPOS,
							                                           (WPARAM)0, (LPARAM)0);
							_stprintf(szText, _T("%i"), nVidFeedbackIntensity);
							SendDlgItemMessage(hDlg, IDC_PHOSPHOR_1_EDIT, WM_SETTEXT, (WPARAM)0, (LPARAM)szText);
							break;
						case IDC_PHOSPHOR_2_SLIDER:
							nVidFeedbackOverSaturation = SendDlgItemMessage(
								hDlg, IDC_PHOSPHOR_2_SLIDER, TBM_GETPOS, (WPARAM)0, (LPARAM)0);
							_stprintf(szText, _T("%i"), nVidFeedbackOverSaturation);
							SendDlgItemMessage(hDlg, IDC_PHOSPHOR_2_EDIT, WM_SETTEXT, (WPARAM)0, (LPARAM)szText);
							break;
						}
...
void PhosphorDialog()
{
	FBNDialogBox(hAppInst, MAKEINTRESOURCE(IDD_PHOSPHOR), hScrnWnd, (DLGPROC)PhosphorProc);
}
	...
	case WM_INITDIALOG:
		{
			...
			SendDlgItemMessage(hDlg, IDC_SCREENANGLE_SLIDER, TBM_SETPOS, (WPARAM)true,
			                   (LPARAM)(fVidScreenAngle * RADTODEG * 100.0f));
			SendDlgItemMessage(hDlg, IDC_SCREENCURVATURE_SLIDER, TBM_SETPOS, (WPARAM)true,
			                   (LPARAM)(fVidScreenCurvature * RADTODEG * 150.0f));
			...
			case EN_UPDATE:
				{
					if (nExitStatus == 0)
					{
						...
						{
							if (SendDlgItemMessage(hDlg, IDC_SCREENANGLE_EDIT, WM_GETTEXTLENGTH, (WPARAM)0,
							                       (LPARAM)0) < 16)
							{
						...
						{
							if (SendDlgItemMessage(hDlg, IDC_SCREENCURVATURE_EDIT, WM_GETTEXTLENGTH, (WPARAM)0,
							                       (LPARAM)0) < 16)
							{
								SendDlgItemMessage(hDlg, IDC_SCREENCURVATURE_EDIT, WM_GETTEXT, (WPARAM)16,
								                   (LPARAM)szText);
							}
						}
			...
			case TB_TOP:
				{
					if (nExitStatus == 0)
					{
						...
						{
							fVidScreenAngle = (float)SendDlgItemMessage(hDlg, IDC_SCREENANGLE_SLIDER, TBM_GETPOS,
							                                            (WPARAM)0, (LPARAM)0) * DEGTORAD / 100.0f;
							_stprintf(szText, _T("%0.2f"), fVidScreenAngle * RADTODEG);
							SendDlgItemMessage(hDlg, IDC_SCREENANGLE_EDIT, WM_SETTEXT, (WPARAM)0, (LPARAM)szText);
						}
						else
						{
							fVidScreenCurvature = (float)SendDlgItemMessage(
								hDlg, IDC_SCREENCURVATURE_SLIDER, TBM_GETPOS, (WPARAM)0, (LPARAM)0) * DEGTORAD / 150.0f;
							_stprintf(szText, _T("%0.2f"), fVidScreenCurvature * RADTODEG);
							SendDlgItemMessage(hDlg, IDC_SCREENCURVATURE_EDIT, WM_SETTEXT, (WPARAM)0, (LPARAM)szText);
						}
...
{
	FBNDialogBox(hAppInst, MAKEINTRESOURCE(IDD_SCREENANGLE), hScrnWnd, (DLGPROC)ScreenAngleProc);
}
...
void CPUClockDialog()
{
	FBNDialogBox(hAppInst, MAKEINTRESOURCE(IDD_CPUCLOCK), hScrnWnd, (DLGPROC)CPUClockProc);
}
	...
	case WM_INITDIALOG:
		{
			...
			// Set slider to current value
			SendDlgItemMessage(hDlg, IDC_SCANLINE_SLIDER, TBM_SETPOS, (WPARAM)true,
			                   (LPARAM)((1.0 - dVidCubicB) * 10000));

			// Set the edit control to current value
			_stprintf(szText, _T("%.3lf"), 1.0 - dVidCubicB);
			SendDlgItemMessage(hDlg, IDC_SCANLINE_EDIT, WM_SETTEXT, (WPARAM)0, (LPARAM)szText);

			SetWindowText(hDlg, FBNLoadStringEx(hAppInst, IDS_NUMDIAL_FILTER_SHARP, true));
			...
			case TB_TOP:
				{
					if (nExitStatus == 0)
					{
						...
						// Update the contents of the edit control
						dVidCubicB = 1.0 - (double)SendDlgItemMessage(hDlg, IDC_SCANLINE_SLIDER, TBM_GETPOS, (WPARAM)0,
						                                              (LPARAM)0) / 10000;
						_stprintf(szText, _T("%.3lf"), 1.0 - dVidCubicB);
						SendDlgItemMessage(hDlg, IDC_SCANLINE_EDIT, WM_SETTEXT, (WPARAM)0, (LPARAM)szText);
...
{
	FBNDialogBox(hAppInst, MAKEINTRESOURCE(IDD_SCANLINE), hScrnWnd, (DLGPROC)CubicProc);
}
