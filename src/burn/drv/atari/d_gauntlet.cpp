...
static struct BurnInputInfo Vindctr2InputList[] = {
	...
	{"P1 Button 1",			BIT_DIGITAL,	DrvInputPort0 + 0,	"p1 fire 1"	},
	{"P1 Button 2",			BIT_DIGITAL,	DrvInputPort0 + 2,	"p1 fire 2"	},
	{"P1 Button 3",			BIT_DIGITAL,	DrvInputPort0 + 1,	"p1 fire 3"	},
	{"P1 Button 4",			BIT_DIGITAL,	DrvInputPort0 + 3,	"p1 fire 4"	},
	...
	{"P2 Button 1",			BIT_DIGITAL,	DrvInputPort1 + 0,	"p2 fire 1"	},
	{"P2 Button 2",			BIT_DIGITAL,	DrvInputPort1 + 2,	"p2 fire 2"	},
	{"P2 Button 3",			BIT_DIGITAL,	DrvInputPort1 + 1,	"p2 fire 3"	},
	{"P2 Button 4",			BIT_DIGITAL,	DrvInputPort1 + 3,	"p2 fire 4"	},
...
struct BurnDriver BurnDrvVindctr2 = {
	...
	NULL, vindctr2RomInfo, vindctr2RomName, NULL, NULL, Vindctr2InputInfo, Vindctr2DIPInfo,
...
struct BurnDriver BurnDrvVindctr2r2 = {
	...
	NULL, vindctr2r2RomInfo, vindctr2r2RomName, NULL, NULL, Vindctr2InputInfo, Vindctr2DIPInfo,
	Vindctr2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, NULL,
	0x400, 336, 240, 4, 3
};
...
struct BurnDriver BurnDrvVindctr2r1 = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	NULL, vindctr2r1RomInfo, vindctr2r1RomName, NULL, NULL, Vindctr2InputInfo, Vindctr2DIPInfo,
	Vindctr2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, NULL,
	0x400, 336, 240, 4, 3
};
