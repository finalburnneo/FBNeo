...
static struct BurnDIPInfo GberetbDIPList[] =
{
	...
	{0x0a, 0xff, 0xff, 0x4a, nullptr},
	{0x0b, 0xff, 0xff, 0x0f, nullptr},
...
static void draw_sprites()
{
	...
	for (INT32 offs = 0; offs < 0xc0; offs += 4)
	{
		if (ram[offs + 3])
		{
			...
			RenderTileTranstabOffset(pTransDraw, DrvGfxROM1, code, color * 16, 0, sx - 8, sy - 16, flipx, flipy, 16, 16,
			                         DrvColPROM + 0x120, 0x100);
		}
	}
}
...
static void gberetb_draw_sprites()
{
	...
	for (INT32 offs = 0x100 - 4; offs >= 0; offs -= 4)
	{
		if (ram[offs + 1])
		{
			...
			RenderTileTranstabOffset(pTransDraw, DrvGfxROM1, code, color * 16, 0, sx - 8, (240 - sy) - 16, flipx, flipy,
			                         16, 16, DrvColPROM + 0x120, 0x100);
		}
	}
}
...
struct BurnDriver BurnDrvGberet = {
	"gberet", nullptr, nullptr, nullptr, "1985",
	"Green Beret\0", nullptr, "Konami", "GX577",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, gberetRomInfo, gberetRomName, nullptr, nullptr, nullptr, nullptr, GberetInputInfo, GberetDIPInfo,
...
struct BurnDriver BurnDrvRushatck = {
	"rushatck", "gberet", nullptr, nullptr, "1985",
	"Rush'n Attack (US)\0", nullptr, "Konami", "GX577",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, rushatckRomInfo, rushatckRomName, nullptr, nullptr, nullptr, nullptr, GberetInputInfo, GberetDIPInfo,
	GberetInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	240, 224, 4, 3
};
...
struct BurnDriver BurnDrvGberetb = {
	"gberetb", "gberet", nullptr, nullptr, "1985",
	...
	nullptr, gberetbRomInfo, gberetbRomName, nullptr, nullptr, nullptr, nullptr, GberetbInputInfo, GberetbDIPInfo,
...
struct BurnDriver BurnDrvMrgoemon = {
	"mrgoemon", nullptr, nullptr, nullptr, "1986",
	"Mr. Goemon (Japan)\0", nullptr, "Konami", "GX621",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_PLATFORM, 0,
	nullptr, mrgoemonRomInfo, mrgoemonRomName, nullptr, nullptr, nullptr, nullptr, GberetInputInfo, MrgoemonDIPInfo,
