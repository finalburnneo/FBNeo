...
static void draw_sprites(UINT8* source, INT32 length, UINT8* gfxbase, INT32 color_offset, INT32 color_mask,
                         INT32 flipscreen)
{
	...
	while (source < finish)
	{
		...
		for (INT32 y = 0; y < height; y++)
		{
			for (INT32 x = 0; x < width; x++)
			{
				...
				Draw16x16MaskTile(pTransDraw, code, sx + x * 16, (sy + y * 16) - 16, flipx, flipy, color, 4, 0,
				                  color_offset, gfxbase);
			}
		}
...
static INT32 DrvFrame()
{
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		if ((i % MULT) == 0)
		{
			// soundcpu doesn't like high sync, run 256 lines instead of 256*MULT
			M6809Open(2);
...
struct BurnDriver BurnDrvDdribble = {
	"ddribble", nullptr, nullptr, nullptr, "1986",
	"Double Dribble\0", nullptr, "Konami", "GX690",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SPORTSMISC, 0,
	nullptr, ddribbleRomInfo, ddribbleRomName, nullptr, nullptr, nullptr, nullptr, DdribbleInputInfo, DdribbleDIPInfo,
...
struct BurnDriver BurnDrvDdribblep = {
	"ddribblep", "ddribble", nullptr, nullptr, "1986",
	"Double Dribble (prototype?)\0", nullptr, "Konami", "GX690",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SPORTSMISC, 0,
	nullptr, ddribblepRomInfo, ddribblepRomName, nullptr, nullptr, nullptr, nullptr, DdribbleInputInfo, DdribbleDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x140,
	256, 224, 4, 3
};
