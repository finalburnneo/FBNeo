...
static INT32 DrvInit()
{
	...
	BurnYM3812Init(1, 3579545, nullptr, DrvSynchroniseStream, 0);
...
static void draw_layer(UINT8* ram, UINT8* ctrl, UINT8* gfx, INT32 colbase, INT32 base, INT32 t)
{
	...
	for (INT32 offs = 0; offs < 64 * 32; offs++)
	{
		...
		INT32 bank = ((attr & 0x80) >> 7) | ((attr >> bit0) & 0x02) | ((attr >> bit1) & 0x04) | ((attr >> bit2) & 0x08)
			| ((attr >> bit3) & 0x10);
...
static void draw_sprites(INT32 bank, UINT8* source, UINT8* ctrl, UINT8* gfx, INT32 col)
{
	...
	static constexpr INT32 x_offset[4] = {0x00, 0x01, 0x04, 0x05};
	static constexpr INT32 y_offset[4] = {0x00, 0x02, 0x08, 0x0a};
...
struct BurnDriver BurnDrvHcastle = {
	"hcastle", nullptr, nullptr, nullptr, "1988",
	"Haunted Castle (ver. M)\0", nullptr, "Konami", "GX768",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT | GBF_PLATFORM, 0,
	nullptr, hcastleRomInfo, hcastleRomName, nullptr, nullptr, nullptr, nullptr, HcastleInputInfo, HcastleDIPInfo,
...
struct BurnDriver BurnDrvHcastlek = {
	"hcastlek", "hcastle", nullptr, nullptr, "1988",
	"Haunted Castle (ver. K)\0", nullptr, "Konami", "GX768",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT | GBF_PLATFORM, 0,
	nullptr, hcastlekRomInfo, hcastlekRomName, nullptr, nullptr, nullptr, nullptr, HcastleInputInfo, HcastleDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvHcastlee = {
	"hcastlee", "hcastle", nullptr, nullptr, "1988",
	"Haunted Castle (ver. E)\0", nullptr, "Konami", "GX768",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT | GBF_PLATFORM, 0,
	nullptr, hcastleeRomInfo, hcastleeRomName, nullptr, nullptr, nullptr, nullptr, HcastleInputInfo, HcastleDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvAkumajou = {
	"akumajou", "hcastle", nullptr, nullptr, "1988",
	"Akuma-Jou Dracula (Japan ver. P)\0", nullptr, "Konami", "GX768",
	L"\u60AA\u9B54\u57CE \u30C9\u30E9\u30AD\u30E5\u30E9 (Japan ver. P)\0Akuma-Jou Dracula\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT | GBF_PLATFORM, 0,
	nullptr, akumajouRomInfo, akumajouRomName, nullptr, nullptr, nullptr, nullptr, HcastleInputInfo, HcastleDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvAkumajoun = {
	"akumajoun", "hcastle", nullptr, nullptr, "1988",
	"Akuma-Jou Dracula (Japan ver. N)\0", nullptr, "Konami", "GX768",
	L"\u60AA\u9B54\u57CE \u30C9\u30E9\u30AD\u30E5\u30E9 (Japan ver. N)\0Akuma-Jou Dracula\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT | GBF_PLATFORM, 0,
	nullptr, akumajounRomInfo, akumajounRomName, nullptr, nullptr, nullptr, nullptr, HcastleInputInfo, HcastleDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	256, 224, 4, 3
};
