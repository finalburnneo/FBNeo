...
static void DrvMCUSync()
{
	INT32 todo = (static_cast<double>(M6809TotalCycles()) * (8000000 / 12) / 2000000) - mcs51TotalCycles();
...
static INT32 SidepcktLoadRoms()
{
	...
	nRet = BurnLoadRom(DrvM6809Rom + 0x00000, 0, 1);
	if (nRet != 0) return 1;

	nRet = BurnLoadRom(DrvM6502Rom + 0x00000, 1, 1);
	if (nRet != 0) return 1;

	realMCU = 1;
	nRet = BurnLoadRom(DrvMCUROM + 0x00000, 2, 1);
	if (nRet != 0) return 1;

	nRet = BurnLoadRom(DrvTempRom + 0x00000, 3, 1);
	if (nRet != 0) return 1;
	nRet = BurnLoadRom(DrvTempRom + 0x08000, 4, 1);
	if (nRet != 0) return 1;
	...
	nRet = BurnLoadRom(DrvProm + 0x00000, 9, 1);
	if (nRet != 0) return 1;
	nRet = BurnLoadRom(DrvProm + 0x00100, 10, 1);
	if (nRet != 0) return 1;
...
static INT32 SidepcktbLoadRoms()
{
	...
	nRet = BurnLoadRom(DrvM6809Rom + 0x04000, 0, 1);
	if (nRet != 0) return 1;
	nRet = BurnLoadRom(DrvM6809Rom + 0x08000, 1, 1);
	if (nRet != 0) return 1;

	nRet = BurnLoadRom(DrvM6502Rom + 0x00000, 2, 1);
	if (nRet != 0) return 1;
...
struct BurnDriver BurnDrvSidepckt = {
	"sidepckt", nullptr, nullptr, nullptr, "1986",
	"Side Pocket (World)\0", nullptr, "Data East Corporation", "Miscellaneous",
	...
	nullptr, 0x100, 256, 224, 4, 3
};

struct BurnDriver BurnDrvSidepcktj = {
	"sidepcktj", "sidepckt", nullptr, nullptr, "1986",
	"Side Pocket (Japan, Cocktail)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, DrvjRomInfo, DrvjRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvjDIPInfo,
	SidepcktjInit, DrvExit, DrvFrame, DrvDraw, DrvScan,
	nullptr, 0x100, 256, 224, 4, 3
};

struct BurnDriver BurnDrvSidepcktb = {
	"sidepcktb", "sidepckt", nullptr, nullptr, "1986",
	"Side Pocket (bootleg, set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, DrvbRomInfo, DrvbRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvbDIPInfo,
	SidepcktbInit, DrvExit, DrvFrame, DrvDraw, DrvScan,
	nullptr, 0x100, 256, 224, 4, 3
};

struct BurnDriver BurnDrvSidepcktb2 = {
	"sidepcktb2", "sidepckt", nullptr, nullptr, "1986",
	"Side Pocket (bootleg, set 2)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
