...
static struct BurnDIPInfo Cop01DIPList[]=
{
	...
	{0x13, 0x01, 0x0c, 0x08, "2 Coins 3 Credits"	},
	{0x13, 0x01, 0x0c, 0x0c, "1 Coin  3 Credits"	},
	{0x13, 0x01, 0x0c, 0x04, "1 Coin  6 Credits"	},
	...
	{0x14, 0x01, 0x0c, 0x00, "6"					},

	{0   , 0xfe, 0   ,    2, "1st Bonus Life"		},
	{0x14, 0x01, 0x10, 0x10, "20000"				},
	{0x14, 0x01, 0x10, 0x00, "30000"				},

	{0   , 0xfe, 0   ,    4, "2nd Bonus Life"		},
	{0x14, 0x01, 0x60, 0x60, "30000"				},
	{0x14, 0x01, 0x60, 0x20, "50000"				},
	{0x14, 0x01, 0x60, 0x40, "100000"				},
	{0x14, 0x01, 0x60, 0x00, "150000"				},

	{0   , 0xfe, 0   ,    8, "Bonus Life"			},
	{0x14, 0x01, 0x70, 0x70, "20k 50k 30k+"			},
	{0x14, 0x01, 0x70, 0x30, "20k 70k 50k+"			},
	{0x14, 0x01, 0x70, 0x50, "20k 120k 100k+"		},
	{0x14, 0x01, 0x70, 0x10, "20k 170k 150k+"		},
	{0x14, 0x01, 0x70, 0x60, "30k 60k 30k+"			},
	{0x14, 0x01, 0x70, 0x20, "30k 80k 50k+"			},
	{0x14, 0x01, 0x70, 0x40, "30k 130k 100k+"		},
	{0x14, 0x01, 0x70, 0x00, "30k 180k 150k+"		},
};
...
static struct BurnDIPInfo MightguyDIPList[]=
{
	...
	{0x13, 0x01, 0x04, 0x04, "Every 200k"			},
	{0x13, 0x01, 0x04, 0x00, "500k only"			},
	...
	{0   , 0xfe, 0   ,    2, "Cabinet"				},
	{0x13, 0x01, 0x10, 0x00, "Upright"				},
	{0x13, 0x01, 0x10, 0x10, "Cocktail"				},
	...
	{0x14, 0x01, 0x30, 0x00, "Invincibility"		},

	{0   , 0xfe, 0   ,    8, "Starting Area"		},
	{0x15, 0x01, 0x07, 0x07, "1"					},
	{0x15, 0x01, 0x07, 0x06, "2"					},
	{0x15, 0x01, 0x07, 0x05, "3"					},
	{0x15, 0x01, 0x07, 0x04, "4"					},
	{0x15, 0x01, 0x07, 0x03, "5"					},
	{0x15, 0x01, 0x07, 0x02, "6"					},
	{0x15, 0x01, 0x07, 0x01, "7"					},
	{0x15, 0x01, 0x07, 0x00, "8"					},
};
	...
	switch (port & 0xff)
	{
		...
		case 0x06:
		{
			if ((ZetTotalCycles() / 11475) & 1) {
				if (timer_pulse == 0) return (soundlatch << 1) | 1;
				timer_pulse = 1;
			} else {
				timer_pulse = 0;
			}
