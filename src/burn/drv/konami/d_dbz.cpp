...
{
	auto dst = (UINT16*)K053247Ram; // 0x800 words
	auto src = (UINT16*)DrvObjDMARam; // 0x2000 words
...
static void dbz_K053936_callback1(INT32 offset, UINT16* ram, INT32* code, INT32* color, INT32*, INT32*, INT32* flipx,
                                  INT32*)
{
...
static void dbz_K053936_callback2(INT32 offset, UINT16* ram, INT32* code, INT32* color, INT32*, INT32*, INT32* flipx,
                                  INT32*)
{
	*code = BURN_ENDIAN_SWAP_INT16(ram[(offset * 2) + 1]) & 0x7fff;
...
static INT32 MemIndex()
{
	...
	Next += 0x010000;
	DrvObjDMARam = Next;
	Next += 0x004000; // dma area, 0x2000 words
	DrvPalRAM = Next;
	Next += 0x004000;
	...
	DrvK053936Ctrl1 = Next;
	Next += 0x000400;
	DrvK053936Ctrl2 = Next;
	Next += 0x000400;
	...
	soundlatch = Next;
	Next += 0x000001 + 0x03; // round up to 4byte
...
struct BurnDriver BurnDrvDbz = {
	"dbz", nullptr, nullptr, nullptr, "1993",
	"Dragonball Z (rev B)\0", nullptr, "Banpresto", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_VSFIGHT, 0,
	nullptr, dbzRomInfo, dbzRomName, nullptr, nullptr, nullptr, nullptr, DbzInputInfo, DbzDIPInfo,
...
struct BurnDriver BurnDrvDbza = {
	"dbza", "dbz", nullptr, nullptr, "1993",
	"Dragonball Z (rev A)\0", nullptr, "Banpresto", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_VSFIGHT, 0,
	nullptr, dbzaRomInfo, dbzaRomName, nullptr, nullptr, nullptr, nullptr, DbzInputInfo, DbzDIPInfo,
...
struct BurnDriver BurnDrvDbz2 = {
	"dbz2", nullptr, nullptr, nullptr, "1994",
	"Dragonball Z 2 - Super Battle\0", nullptr, "Banpresto", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_VSFIGHT, 0,
	nullptr, dbz2RomInfo, dbz2RomName, nullptr, nullptr, nullptr, nullptr, DbzInputInfo, Dbz2DIPInfo,
