...
{
	{0x1d, 0xff, 0xff, 0xff, nullptr},
	{0x1e, 0xff, 0xff, 0x5e, nullptr},
	{0x1f, 0xff, 0xff, 0xff, nullptr},
...
static INT32 MemIndex()
{
	...
	Next += 0x0401 * 2 * sizeof(UINT32); // first: normal, second (+0x400) shadow, 0x801 default shadow
...
{
	auto src = (UINT16*)DrvGfxROM1;
	auto dst = (UINT16*)BurnMalloc(0x200000);
...
enum
{
	...
	TWIN16_SCREEN_FLIPX = 0x02,
	// confirmed: Hard Puncher Intro
	TWIN16_PRI0 = 0x04,
	// PRI0 input into 007789 PAL
	TWIN16_PRI1 = 0x08,
	// PRI1 input into 007789 PAL
	TWIN16_PRI2_UNUSED = 0x10,
	// schematic shows as PRI2 input, but unused
...
enum
{
	...
	TWIN16_BG_OVER_SPRITES = 0x01,
	// BG pixel has priority over opaque sprite pixels
	TWIN16_BG_NO_SHADOW = 0x02,
	// BG pixel has priority over shadow sprite pixels
...
static void draw_layer(INT32 layernum, INT32 catagory, INT32 priflags)
{
	...
	auto vram = (UINT16*)(DrvVidRAM + (layernum << 13));
	banks[3] = gfx_bank >> 12;
...
{
	auto twin16_sprite_gfx_ram = (UINT16*)DrvSprGfxRAM;
	auto twin16_gfx_rom = (UINT16*)DrvGfxROM1;
	auto buffered_spriteram16 = (UINT16*)DrvSprBuf;
...
struct BurnDriver BurnDrvDevilw = {
	"devilw", nullptr, nullptr, nullptr, "1987",
	"Devil World\0", nullptr, "Konami", "GX687",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, devilwRomInfo, devilwRomName, nullptr, nullptr, nullptr, nullptr, DevilwInputInfo, DevilwDIPInfo,
...
struct BurnDriver BurnDrvMajuu = {
	"majuu", "devilw", nullptr, nullptr, "1987",
	"Majuu no Ohkoku\0", nullptr, "Konami", "GX687",
	L"\u9B54\u7363\u306E\u738B\u56FD\0Majuu no Ohkoku\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, majuuRomInfo, majuuRomName, nullptr, nullptr, nullptr, nullptr, DevilwInputInfo, DevilwDIPInfo,
	devilwInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvDarkadv = {
	"darkadv", "devilw", nullptr, nullptr, "1987",
	"Dark Adventure\0", nullptr, "Konami", "GX687",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, darkadvRomInfo, darkadvRomName, nullptr, nullptr, nullptr, nullptr, DarkadvInputInfo, DarkadvDIPInfo,
	devilwInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvVulcan = {
	"vulcan", nullptr, nullptr, nullptr, "1988",
	"Vulcan Venture (New)\0", nullptr, "Konami", "GX785",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	nullptr, vulcanRomInfo, vulcanRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, VulcanDIPInfo,
...
struct BurnDriver BurnDrvVulcana = {
	"vulcana", "vulcan", nullptr, nullptr, "1988",
	"Vulcan Venture (Old)\0", nullptr, "Konami", "GX785",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	nullptr, vulcanaRomInfo, vulcanaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, VulcanDIPInfo,
	vulcanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvVulcanb = {
	"vulcanb", "vulcan", nullptr, nullptr, "1988",
	"Vulcan Venture (Oldest)\0", nullptr, "Konami", "GX785",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	nullptr, vulcanbRomInfo, vulcanbRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, VulcanDIPInfo,
	vulcanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvGradius2 = {
	"gradius2", "vulcan", nullptr, nullptr, "1988",
	"Gradius II - GOFER no Yabou (Japan New Ver.)\0", nullptr, "Konami", "GX785",
	L"Gradius II - GOFER \u306E\u91CE\u671B (Japan New Ver.)\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	nullptr, gradius2RomInfo, gradius2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, Gradius2DIPInfo,
	vulcanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvGradius2a = {
	"gradius2a", "vulcan", nullptr, nullptr, "1988",
	"Gradius II - GOFER no Yabou (Japan Old Ver.)\0", nullptr, "Konami", "GX785",
	L"Gradius II - GOFER \u306E\u91CE\u671B (Japan Old Ver.)\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	nullptr, gradius2aRomInfo, gradius2aRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, VulcanDIPInfo,
	vulcanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvGradius2b = {
	"gradius2b", "vulcan", nullptr, nullptr, "1988",
	"Gradius II - GOFER no Yabou (Japan Older Ver.)\0", nullptr, "Konami", "GX785",
	L"Gradius II - GOFER \u306E\u91CE\u671B (Japan Older Ver.)\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	nullptr, gradius2bRomInfo, gradius2bRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, VulcanDIPInfo,
	vulcanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvFround = {
	"fround", nullptr, nullptr, nullptr, "1988",
	"The Final Round (version M)\0", nullptr, "Konami", "GX870",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SPORTSMISC, 0,
	nullptr, froundRomInfo, froundRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, FroundDIPInfo,
...
struct BurnDriver BurnDrvFroundl = {
	"froundl", "fround", nullptr, nullptr, "1988",
	"The Final Round (version L)\0", nullptr, "Konami", "GX870",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SPORTSMISC, 0,
	nullptr, froundlRomInfo, froundlRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, FroundDIPInfo,
	froundInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvHpuncher = {
	"hpuncher", "fround", nullptr, nullptr, "1988",
	"Hard Puncher (Japan)\0", nullptr, "Konami", "GX870",
	L"Hard Puncher \uFF0D\u8840\u307E\u307F\u308C\u306E\u6804\u5149\uFF0D (Japan)\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SPORTSMISC, 0,
	nullptr, hpuncherRomInfo, hpuncherRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, FroundDIPInfo,
...
struct BurnDriver BurnDrvMiaj = {
	"miaj", "mia", nullptr, nullptr, "1989",
	"M.I.A. - Missing in Action (version R) (Japan)\0", nullptr, "Konami", "GX808",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, miajRomInfo, miajRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MiajDIPInfo,
...
struct BurnDriver BurnDrvCuebrckj = {
	"cuebrickj", "cuebrick", nullptr, nullptr, "1989",
	"Cue Brick (Japan)\0", nullptr, "Konami", "GX903",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_PUZZLE, 0,
	nullptr, cuebrckjRomInfo, cuebrckjRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, CuebrckjDIPInfo,
