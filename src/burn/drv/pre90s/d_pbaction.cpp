...
static void draw_sprites()
{
	for (INT32 offs = 0x80 - 4; offs >= 0; offs -= 4)
	{
		...
		if (size == 32)
		{
			Draw32x32MaskTile(pTransDraw, code, sx + ((flipscreen) ? scroll : -scroll), sy, flipx, flipy, color, 3, 0,
			                  0, DrvGfxROM3);
		}
		else
		{
			Draw16x16MaskTile(pTransDraw, code, sx + ((flipscreen) ? scroll : -scroll), sy, flipx, flipy, color, 3, 0,
			                  0, DrvGfxROM2);
		}
	}
}
...
struct BurnDriver BurnDrvPbaction = {
	"pbaction", nullptr, nullptr, nullptr, "1985",
	"Pinball Action (set 1)\0", nullptr, "Tehkan", "Miscellaneous",
	...
	nullptr, pbactionRomInfo, pbactionRomName, nullptr, nullptr, nullptr, nullptr, PbactionInputInfo, PbactionDIPInfo,
...
struct BurnDriver BurnDrvPbaction2 = {
	"pbaction2", "pbaction", nullptr, nullptr, "1985",
	"Pinball Action (set 2, encrypted)\0", nullptr, "Tehkan", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PINBALL, 0,
	nullptr, pbaction2RomInfo, pbaction2RomName, nullptr, nullptr, nullptr, nullptr, PbactionInputInfo, PbactionDIPInfo,
...
struct BurnDriver BurnDrvPbaction3 = {
	"pbaction3", "pbaction", nullptr, nullptr, "1985",
	"Pinball Action (set 3, encrypted)\0", nullptr, "Tehkan", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PINBALL, 0,
	nullptr, pbaction3RomInfo, pbaction3RomName, nullptr, nullptr, nullptr, nullptr, PbactionInputInfo, PbactionDIPInfo,
...
struct BurnDriver BurnDrvPbaction4 = {
	"pbaction4", "pbaction", nullptr, nullptr, "1985",
	"Pinball Action (set 4, encrypted)\0", nullptr, "Tehkan", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PINBALL, 0,
	nullptr, pbaction4RomInfo, pbaction4RomName, nullptr, nullptr, nullptr, nullptr, PbactionInputInfo, PbactionDIPInfo,
...
struct BurnDriver BurnDrvPbactiont = {
	"pbactiont", "pbaction", nullptr, nullptr, "1985",
	"Pinball Action (Tecfri license)\0", nullptr, "Tehkan (Tecfri license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PINBALL, 0,
	nullptr, pbactiontRomInfo, pbactiontRomName, nullptr, nullptr, nullptr, nullptr, PbactionInputInfo, PbactionDIPInfo,
	PbactionInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
