...
static INT32 MemIndex()
{
	...
	coprocessor.image_ram = Next;
	Next += 0x002000;
	coprocessor.context_ram = Next;
	Next += 0x000400;
...
static void draw_bitmap()
{
	...
	for (INT32 offs = 0; offs < 0x2000; offs++)
	{
		...
		if (flipscreen)
		{
			...
			{
				INT32 pixel = (((p0 << bit) & 0x80) >> 7) | (((p1 << bit) & 0x80) >> 6) | (((p2 << bit) & 0x80) >> 5) |
					(((p3 << bit) & 0x80) >> 4);
...
struct BurnDriver BurnDrvSharkatt = {
	"sharkatt", nullptr, nullptr, "sharkatt", "1980",
	"Shark Attack\0", nullptr, "Pacific Novelty", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, sharkattRomInfo, sharkattRomName, nullptr, nullptr, DrvSampleInfo, DrvSampleName, SharkattInputInfo,
	SharkattDIPInfo,
...
struct BurnDriver BurnDrvThief = {
	"thief", nullptr, nullptr, "thief", "1981",
	"Thief\0", nullptr, "Pacific Novelty", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, thiefRomInfo, thiefRomName, nullptr, nullptr, DrvSampleInfo, DrvSampleName, ThiefInputInfo, ThiefDIPInfo,
...
struct BurnDriver BurnDrvNatodef = {
	"natodef", nullptr, nullptr, "natodef", "1982",
	"NATO Defense\0", nullptr, "Pacific Novelty", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE | GBF_SHOOT, 0,
	nullptr, natodefRomInfo, natodefRomName, nullptr, nullptr, DrvSampleInfo, DrvSampleName, NatodefInputInfo,
	NatodefDIPInfo,
...
struct BurnDriver BurnDrvNatodefa = {
	"natodefa", "natodef", nullptr, "natodef", "1982",
	"NATO Defense (alternate mazes)\0", nullptr, "Pacific Novelty", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE | GBF_SHOOT, 0,
	nullptr, natodefaRomInfo, natodefaRomName, nullptr, nullptr, DrvSampleInfo, DrvSampleName, NatodefInputInfo,
	NatodefDIPInfo,
	NatodefInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	256, 256, 4, 3
};
