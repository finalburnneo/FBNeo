...
static struct BurnDIPInfo SpeedbalDIPList[] =
{
	...
	{0x00, 0x01, 0x03, 0x01, "1 Coin  4 Credits"},
	{0x00, 0x01, 0x03, 0x00, "1 Coin  5 Credits"},
	...
	{0x01, 0x01, 0x07, 0x06, "70000 200000 1M"},
	{0x01, 0x01, 0x07, 0x07, "70000 200000"},
	{0x01, 0x01, 0x07, 0x03, "100000 300000 1M"},
	{0x01, 0x01, 0x07, 0x04, "100000 300000"},
	{0x01, 0x01, 0x07, 0x01, "200000 1M"},
	{0x01, 0x01, 0x07, 0x05, "200000"},
	{0x01, 0x01, 0x07, 0x02, "200000 (duplicate)"},
	{0x01, 0x01, 0x07, 0x00, "None"},
	...
	{0x01, 0x01, 0x30, 0x30, "Very Easy"},
	{0x01, 0x01, 0x30, 0x20, "Easy"},
	{0x01, 0x01, 0x30, 0x10, "Difficult"},
	{0x01, 0x01, 0x30, 0x00, "Very Difficult"},

	{0, 0xfe, 0, 4, "Difficulty 2"},
	{0x01, 0x01, 0xc0, 0xc0, "Very Easy"},
	{0x01, 0x01, 0xc0, 0x80, "Easy"},
	{0x01, 0x01, 0xc0, 0x40, "Difficult"},
	{0x01, 0x01, 0xc0, 0x00, "Very Difficult"},
};
...
static struct BurnDIPInfo MusicbalDIPList[] =
{
	...
	{0, 0xfe, 0, 8, "Bonus Life"},
	{0x01, 0x01, 0x07, 0x03, "1M 2M 2.5M"},
	{0x01, 0x01, 0x07, 0x06, "1.2M 1.8M 2.5M"},
	{0x01, 0x01, 0x07, 0x07, "1.2M 1.8M"},
	{0x01, 0x01, 0x07, 0x04, "1.5M 2M"},
	{0x01, 0x01, 0x07, 0x05, "1.5M"},
	{0x01, 0x01, 0x07, 0x01, "1.8M 2.5M"},
	{0x01, 0x01, 0x07, 0x02, "1.8M"},
	{0x01, 0x01, 0x07, 0x00, "None"},
...
static INT32 DrvInit(INT32 game)
{
	...
	BurnYM3812Init(1, 4000000, nullptr, 0);
	...
	GenericTilemapSetTransSplit(0, 0, 0xffff, 0x0001); // tmap, category, layer0, layer1
	GenericTilemapSetTransSplit(0, 1, 0x0001, 0x0001);

	// background
	GenericTilemapInit(1, TILEMAP_SCAN_COLS, bg_map_callback, 16, 16, 16, 16);
	GenericTilemapSetTransSplit(1, 0, 0xffff, 0x0000); // tmap, category, layer0, layer1
	GenericTilemapSetTransSplit(1, 1, 0x00f7, 0x0000);
...
struct BurnDriver BurnDrvSpeedbal = {
	"speedbal", nullptr, nullptr, nullptr, "1987",
	"Speed Ball (set 1)\0", nullptr, "Tecfri / Desystem S.A.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PINBALL, 0,
	nullptr, speedbalRomInfo, speedbalRomName, nullptr, nullptr, nullptr, nullptr, SpeedbalInputInfo, SpeedbalDIPInfo,
...
struct BurnDriver BurnDrvSpeedbala = {
	"speedbala", "speedbal", nullptr, nullptr, "1987",
	"Speed Ball (set 2)\0", nullptr, "Tecfri / Desystem S.A.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PINBALL, 0,
	nullptr, speedbalaRomInfo, speedbalaRomName, nullptr, nullptr, nullptr, nullptr, SpeedbalInputInfo, SpeedbalDIPInfo,
	SpeedbalInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvMusicbal = {
	"musicbal", nullptr, nullptr, nullptr, "1988",
	"Music Ball\0", nullptr, "Tecfri / Desystem S.A.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PINBALL, 0,
	nullptr, musicbalRomInfo, musicbalRomName, nullptr, nullptr, nullptr, nullptr, SpeedbalInputInfo, MusicbalDIPInfo,
