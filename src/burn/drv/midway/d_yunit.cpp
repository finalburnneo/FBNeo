...
static const protection_data* prot_data = nullptr;
...
static void (*sound_write)(UINT16) = nullptr;
static void (*sound_reset_write)(UINT16) = nullptr;
static UINT16 (*sound_response_read)() = nullptr;
static UINT16 (*sound_irq_state_read)() = nullptr;
static void (*sound_reset)() = nullptr;
static INT32 (*sound_scan)(INT32, INT32*) = nullptr;
static void (*sound_exit)() = nullptr;
static void (*sound_update)(INT16*, INT32) = nullptr;
static INT32 (*sound_in_reset)() = nullptr;
...
{
	DIP_OFFSET(0x1c)
	{0x00, 0xff, 0xff, 0xf8, nullptr},
	{0x01, 0xff, 0xff, 0x7d, nullptr},
...
{
	DIP_OFFSET(0x1f)
	{0x00, 0xff, 0xff, 0xbf, nullptr},
	{0x01, 0xff, 0xff, 0xcf, nullptr},
...
static void cmos_enable_write(UINT32, UINT16 data)
{
	...
	if (prot_data)
	{
		...
		{
			if (prot_sequence[0] == prot_data->reset_sequence[0] && prot_sequence[1] == prot_data->reset_sequence[1] &&
...
static void dma_write(UINT32 offset, UINT16)
{
	...
	dma_state.rowbytes = static_cast<INT16>(dma_register[DMA_ROWBYTES]);
	dma_state.xpos = static_cast<INT16>(dma_register[DMA_XSTART]);
	dma_state.ypos = static_cast<INT16>(dma_register[DMA_YSTART]);
	...
	TMS34010TimerSet((static_cast<double>(master_clock) / 8 / 1000000000 * (41 * dma_state.width * dma_state.height)));
}
...
static void midyunit_main_write(UINT32 address, UINT16 data)
{
	...
	if (address >= 0x1820000 && address <= 0x1a1eff0) return;
	// nop - many games write to this entire range after post... why?
		...
		case 2:
			{
				...
				else
				{
					...
					{
					case 0: rv = (0xff - BurnGunReturnX(0)) | 0xff00;
						break;
					case 1: rv = BurnGunReturnY(0) | 0xff00;
						break;
					case 2: rv = (0xff - BurnGunReturnX(1)) | 0xff00;
						break;
					case 3: rv = BurnGunReturnY(1) | 0xff00;
						break;
					}
				}
				break;
...
static INT32 MemIndex()
{
	...
	pen_map = (INT32*)Next;
	Next += 0x010000 * sizeof(INT32);

	BurnPalette = (UINT32*)Next;
	Next += 0x002000 * sizeof(UINT32);
	...
	DrvMainRAM = Next;
	Next += 0x020000;
	DrvPalMAP = (UINT16*)Next;
	Next += 0x002000 * sizeof(UINT16); // in ram section!
...
static INT32 DrvLoadRoms(INT32 gfxbpp)
{
	...
	for (INT32 i = 0; i < nGfxOffset; i++)
	{
		...
		if ((ri.nType & BRF_SND) && (ri.nType & 7) == 2)
		{
			// MSM6295 Samples
			if (BurnLoadRom(pDest[(ri.nType - 1) & 7], i, 1)) return 1;
		...
		if ((ri.nType & BRF_PRG) && (ri.nType & 0xf) == 3)
		{
			// TMS34010 Code
		...
		if ((ri.nType & BRF_PRG) && (ri.nType & 0xf) == (3 | 8))
		{
			// TMS34010 Code, staggered
...
static INT32 CommonInit(void (*load_callback)(), INT32 sound_system, UINT32 clock, INT32 gfx_depth, INT32 sndprot_start,
                        INT32 sndprot_end)
{
...

	{
		...
		switch (gfx_depth)
		{
		case 4: reorder_6bpp_graphics();
			midyunit_4bit();
			break;
		case 6: reorder_6bpp_graphics();
			midyunit_6bit();
			break;
		case 8: reorder_8bpp_graphics();
			midzunit_8bit();
			break;
		}
	}
	...
	TMS34010SetCpuCyclesPerFrame(static_cast<INT32>((master_clock / 8) * 100) / nBurnFPS);
...
static INT32 DrvExit()
{
	...
	sound_scan = nullptr;
	sound_exit = nullptr;
	sound_update = nullptr;
	sound_in_reset = nullptr;
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[3] = {
		static_cast<INT32>((master_clock / 8) * 100) / nBurnFPS, (2000060 * 100) / nBurnFPS, (2000060 * 100) / nBurnFPS
	};
...
static INT32 YawdimFrame()
{
	...
	INT32 nCyclesTotal[2] = {static_cast<INT32>(((master_clock / 8) * 100) / nBurnFPS), (4000000 * 100) / nBurnFPS};
...
static INT32 NarcInit()
{
	...
	return CommonInit(nullptr, 2, 48000000, 8, 0xcdff, 0xce29);
}

struct BurnDriver BurnDrvNarc = {
	"narc", nullptr, nullptr, nullptr, "1988",
	"Narc (rev 7.00)\0", nullptr, "Williams", "Z Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, narcRomInfo, narcRomName, nullptr, nullptr, nullptr, nullptr, NarcInputInfo, NarcDIPInfo,
...
struct BurnDriver BurnDrvNarc6 = {
	"narc6", "narc", nullptr, nullptr, "1988",
	"Narc (rev 6.00)\0", nullptr, "Williams", "Z Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, narc6RomInfo, narc6RomName, nullptr, nullptr, nullptr, nullptr, NarcInputInfo, NarcDIPInfo,
	NarcInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 8192,
	512, 400, 4, 3
};
...
struct BurnDriver BurnDrvNarc4 = {
	"narc4", "narc", nullptr, nullptr, "1988",
	"Narc (rev 4.00)\0", nullptr, "Williams", "Z Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, narc4RomInfo, narc4RomName, nullptr, nullptr, nullptr, nullptr, NarcInputInfo, NarcDIPInfo,
	NarcInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 8192,
	512, 400, 4, 3
};
...
struct BurnDriver BurnDrvNarc3 = {
	"narc3", "narc", nullptr, nullptr, "1988",
	"Narc (rev 3.20)\0", nullptr, "Williams", "Z Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, narc3RomInfo, narc3RomName, nullptr, nullptr, nullptr, nullptr, NarcInputInfo, NarcDIPInfo,
	NarcInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 8192,
	512, 400, 4, 3
};
...
struct BurnDriver BurnDrvNarc2 = {
	"narc2", "narc", nullptr, nullptr, "1988",
	"Narc (rev 2.00)\0", nullptr, "Williams", "Z Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, narc2RomInfo, narc2RomName, nullptr, nullptr, nullptr, nullptr, NarcInputInfo, NarcDIPInfo,
	NarcInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 8192,
	512, 400, 4, 3
};
...
struct BurnDriver BurnDrvNarc1 = {
	"narc1", "narc", nullptr, nullptr, "1988",
	"Narc (rev 1.80)\0", nullptr, "Williams", "Z Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, narc1RomInfo, narc1RomName, nullptr, nullptr, nullptr, nullptr, NarcInputInfo, NarcDIPInfo,
	NarcInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 8192,
	512, 400, 4, 3
};
...
static INT32 MkInit()
{
	static const struct protection_data mk_protection_data =
	{
		...
		{
			0x4600, 0xf600, 0xa600, 0x0600, 0x2600, 0x9600, 0xc600, 0xe600, 0x8600, 0x7600, 0x8600, 0x8600, 0x9600,
			0xd600, 0x6600, 0xb600, 0xd600, 0xe600, 0xf600, 0x7600, 0xb600, 0xa600, 0x3600
		}
	};

	prot_data = &mk_protection_data;

	return CommonInit(nullptr, 0, 48000000, 6, 0xfb9c, 0xfbc6);
}

struct BurnDriver BurnDrvMkla4 = {
	"mkla4", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (rev 4.0 09/28/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkla4RomInfo, mkla4RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
...
struct BurnDriver BurnDrvMkla3 = {
	"mkla3", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (rev 3.0 08/31/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkla3RomInfo, mkla3RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	MkInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvMkla2 = {
	"mkla2", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (rev 2.0 08/18/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkla2RomInfo, mkla2RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	MkInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvMkla1 = {
	"mkla1", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (rev 1.0 08/09/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkla1RomInfo, mkla1RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	MkInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
static INT32 Mkprot9Init()
{
	...
	return CommonInit(nullptr, 0, 50000000, 6, 0xfb9c, 0xfbc6);
}

struct BurnDriver BurnDrvMkprot9 = {
	"mkprot9", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (prototype, rev 9.0 07/28/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkprot9RomInfo, mkprot9RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
...
struct BurnDriver BurnDrvMkprot8 = {
	"mkprot8", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (prototype, rev 8.0 07/21/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkprot8RomInfo, mkprot8RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	Mkprot9Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvMkprot4 = {
	"mkprot4", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (prototype, rev 4.0 07/14/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkprot4RomInfo, mkprot4RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	Mkprot9Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvMkyturbo = {
	"mkyturbo", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (Turbo 3.1 09/09/93, hack)\0", nullptr, "hack", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkyturboRomInfo, mkyturboRomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
...
struct BurnDriver BurnDrvMkyturboe = {
	"mkyturboe", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (Turbo 3.0 08/31/92, hack)\0", nullptr, "hack", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkyturboeRomInfo, mkyturboeRomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	MkyturboInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriverD BurnDrvMkrep = {
	"mkrep", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (Reptile Man hack)\0", nullptr, "hack", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkrepRomInfo, mkrepRomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	MkyturboInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvMknifty = {
	"mknifty", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (Nifty Kombo, hack)\0", nullptr, "hack", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkniftyRomInfo, mkniftyRomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	MkyturboInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvMknifty666 = {
	"mknifty666", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (Nifty Kombo 666, hack)\0", nullptr, "hack", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mknifty666RomInfo, mknifty666RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	MkyturboInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvMkyawdim = {
	"mkyawdim", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (Yawdim bootleg, set 1)\0", nullptr, "bootleg (Yawdim)", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkyawdimRomInfo, mkyawdimRomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
...
struct BurnDriver BurnDrvMkyawdim2 = {
	"mkyawdim2", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (Yawdim bootleg, set 2)\0", nullptr, "bootleg (Yawdim)", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkyawdim2RomInfo, mkyawdim2RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
...
struct BurnDriver BurnDrvMkyawdim3 = {
	"mkyawdim3", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (Yawdim bootleg, set 3)\0", nullptr, "bootleg (Yawdim)", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkyawdim3RomInfo, mkyawdim3RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
...
struct BurnDriver BurnDrvMkyawdim4 = {
	"mkyawdim4", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (Yawdim bootleg, set 4)\0", nullptr, "bootleg (Yawdim)", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkyawdim4RomInfo, mkyawdim4RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	Mkyawdim3Init, DrvExit, YawdimFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvMkyawdim5 = {
	"mkyawdim5", "mk", nullptr, nullptr, "1992",
	"Mortal Kombat (Yawdim bootleg, set 5)\0", nullptr, "bootleg (Yawdim)", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_PREFIX_MIDWAY, GBF_VSFIGHT, 0,
	nullptr, mkyawdim5RomInfo, mkyawdim5RomName, nullptr, nullptr, nullptr, nullptr, Mkla4InputInfo, Mkla4DIPInfo,
	Mkyawdim3Init, DrvExit, YawdimFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
static INT32 TrogInit()
{
	static const struct protection_data trog_protection_data =
	{
		...
		{
			0x3000, 0x1000, 0x2000, 0x0000, 0x2000, 0x3000, 0x3000, 0x1000, 0x0000, 0x0000, 0x2000, 0x3000, 0x1000,
			0x1000, 0x2000
		}
	};
...
struct BurnDriver BurnDrvTrog = {
	"trog", nullptr, nullptr, nullptr, "1990",
	"Trog (rev LA5 3/29/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 4, HARDWARE_PREFIX_MIDWAY, GBF_MAZE, 0,
	nullptr, trogRomInfo, trogRomName, nullptr, nullptr, nullptr, nullptr, TrogInputInfo, TrogDIPInfo,
...
struct BurnDriver BurnDrvTrog4 = {
	"trog4", "trog", nullptr, nullptr, "1990",
	"Trog (rev LA4 3/11/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_MAZE, 0,
	nullptr, trog4RomInfo, trog4RomName, nullptr, nullptr, nullptr, nullptr, TrogInputInfo, TrogDIPInfo,
	TrogInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvTrog3 = {
	"trog3", "trog", nullptr, nullptr, "1990",
	"Trog (rev LA3 2/14/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_MAZE, 0,
	nullptr, trog3RomInfo, trog3RomName, nullptr, nullptr, nullptr, nullptr, TrogInputInfo, TrogDIPInfo,
	TrogInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvTrog3a = {
	"trog3a", "trog", nullptr, nullptr, "1990",
	"Trog (rev LA3 2/10/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_MAZE, 0,
	nullptr, trog3aRomInfo, trog3aRomName, nullptr, nullptr, nullptr, nullptr, TrogInputInfo, TrogDIPInfo,
	TrogInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvTrogpa6 = {
	"trogpa6", "trog", nullptr, nullptr, "1990",
	"Trog (prototype, rev PA6-PAC 9/09/90)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 4, HARDWARE_PREFIX_MIDWAY, GBF_MAZE, 0,
	nullptr, trogpa6RomInfo, trogpa6RomName, nullptr, nullptr, nullptr, nullptr, TrogInputInfo, TrogDIPInfo,
	TrogInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvTrogpa5 = {
	"trogpa5", "trog", nullptr, nullptr, "1990",
	"Trog (prototype, rev PA5-PAC 8/28/90)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 4, HARDWARE_PREFIX_MIDWAY, GBF_MAZE, 0,
	nullptr, trogpa5RomInfo, trogpa5RomName, nullptr, nullptr, nullptr, nullptr, TrogInputInfo, TrogDIPInfo,
	TrogInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvTrogpa4 = {
	"trogpa4", "trog", nullptr, nullptr, "1990",
	"Trog (prototype, rev 4.00 7/27/90)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 4, HARDWARE_PREFIX_MIDWAY, GBF_MAZE, 0,
	nullptr, trogpa4RomInfo, trogpa4RomName, nullptr, nullptr, nullptr, nullptr, TrogInputInfo, TrogDIPInfo,
	TrogInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
{
	auto pTemp = BurnMalloc(0x040000);
...
struct BurnDriver BurnDrvMazebl = {
	"mazebl", "trog", nullptr, nullptr, "1990",
	"Maze (Trog rev LA4 3/11/91 bootleg)\0", nullptr, "bootleg", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG, 4, HARDWARE_PREFIX_MIDWAY, GBF_MAZE, 0,
	nullptr, mazeblRomInfo, mazeblRomName, nullptr, nullptr, nullptr, nullptr, TrogInputInfo, TrogDIPInfo,
...
static INT32 SmashtvInit()
{
	...
	return CommonInit(nullptr, 1 | 0x80, 40000000, 6, 0x9cf6, 0x9d21);
}

struct BurnDriver BurnDrvSmashtv = {
	"smashtv", nullptr, nullptr, nullptr, "1990",
	"Smash T.V. (rev 8.00)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 4, HARDWARE_PREFIX_MIDWAY, GBF_RUNGUN, 0,
	nullptr, smashtvRomInfo, smashtvRomName, nullptr, nullptr, nullptr, nullptr, SmashtvInputInfo, SmashtvDIPInfo,
...
struct BurnDriver BurnDrvSmashtv6 = {
	"smashtv6", "smashtv", nullptr, nullptr, "1990",
	"Smash T.V. (rev 6.00)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_RUNGUN, 0,
	nullptr, smashtv6RomInfo, smashtv6RomName, nullptr, nullptr, nullptr, nullptr, SmashtvInputInfo, SmashtvDIPInfo,
	SmashtvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvSmashtv5 = {
	"smashtv5", "smashtv", nullptr, nullptr, "1990",
	"Smash T.V. (rev 5.00)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_RUNGUN, 0,
	nullptr, smashtv5RomInfo, smashtv5RomName, nullptr, nullptr, nullptr, nullptr, SmashtvInputInfo, SmashtvDIPInfo,
	SmashtvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvSmashtv4 = {
	"smashtv4", "smashtv", nullptr, nullptr, "1990",
	"Smash T.V. (rev 4.00)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_RUNGUN, 0,
	nullptr, smashtv4RomInfo, smashtv4RomName, nullptr, nullptr, nullptr, nullptr, SmashtvInputInfo, SmashtvDIPInfo,
	SmashtvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvSmashtv3 = {
	"smashtv3", "smashtv", nullptr, nullptr, "1990",
	"Smash T.V. (rev 3.01)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_RUNGUN, 0,
	nullptr, smashtv3RomInfo, smashtv3RomName, nullptr, nullptr, nullptr, nullptr, SmashtvInputInfo, SmashtvDIPInfo,
	SmashtvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
static INT32 HiimpactInit()
{
	static const struct protection_data hiimpact_protection_data = {
		...
		{
			0x2000, 0x4000, 0x4000, 0x0000, 0x6000, 0x6000, 0x2000, 0x4000, 0x2000, 0x4000, 0x2000, 0x0000, 0x4000,
			0x6000, 0x2000
		}
	};
	...
	return CommonInit(nullptr, 1, 40000000, 6, 0x9b79, 0x9ba3);
}

struct BurnDriver BurnDrvHiimpact = {
	"hiimpact", nullptr, nullptr, nullptr, "1990",
	"High Impact Football (rev LA5 02/15/91)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 4, HARDWARE_PREFIX_MIDWAY, GBF_SPORTSFOOTBALL, 0,
	nullptr, hiimpactRomInfo, hiimpactRomName, nullptr, nullptr, nullptr, nullptr, HiimpactInputInfo, HiimpactDIPInfo,
...
struct BurnDriver BurnDrvHiimpact4 = {
	"hiimpact4", "hiimpact", nullptr, nullptr, "1990",
	"High Impact Football (rev LA4 02/04/91)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_SPORTSFOOTBALL, 0,
	nullptr, hiimpact4RomInfo, hiimpact4RomName, nullptr, nullptr, nullptr, nullptr, HiimpactInputInfo, HiimpactDIPInfo,
	HiimpactInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvHiimpact3 = {
	"hiimpact3", "hiimpact", nullptr, nullptr, "1990",
	"High Impact Football (rev LA3 12/27/90)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_SPORTSFOOTBALL, 0,
	nullptr, hiimpact3RomInfo, hiimpact3RomName, nullptr, nullptr, nullptr, nullptr, HiimpactInputInfo, HiimpactDIPInfo,
	HiimpactInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvHiimpact2 = {
	"hiimpact2", "hiimpact", nullptr, nullptr, "1990",
	"High Impact Football (rev LA2 12/26/90)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_SPORTSFOOTBALL, 0,
	nullptr, hiimpact2RomInfo, hiimpact2RomName, nullptr, nullptr, nullptr, nullptr, HiimpactInputInfo, HiimpactDIPInfo,
	HiimpactInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvHiimpact1 = {
	"hiimpact1", "hiimpact", nullptr, nullptr, "1990",
	"High Impact Football (rev LA1 12/16/90)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_PREFIX_MIDWAY, GBF_SPORTSFOOTBALL, 0,
	nullptr, hiimpact1RomInfo, hiimpact1RomName, nullptr, nullptr, nullptr, nullptr, HiimpactInputInfo, HiimpactDIPInfo,
	HiimpactInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvHiimpactp = {
	"hiimpactp", "hiimpact", nullptr, nullptr, "1990",
	"High Impact Football (prototype, revision0 proto 8.6 12/09/90)\0", nullptr, "Williams", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 4, HARDWARE_PREFIX_MIDWAY, GBF_SPORTSFOOTBALL, 0,
	nullptr, hiimpactpRomInfo, hiimpactpRomName, nullptr, nullptr, nullptr, nullptr, HiimpactInputInfo, HiimpactDIPInfo,
	HiimpactInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
static INT32 ShimpactInit()
{
	static const struct protection_data shimpact_protection_data = {
		...
		{
			0x0000, 0x4000, 0x2000, 0x5000, 0x2000, 0x1000, 0x4000, 0x6000, 0x3000, 0x0000, 0x2000, 0x5000, 0x5000,
			0x5000, 0x2000
		}
	};
	...
	return CommonInit(nullptr, 1, 40000000, 6, 0x9c06, 0x9c15);
}

struct BurnDriver BurnDrvShimpact = {
	"shimpact", nullptr, nullptr, nullptr, "1991",
	"Super High Impact (rev LA1 09/30/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 4, HARDWARE_PREFIX_MIDWAY, GBF_SPORTSFOOTBALL, 0,
	nullptr, shimpactRomInfo, shimpactRomName, nullptr, nullptr, nullptr, nullptr, HiimpactInputInfo, ShimpactDIPInfo,
...
struct BurnDriver BurnDrvShimpactp6 = {
	"shimpactp6", "shimpact", nullptr, nullptr, "1991",
	"Super High Impact (prototype, proto 6.0 09/23/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 4, HARDWARE_PREFIX_MIDWAY, GBF_SPORTSFOOTBALL, 0,
	nullptr, shimpactp6RomInfo, shimpactp6RomName, nullptr, nullptr, nullptr, nullptr, HiimpactInputInfo,
	ShimpactDIPInfo,
	ShimpactInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvShimpactp5 = {
	"shimpactp5", "shimpact", nullptr, nullptr, "1991",
	"Super High Impact (prototype, proto 5.0 09/15/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 4, HARDWARE_PREFIX_MIDWAY, GBF_SPORTSFOOTBALL, 0,
	nullptr, shimpactp5RomInfo, shimpactp5RomName, nullptr, nullptr, nullptr, nullptr, HiimpactInputInfo,
	ShimpactDIPInfo,
	ShimpactInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
struct BurnDriver BurnDrvShimpactp4 = {
	"shimpactp4", "shimpact", nullptr, nullptr, "1991",
	"Super High Impact (prototype, proto 4.0 09/10/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 4, HARDWARE_PREFIX_MIDWAY, GBF_SPORTSFOOTBALL, 0,
	nullptr, shimpactp4RomInfo, shimpactp4RomName, nullptr, nullptr, nullptr, nullptr, HiimpactInputInfo,
	ShimpactDIPInfo,
	ShimpactInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	396, 256, 4, 3
};
...
{
	static constexpr struct protection_data strkforc_protection_data = {
		{0x1234}, {0}
	};

	prot_data = &strkforc_protection_data;

	return CommonInit(nullptr, 1 | 0x80, 48000000, 4, 0x9f7d, 0x9fa7);
}

struct BurnDriver BurnDrvStrkforc = {
	"strkforc", nullptr, nullptr, nullptr, "1991",
	"Strike Force (rev 1 02/25/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_PREFIX_MIDWAY, GBF_HORSHOOT, 0,
	nullptr, strkforcRomInfo, strkforcRomName, nullptr, nullptr, nullptr, nullptr, StrkforcInputInfo, StrkforcDIPInfo,
...
struct BurnDriver BurnDrvTotcarn = {
	"totcarn", nullptr, nullptr, nullptr, "1992",
	"Total Carnage (rev LA1 03/10/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 4, HARDWARE_PREFIX_MIDWAY, GBF_RUNGUN, 0,
	nullptr, totcarnRomInfo, totcarnRomName, nullptr, nullptr, nullptr, nullptr, TotcarnInputInfo, TotcarnDIPInfo,
...
struct BurnDriver BurnDrvTotcarnp2 = {
	"totcarnp2", "totcarn", nullptr, nullptr, "1992",
	"Total Carnage (prototype, proto v 2.0 02/10/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 4, HARDWARE_PREFIX_MIDWAY, GBF_RUNGUN, 0,
	nullptr, totcarnp2RomInfo, totcarnp2RomName, nullptr, nullptr, nullptr, nullptr, TotcarnInputInfo, TotcarnDIPInfo,
	TotcarnInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvTotcarnp1 = {
	"totcarnp1", "totcarn", nullptr, nullptr, "1992",
	"Total Carnage (prototype, proto v 1.0 01/25/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 4, HARDWARE_PREFIX_MIDWAY, GBF_RUNGUN, 0,
	nullptr, totcarnp1RomInfo, totcarnp1RomName, nullptr, nullptr, nullptr, nullptr, TotcarnInputInfo, TotcarnDIPInfo,
	TotcarnInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvTerm2 = {
	"term2", nullptr, nullptr, nullptr, "1991",
	"Terminator 2 - Judgment Day (rev LA4 08/03/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_PREFIX_MIDWAY, GBF_SHOOT, 0,
	nullptr, term2RomInfo, term2RomName, nullptr, nullptr, nullptr, nullptr, Term2InputInfo, Term2DIPInfo,
...
struct BurnDriver BurnDrvTerm2la3 = {
	"term2la3", "term2", nullptr, nullptr, "1991",
	"Terminator 2 - Judgment Day (rev LA3 03/27/92)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_MIDWAY, GBF_SHOOT, 0,
	nullptr, term2la3RomInfo, term2la3RomName, nullptr, nullptr, nullptr, nullptr, Term2InputInfo, Term2DIPInfo,
	Term2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvTerm2la2 = {
	"term2la2", "term2", nullptr, nullptr, "1991",
	"Terminator 2 - Judgment Day (rev LA2 12/09/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_MIDWAY, GBF_SHOOT, 0,
	nullptr, term2la2RomInfo, term2la2RomName, nullptr, nullptr, nullptr, nullptr, Term2InputInfo, Term2DIPInfo,
	Term2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvTerm2la1 = {
	"term2la1", "term2", nullptr, nullptr, "1991",
	"Terminator 2 - Judgment Day (rev LA1 11/01/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_MIDWAY, GBF_SHOOT, 0,
	nullptr, term2la1RomInfo, term2la1RomName, nullptr, nullptr, nullptr, nullptr, Term2InputInfo, Term2DIPInfo,
	Term2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvTerm2pa2 = {
	"term2pa2", "term2", nullptr, nullptr, "1991",
	"Terminator 2 - Judgment Day (prototype, rev PA2 10/18/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 2, HARDWARE_PREFIX_MIDWAY, GBF_SHOOT, 0,
	nullptr, term2pa2RomInfo, term2pa2RomName, nullptr, nullptr, nullptr, nullptr, Term2InputInfo, Term2DIPInfo,
	Term2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
...
struct BurnDriver BurnDrvTerm2lg1 = {
	"term2lg1", "term2", nullptr, nullptr, "1991",
	"Terminator 2 - Judgment Day (German, rev LG1 11/04/91)\0", nullptr, "Midway", "Y Unit",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_MIDWAY, GBF_SHOOT, 0,
	nullptr, term2lg1RomInfo, term2lg1RomName, nullptr, nullptr, nullptr, nullptr, Term2InputInfo, Term2DIPInfo,
	Term2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 256,
	400, 256, 4, 3
};
