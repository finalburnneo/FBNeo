...
static void charram_write(INT32 offset, UINT8 data)
// to do - simplify this so that it's written in as a bitmap not 8x8 tiles
{
	if (char_pen == 7)
	{
		for (INT32 i = 0; i < 8; i++)
	...
	else
	{
		for (INT32 i = 0; i < 8; i++)
		{
			if (DrvFgBuffer[offset + i] == char_pen)
				...
				DrvFgBuffer[offset + i] = data & (1 << (7 - i))
					                          ? (DrvFgBuffer[offset + i] | char_pen)
					                          : DrvFgBuffer[offset + i];
		}
	}
}
...
struct BurnDriver BurnDrvProgolf = {
	"progolf", nullptr, nullptr, nullptr, "1981",
	"18 Holes Pro Golf (set 1)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC,
	0,
	nullptr, progolfRomInfo, progolfRomName, nullptr, nullptr, nullptr, nullptr, ProgolfInputInfo, ProgolfDIPInfo,
...
struct BurnDriverD BurnDrvProgolfa = {
	"progolfa", "progolf", nullptr, nullptr, "1981",
	"18 Holes Pro Golf (set 2)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_PREFIX_DATAEAST, GBF_SPORTSMISC, 0,
	nullptr, progolfaRomInfo, progolfaRomName, nullptr, nullptr, nullptr, nullptr, ProgolfInputInfo, ProgolfDIPInfo,
