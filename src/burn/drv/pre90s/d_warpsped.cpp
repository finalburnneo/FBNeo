...
static void draw_circles()
{
	for (INT32 i = 0; i < 4; i++)
	{
		...
		radius = static_cast<UINT16>(sqrt(static_cast<float>(0xffff - radius)));
...
struct BurnDriverD BurnDrvWarpsped = {
	"warpsped", nullptr, nullptr, nullptr, "1979",
	"Warp Speed (prototype)\0", "No sound, bad colors", "Meadows Games, Inc.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, warpspedRomInfo, warpspedRomName, nullptr, nullptr, nullptr, nullptr, WarpspeedInputInfo, WarpspeedDIPInfo,
