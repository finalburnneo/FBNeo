...
enum { CART_NONE = 0, CART_LOROM, CART_HIROM, CART_EXLOROM, CART_EXHIROM, CART_CX4, CART_LOROMDSP, CART_HIROMDSP, CART_LOROMSETA, CART_LOROMSA1, CART_LOROMOBC1, CART_LOROMSDD1, CART_SUPERFX, CART_SPC7110, CART_MSU1, CART_ST018, CART_SFEX, CART_SUPERFX3, CART_MAXENTRY };
...
struct Cart {
  ...
  UINT8  msuBase;				// MSU-1: underlying base mapping (CART_LOROM / CART_HIROM); 0 = not MSU-1
  UINT8  sfexTag;
  UINT8  gsuType;
};
