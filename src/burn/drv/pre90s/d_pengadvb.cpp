...
static UINT8* AllMem = nullptr;
static UINT8* MemEnd = nullptr;
static UINT8* AllRam = nullptr;
static UINT8* RamEnd = nullptr;
static UINT8* maincpu = nullptr;
static UINT8* game = nullptr;
static UINT8* main_mem = nullptr;
...
static void __fastcall msx_write(UINT16 address, UINT8 data)
{
	...
	else
	{
		switch (address)
		{
		case 0x4000: mem_banks[0] = data;
			mem_map_banks();
			break;
		case 0x6000: mem_banks[1] = data;
			mem_map_banks();
			break;
		case 0x8000: mem_banks[2] = data;
			mem_map_banks();
			break;
		case 0xa000: mem_banks[3] = data;
			mem_map_banks();
			break;
		}
	}
...
static void pengadvb_decrypt(UINT8* mem, INT32 memsize)
{
	...
	// address line swap
	buf = BurnMalloc(memsize);
	memcpy(buf, mem, memsize);
	for (i = 0; i < memsize; i++)
	{
		mem[i] = buf[BITSWAP24(i, 23, 22, 21, 20, 19, 18, 17, 16, 15, 14, 13, 5, 11, 10, 9, 8, 7, 6, 12, 4, 3, 2, 1,
		                       0)];
	}
	BurnFree(buf);
}
...
static INT32 DrvInit()
{
	...
	AY8910SetPorts(0, ay8910portAread, nullptr, nullptr, ay8910portBwrite);
	...
	ppi8255_init(1);
	ppi8255_set_read_ports(0, nullptr, sg1000_ppi8255_portB_read, nullptr);
	ppi8255_set_write_ports(0, sg1000_ppi8255_portA_write, nullptr, nullptr);
...
struct BurnDriver BurnDrvPengadvb = {
	"pengadvb", nullptr, nullptr, nullptr, "1988",
	"Penguin Adventure (bootleg of MSX version, encrypted)\0", nullptr, "bootleg (Screen)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_BOOTLEG, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, pengadvbRomInfo, pengadvbRomName, nullptr, nullptr, nullptr, nullptr, PengadvbInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, nullptr, TMS9928A_PALETTE_SIZE,
	272, 216, 4, 3
};
