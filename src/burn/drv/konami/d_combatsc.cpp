...
static struct BurnDIPInfo CombatscDIPList[] =
{
	...
	{0x12, 0xff, 0xff, 0x60, nullptr},
	{0x13, 0xff, 0xff, 0x50, nullptr},
...
static INT32 DrvDraw()
{
	...
	if (priority_select == 0)
	{
		...
		if (nSpriteEnable & 2) k007121_draw(1, pTransDraw, DrvGfxROM1, color_table, DrvSprRAM[1], (0x40 + color1), 0,
		                                    16, 0, 0x0f00, 0x0000);
		if (nSpriteEnable & 1) k007121_draw(0, pTransDraw, DrvGfxROM0, color_table, DrvSprRAM[0], (0x00 + color0), 0,
		                                    16, 0, 0x4444, 0x0000);
	}
	else
	{
...
struct BurnDriver BurnDrvCombatsc = {
	"combatsc", nullptr, nullptr, nullptr, "1988",
	"Combat School (joystick)\0", nullptr, "Konami", "GX611",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_VERSHOOT, 0,
	nullptr, combatscRomInfo, combatscRomName, nullptr, nullptr, nullptr, nullptr, CombatscInputInfo, CombatscDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, nullptr, 0x800,
	256, 224, 4, 3
};
