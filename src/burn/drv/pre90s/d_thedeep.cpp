...
static void DrvPaletteInit()
{
	...
	{
		DrvPalette[i] = BurnHighCol(pal4bit(DrvColPROM[0x200 + i]), pal4bit(DrvColPROM[0x200 + i] >> 4),
		                            pal4bit(DrvColPROM[i]), 0);
	}
...
static void draw_sprites()
{
	...
	for (INT32 offs = 0; offs < 0x400 / 2;)
	{
		...
		for (INT32 x = 0; x < w; x++)
		{
			...
			for (INT32 y = 0; y < h; y++)
			{
				DrawGfxMaskTile(0, 0, (code - y * incy) & 0x7ff, sx + (mult * x), sy + (mult * y), flipx, flipy, color,
				                0);
			}
...
struct BurnDriver BurnDrvThedeep = {
	"thedeep", nullptr, nullptr, nullptr, "1987",
	"The Deep (Japan)\0", nullptr, "Woodplace Inc.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, thedeepRomInfo, thedeepRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvRundeep = {
	"rundeep", "thedeep", nullptr, nullptr, "1988",
	"Run Deep\0", nullptr, "Cream Co., Ltd.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, rundeepRomInfo, rundeepRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x201,
	248, 256, 3, 4
};
