...
static INT32 MemIndex()
{
	...
	DrvNVRAM = Next;
	Next += 0x000400; // really 200

	AllRam = Next;

	DrvVectorRAM = Next;
	Next += 0x004000; // 2x size
	Drv68KRAM = Next;
	Next += 0x005000;
	DrvColRAM = Next;
	Next += 0x000010;
...
static INT32 DrvFrame()
{
...

	{
		...
		BurnTrackballFrame(0, DrvAnalogPort0, DrvAnalogPort1, (DrvInputs[1]) ? 4 : 1, 7);
		// Velocity: 4 digital, 1 analog
...
struct BurnDriver BurnDrvQuantum = {
	"quantum", nullptr, nullptr, nullptr, "1982",
	"Quantum (rev 2)\0", nullptr, "General Computer Corporation (Atari license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION | GBF_VECTOR, 0,
	nullptr, quantumRomInfo, quantumRomName, nullptr, nullptr, nullptr, nullptr, QuantumInputInfo, QuantumDIPInfo,
...
struct BurnDriver BurnDrvQuantum1 = {
	"quantum1", "quantum", nullptr, nullptr, "1982",
	"Quantum (rev 1)\0", nullptr, "General Computer Corporation (Atari license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION | GBF_VECTOR, 0,
	nullptr, quantum1RomInfo, quantum1RomName, nullptr, nullptr, nullptr, nullptr, QuantumInputInfo, QuantumDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	480, 640, 3, 4
};
...
struct BurnDriver BurnDrvQuantump = {
	"quantump", "quantum", nullptr, nullptr, "1982",
	"Quantum (prototype)\0", nullptr, "General Computer Corporation (Atari license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION | GBF_VECTOR, 0,
	nullptr, quantumpRomInfo, quantumpRomName, nullptr, nullptr, nullptr, nullptr, QuantumInputInfo, QuantumDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	480, 640, 3, 4
};
