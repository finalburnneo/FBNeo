...
{
	{0x0a, 0xff, 0xff, 0xfb, nullptr},
	{0x0b, 0xff, 0xff, 0x40, nullptr},
...
{
	{0x0c, 0xff, 0xff, 0xac, nullptr},
	{0x0d, 0xff, 0xff, 0xcf, nullptr},
...
static INT32 PkunwarInit()
{
	...
	AY8910SetPorts(0, &pkunwar_port_0, &pkunwar_port_1, nullptr, nullptr);
	AY8910SetPorts(1, &pkunwar_port_2, &pkunwar_port_3, nullptr, nullptr);
...
static INT32 NovaInit()
{
	...
	AY8910SetPorts(0, nullptr, nullptr, &nova2001_scroll_x_w, &nova2001_scroll_y_w);
	AY8910SetPorts(1, &nova2001_port_3, &nova2001_port_4, nullptr, nullptr);
...
static INT32 NinjakunInit()
{
	...
	AY8910SetPorts(1, nullptr, nullptr, &nova2001_scroll_x_w, &nova2001_scroll_y_w);
	AY8910SetPorts(0, &nova2001_port_3, &nova2001_port_4, nullptr, nullptr);
	AY8910SetAllRoutes(0, 0.20, BURN_SND_ROUTE_BOTH);
	AY8910SetAllRoutes(1, 0.20, BURN_SND_ROUTE_BOTH);
	AY8910SetBuffered(ZetTotalCycles, 3000000);
...
static INT32 Raiders5Init()
{
	...
	AY8910Init(0, 1500000, 0);
	AY8910Init(1, 1500000, 1);
	AY8910SetPorts(0, &raiders5_port_0, &pkunwar_port_1, nullptr, nullptr);
	AY8910SetPorts(1, &nova2001_port_3, &nova2001_port_4, nullptr, nullptr);
	AY8910SetAllRoutes(0, 0.25, BURN_SND_ROUTE_BOTH);
	AY8910SetAllRoutes(1, 0.25, BURN_SND_ROUTE_BOTH);
	AY8910SetBuffered(ZetTotalCycles, 3000000);
...
static void draw_layer(UINT8* ram_base, UINT8* gfx_base, INT32 config, INT32 color_base, INT32 priority)
{
	...
	for (INT32 offs = 0; offs < 32 * 32; offs++)
	{
		...
		if (flipscreen)
		{
			Render8x8Tile_Mask_FlipXY_Clip(pTransDraw, code, 248 - sx, 184 - sy, color, 4, transparent, color_base,
			                               gfx_base);
		}
		else
		{
...
struct BurnDriver BurnDrvpkunwar = {
	"pkunwar", nullptr, nullptr, nullptr, "1985",
	"Penguin-Kun Wars (US)\0", nullptr, "UPL", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, pkunwarRomInfo, pkunwarRomName, nullptr, nullptr, nullptr, nullptr, PkunwarInputInfo, PkunwarDIPInfo,
...
struct BurnDriver BurnDrvpkunwarj = {
	"pkunwarj", "pkunwar", nullptr, nullptr, "1985",
	"Penguin-Kun Wars (Japan, set 1)\0", nullptr, "UPL", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, pkunwarjRomInfo, pkunwarjRomName, nullptr, nullptr, nullptr, nullptr, PkunwarInputInfo, PkunwarDIPInfo,
	PkunwarInit, DrvExit, PkunwarFrame, PkunwarDraw, DrvScan, &DrvRecalc, 0x200,
	256, 192, 4, 3
};
...
struct BurnDriver BurnDrvpkunwarja = {
	"pkunwarja", "pkunwar", nullptr, nullptr, "1985",
	"Penguin-Kun Wars (Japan, set 2)\0", nullptr, "UPL", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, pkunwarjaRomInfo, pkunwarjaRomName, nullptr, nullptr, nullptr, nullptr, PkunwarInputInfo, PkunwarDIPInfo,
	PkunwarInit, DrvExit, PkunwarFrame, PkunwarDraw, DrvScan, &DrvRecalc, 0x200,
	256, 192, 4, 3
};
...
struct BurnDriver BurnDrvNova2001 = {
	"nova2001", nullptr, nullptr, nullptr, "1983",
	"Nova 2001 (Japan)\0", nullptr, "UPL", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, nova2001RomInfo, nova2001RomName, nullptr, nullptr, nullptr, nullptr, Nova2001InputInfo, Nova2001DIPInfo,
...
struct BurnDriver BurnDrvNova2001h = {
	"nova2001h", "nova2001", nullptr, nullptr, "1983",
	"Nova 2001 (Japan, hack?)\0", nullptr, "UPL", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, nova2001hRomInfo, nova2001hRomName, nullptr, nullptr, nullptr, nullptr, Nova2001InputInfo, Nova2001DIPInfo,
	NovaInit, DrvExit, NovaFrame, NovaDraw, DrvScan, &DrvRecalc, 0x200,
	256, 192, 4, 3
};
...
struct BurnDriver BurnDrvNova2001u = {
	"nova2001u", "nova2001", nullptr, nullptr, "1983",
	"Nova 2001 (US)\0", nullptr, "UPL (Universal license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, nova2001uRomInfo, nova2001uRomName, nullptr, nullptr, nullptr, nullptr, Nova2001InputInfo, Nova2001DIPInfo,
	NovaInit, DrvExit, NovaFrame, NovaDraw, DrvScan, &DrvRecalc, 0x200,
	256, 192, 4, 3
};
...
struct BurnDriver BurnDrvNinjakun = {
	"ninjakun", nullptr, nullptr, nullptr, "1984",
	"Ninjakun Majou no Bouken\0", nullptr, "UPL (Taito license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, ninjakunRomInfo, ninjakunRomName, nullptr, nullptr, nullptr, nullptr, NinjakunInputInfo, NinjakunDIPInfo,
...
struct BurnDriver BurnDrvRaiders5 = {
	"raiders5", nullptr, nullptr, nullptr, "1985",
	"Raiders5\0", nullptr, "UPL", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, raiders5RomInfo, raiders5RomName, nullptr, nullptr, nullptr, nullptr, Raiders5InputInfo, Raiders5DIPInfo,
	Raiders5Init, DrvExit, Raiders5Frame, Raiders5Draw, nullptr, &DrvRecalc, 0x300,
	256, 192, 4, 3
};
...
struct BurnDriver BurnDrvRaidrs5t = {
	"raiders5t", "raiders5", nullptr, nullptr, "1985",
	"Raiders5 (Japan, set 1)\0", nullptr, "UPL (Taito license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_FLIPPED | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE,
	0,
	nullptr, raiders5tRomInfo, raiders5tRomName, nullptr, nullptr, nullptr, nullptr, Raiders5InputInfo, Raiders5DIPInfo,
	Raiders5Init, DrvExit, Raiders5Frame, Raiders5Draw, nullptr, &DrvRecalc, 0x300,
	256, 192, 4, 3
};
...
struct BurnDriver BurnDrvRaidrs5ta = {
	"raiders5ta", "raiders5", nullptr, nullptr, "1985",
	"Raiders5 (Japan, set 2, bootleg?)\0", nullptr, "UPL (Taito license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_FLIPPED | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE,
	0,
	nullptr, raiders5taRomInfo, raiders5taRomName, nullptr, nullptr, nullptr, nullptr, Raiders5InputInfo,
	Raiders5taDIPInfo,
	Raiders5Init, DrvExit, Raiders5Frame, Raiders5Draw, nullptr, &DrvRecalc, 0x300,
	256, 192, 4, 3
};
