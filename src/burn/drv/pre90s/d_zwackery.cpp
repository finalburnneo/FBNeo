...
{
	INT32 cyc = (static_cast<INT64>(SekTotalCycles(0)) * 8000000 / 7652400) - SekTotalCycles(1);
	if (cyc > 0)
	{
		SekRun(1, cyc);
	}
...
static constexpr pia6821_interface pia_0 = {
	nullptr, pia0_read_b, // in_a, in_b
	nullptr, nullptr, nullptr, nullptr, // in_ca1, in_cb1, in_ca2, in_cb2
	pia0_out_a, nullptr, nullptr, nullptr, // out_a, out_b, out_ca2, out_cb2
	pia0_irq, pia0_irq // irq_a, irq_b
};

static constexpr pia6821_interface pia_1 = {
	pia1_read_a, pia1_read_b, // in_a, in_b
	nullptr, nullptr, nullptr, nullptr, // in_ca1, in_cb1, in_ca2, in_cb2
	pia1_out_a, nullptr, pia1_out_ca2, nullptr, // out_a, out_b, out_ca2, out_cb2
	nullptr, nullptr // irq_a, irq_b
};

static constexpr pia6821_interface pia_2 = {
	pia2_read_a, pia2_read_b, // in_a, in_b
	nullptr, nullptr, nullptr, nullptr, // in_ca1, in_cb1, in_ca2, in_cb2
	nullptr, nullptr, nullptr, nullptr, // out_a, out_b, out_ca2, out_cb2
	nullptr, nullptr // irq_a, irq_b
};
...
static INT32 MemIndex()
{
	...
	Next += 0x040000;
	DrvGfxROM2 = Next;
	Next += 0x040000; // sprites
	DrvGfxROM3 = Next;
	Next += 0x008000; // color maps
...
static INT32 DrvGfxDecode()
{
	...
	INT32 YOffs0[16] = {
		4, 0x4000 * 8 + 4, 0, 0x4000 * 8 + 0, 36, 0x4000 * 8 + 36, 32, 0x4000 * 8 + 32, 68, 0x4000 * 8 + 68, 64,
		0x4000 * 8 + 64, 100, 0x4000 * 8 + 100, 96, 0x4000 * 8 + 96
	};
...
static void draw_sprites(INT32 priority)
{
	...
	for (INT32 offs = 0x1000 / 2 - 4; offs >= 0; offs -= 4)
	{
		...
		if (priority == 1 && color != 7) continue;
		...
		RenderPrioTransmaskSprite(pTransDraw, DrvGfxROM2, code, (color * 16) | 0x800, 0x0101, sx, sy, flipx, flipy, 32,
		                          32, 0);
		RenderPrioTransmaskSprite(pTransDraw, DrvGfxROM2, code, (color * 16) | 0x800, 0xfeff, sx, sy, flipx, flipy, 32,
		                          32, 0);
	}
}
...
struct BurnDriver BurnDrvZwackery = {
	"zwackery", nullptr, nullptr, nullptr, "1984",
	"Zwackery\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, zwackeryRomInfo, zwackeryRomName, nullptr, nullptr, nullptr, nullptr, ZwackeryInputInfo, ZwackeryDIPInfo,
