...
static void sound_stream_update(INT16* output, INT32 samples)
{
	...
	{
		output[sampindex * 2 + 0] = output[sampindex * 2 + 1] =
			((forced_ontime > 0) || ((sample_counter & target) == target)) ? BURN_SND_CLIP(envelope) : 0;
...
static INT32 MemIndex()
{
	...
	Next += BurnDrvGetPaletteEntries() * sizeof(UINT32);
...
static void DrvPaletteInit()
{
	...
	{
		BurnPalette[i] = BurnHighCol(color_table[color_map[i]][0], color_table[color_map[i]][1],
		                             color_table[color_map[i]][2], 0);
	}
}
...
static void draw_screen()
{
	...
	{
		INT32 palette_offset = (((DrvVideoRAM[((y / SM) * 128) + 125] & 2) >> 1) | (DrvVideoRAM[((y / SM) * 128) + 126]
			& 2)) << 2;

		for (INT32 x = 4 * SM; x < 106 * SM; x++)
		{
			pTransDraw[(y - (4 * SM)) * nScreenWidth + (x - (4 * SM))] = palette_offset | DrvVideoRAM[(x / SM) + ((y /
				SM) * 128)];
		}
	}
}
...
struct BurnDriver BurnDrvCHF_Channelf = {
	"chf_channelf", nullptr, nullptr, nullptr, "1976",
	"Fairchild Channel F (Bios)\0", "BIOS only", "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_BOARDROM, 2, HARDWARE_CHANNELF, GBF_BIOS, 0,
	ChannelfGetZipName, CHF_channelfRomInfo, CHF_channelfRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
...
struct BurnDriver BurnDrvCHF_democrt1 = {
	"chf_democrt1", nullptr, "chf_channelf", nullptr, "1977",
	"Democart 1\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_DEMO, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_democrt1RomInfo, CHF_democrt1RomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_democrt2 = {
	"chf_democrt2", nullptr, "chf_channelf", nullptr, "197?",
	"Democart 2\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_DEMO, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_democrt2RomInfo, CHF_democrt2RomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_tctactoe = {
	"chf_tctactoe", nullptr, "chf_channelf", nullptr, "1976",
	"Tic-Tac-Toe / Shooting Gallery / Doodle / Quadra-Doodle\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_tctactoeRomInfo, CHF_tctactoeRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_muehle = {
	"chf_muehle", "chf_tctactoe", "chf_channelf", nullptr, "1978",
	"Muehle / Tontauben-Schiessen / Kreatives Malspiel / Videoscope (Ger)\0", nullptr, "SABA", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_muehleRomInfo, CHF_muehleRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_dsrtfox = {
	"chf_dsrtfox", nullptr, "chf_channelf", nullptr, "1976",
	"Desert Fox / Shooting Gallery\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_SHOOT, 0,
	ChannelfGetZipName, CHF_dsrtfoxRomInfo, CHF_dsrtfoxRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_vblckjck = {
	"chf_vblckjck", nullptr, "chf_channelf", nullptr, "1976",
	"Video Blackjack\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_CASINO, 0,
	ChannelfGetZipName, CHF_vblckjckRomInfo, CHF_vblckjckRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_spitfire = {
	"chf_spitfire", nullptr, "chf_channelf", nullptr, "1976",
	"Spitfire\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_SHOOT, 0,
	ChannelfGetZipName, CHF_spitfireRomInfo, CHF_spitfireRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_spitfirep = {
	"chf_spitfirep", "chf_spitfire", "chf_channelf", nullptr, "1976",
	"Spitfire (Prototype)\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 2, HARDWARE_CHANNELF, GBF_SHOOT, 0,
	ChannelfGetZipName, CHF_spitfirepRomInfo, CHF_spitfirepRomName, nullptr, nullptr, nullptr, nullptr,
	ChannelfInputInfo, ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_spacewar = {
	"chf_spacewar", nullptr, "chf_channelf", nullptr, "1977",
	"Space War\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_SHOOT, 0,
	ChannelfGetZipName, CHF_spacewarRomInfo, CHF_spacewarRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_mthquiz1 = {
	"chf_mthquiz1", nullptr, "chf_channelf", nullptr, "1976",
	"Math Quiz 1\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_QUIZ, 0,
	ChannelfGetZipName, CHF_mthquiz1RomInfo, CHF_mthquiz1RomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_mthquiz2 = {
	"chf_mthquiz2", nullptr, "chf_channelf", nullptr, "1977",
	"Math Quiz 2\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_QUIZ, 0,
	ChannelfGetZipName, CHF_mthquiz2RomInfo, CHF_mthquiz2RomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_magicnum = {
	"chf_magicnum", nullptr, "chf_channelf", nullptr, "1977",
	"Magic Numbers / Mind Reader / Nim\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_PUZZLE, 0,
	ChannelfGetZipName, CHF_magicnumRomInfo, CHF_magicnumRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_dragrace = {
	"chf_dragrace", nullptr, "chf_channelf", nullptr, "1977",
	"Drag Race\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_dragraceRomInfo, CHF_dragraceRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_maze = {
	"chf_maze", nullptr, "chf_channelf", nullptr, "1977",
	"Maze / Jailbreak / Blind-man's-bluff / Trailblazer\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_MAZE, 0,
	ChannelfGetZipName, CHF_mazeRomInfo, CHF_mazeRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_mazea = {
	"chf_mazea", "chf_maze", "chf_channelf", nullptr, "1977",
	"Maze / Jailbreak / Blind-man's-bluff / Trailblazer (Alt)\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_CHANNELF, GBF_MAZE, 0,
	ChannelfGetZipName, CHF_mazeaRomInfo, CHF_mazeaRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_backgamm = {
	"chf_backgamm", nullptr, "chf_channelf", nullptr, "1977",
	"Backgammon / Acey-Deucey\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_PUZZLE, 0,
	ChannelfGetZipName, CHF_backgammRomInfo, CHF_backgammRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_baseball = {
	"chf_baseball", nullptr, "chf_channelf", nullptr, "1977",
	"Baseball\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_SPORTSMISC, 0,
	ChannelfGetZipName, CHF_baseballRomInfo, CHF_baseballRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_robotwar = {
	"chf_robotwar", nullptr, "chf_channelf", nullptr, "1977",
	"Robot War / Torpedo Alley\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_robotwarRomInfo, CHF_robotwarRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_robotwarp = {
	"chf_robotwarp", "chf_robotwar", "chf_channelf", nullptr, "1977",
	"Robot War (Prototype)\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_robotwarpRomInfo, CHF_robotwarpRomName, nullptr, nullptr, nullptr, nullptr,
	ChannelfInputInfo, ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_sonrsrch = {
	"chf_sonrsrch", nullptr, "chf_channelf", nullptr, "1977",
	"Sonar Search\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_sonrsrchRomInfo, CHF_sonrsrchRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_memory = {
	"chf_memory", nullptr, "chf_channelf", nullptr, "1978",
	"Memory Match 1 & 2\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_PUZZLE, 0,
	ChannelfGetZipName, CHF_memoryRomInfo, CHF_memoryRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_dodgeit = {
	"chf_dodgeit", nullptr, "chf_channelf", nullptr, "1978",
	"Dodge It\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_dodgeitRomInfo, CHF_dodgeitRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_pinball = {
	"chf_pinball", nullptr, "chf_channelf", nullptr, "1978",
	"Pinball Challenge\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_BREAKOUT, 0,
	ChannelfGetZipName, CHF_pinballRomInfo, CHF_pinballRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_pinballa = {
	"chf_pinballa", "chf_pinball", "chf_channelf", nullptr, "1978",
	"Pinball Challenge (Alt)\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_CHANNELF, GBF_BREAKOUT, 0,
	ChannelfGetZipName, CHF_pinballaRomInfo, CHF_pinballaRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_hangman = {
	"chf_hangman", nullptr, "chf_channelf", nullptr, "1978",
	"Hangman\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 1, HARDWARE_CHANNELF, GBF_PUZZLE, 0,
	ChannelfGetZipName, CHF_hangmanRomInfo, CHF_hangmanRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_ordtvlng = {
	"chf_ordtvlng", "chf_hangman", "chf_channelf", nullptr, "1978",
	"Ordtavling (Swe)\0", nullptr, "Luxor", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 1, HARDWARE_CHANNELF, GBF_PUZZLE, 0,
	ChannelfGetZipName, CHF_ordtvlngRomInfo, CHF_ordtvlngRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_ratmal = {
	"chf_ratmal", "chf_hangman", "chf_channelf", nullptr, "197?",
	"Rat' Mal (Ger)\0", nullptr, "SABA", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 1, HARDWARE_CHANNELF, GBF_PUZZLE, 0,
	ChannelfGetZipName, CHF_ratmalRomInfo, CHF_ratmalRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_checkers = {
	"chf_checkers", nullptr, "chf_channelf", nullptr, "1978",
	"Checkers\0", nullptr, "Zircon", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_STRATEGY, 0,
	ChannelfGetZipName, CHF_checkersRomInfo, CHF_checkersRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_whizball = {
	"chf_whizball", nullptr, "chf_channelf", nullptr, "1978",
	"Video Whizball\0", nullptr, "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_whizballRomInfo, CHF_whizballRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_schach = {
	"chf_schach", nullptr, "chf_channelf", nullptr, "197?",
	"Schach (Ger)\0", nullptr, "SABA", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_STRATEGY, 0,
	ChannelfGetZipName, CHF_schachRomInfo, CHF_schachRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_bowling = {
	"chf_bowling", nullptr, "chf_channelf", nullptr, "1978",
	"Bowling\0", nullptr, "Fairchil", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_bowlingRomInfo, CHF_bowlingRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_slotmchn = {
	"chf_slotmchn", nullptr, "chf_channelf", nullptr, "1980",
	"Slot Machine\0", nullptr, "Zircon", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 1, HARDWARE_CHANNELF, GBF_CASINO, 0,
	ChannelfGetZipName, CHF_slotmchnRomInfo, CHF_slotmchnRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_galactic = {
	"chf_galactic", nullptr, "chf_channelf", nullptr, "1980",
	"Galactic Space Wars / Lunar Lander\0", nullptr, "Zircon", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 1, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_galacticRomInfo, CHF_galacticRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_galacticp = {
	"chf_galacticp", "chf_galactic", "chf_channelf", nullptr, "1980",
	"Galactic Space Wars (Prototype)\0", nullptr, "Zircon", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 1, HARDWARE_CHANNELF, GBF_ACTION, 0,
	ChannelfGetZipName, CHF_galacticpRomInfo, CHF_galacticpRomName, nullptr, nullptr, nullptr, nullptr,
	ChannelfInputInfo, ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_pfootbll = {
	"chf_pfootbll", nullptr, "chf_channelf", nullptr, "1981",
	"Pro Football\0", nullptr, "Zircon", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_SPORTSMISC, 0,
	ChannelfGetZipName, CHF_pfootbllRomInfo, CHF_pfootbllRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_football = {
	"chf_football", "chf_pfootbll", "chf_channelf", nullptr, "1981",
	"Football (Prototype)\0", nullptr, "Zircon", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 2, HARDWARE_CHANNELF, GBF_SPORTSMISC, 0,
	ChannelfGetZipName, CHF_footballRomInfo, CHF_footballRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_casinop = {
	"chf_casinop", nullptr, "chf_channelf", nullptr, "1980",
	"Casino Poker\0", nullptr, "Zircon", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 1, HARDWARE_CHANNELF, GBF_CASINO, 0,
	ChannelfGetZipName, CHF_casinopRomInfo, CHF_casinopRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_drawpkr = {
	"chf_drawpkr", "chf_casinop", "chf_channelf", nullptr, "1980",
	"Draw Poker (Prototype)\0", nullptr, "Zircon", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 1, HARDWARE_CHANNELF, GBF_CASINO, 0,
	ChannelfGetZipName, CHF_drawpkrRomInfo, CHF_drawpkrRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_alieninv = {
	"chf_alieninv", nullptr, "chf_channelf", nullptr, "1981",
	"Alien Invasion\0", nullptr, "Zircon", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_SHOOT, 0,
	ChannelfGetZipName, CHF_alieninvRomInfo, CHF_alieninvRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_werbetxt = {
	"chf_werbetxt", nullptr, "chf_channelf", nullptr, "198?",
	"Werbetextcassette\0", nullptr, "Electronic-Partner", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 1, HARDWARE_CHANNELF, GBF_MISC, 0,
	ChannelfGetZipName, CHF_werbetxtRomInfo, CHF_werbetxtRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_clrorgan = {
	"chf_clrorgan", nullptr, "chf_channelf", nullptr, "19??",
	"Color Organ (Prototype)\0", nullptr, "Zircon", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_DEMO | BDF_PROTOTYPE, 1, HARDWARE_CHANNELF, GBF_MISC, 0,
	ChannelfGetZipName, CHF_clrorganRomInfo, CHF_clrorganRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_multicrt = {
	"chf_multicrt", nullptr, "chf_channelf", nullptr, "2004",
	"Channel F Multi-Cart (Final)\0", nullptr, "homebrew", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_CHANNELF, GBF_MISC, 0,
	ChannelfGetZipName, CHF_multicrtRomInfo, CHF_multicrtRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
...
struct BurnDriver BurnDrvCHF_multicrto = {
	"chf_multicrto", "chf_multicrt", "chf_channelf", nullptr, "2004",
	"Channel F Multi-Cart (Older)\0", nullptr, "homebrew", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HOMEBREW, 2, HARDWARE_CHANNELF, GBF_MISC, 0,
	ChannelfGetZipName, CHF_multicrtoRomInfo, CHF_multicrtoRomName, nullptr, nullptr, nullptr, nullptr,
	ChannelfInputInfo, ChannelfDIPInfo,
...
struct BurnDriver BurnDrvCHF_builtin = {
	"chf_builtin", nullptr, "chf_channelf", nullptr, "1976",
	"Hockey + Tennis\0", "Channel F built-in games", "Fairchild", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_CHANNELF, GBF_BALLPADDLE, 0,
	ChannelfGetZipName, CHF_builtinRomInfo, CHF_builtinRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_lightsout = {
	"chf_lightsout", nullptr, "chf_channelf", nullptr, "2004",
	"Lights Out (HB)\0", nullptr, "Sean Riddle", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_CHANNELF, GBF_PUZZLE, 0,
	ChannelfGetZipName, CHF_lightsoutRomInfo, CHF_lightsoutRomName, nullptr, nullptr, nullptr, nullptr,
	ChannelfInputInfo, ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_pacman = {
	"chf_pacman", nullptr, "chf_channelf", nullptr, "2004",
	"Pac-Man (HB)\0", nullptr, "Blackbird - e5frog", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_CHANNELF, GBF_MAZE, 0,
	ChannelfGetZipName, CHF_pacmanRomInfo, CHF_pacmanRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_pacmanv2 = {
	"chf_pacmanv2", "chf_pacman", "chf_channelf", nullptr, "2004",
	"Pac-Man (HB, v2)\0", nullptr, "Blackbird - e5frog", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HOMEBREW, 2, HARDWARE_CHANNELF, GBF_MAZE, 0,
	ChannelfGetZipName, CHF_pacmanv2RomInfo, CHF_pacmanv2RomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_tetris = {
	"chf_tetris", nullptr, "chf_channelf", nullptr, "2004",
	"Tetris (HB)\0", nullptr, "Peter Trauner", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_CHANNELF, GBF_PUZZLE, 0,
	ChannelfGetZipName, CHF_tetrisRomInfo, CHF_tetrisRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
...
struct BurnDriver BurnDrvCHF_wrdlf = {
	"chf_wrdlf", nullptr, "chf_channelf", nullptr, "2022",
	"Wrdl-F (HB)\0", nullptr, "Arlasoft", "Channel F",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_CHANNELF, GBF_PUZZLE, 0,
	ChannelfGetZipName, CHF_wrdlfRomInfo, CHF_wrdlfRomName, nullptr, nullptr, nullptr, nullptr, ChannelfInputInfo,
	ChannelfDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 16,
	102 * SM, 58 * SM, 4, 3
};
