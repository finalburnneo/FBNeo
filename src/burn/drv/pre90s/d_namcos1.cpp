...
static UINT8 (*input_read_callback)(INT32 offset) = nullptr;

static UINT8 (*key_read_callback)(INT32 offset) = nullptr;
static void (*key_write_callback)(INT32 offset, UINT8 data) = nullptr;
...
{
	{0x14, 0xff, 0xff, 0xa0 + 0x17, nullptr}, // 0x17 for the strange watchdog settings.
...
static UINT8 key_type3_read(INT32 offset)
{
	...
	if (op == namcos1_key_swap4) return (namcos1_key[namcos1_key_swap4_arg] << 4) | (namcos1_key[namcos1_key_swap4_arg]
		>> 4);
...
static void namcos1_key_init(INT32 type, UINT16 key, INT32 reg, INT32 rng, INT32 swap4_arg, INT32 swap4, INT32 bottom4,
                             INT32 top4)
{
	switch (type)
	{
...
{
	static constexpr int ALL_CPU_MASK = 7;
...
static void mcu_bankswitch(INT32 data)
{
	...
	case 0xf8: bank = 0;
		data ^= 2;
		break; // bit 2 : ROM 0, A16 is inverted
	case 0xf4: bank = 4;
		break; // bit 3 : ROM 1
	case 0xec: bank = 8;
		break; // bit 4 : ROM 2
	...
	case 0x7c: bank = 20;
		break; // bit 7 : ROM 5
	default: bank = 0;
		break; // illegal (selects multiple ROMs at once)
	}
...
static INT32 DrvDoReset(INT32 clear_mem)
{
	...
	if (clear_mem)
	{
		M6809MapMemory(nullptr, 0x0000, 0x3fff, MAP_ROM);
		m6809_reset_hard();
	}
	NamcoSoundReset();
	BurnYM2151Reset();
	...
	if (clear_mem)
	{
		HD63701MapMemory(nullptr, 0x4000, 0xbfff, MAP_ROM);
		HD63701Reset();
	}
	HD63701Close();
...
static INT32 MemIndex()
{
	...
	DrvPalRAMB = Next;
	Next += 0x002000;
	DrvPalRegs = (UINT16*)Next;
	Next += 0x00008 * sizeof(UINT16);
...
static INT32 Namcos1GetRoms()
{
	...
	for (INT32 i = 0; !BurnDrvGetRomName(&pRomName, i, 0); i++)
	{
		...
		INT32 whichrompos = 0;
		for (INT32 j = 0; j < static_cast<INT32>(strlen(pRomName)); j++)
		{
			if (pRomName[j] == '.') break;
			if ((pRomName[j] & 0xf8) == 0x30)
			{
				// '0', '1', '2', '3'
...
static INT32 DrvInit()
{
	...
	BurnYM2151InitBuffered(3579580, 1, nullptr, 0);
...
static INT32 DrvExit()
{
	...
	input_read_callback = nullptr;
	key_read_callback = nullptr;
	key_write_callback = nullptr;
...
static void draw_sprites()
{
	...
	while (source >= finish)
	{
		static constexpr INT32 sprite_size[4] = {16, 8, 32, 4};
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[4] = {
		static_cast<INT32>(static_cast<double>(1536000) / 60.6060),
		static_cast<INT32>(static_cast<double>(1536000) / 60.6060),
		static_cast<INT32>(static_cast<double>(1536000) / 60.6060),
		static_cast<INT32>(static_cast<double>(1536000) / 60.00/*6060*/)
	}; // run dac cpu @ 60hz for better dac sound quality
	if (sixtyhz)
	{
...
struct BurnDriver BurnDrvShadowld = {
	"shadowld", nullptr, nullptr, nullptr, "1987",
	"Shadowland (YD3)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, shadowldRomInfo, shadowldRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, ShadowldDIPInfo,
...
struct BurnDriver BurnDrvYoukaidk2 = {
	"youkaidk2", "shadowld", nullptr, nullptr, "1987",
	"Youkai Douchuuki (Japan, new version (YD2, Rev B))\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, youkaidk2RomInfo, youkaidk2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, ShadowldDIPInfo,
	ShadowldInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvYoukaidk1 = {
	"youkaidk1", "shadowld", nullptr, nullptr, "1987",
	"Youkai Douchuuki (Japan, old version (YD1))\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, youkaidk1RomInfo, youkaidk1RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, ShadowldDIPInfo,
	ShadowldInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvDspirit = {
	"dspirit", nullptr, nullptr, nullptr, "1987",
	"Dragon Spirit (new version (DS3))\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, dspiritRomInfo, dspiritRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DspiritDIPInfo,
...
struct BurnDriver BurnDrvDspirit2 = {
	"dspirit2", "dspirit", nullptr, nullptr, "1987",
	"Dragon Spirit (DS2)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, dspirit2RomInfo, dspirit2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DspiritDIPInfo,
	DspiritInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvDspirit1 = {
	"dspirit1", "dspirit", nullptr, nullptr, "1987",
	"Dragon Spirit (old version (DS1))\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, dspirit1RomInfo, dspirit1RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DspiritDIPInfo,
	DspiritInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvBlazer = {
	"blazer", nullptr, nullptr, nullptr, "1987",
	"Blazer (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, blazerRomInfo, blazerRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvQuester = {
	"quester", nullptr, nullptr, nullptr, "1987",
	"Quester (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_BREAKOUT, 0,
	nullptr, questerRomInfo, questerRomName, nullptr, nullptr, nullptr, nullptr, QuesterInputInfo, QuesterDIPInfo,
...
struct BurnDriver BurnDrvQuesters = {
	"questers", "quester", nullptr, nullptr, "1987",
	"Quester Special Edition (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_BREAKOUT, 0,
	nullptr, questersRomInfo, questersRomName, nullptr, nullptr, nullptr, nullptr, QuesterInputInfo, QuesterDIPInfo,
	QuesterInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvPacmania = {
	"pacmania", nullptr, nullptr, nullptr, "1987",
	"Pac-Mania\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, pacmaniaRomInfo, pacmaniaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, PacmaniaDIPInfo,
...
struct BurnDriver BurnDrvPacmaniao = {
	"pacmaniao", "pacmania", nullptr, nullptr, "1987",
	"Pac-Mania (111187 sound program)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, pacmaniaoRomInfo, pacmaniaoRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, PacmaniaDIPInfo,
	PacmaniaInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvPacmaniaj = {
	"pacmaniaj", "pacmania", nullptr, nullptr, "1987",
	"Pac-Mania (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, pacmaniajRomInfo, pacmaniajRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, PacmaniaDIPInfo,
	PacmaniaInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGalaga88 = {
	"galaga88", nullptr, nullptr, nullptr, "1987",
	"Galaga '88\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, galaga88RomInfo, galaga88RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, Galaga88DIPInfo,
...
struct BurnDriver BurnDrvGalaga88j = {
	"galaga88j", "galaga88", nullptr, nullptr, "1987",
	"Galaga '88 (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, galaga88jRomInfo, galaga88jRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, Galaga88DIPInfo,
	Galaga88Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGalaga88a = {
	"galaga88a", "galaga88", nullptr, nullptr, "1987",
	"Galaga '88 (02-03-88)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, galaga88aRomInfo, galaga88aRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, Galaga88DIPInfo,
	Galaga88Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvWs = {
	"ws", nullptr, nullptr, nullptr, "1988",
	"Pro Yakyuu World Stadium (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, wsRomInfo, wsRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvBerabohm = {
	"berabohm", nullptr, nullptr, nullptr, "1988",
	"Chou Zetsurinjin Berabowman (Japan, Rev C)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, berabohmRomInfo, berabohmRomName, nullptr, nullptr, nullptr, nullptr, BerabohmInputInfo, BerabohmDIPInfo,
...
struct BurnDriver BurnDrvBerabohmb = {
	"berabohmb", "berabohm", nullptr, nullptr, "1988",
	"Chou Zetsurinjin Berabowman (Japan, Rev B)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, berabohmbRomInfo, berabohmbRomName, nullptr, nullptr, nullptr, nullptr, BerabohmInputInfo, BerabohmDIPInfo,
	BerabohmInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMmaze = {
	"mmaze", nullptr, nullptr, nullptr, "1988",
	...
	nullptr, mmazeRomInfo, mmazeRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MmazeDIPInfo,
...
struct BurnDriver BurnDrvMmaze2 = {
	"mmaze2", "mmaze", nullptr, nullptr, "1988",
	...
	nullptr, mmaze2RomInfo, mmaze2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MmazeDIPInfo,
	MmazeInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvBakutotu = {
	"bakutotu", nullptr, nullptr, nullptr, "1988",
	"Bakutotsu Kijuutei\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, bakutotuRomInfo, bakutotuRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, BakutotuDIPInfo,
...
struct BurnDriver BurnDrvWldcourt = {
	"wldcourt", nullptr, nullptr, nullptr, "1988",
	"Pro Tennis World Court (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, wldcourtRomInfo, wldcourtRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, WldcourtDIPInfo,
...
struct BurnDriver BurnDrvSplatter = {
	"splatter", nullptr, nullptr, nullptr, "1988",
	"Splatter House (World, new version (SH3))\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, splatterRomInfo, splatterRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, Splatter3DIPInfo,
...
struct BurnDriver BurnDrvSplatter2 = {
	"splatter2", "splatter", nullptr, nullptr, "1988",
	"Splatter House (World, old version (SH2))\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, splatter2RomInfo, splatter2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	SplatterInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvSplatterj = {
	"splatterj", "splatter", nullptr, nullptr, "1988",
	"Splatter House (Japan, SH1)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, splatterjRomInfo, splatterjRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	SplatterInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvFaceoff = {
	"faceoff", nullptr, nullptr, nullptr, "1988",
	"Face Off (Japan 2 Players)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, faceoffRomInfo, faceoffRomName, nullptr, nullptr, nullptr, nullptr, FaceoffInputInfo, FaceoffDIPInfo,
...
struct BurnDriver BurnDrvRompers = {
	"rompers", nullptr, nullptr, nullptr, "1989",
	"Rompers (Japan, new version (Rev B))\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, rompersRomInfo, rompersRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvRomperso = {
	"romperso", "rompers", nullptr, nullptr, "1989",
	"Rompers (Japan, old version)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, rompersoRomInfo, rompersoRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	RompersInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvBlastoff = {
	"blastoff", nullptr, nullptr, nullptr, "1989",
	"Blast Off (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, blastoffRomInfo, blastoffRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvWs89 = {
	"ws89", "ws", nullptr, nullptr, "1989",
	"Pro Yakyuu World Stadium '89 (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, ws89RomInfo, ws89RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, Ws89DIPInfo,
...
struct BurnDriver BurnDrvDangseed = {
	"dangseed", nullptr, nullptr, nullptr, "1989",
	"Dangerous Seed (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, dangseedRomInfo, dangseedRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DangseedDIPInfo,
...
struct BurnDriver BurnDrvWs90 = {
	"ws90", "ws", nullptr, nullptr, "1990",
	"Pro Yakyuu World Stadium '90 (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_SPORTSMISC, 0,
	nullptr, ws90RomInfo, ws90RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, Ws90DIPInfo,
...
struct BurnDriver BurnDrvPistoldm = {
	"pistoldm", nullptr, nullptr, nullptr, "1990",
	"Pistol Daimyo no Bouken (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_HORSHOOT, 0,
	nullptr, pistoldmRomInfo, pistoldmRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvBoxyboy = {
	"boxyboy", nullptr, nullptr, nullptr, "1990",
	"Boxy Boy (World, SB2)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_PUZZLE, 0,
	nullptr, boxyboyRomInfo, boxyboyRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, BoxyboyDIPInfo,
...
struct BurnDriver BurnDrvBoxyboya = {
	"boxyboya", "boxyboy", nullptr, nullptr, "1990",
	"Boxy Boy (SB?)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_PUZZLE, 0,
	nullptr, boxyboyaRomInfo, boxyboyaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, BoxyboyDIPInfo,
	BoxyboyInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvSoukobdx = {
	"soukobdx", "boxyboy", nullptr, nullptr, "1990",
	"Souko Ban Deluxe (Japan, SB1)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_PUZZLE, 0,
	nullptr, soukobdxRomInfo, soukobdxRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, BoxyboyDIPInfo,
	BoxyboyInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvPuzlclub = {
	"puzlclub", nullptr, nullptr, nullptr, "1990",
	"Puzzle Club (Japan prototype)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_PROTOTYPE | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_POST90S, GBF_PUZZLE, 0,
	nullptr, puzlclubRomInfo, puzlclubRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, PuzlclubDIPInfo,
...
struct BurnDriver BurnDrvTankfrce = {
	"tankfrce", nullptr, nullptr, nullptr, "1991",
	"Tank Force (US, 2 Players)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_SHOOT, 0,
	nullptr, tankfrceRomInfo, tankfrceRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvTankfrce4 = {
	"tankfrce4", "tankfrce", nullptr, nullptr, "1991",
	"Tank Force (US, 4 Players)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_MISC_POST90S, GBF_SHOOT, 0,
	nullptr, tankfrce4RomInfo, tankfrce4RomName, nullptr, nullptr, nullptr, nullptr, Tankfrce4InputInfo, FaceoffDIPInfo,
...
struct BurnDriver BurnDrvTankfrcej = {
	"tankfrcej", "tankfrce", nullptr, nullptr, "1991",
	"Tank Force (Japan)\0", nullptr, "Namco", "System 1",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_SHOOT, 0,
	nullptr, tankfrcejRomInfo, tankfrcejRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	TankfrceInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
