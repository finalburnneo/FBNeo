...
static void __fastcall stuntair_main_write(UINT16 address, UINT8 data)
{
	...
	case 0xf001:
		...
		return;
	case 0xf002: return;
	case 0xf003: spritebank = (spritebank & 2) | (data & 1);
		return;
	case 0xf004: return;
	case 0xf005: spritebank = (spritebank & 1) | ((data & 1) << 1);
		return;
	case 0xf006: return;
	case 0xf007: return;
...
struct BurnDriver BurnDrvStuntair = {
	"stuntair", nullptr, nullptr, nullptr, "1983",
	"Stunt Air\0", nullptr, "Nuova Videotron", "Miscellaneous",
	...
	nullptr, stuntairRomInfo, stuntairRomName, nullptr, nullptr, nullptr, nullptr, StuntairInputInfo, StuntairDIPInfo,
