...
static UINT8* Sf2mdtZ80Ram = nullptr;
...
void Sf2mdtSoundCommand(UINT16 d)
{
	...
	INT32 nEnd = Sf2mdtSoundPos + static_cast<INT64>(Sf2mdtMSM5205Interleave) * nCyclesToDo / nCpsZ80Cycles;
...
{
	return static_cast<INT64>((double)ZetTotalCycles() * nSoundRate / 3579540);
}
...
void Sf2mdtSoundFrameStart()
{
	...
	Sf2mdtSoundPos = 0;
	Sf2mdtCyclesPerSegment = static_cast<INT64>(nCpsZ80Cycles) / Sf2mdtMSM5205Interleave;
