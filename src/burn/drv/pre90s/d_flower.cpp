	...
	while (source >= finish)
	{
		...
		for (INT32 xblock = 0; xblock < xsize; xblock++)
		{
			...
			for (INT32 yblock = 0; yblock < ysize; yblock++)
			{
				...
				RenderZoomedTile(pTransDraw, DrvGfxROM1, code + yoffs + xoffs, color * 16, 0xf, sx + sxoffs + 16,
				                 sy + syoffs, flipx, flipy, 16, 16, zoomx, zoomy);
			}
		}
		source -= 8;
	}
...
struct BurnDriver BurnDrvFlower = {
	"flower", nullptr, nullptr, nullptr, "1986",
	"Flower (US)\0", nullptr, "Clarue (Komax license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, flowerRomInfo, flowerRomName, nullptr, nullptr, nullptr, nullptr, FlowerInputInfo, FlowerDIPInfo,
...
struct BurnDriver BurnDrvFlowerj = {
	"flowerj", "flower", nullptr, nullptr, "1986",
	"Flower (Japan)\0", nullptr, "Clarue (Sega / Alpha Denshi Co. license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, flowerjRomInfo, flowerjRomName, nullptr, nullptr, nullptr, nullptr, FlowerInputInfo, FlowerDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	288, 224, 4, 3
};
