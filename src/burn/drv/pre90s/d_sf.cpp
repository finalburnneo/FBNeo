...
static struct BurnDIPInfo SfDIPList[] =
{
	...
	{0x1c, 0xff, 0xff, 0xf8, nullptr},
	{0x1d, 0xff, 0xff, 0x7f, nullptr},
...
static void __fastcall sf_write_word(UINT32 address, UINT16 data)
{
	...
	{
		auto pal = (UINT16*)(Drv68kPalRam + (address & 0x7ff));
...
{
	return static_cast<INT64>((double)ZetTotalCycles()) * nSoundRate / 3579545;
}
...
static INT32 DrvGfxDecode()
{
	...
	static INT32 GfxYOffsets[16] = {
		0x00, 0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70,
		0x80, 0x90, 0xa0, 0xb0, 0xc0, 0xd0, 0xe0, 0xf0
	};

	auto tmp = BurnMalloc(0x1C0000);
	if (tmp == nullptr)
	{
		return 1;
	}
...
static INT32 DrvInit(INT32 initver)
{
	...
	MSM5205Init(0, DrvSynchroniseStream, 384000, nullptr, MSM5205_SEX_4B, 1);
	MSM5205Init(1, DrvSynchroniseStream, 384000, nullptr, MSM5205_SEX_4B, 1);
...
{
	auto fg_ram = (UINT16*)(Drv68kVidRam);
...
{
	static constexpr INT32 delta[4] = {0x00, 0x18, 0x18, 0x00};
	return nb ^ delta[(nb >> 3) & 3];
}

static void draw_sprites()
{
	auto sf_objectram = (UINT16*)(Drv68kRam + 0x6000);
		...
		if (attr & 0x400) // large sprite
		{
			...
			if (flipy)
			{
				if (flipx)
				{
					...
					Render16x16Tile_Mask_FlipXY_Clip(pTransDraw, sf_invert(c4), sx + 16, sy + 16, color, 4, 15, 0x200,
					                                 Gfx2);
				}
				else
				{
					...
					Render16x16Tile_Mask_FlipY_Clip(pTransDraw, sf_invert(c4), sx + 16, sy + 16, color, 4, 15, 0x200,
					                                Gfx2);
				}
			}
			else
			{
				if (flipx)
				{
					...
					Render16x16Tile_Mask_FlipX_Clip(pTransDraw, sf_invert(c4), sx + 16, sy + 16, color, 4, 15, 0x200,
					                                Gfx2);
				}
				else
				{
...
static INT32 DrvFrame()
{
	...
	nCyclesTotal[0] = static_cast<INT32>((INT64)8000000 * nBurnCPUSpeedAdjust / (0x0100 * 60));
	nCyclesTotal[1] = static_cast<INT32>((INT64)3579545 * nBurnCPUSpeedAdjust / (0x0100 * 60));
...
struct BurnDriver BurnDrvsf = {
	"sf", nullptr, nullptr, nullptr, "1987",
	"Street Fighter (US, set 1)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_VSFIGHT, FBF_SF,
	nullptr, sfRomInfo, sfRomName, nullptr, nullptr, nullptr, nullptr, SfusInputInfo, SfusDIPInfo,
...
struct BurnDriver BurnDrvsfan = {
	"sfan", "sf", nullptr, nullptr, "1987",
	"Street Fighter (World, pneumatic buttons)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_VSFIGHT, FBF_SF,
	nullptr, sfanRomInfo, sfanRomName, nullptr, nullptr, nullptr, nullptr, SfInputInfo, SfDIPInfo,
...
struct BurnDriver BurnDrvsfua = {
	"sfua", "sf", nullptr, nullptr, "1987",
	"Street Fighter (US, set 2) (protected)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_VSFIGHT, FBF_SF,
	nullptr, sfuaRomInfo, sfuaRomName, nullptr, nullptr, nullptr, nullptr, SfjInputInfo, SfusDIPInfo,
...
struct BurnDriver BurnDrvsfj = {
	"sfj", "sf", nullptr, nullptr, "1987",
	"Street Fighter (Japan) (protected)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_VSFIGHT, FBF_SF,
	nullptr, sfjRomInfo, sfjRomName, nullptr, nullptr, nullptr, nullptr, SfjInputInfo, SfusDIPInfo,
...
struct BurnDriver BurnDrvsfjan = {
	"sfjan", "sf", nullptr, nullptr, "1987",
	"Street Fighter (Japan, pneumatic buttons)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_VSFIGHT, FBF_SF,
	nullptr, sfjanRomInfo, sfjanRomName, nullptr, nullptr, nullptr, nullptr, SfInputInfo, SfDIPInfo,
...
struct BurnDriver BurnDrvsfp = {
	"sfp", "sf", nullptr, nullptr, "1987",
	"Street Fighter (prototype)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_VSFIGHT, FBF_SF,
	nullptr, sfpRomInfo, sfpRomName, nullptr, nullptr, nullptr, nullptr, SfInputInfo, SfDIPInfo,
...
struct BurnDriver BurnDrvsfw = {
	"sfw", "sf", nullptr, nullptr, "1987",
	"Street Fighter (World) (protected)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_VSFIGHT, FBF_SF,
	nullptr, sfwRomInfo, sfwRomName, nullptr, nullptr, nullptr, nullptr, SfjInputInfo, SfusDIPInfo,
