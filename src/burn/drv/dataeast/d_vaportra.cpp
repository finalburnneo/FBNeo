...
static INT32 DrvInit(INT32 type)
{
	...
	deco16SoundInit(DrvHucROM, DrvHucRAM, 8055000, 1, nullptr, 0.60, 1006875, 0.75, 2013750, 0.60);
...
static void DrvPaletteRecalc()
{
	...
	{
		DrvPalette[i] = BurnHighCol(BURN_ENDIAN_SWAP_INT16(p0[i]) & 0xff, BURN_ENDIAN_SWAP_INT16(p0[i]) >> 8,
		                            BURN_ENDIAN_SWAP_INT16(p1[i]) & 0xff, 0);
	}
}
...
static void draw_sprites(INT32 pri)
{
	...
	for (INT32 offs = 0; offs < 0x400; offs += 4)
	{
		...
		while (multi >= 0)
		{
			Draw16x16MaskTile(pTransDraw, sprite - multi * inc, x, (y + mult * multi) - 8, fx, fy, colour, 4, 0, 0x100,
			                  DrvGfxROM3);
...
struct BurnDriver BurnDrvVaportra = {
	"vaportra", nullptr, nullptr, nullptr, "1989",
	"Vapor Trail - Hyper Offence Formation (World revision 1)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_VERSHOOT, 0,
	nullptr, vaportraRomInfo, vaportraRomName, nullptr, nullptr, nullptr, nullptr, VaportraInputInfo, VaportraDIPInfo,
...
struct BurnDriver BurnDrvVaportraw3 = {
	"vaportra3", "vaportra", nullptr, nullptr, "1989",
	"Vapor Trail - Hyper Offence Formation (World revision 3?)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST,
	GBF_VERSHOOT, 0,
	nullptr, vaportraw3RomInfo, vaportraw3RomName, nullptr, nullptr, nullptr, nullptr, VaportraInputInfo,
	VaportraDIPInfo,
...
struct BurnDriver BurnDrvVaportrau = {
	"vaportrau", "vaportra", nullptr, nullptr, "1989",
	"Vapor Trail - Hyper Offence Formation (US)\0", nullptr, "Data East USA", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST,
	GBF_VERSHOOT, 0,
	nullptr, vaportrauRomInfo, vaportrauRomName, nullptr, nullptr, nullptr, nullptr, VaportraInputInfo, VaportraDIPInfo,
	VaportraInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x500,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvKuhga = {
	"kuhga", "vaportra", nullptr, nullptr, "1989",
	"Kuhga - Operation Code 'Vapor Trail' (Japan revision 3)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST,
	GBF_VERSHOOT, 0,
	nullptr, kuhgaRomInfo, kuhgaRomName, nullptr, nullptr, nullptr, nullptr, VaportraInputInfo, VaportraDIPInfo,
	VaportraInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x500,
	240, 256, 3, 4
};
