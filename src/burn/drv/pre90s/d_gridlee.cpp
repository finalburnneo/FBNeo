...
static struct BurnDIPInfo GridleeDIPList[] =
{
	...
	{0x01, 0xff, 0xff, 0x05, nullptr},
	{0x02, 0xff, 0xff, 0x20, nullptr},
...
static void gridlee_write(UINT16 address, UINT8 data)
{
	...
	if (address >= 0x9828 && address <= 0x993f)
	{
		...
		case 0x10:
			stream.update();
			tone_step = (data) ? ((static_cast<double>(1 << 24) / nBurnSoundRate) * (data * 5)) : 0;
			break;
		case 0x11:
			stream.update();
			tone_vol = data;
...
static INT32 DrvInit()
{
	...
	stream.init(nBurnSoundRate, nBurnSoundRate, 1, true, sound_tone_render);
...
struct BurnDriver BurnDrvGridlee = {
	"gridlee", nullptr, nullptr, "gridlee", "1983",
	"Gridlee\0", nullptr, "Videa", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, gridleeRomInfo, gridleeRomName, nullptr, nullptr, GridleeSampleInfo, GridleeSampleName, GridleeInputInfo,
	GridleeDIPInfo,
