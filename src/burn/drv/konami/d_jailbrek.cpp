...
static struct BurnDIPInfo JailbrekDIPList[] =
{
	...
	{0x15, 0xff, 0xff, 0x59, nullptr},
	{0x16, 0xff, 0xff, 0x0f, nullptr},
...
static void draw_sprites()
{
	for (INT32 i = 0; i < 0xc0; i += 4)
	{
		...
		if (flipy)
		{
			if (flipx)
			{
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 3, color, 0, sx + 0, sy + 0, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 2, color, 0, sx + 8, sy + 0, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 1, color, 0, sx + 0, sy + 8, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 0, color, 0, sx + 8, sy + 8, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
			}
			else
			{
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 2, color, 0, sx + 0, sy + 0, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 3, color, 0, sx + 8, sy + 0, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 0, color, 0, sx + 0, sy + 8, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 1, color, 0, sx + 8, sy + 8, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
			}
		}
		else
		{
			if (flipx)
			{
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 1, color, 0, sx + 0, sy + 0, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 0, color, 0, sx + 8, sy + 0, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 3, color, 0, sx + 0, sy + 8, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 2, color, 0, sx + 8, sy + 8, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
			}
			else
			{
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 0, color, 0, sx + 0, sy + 0, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 1, color, 0, sx + 8, sy + 0, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 2, color, 0, sx + 0, sy + 8, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
				RenderTileTranstab(pTransDraw, DrvGfxROM1, code * 4 + 3, color, 0, sx + 8, sy + 8, flipx, flipy, 8, 8,
				                   DrvColPROM + 0x40);
			}
		}
	}
...
struct BurnDriver BurnDrvJailbrek = {
	"jailbrek", nullptr, nullptr, nullptr, "1986",
	"Jail Break\0", nullptr, "Konami", "GX507",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, jailbrekRomInfo, jailbrekRomName, nullptr, nullptr, nullptr, nullptr, JailbrekInputInfo, JailbrekDIPInfo,
...
struct BurnDriver BurnDrvManhatan = {
	"manhatan", "jailbrek", nullptr, nullptr, "1986",
	"Manhattan 24 Bunsyo (Japan)\0", nullptr, "Konami", "GX507",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, manhatanRomInfo, manhatanRomName, nullptr, nullptr, nullptr, nullptr, JailbrekInputInfo, JailbrekDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	240, 224, 4, 3
};
...
struct BurnDriver BurnDrvJailbrekb = {
	"jailbrekb", "jailbrek", nullptr, nullptr, "1986",
	"Jail Break (bootleg)\0", nullptr, "bootleg", "GX507",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, jailbrekbRomInfo, jailbrekbRomName, nullptr, nullptr, nullptr, nullptr, JailbrekInputInfo, JailbrekDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	240, 224, 4, 3
};
