...
static constexpr res_net_decode_info popeye_7051_decode_info =
{
	1, 0, 15, {0, 0, 0}, {0, 3, 6}, {7, 7, 3}
};

static constexpr res_net_decode_info popeye_7052_decode_info =
{
	2, 0, 255, {0, 0, 0, 256, 256, 256}, {0, 3, 0, 0, -1, 2}, {7, 1, 0, 0, 6, 3}
};

static constexpr res_net_info popeye_7051_txt_net_info =
{
...
static constexpr res_net_info popeye_7051_bck_net_info =
{
	RES_NET_VCC_5V | RES_NET_VBIAS_5V | RES_NET_VIN_MB7051 | RES_NET_MONITOR_SANYO_EZV20,
	{
...
static constexpr res_net_info popeye_7052_obj_net_info =
{
...
static void __fastcall main_write(UINT16 address, UINT8 data)
{
	...
	switch (address)
	{
	case 0xE000: m_prot_shift = data & 0x07;
		return;
	case 0xE001: m_prot0 = m_prot1;
		m_prot1 = data;
		return;
	case 0x8c00:
	case 0x8c01:
	case 0x8c02: background_pos[address & 3] = data;
		return;
	case 0x8c03: *palette_bank = data;
	}
...
static INT32 MemIndex()
{
	...
	palette_bank = Next;
	Next += 0x00002;
	bgbitmap = (UINT16*)Next;
	Next += 1024 * 1024 * sizeof(UINT16); // background bitmap (RAM section)
...
static void DecodeGfx(INT32 is_chars, UINT8* data)
{
	...
	INT32 SpriteXOffsets[16] = {
		RGN_FRAC(((gfxlenx1) ? 0x4000 : 0x8000), 1, 4) + 7,RGN_FRAC(((gfxlenx1) ? 0x4000 : 0x8000), 1, 4) + 6,
		RGN_FRAC(((gfxlenx1) ? 0x4000 : 0x8000), 1, 4) + 5,RGN_FRAC(((gfxlenx1) ? 0x4000 : 0x8000), 1, 4) + 4,
		RGN_FRAC(((gfxlenx1) ? 0x4000 : 0x8000), 1, 4) + 3,RGN_FRAC(((gfxlenx1) ? 0x4000 : 0x8000), 1, 4) + 2,
		RGN_FRAC(((gfxlenx1) ? 0x4000 : 0x8000), 1, 4) + 1,RGN_FRAC(((gfxlenx1) ? 0x4000 : 0x8000), 1, 4) + 0, 7, 6, 5,
		4, 3, 2, 1, 0
	};
	INT32 SpriteYOffsets[16] = {
	...
	{
		// sprites
		GfxDecode((gfxlenx1) ? 0x100 : 0x200 /*((0x4000*8)/2)/(16*16))*/, 2, 16, 16, SpritePlaneOffsets, SpriteXOffsets,
		          SpriteYOffsets, 0x80, data, DrvSpriteGFX);
	}
}
...
static INT32 SkyskipprLoad(UINT8* DrvTempRom)
{
	...
	for (INT32 i = 0; i < 0x8000; i++)
		DrvZ80ROM[i] = BITSWAP08(DrvTempRom[BITSWAP16(i,15,14,13,12,11,10,8,7,0,1,2,4,5,9,3,6) ^ 0xfc], 3, 4, 2, 5, 1,
		                         6, 0, 7);
...
static INT32 PopeyeLoad(UINT8* DrvTempRom)
{
	...
	for (INT32 i = 0; i < 0x8000; i++)
		DrvZ80ROM[i] = BITSWAP08(DrvTempRom[BITSWAP16(i,15,14,13,12,11,10,8,7,6,3,9,5,4,2,1,0) ^ 0x3f], 3, 4, 2, 5, 1,
		                         6, 0, 7);
...
static INT32 DrvInit(INT32 (*LoadRoms)(UINT8* DrvTempRom))
{
	...
	AY8910SetPorts(0, popeye_ayportA_read, nullptr, nullptr, popeye_ayportB_write);
...
static void draw_background()
{
	...
	for (INT32 cury = desty; cury < destendy; cury++)
		for (INT32 curx = destx; curx < destendx; curx++)
		{
			...
			if (cury - desty < 0 || curx - destx < 0 || cury - desty >= nScreenHeight || curx - destx >= nScreenWidth ||
				cury >= bgbitmapwh /*|| curx >= bgbitmapwh this is solved by modulus below!*/ || cury < 0 || curx < 0)
				continue;
...
static void DrvMakeInputs()
{
	...
	CompileInput(DrvJoy, DrvInput, 3, 8, DrvJoyInit);
...
struct BurnDriver BurnDrvSkyskipr = {
	"skyskipr", nullptr, nullptr, nullptr, "1981",
	"Sky Skipper\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, skyskiprRomInfo, skyskiprRomName, nullptr, nullptr, nullptr, nullptr, SkyskiprInputInfo, SkyskiprDIPInfo,
...
struct BurnDriver BurnDrvPopeye = {
	"popeye", nullptr, nullptr, nullptr, "1982",
	"Popeye (revision D)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_PLATFORM, 0,
	nullptr, popeyeRomInfo, popeyeRomName, nullptr, nullptr, nullptr, nullptr, PopeyeInputInfo, PopeyeDIPInfo,
...
struct BurnDriver BurnDrvPopeyeu = {
	"popeyeu", "popeye", nullptr, nullptr, "1982",
	"Popeye (revision D not protected)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_PLATFORM, 0,
	nullptr, popeyeuRomInfo, popeyeuRomName, nullptr, nullptr, nullptr, nullptr, PopeyeInputInfo, PopeyeDIPInfo,
	DrvInitPopeye, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	512, 448, 4, 3
};
...
struct BurnDriver BurnDrvPopeyef = {
	"popeyef", "popeye", nullptr, nullptr, "1982",
	"Popeye (revision F)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_PLATFORM, 0,
	nullptr, popeyefRomInfo, popeyefRomName, nullptr, nullptr, nullptr, nullptr, PopeyeInputInfo, PopeyefDIPInfo,
	DrvInitPopeye, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	512, 448, 4, 3
};
...
struct BurnDriver BurnDrvPopeyebl = {
	"popeyebl", "popeye", nullptr, nullptr, "1982",
	"Popeye (bootleg set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_PLATFORM, 0,
	nullptr, popeyeblRomInfo, popeyeblRomName, nullptr, nullptr, nullptr, nullptr, PopeyeInputInfo, PopeyeDIPInfo,
...
struct BurnDriver BurnDrvPopeyeb3 = {
	"popeyeb3", "popeye", nullptr, nullptr, "1982",
	"Popeye (bootleg set 3)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION | GBF_PLATFORM, 0,
	nullptr, popeyeb3RomInfo, popeyeb3RomName, nullptr, nullptr, nullptr, nullptr, PopeyeInputInfo, PopeyeDIPInfo,
	DrvInitPopeye, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	512, 448, 4, 3
};
...
struct BurnDriver BurnDrvPopeyej = {
	"popeyej", "popeye", nullptr, nullptr, "1982",
	"Popeye (Japan)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_PLATFORM, 0,
	nullptr, popeyejRomInfo, popeyejRomName, nullptr, nullptr, nullptr, nullptr, PopeyeInputInfo, PopeyeDIPInfo,
...
struct BurnDriver BurnDrvPopeyejo = {
	"popeyejo", "popeye", nullptr, nullptr, "1982",
	"Popeye (Japan, Older)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_PLATFORM, 0,
	nullptr, popeyejoRomInfo, popeyejoRomName, nullptr, nullptr, nullptr, nullptr, PopeyeInputInfo, PopeyeDIPInfo,
	DrvInitPopeyej, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	512, 448, 4, 3
};
