...
using output_func = void(*)(UINT8 offset, UINT8 data);
using input_func = UINT8(*)(UINT8 offset);
...
{
	AY8910SetRoute(0, BURN_SND_AY8910_ROUTE_1,
	               ssio_mute ? 0 : ssio_ayvolume_lookup[ssio_duty_cycle[0][0]] + ssio_basevol, BURN_SND_ROUTE_PANLEFT);
	AY8910SetRoute(0, BURN_SND_AY8910_ROUTE_2,
	               ssio_mute ? 0 : ssio_ayvolume_lookup[ssio_duty_cycle[0][1]] + ssio_basevol, BURN_SND_ROUTE_PANLEFT);
	AY8910SetRoute(0, BURN_SND_AY8910_ROUTE_3,
	               ssio_mute ? 0 : ssio_ayvolume_lookup[ssio_duty_cycle[0][2]] + ssio_basevol, BURN_SND_ROUTE_PANLEFT);

	AY8910SetRoute(1, BURN_SND_AY8910_ROUTE_1,
	               ssio_mute ? 0 : ssio_ayvolume_lookup[ssio_duty_cycle[1][0]] + ssio_basevol, BURN_SND_ROUTE_PANRIGHT);
	AY8910SetRoute(1, BURN_SND_AY8910_ROUTE_2,
	               ssio_mute ? 0 : ssio_ayvolume_lookup[ssio_duty_cycle[1][1]] + ssio_basevol, BURN_SND_ROUTE_PANRIGHT);
	AY8910SetRoute(1, BURN_SND_AY8910_ROUTE_3,
	               ssio_mute ? 0 : ssio_ayvolume_lookup[ssio_duty_cycle[1][2]] + ssio_basevol, BURN_SND_ROUTE_PANRIGHT);
...
static void ssio_compute_ay8910_modulation(UINT8* prom)
{
	for (INT32 volval = 0; volval < 16; volval++)
	{
		...
		ssio_ayvolume_lookup[15 - volval] = (static_cast<double>(clock * 100 / 160) / 100) / 4;
