...
static void draw_layer()
{
	...
	for (INT32 offs = 0; offs < 32 * 32; offs++)
	{
		...
		if (layer_control & 0x02)
		{
			...
			{
				sx -= scrollram[(sy + layer_offset_y) / 8];
				// maybe apply the offset here? I guess we'll know for sure after playtesting. -dink
				sy -= yscroll;
			}
			else if (layer_control & 0x04)
			{
				sy -= scrollram[(sx + layer_offset_x) / 8];
				// offset applied here fixes the konami logo on the titlescreen. -dink
				sx -= xscroll;
			}
		}
		else
...
struct BurnDriver BurnDrvJackal = {
	"jackal", nullptr, nullptr, nullptr, "1986",
	"Jackal (World, 8-way Joystick)\0", nullptr, "Konami", "Miscellaneous",
	...
	nullptr, jackalRomInfo, jackalRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	224, 240, 3, 4
};

struct BurnDriver BurnDrvJackalr = {
	"jackalr", "jackal", nullptr, nullptr, "1986",
	"Jackal (World, Rotary Joystick)\0", nullptr, "Konami", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, jackalrRomInfo, jackalrRomName, nullptr, nullptr, nullptr, nullptr, DrvrotateInputInfo, DrvrotateDIPInfo,
	DrvInitRo, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	224, 240, 3, 4
};

struct BurnDriver BurnDrvJackalj = {
	"jackalj", "jackal", nullptr, nullptr, "1986",
	"Tokushu Butai Jackal (Japan, 8-way Joystick)\0", nullptr, "Konami", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, jackaljRomInfo, jackaljRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	224, 240, 3, 4
};

struct BurnDriver BurnDrvJackalbl = {
	"jackalbl", "jackal", nullptr, nullptr, "1986",
	"Jackal (bootleg, Rotary Joystick)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, jackalblRomInfo, jackalblRomName, nullptr, nullptr, nullptr, nullptr, DrvrotateInputInfo, DrvrotateDIPInfo,
	DrvInitbl, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	224, 240, 3, 4
};

struct BurnDriver BurnDrvTopgunr = {
	"topgunr", "jackal", nullptr, nullptr, "1986",
	"Top Gunner (US, 8-way Joystick)\0", nullptr, "Konami", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, topgunrRomInfo, topgunrRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	224, 240, 3, 4
};

struct BurnDriver BurnDrvTopgunbl = {
	"topgunbl", "jackal", nullptr, nullptr, "1986",
	"Top Gunner (bootleg, Rotary Joystick)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, topgunblRomInfo, topgunblRomName, nullptr, nullptr, nullptr, nullptr, DrvrotateInputInfo, DrvrotateDIPInfo,
	DrvInitbl, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	224, 240, 3, 4
};
