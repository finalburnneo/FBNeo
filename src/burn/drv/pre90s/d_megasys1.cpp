...
/*
	peekaboo analog inputs need hooked up
	sound is not great
*/
...
static struct BurnInputInfo PeekabooInputList[] = {
	...
	{"Stage Clear",		BIT_DIGITAL,	DrvJoy1 + 12,	"p1 fire 3"	},
	{"Option",		BIT_DIGITAL,	DrvJoy1 + 13,	"p1 fire 4"	},

	{"P1 Start",		BIT_DIGITAL,	DrvJoy1 + 4,	"p1 start"	},
	{"P1 Button 1",		BIT_DIGITAL,	DrvJoy1 + 8,	"p1 fire 1"	},
	{"P1 Button 2",		BIT_DIGITAL,	DrvJoy1 + 9,	"p1 fire 2"	},

	A("P1 Paddle", 		BIT_ANALOG_REL, &DrvAnalogPort0,"p1 x-axis"     ),
	...
	A("P2 Paddle",		BIT_ANALOG_REL, &DrvAnalogPort1,"p2 x-axis"     ),
...
static struct BurnDIPInfo PeekabooDIPList[]=
{
	...
	{0x0d, 0x01, 0x08, 0x00, "Buttons"			},

	{0   , 0xfe, 0   ,    4, "Nudity"			},
	{0x0d, 0x01, 0x30, 0x30, "Female and Male (Full)"	},
	{0x0d, 0x01, 0x30, 0x20, "Female (Full)"		},
	{0x0d, 0x01, 0x30, 0x10, "Female (Partial)"		},
	{0x0d, 0x01, 0x30, 0x00, "None"				},
	...
	{0x0d, 0x01, 0x80, 0x80, "1"				},
	{0x0d, 0x01, 0x80, 0x00, "2"				},
	...
	{0x0e, 0x01, 0x38, 0x18, "2 Coins 1 Credits"		},
...
struct BurnDriver BurnDrvStreet64j = {
	...
	"64th. Street - A Detective Story (Japan)\0", NULL, "Jaleco", "Mega System 1",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_SCRFIGHT, 0,
