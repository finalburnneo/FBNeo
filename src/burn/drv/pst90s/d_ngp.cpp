...
// Don't Die, Mr. Robot! v2.0 (HB)
static struct BurnRomInfo ngpc_ddmrRomDesc[] = {
	{ "Don't Die, Mr. Robot! (2025)(Infinite State Games).ngp", 2097152, 0xd3f986b2, 1 | BRF_PRG | BRF_ESS }, // Cartridge
};
...
struct BurnDriver BurnDrvngpc_ddmr = {
	...
	"Don't Die, Mr. Robot! v2.0 (HB)\0", NULL, "Infinite State Games", "NeoGeo Pocket Color",
	NULL, NULL, NULL, NULL,
