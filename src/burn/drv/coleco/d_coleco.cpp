...
static INT32 DrvDoReset()
{
	...
	last_state = 0; // previous irq state

	// In I2C mode MegaCartBank needs to default to the next 16k block of the rom
	MegaCartBank = (use_I2C) ? 1 : 0;
    SGM_map_24k = 0;
    SGM_map_8k = 0;
...
struct BurnDriver BurnDrvcv_suprtest = {
	...
	"Super Controller Test Cartridge\0", NULL, "Coleco - Nuvatec", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvcv_cvjoytest = {
	...
	"ColecoVision Joystick Test\0", NULL, "Coleco - Nuvatec", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_MISC, 0,
...
static struct BurnRomInfo cv_sgmtestRomDesc[] = {
	{ "ColecoVision Super Game Module (200x).rom",	0x002000, 0xabc4763d, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_sgmtest = {
	...
	"ColecoVision Super Game Module Test (SGM)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_MISC, 0,
...
static struct BurnRomInfo cv_campaignRomDesc[] = {
	{ "Campaign '84 (USA)(1983)(Sunrise Software).rom",	16384, 0x5aa22d66, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_campaign = {
	...
	"Campaign '84 (USA)\0", NULL, "Sunrise Software", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_ACTION, 0,
...
static struct BurnRomInfo cv_ccrisisRomDesc[] = {
	{ "Cosmic Crisis (Euro)(1983)(Bit Corporation).rom",	16384, 0x7c2c7c41, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_ccrisis = {
	...
	"Cosmic Crisis (Euro)\0", NULL, "Bit Corporation", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_ACTION, 0,
...
static struct BurnRomInfo cv_dncfntsyRomDesc[] = {
	{ "Dance Fantasy (USA)(1984)(Fisher-Price).rom",	8192, 0xbff86a98, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_dncfntsy = {
	...
	"Dance Fantasy (USA)\0", NULL, "Fisher-Price", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_ACTION, 0,
...
// Dr. Seuss's Fix-Up the Mix-Up Puzzler (USA)
static struct BurnRomInfo cv_drseussRomDesc[] = {
	{ "Dr. Seuss's Fix-Up the Mix-Up Puzzler (USA)(1984)(Coleco).rom",	16384, 0x109699e2, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_drseuss = {
	...
	"Dr. Seuss's Fix-Up the Mix-Up Puzzler (USA)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo cv_hazzardRomDesc[] = {
	{ "Dukes of Hazzard, The (USA)(1984)(Coleco).rom",	32768, 0x4025ac94, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_hazzard = {
	...
	"Dukes of Hazzard, The (USA)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
// Energy Quiz (Canada, Prototype)
static struct BurnRomInfo cv_enerquizRomDesc[] = {
	{ "Energy Quiz (Canada, Proto)(1983)(Sydney).rom",	32768, 0xafb90dcd, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_enerquiz, cv_enerquiz, cv_coleco)
STD_ROM_FN(cv_enerquiz)

struct BurnDriver BurnDrvcv_enerquiz = {
	"cv_enerquiz", NULL, "cv_coleco", NULL, "1983",
	"Energy Quiz (Canada, Prototype)\0", NULL, "Sydney Dev.", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 2, HARDWARE_COLECO, GBF_ACTION, 0,
	CVGetZipName, cv_enerquizRomInfo, cv_enerquizRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Escape from the Mindmaster (USA, Prototype)
static struct BurnRomInfo cv_mindmstrRomDesc[] = {
	{ "Escape from the Mindmaster (USA, Proto)(1983)(Epyx).rom",	16384, 0x3678ab6f, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_mindmstr = {
	...
	"Escape from the Mindmaster (USA, Prototype)\0", NULL, "Epyx", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
// Fall Guy (USA, Prototype)
static struct BurnRomInfo cv_fallguyRomDesc[] = {
	{ "Fall Guy (USA, Proto)(1983)(Fox Video Games).rom",	16384, 0x8a731b38, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_fallguy = {
	...
	"Fall Guy (USA, Prototype)\0", NULL, "Fox Video Games", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo cv_fortuneRomDesc[] = {
	{ "Fortune Builder (USA)(1984)(Coleco).rom",	32768, 0x65bbbcb4, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_fortune = {
	...
	"Fortune Builder (USA)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo cv_fracfevrRomDesc[] = {
	{ "Fraction Fever (USA)(1983)(Spinnaker Software).rom",	8192, 0x964db3bc, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_fracfevr = {
	...
	"Fraction Fever (USA)\0", NULL, "Spinnaker Software", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_ACTION, 0,
...
static struct BurnRomInfo cv_illusionRomDesc[] = {
	{ "Illusions (USA)(1984)(Nice Ideas).rom",	16384, 0x2787516d, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_illusion = {
	...
	"Illusions (USA)\0", NULL, "Nice Ideas", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_ACTION, 0,
...
// It's Only Rock 'n' Roll (USA)
static struct BurnRomInfo cv_onlyrockRomDesc[] = {
	{ "It's Only Rock 'N' Roll (USA)(1984)(K-Tel).rom",	16384, 0xcc43ebf7, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_onlyrock = {
	...
	"It's Only Rock 'n' Roll (USA)\0", NULL, "K-Tel", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_MISC, 0,
...
static struct BurnRomInfo cv_jbondRomDesc[] = {
	{ "James Bond 007 (USA)(1984)(Parker Brothers).rom",	12288, 0x561f2530, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_jbond = {
	...
	"James Bond 007 (USA)\0", NULL, "Parker Brothers", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_HORSHOOT, 0,
...
static struct BurnRomInfo cv_linklogcRomDesc[] = {
	{ "Linking Logic (USA)(1984)(Fisher-Price).rom",	8192, 0x918f12c0, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_linklogc = {
	...
	"Linking Logic (USA)\0", NULL, "Fisher-Price", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_PUZZLE, 0,
...
static struct BurnRomInfo cv_logiclvlRomDesc[] = {
	{ "Logic Levels (USA)(1984)(Fisher-Price).rom",	8192, 0xd54c581b, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_logiclvl = {
	...
	"Logic Levels (USA)\0", NULL, "Fisher-Price", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_PUZZLE, 0,
...
static struct BurnRomInfo cv_loopingRomDesc[] = {
	{ "Looping (USA, Euro)(1983)(Coleco).rom",	16384, 0x6a2d637b, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_looping = {
	...
	"Looping (USA, Euro)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_HORSHOOT, 0,
...
static struct BurnRomInfo cv_masterspRomDesc[] = {
	{ "Masters of the Universe - The Power of He-Man (USA, Proto)(1983)(Mattel Electronics).rom",	32768, 0x2277f82b, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_mastersp, cv_mastersp, cv_coleco)
STD_ROM_FN(cv_mastersp)

struct BurnDriver BurnDrvcv_mastersp = {
	"cv_mastersp", "cv_masters", "cv_coleco", NULL, "1983",
	"Masters of the Universe: The Power of He-Man (USA, Prototype)\0", NULL, "Mattel Electronics", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 1, HARDWARE_COLECO, GBF_ACTION | GBF_HORSHOOT, 0,
	CVGetZipName, cv_masterspRomInfo, cv_masterspRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
static struct BurnRomInfo cv_memmanorRomDesc[] = {
	{ "Memory Manor (USA)(1984)(Fisher-Price).rom",	8192, 0xbab520ea, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_memmanor = {
	...
	"Memory Manor (USA)\0", NULL, "Fisher-Price", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_PUZZLE, 0,
...
// Memory Manor (USA, Alt)
static struct BurnRomInfo cv_memmanoraRomDesc[] = {
	{ "Memory Manor (USA, Alt)(1984)(Fisher-Price).rom",	16384, 0x861c9825, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_memmanora, cv_memmanora, cv_coleco)
STD_ROM_FN(cv_memmanora)

struct BurnDriver BurnDrvcv_memmanora = {
	"cv_memmanora", "cv_memmanor", "cv_coleco", NULL, "1984",
	"Memory Manor (USA, Alt)\0", NULL, "Fisher-Price", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 1, HARDWARE_COLECO, GBF_PUZZLE, 0,
	CVGetZipName, cv_memmanoraRomInfo, cv_memmanoraRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
static struct BurnRomInfo cv_meteoshoRomDesc[] = {
	{ "Meteoric Shower (USA)(1983)(Bit Corporation).rom",	16384, 0x3beffc06, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_meteosho = {
	...
	"Meteoric Shower (USA)\0", NULL, "Bit Corporation", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_VERSHOOT, 0,
...
static struct BurnRomInfo cv_meteoshoaRomDesc[] = {
	{ "Meteoric Shower (Euro)(1983)(Bit Corporation).rom",	12288, 0xe51f464f, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_meteoshoa = {
	...
	"Meteoric Shower (Euro)\0", NULL, "Bit Corporation", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_COLECO, GBF_VERSHOOT, 0,
...
static struct BurnRomInfo cv_novablstRomDesc[] = {
	{ "Nova Blast (USA, Euro)(1983)(Imagic).rom",	12288, 0x4491a35b, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_novablst = {
	...
	"Nova Blast (USA, Euro)\0", NULL, "Imagic", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_HORSHOOT, 0,
...
static struct BurnRomInfo cv_orbitRomDesc[] = {
	{ "Orbit (USA, Proto)(1983)(Parker Brothers).rom",	8192, 0x2cc6f4aa, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_orbit = {
	...
	"Orbit (USA, Prototype)\0", "Not playable Demo", "Parker Brothers", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 1, HARDWARE_COLECO, GBF_MISC, 0,
...
static struct BurnRomInfo cv_pepper2RomDesc[] = {
	{ "Pepper II (USA, Euro)(1983)(Coleco).rom",	16384, 0x53b85e20, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_pepper2 = {
	...
	"Pepper II (USA, Euro)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_ACTION | GBF_MAZE, 0,
...
// Power Lords: Quest for Volcan (USA, Prototype)
static struct BurnRomInfo cv_powerRomDesc[] = {
	{ "Power Lords - Quest for Volcan (USA, Proto)(1983)(Strongin-Mayem).rom",	32768, 0xcaa61d8d, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_power = {
	...
	"Power Lords: Quest for Volcan (USA, Prototype)\0", NULL, "Strongin-Mayem", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 1, HARDWARE_COLECO, GBF_ACTION | GBF_SHOOT, 0,
...
static struct BurnRomInfo cv_quintanaRomDesc[] = {
	{ "Quest for Quintana Roo (USA)(1983)(Sunrise Software).rom",	16384, 0x2d32b1f0, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_quintana = {
	...
	"Quest for Quintana Roo (UA)\0", NULL, "Sunrise Software", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_ACTION, 0,
...
static struct BurnRomInfo cv_quintanaaRomDesc[] = {
	{ "Quest for Quintana Roo (USA, Alt)(1983)(Sunrise Software).rom",	16384, 0xeec81c42, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_quintanaa = {
	...
	"Quest for Quintana Roo (USA, Alt)\0", NULL, "Sunrise Software", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 1, HARDWARE_COLECO, GBF_ACTION, 0,
...
// Rocky: Super Action Boxing (USA, Euro)
static struct BurnRomInfo cv_rockyRomDesc[] = {
	{ "Rocky - Super Action Boxing (USA, Euro)(1983)(Coleco).rom",	20480, 0x37f144d3, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_rocky = {
	...
	"Rocky: Super Action Boxing (USA, Euro)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo cv_rolloverRomDesc[] = {
	{ "Rolloverture (USA)(1983)(Sunrise Software).rom",	16384, 0x0364fb81, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_rollover = {
	...
	"Rolloverture (USA)\0", NULL, "Sunrise Software", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_ACTION, 0,
...
static struct BurnRomInfo cv_sammylfRomDesc[] = {
	{ "Sammy Lightfoot (USA)(1983)(Sierra On-Line).rom",	16384, 0xc5f69a1b, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_sammylf = {
	...
	"Sammy Lightfoot (USA)\0", NULL, "Sierra On-Line", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
// Sammy Lightfoot (USA, Alt)
static struct BurnRomInfo cv_sammylfaRomDesc[] = {
	{ "Sammy Lightfoot (USA, Alt)(1983)(Sierra On-Line).rom",	16384, 0x3563286b, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_sammylfa = {
	...
	"Sammy Lightfoot (USA, Alt)\0", NULL, "Sierra On-Line", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
static struct BurnRomInfo cv_secalphaRomDesc[] = {
	{ "Sector Alpha (USA)(1983)(Spectravideo).rom",	20480, 0x0ec63a5c, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_secalpha = {
	...
	"Sector Alpha (USA)\0", NULL, "Spectravideo", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_SHOOT, 0,
...
struct BurnDriver BurnDrvcv_sewersam = {
	...
	"Sewer Sam (USA)\0", NULL, "Interphase", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_ACTION, 0,
...
// Smurf: Paint 'n Play Workshop (USA, Euro)
static struct BurnRomInfo cv_smurfpntRomDesc[] = {
	{ "Smurf - Paint 'n Play Workshop (USA, Euro)(1983)(Peyo).rom",	24576, 0x97c0382d, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_smurfpnt = {
	...
	"Smurf: Paint 'n Play Workshop (USA, Euro)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_MISC, 0,
...
// Smurf: Paint 'n Play Workshop (USA, Alt)
static struct BurnRomInfo cv_smurfpntaRomDesc[] = {
	{ "Smurf - Paint 'n Play Workshop (USA, Alt)(1983)(Peyo).rom",	32768, 0x176eb9c3, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_smurfpnta, cv_smurfpnta, cv_coleco)
STD_ROM_FN(cv_smurfpnta)

struct BurnDriver BurnDrvcv_smurfpnta = {
	"cv_smurfpnta", "cv_smurfpnt", "cv_coleco", NULL, "1983",
	"Smurf: Paint 'n Play Workshop (USA, Alt)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 1, HARDWARE_COLECO, GBF_MISC, 0,
	CVGetZipName, cv_smurfpntaRomInfo, cv_smurfpntaRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Smurf Play and Learn (USA, Prototype)
static struct BurnRomInfo cv_smurfplyRomDesc[] = {
	{ "Smurf Play and Learn (USA, Proto)(1982)(Coleco).rom",	16384, 0x9a3b8587, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_smurfply = {
	...
	"Smurf Play and Learn (USA, Prototype)\0", "Not playable Demo", "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo cv_spacfuryRomDesc[] = {
	{ "Space Fury (USA, Euro)(1983)(Coleco).rom",	16384, 0xdf8de30f, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_spacfury = {
	...
	"Space Fury (USA, Euro)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_MULTISHOOT, 0,
...
// Space Panic (USA, Euro)
static struct BurnRomInfo cv_panicRomDesc[] = {
	{ "Space Panic (USA, Euro)(1983)(Coleco).rom",	16384, 0x5bdf2997, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_panic = {
	...
	"Space Panic (USA, Euro)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_ACTION, 0,
...
static struct BurnRomInfo cv_spectronRomDesc[] = {
	{ "Spectron (USA)(1983)(Spectravideo).rom",	16384, 0xa6401c46, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_spectron = {
	...
	"Spectron (USA)\0", NULL, "Spectravideo", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_VERSHOOT, 0,
...
static struct BurnRomInfo cv_squishemRomDesc[] = {
	{ "Squish'em Sam! (USA)(1983)(Interphase).rom",	16384, 0xac92862d, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_squishem = {
	"cv_squishem", NULL, "cv_coleco", NULL, "1983",
	"Squish'em Sam! (USA)\0", NULL, "Interphase", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_ACTION, 0,
...
static struct BurnRomInfo cv_startrekRomDesc[] = {
	{ "Star Trek - Strategic Operations Simulator (USA)(1984)(Coleco).rom",	24576, 0x95824f1e, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_startrek = {
	...
	"Star Trek: Strategic Operations Simulator (USA)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_SHOOT | GBF_SIM, 0,
...
// Star Trek: Strategic Operations Simulator (USA, Alt)
static struct BurnRomInfo cv_startrekaRomDesc[] = {
	{ "Star Trek - Strategic Operations Simulator (USA, Alt)(1984)(Coleco).rom",	32768, 0xaff42aa9, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_startreka, cv_startreka, cv_coleco)
STD_ROM_FN(cv_startreka)

struct BurnDriver BurnDrvcv_startreka = {
	"cv_startreka", "cv_startrek", "cv_coleco", NULL, "1984",
	"Star Trek: Strategic Operations Simulator (USA, Alt)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 1, HARDWARE_COLECO, GBF_SHOOT | GBF_SIM, 0,
	CVGetZipName, cv_startrekaRomInfo, cv_startrekaRomName, NULL, NULL, NULL, NULL, SACInputInfo, SACDIPInfo,
	DrvInitSAC, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Steamroller (USA, Prototype)
static struct BurnRomInfo cv_steamRomDesc[] = {
	{ "Steamroller (USA, Proto)(1984)(Activision).rom",	16384, 0x153ac4ef, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_steam = {
	...
	"Steamroller (USA, Prototype)\0", NULL, "Activision", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 2, HARDWARE_COLECO, GBF_ACTION | GBF_MAZE, 0,
...
static struct BurnRomInfo cv_strikeitRomDesc[] = {
	{ "Strike It! (Euro)(1983)(Bit Corporation).rom",	16384, 0xd247a1c8, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_strikeit = {
	...
	"Strike It! (Euro)\0", NULL, "Bit Corporation", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_BREAKOUT, 0,
...
// Super Cross Force (USA, Euro)
static struct BurnRomInfo cv_sprcrossRomDesc[] = {
	{ "Super Cross Force (USA, Euro)(1983)(Spectravideo).rom",	12288, 0x84350129, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_sprcross = {
	...
	"Super Cross Force (USA, Euro)\0", NULL, "Spectravideo", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_VERSHOOT, 0,
...
// Super Cross Force (USA, Alt)
static struct BurnRomInfo cv_sprcrossaRomDesc[] = {
	{ "Super Cross Force (USA, Alt)(1983)(Spectravideo).rom",	16384, 0x8093b672, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_sprcrossa = {
	...
	"Super Cross Force (USA, Alt)\0", NULL, "Spectravideo", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_COLECO, GBF_VERSHOOT, 0,
...
// Super DK! (USA, Prototype)
static struct BurnRomInfo cv_superdkRomDesc[] = {
	{ "Super DK! (USA, Proto)(1982)(Coleco).rom",	32768, 0xef25af90, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_superdk = {
	...
	"Super DK! (USA, Prototype)\0", NULL, "Coleco - Nintendo", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
	CVGetZipName, cv_superdkRomInfo, cv_superdkRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Super DK Junior (USA, Prototype)
static struct BurnRomInfo cv_suprdkjrRomDesc[] = {
	{ "Super DK Junior (USA, Proto)(1983)(Coleco).rom",	32768, 0xc2e7f0e0, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_suprdkjr = {
	...
	"Super DK Junior (USA, Prototype)\0", NULL, "Coleco - Nintendo", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
static struct BurnRomInfo cv_ssketchRomDesc[] = {
	{ "Super Sketch (USA)(1984)(Personal Peripherals).rom",	0x02000, 0x8627300a, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_ssketch = {
	...
	"Super Sketch (USA)\0", "NB: drawing software, it needs a specific device to work properly.", "Personal Peripherals", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_MISC, 0,
...
static struct BurnRomInfo cv_tankwarsRomDesc[] = {
	{ "Tank Wars (Euro)(1983)(Bit Corporation).rom",	12288, 0xaf6bbc7e, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_tankwars = {
	...
	"Tank Wars (Euro)\0", NULL, "Bit Corporation", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_MAZE | GBF_RUNGUN, 0,
...
static struct BurnRomInfo cv_tellyRomDesc[] = {
	{ "Telly Turtle (USA)(1984)(Coleco).rom",	16384, 0xc8bc1950, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_telly = {
	...
	"Telly Turtle (USA)\0", NULL, "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo cv_threshldRomDesc[] = {
	{ "Threshold (USA)(1983)(Sierra On-Line).rom",	16384, 0x1593f7df, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_threshld = {
	...
	"Threshold (USA)\0", NULL, "Sierra On-Line", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_COLECO, GBF_VERSHOOT, 0,
...
// Tunnels and Trolls (USA, Prototype)
static struct BurnRomInfo cv_tunnelsRomDesc[] = {
	{ "Tunnels & Trolls (USA, Proto)(1984)(Coleco).rom",	32768, 0x291a0004, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_tunnels = {
	"cv_tunnels", NULL, "cv_coleco", NULL, "1984",
	"Tunnels and Trolls (USA, Prototype)\0", "Not playable Demo", "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 1, HARDWARE_COLECO, GBF_MISC, 0,
...
static struct BurnRomInfo cv_wizmathRomDesc[] = {
	{ "Wizard of Id's WizMath (USA)(1984)(Sierra On-Line).rom",	16384, 0xb9ba2bb6, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_wizmath = {
	...
	"Wizard of Id's Wizmath (USA)\0", NULL, "Sierra On-Line", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvcv_advisland = {
    ...
    L"Adventure Island (SGM) (HB)\0\u9ad8\u6a4b\u540d\u4eba\u306e\u5192\u967a\u5cf6\0", NULL, NULL, NULL,
...
// Adventures of the Pink Panther, The (HB)
static struct BurnRomInfo cv_pinkpantherRomDesc[] = {
    { "Adventures of the Pink Panther, The (1983-2019)(CollectorVision).rom",	131072, 0xa9d82b08, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_pinkpanther, cv_pinkpanther, cv_coleco)
STD_ROM_FN(cv_pinkpanther)

struct BurnDriver BurnDrvcv_pinkpanther = {
    "cv_pinkpanther", NULL, "cv_coleco", NULL, "1983-2019",
    "Adventures of the Pink Panther, The (HB)\0", "Published by CollectorVision Games", "Napcec", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PLATFORM, 0,
    CVGetZipName, cv_pinkpantherRomInfo, cv_pinkpantherRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
static struct BurnRomInfo cv_AmidarRomDesc[] = {
	{ "Amidar SGM (2024)(Opcode Games).rom", 131072, 0xe4676d56, BRF_ESS | BRF_PRG },
};
...
struct BurnDriver BurnDrvcv_Amidar = {
	"cv_amidar", NULL, "cv_coleco", NULL, "1981-2024",
	"Amidar (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - Konami", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvcv_arkanoid = {
    ...
    "Arkanoid (SGM) (HB)\0", "SGM - Published by CollectorVision Games", "Taito Corp.", "ColecoVision",
    NULL, NULL, NULL, NULL,
...
struct BurnDriver BurnDrvcv_bankpanic = {
    ...
    "Bank Panic (HB)\0", "Published by Team Pixelboy", "Sega - Eduardo Mello", "ColecoVision",
    NULL, NULL, NULL, NULL,
...
// Barbarricade (HB, 06-25-26)
static struct BurnRomInfo cv_barbarricadeRomDesc[] = {
	{ "Barbarricade 06-25-26 (2026)(Jess Creations).rom",	32768, 0xe5d8753d, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_barbarricade = {
	...
	"Barbarricade (HB, 06-25-26)\0", NULL, "Jess Creations", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_BREAKOUT, 0,
...
// Battlot (HB)
static struct BurnRomInfo cv_battlotRomDesc[] = {
	{ "Battlot (2022)(Inufuto).rom",	9601, 0x115d32a3, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_battlot, cv_battlot, cv_coleco)
STD_ROM_FN(cv_battlot)

struct BurnDriver BurnDrvcv_battlot = {
	"cv_battlot", NULL, "cv_coleco", NULL, "2022",
	"Battlot (HB)\0", NULL, "Inufuto", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_MAZE | GBF_RUNGUN, 0,
	CVGetZipName, cv_battlotRomInfo, cv_battlotRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Bokosuka Wars (SGM) (HB)
static struct BurnRomInfo cv_bokosukawarsRomDesc[] = {
    { "Bokosuka Wars SGM (2017)(Opcode Games).rom",	32768, 0x59b0eb86, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_bokosukawars, cv_bokosukawars, cv_coleco)
STD_ROM_FN(cv_bokosukawars)

struct BurnDriver BurnDrvcv_bokosukawars = {
    "cv_bokosukawars", NULL, "cv_coleco", NULL, "1983-2017",
    "Bokosuka Wars (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - ASCII", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_STRATEGY, 0,
    CVGetZipName, cv_bokosukawarsRomInfo, cv_bokosukawarsRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};

// Bomber King (SGM) (HB)
static struct BurnRomInfo cv_bombkingRomDesc[] = {
    { "Bomber King SGM (1988-2020)(Team Pixelboy).rom",	131072, 0x782cfb9f, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_bombking, cv_bombking, cv_coleco)
STD_ROM_FN(cv_bombking)

struct BurnDriver BurnDrvcv_bombking = {
    "cv_bombking", NULL, "cv_coleco", NULL, "1988-2020",
    "Bomber King (SGM) (HB)\0", "SGM - Published by Team Pixelboy", "Hudson Soft", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION | GBF_PUZZLE, 0,
    CVGetZipName, cv_bombkingRomInfo, cv_bombkingRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
static struct BurnRomInfo cv_bombjackRomDesc[] = {
    { "Bomb Jack RC2.2 (2015)(CollectorVision).rom",	32174, 0xa399d4cd, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_bombjack = {
    ...
    "Bomb Jack (HB, RC2.2)\0", NULL, "CollectorVision Games", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
// Bootskell (HB)
static struct BurnRomInfo cv_bootskellRomDesc[] = {
	{ "Bootskell (2022)(Inufuto).rom",	9283, 0x46f2cea5, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_bootskell, cv_bootskell, cv_coleco)
STD_ROM_FN(cv_bootskell)

struct BurnDriver BurnDrvcv_bootskell = {
	"cv_bootskell", NULL, "cv_coleco", NULL, "2022",
	"Bootskell (HB)\0", NULL, "Inufuto", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION | GBF_MAZE, 0,
	CVGetZipName, cv_bootskellRomInfo, cv_bootskellRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Bounty Bob Strikes Back! (HB)
static struct BurnRomInfo cv_bountybobRomDesc[] = {
	{ "Bounty Bob Strikes Back (1984-2024)(CollectorVision).rom",	32768, 0x86db78b3, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_bountybob, cv_bountybob, cv_coleco)
STD_ROM_FN(cv_bountybob)

struct BurnDriver BurnDrvcv_bountybob = {
	"cv_bountybob", NULL, "cv_coleco", NULL, "1984-2024",
	"Bounty Bob Strikes Back! (HB)\0", "Published by CollectorVision Games", "Big Five Software", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PLATFORM, 0,
	CVGetZipName, cv_bountybobRomInfo, cv_bountybobRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Breakout (2023) (HB, Joystick Version)
static struct BurnRomInfo cv_breakout23jRomDesc[] = {
	{ "Breakout Joystick Version (2023)(AnalogKid).rom",	6660, 0x928a1ffc, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_breakout23j, cv_breakout23j, cv_coleco)
STD_ROM_FN(cv_breakout23j)

struct BurnDriver BurnDrvcv_breakout23j = {
	"cv_breakout23j", NULL, "cv_coleco", NULL, "2023",
	"Breakout (2023) (HB, Joystick Version)\0", NULL, "AnalogKid", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_BREAKOUT, 0,
	CVGetZipName, cv_breakout23jRomInfo, cv_breakout23jRomName, NULL, NULL, NULL, NULL, ROLLERInputInfo, ROLLERDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Breakout (2023) (HB, Roller Version)
static struct BurnRomInfo cv_breakout23rRomDesc[] = {
	{ "Breakout Roller Version (2023)(AnalogKid).rom",	6562, 0x2f758657, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_breakout23r, cv_breakout23r, cv_coleco)
STD_ROM_FN(cv_breakout23r)

struct BurnDriver BurnDrvcv_breakout23r = {
	"cv_breakout23r", "cv_breakout23j", "cv_coleco", NULL, "2023",
	"Breakout (2023) (HB, Roller Version)\0", NULL, "AnalogKid", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_BREAKOUT, 0,
	CVGetZipName, cv_breakout23rRomInfo, cv_breakout23rRomName, NULL, NULL, NULL, NULL, ROLLERInputInfo, ROLLERDIPInfo,
	DrvInitROLLER, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Bubbles (HB)
static struct BurnRomInfo cv_bubblesRomDesc[] = {
	{ "Bubbles (1982-2024)(CollectorVision).rom",	32768, 0x6e518f13, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_bubbles, cv_bubbles, cv_coleco)
STD_ROM_FN(cv_bubbles)

struct BurnDriver BurnDrvcv_bubbles = {
	"cv_bubbles", NULL, "cv_coleco", NULL, "1982-2024",
	"Bubbles (HB)\0", "Published by CollectorVision Games", "Williams", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
	CVGetZipName, cv_bubblesRomInfo, cv_bubblesRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Bull & Mighty's Critical Moment (SGM) (HB)
static struct BurnRomInfo cv_bullmightyRomDesc[] = {
    { "Bull and Mighty's Critical Moment SGM (2024)(Opcode Games).rom",	131072, 0x257a2565, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_bullmighty, cv_bullmighty, cv_coleco)
STD_ROM_FN(cv_bullmighty)

struct BurnDriver BurnDrvcv_bullmighty = {
    "cv_bullmighty", NULL, "cv_coleco", NULL, "1986-2024",
    "Bull & Mighty's Critical Moment (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - HAL Laboratory", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PLATFORM, 0,
    CVGetZipName, cv_bullmightyRomInfo, cv_bullmightyRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
// Bust-A-Bobble (HB)
static struct BurnRomInfo cv_bustabobbleRomDesc[] = {
	{ "Bust-A-Bobble (2026)(unhuman).rom",	24576, 0x30aa8d12, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_bustabobble, cv_bustabobble, cv_coleco)
STD_ROM_FN(cv_bustabobble)

struct BurnDriver BurnDrvcv_bustabobble = {
	"cv_bustabobble", NULL, "cv_coleco", NULL, "2026",
	"Bust-A-Bobble (HB)\0", NULL, "unhuman", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PUZZLE, 0,
	CVGetZipName, cv_bustabobbleRomInfo, cv_bustabobbleRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Bust-A-Bobble 2 (HB)
static struct BurnRomInfo cv_bustabobble2RomDesc[] = {
	{ "Bust-A-Bobble 2 (2026)(unhuman).rom",	24576, 0x0d6c2ec1, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_bustabobble2, cv_bustabobble2, cv_coleco)
STD_ROM_FN(cv_bustabobble2)

struct BurnDriver BurnDrvcv_bustabobble2 = {
	"cv_bustabobble2", NULL, "cv_coleco", NULL, "2026",
	"Bust-A-Bobble 2 (HB)\0", NULL, "unhuman", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PUZZLE, 0,
	CVGetZipName, cv_bustabobble2RomInfo, cv_bustabobble2RomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
STDROMPICKEXT(cv_bustinout1, cv_bustinout1, cv_coleco)
STD_ROM_FN(cv_bustinout1)

struct BurnDriver BurnDrvcv_bustinout1 = {
    "cv_bustinout1", NULL, "cv_coleco", NULL, "2000-2016",
    "BUSTin-Out Vol. 1 (HB)\0", "Published by CollectorVision Games", "Daniel Bienvenu", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_BREAKOUT, 0,
    CVGetZipName, cv_bustinout1RomInfo, cv_bustinout1RomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};

// BUSTin-Out Vol. 2 (HB)
static struct BurnRomInfo cv_bustinout2RomDesc[] = {
    { "BUSTin-Out Vol. 2 (2000-2016)(CollectorVision Games).rom",	32640, 0xe12ccc1e, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_bustinout2, cv_bustinout2, cv_coleco)
STD_ROM_FN(cv_bustinout2)

struct BurnDriver BurnDrvcv_bustinout2 = {
    "cv_bustinout2", NULL, "cv_coleco", NULL, "2000-2016",
    "BUSTin-Out Vol. 2 (HB)\0", "Published by CollectorVision Games", "Daniel Bienvenu", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_BREAKOUT, 0,
    CVGetZipName, cv_bustinout2RomInfo, cv_bustinout2RomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};

// BUSTin-Out Vol. 3 (HB)
static struct BurnRomInfo cv_bustinout3RomDesc[] = {
    { "BUSTin-Out Vol. 3 (2000-2016)(CollectorVision Games).rom",	32768, 0xc3a925af, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_bustinout3, cv_bustinout3, cv_coleco)
STD_ROM_FN(cv_bustinout3)

struct BurnDriver BurnDrvcv_bustinout3 = {
    "cv_bustinout3", NULL, "cv_coleco", NULL, "2000-2016",
    "BUSTin-Out Vol. 3 (HB)\0", "Published by CollectorVision Games", "Daniel Bienvenu", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_BREAKOUT, 0,
    CVGetZipName, cv_bustinout3RomInfo, cv_bustinout3RomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};

// Cabbage Patch Kids (HB)
static struct BurnRomInfo cv_cabbagepkRomDesc[] = {
	{ "Cabbage Patch Kids (2017)(Opcode Games).rom", 65536, 0x741cf863, BRF_ESS | BRF_PRG },
};

STDROMPICKEXT(cv_cabbagepk, cv_cabbagepk, cv_coleco)
STD_ROM_FN(cv_cabbagepk)

struct BurnDriver BurnDrvcv_cabbagepk = {
	"cv_cabbagepk", NULL, "cv_coleco", NULL, "1983-2017",
	"Cabbage Patch Kids (HB)\0", NULL, "Opcode Games - Konami", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_ACTION, 0,
	CVGetZipName, cv_cabbagepkRomInfo, cv_cabbagepkRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Challenger (HB)
static struct BurnRomInfo cv_challengerRomDesc[] = {
    { "Challenger (2019)(CollectorVision).rom",	29232, 0x37265d37, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_challenger, cv_challenger, cv_coleco)
STD_ROM_FN(cv_challenger)

struct BurnDriver BurnDrvcv_challenger = {
    "cv_challenger", NULL, "cv_coleco", NULL, "2019",
    "Challenger (HB)\0", NULL, "CollectorVision Games", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_VERSHOOT, 0,
    CVGetZipName, cv_challengerRomInfo, cv_challengerRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
// Coleco Tennis (HB)
static struct BurnRomInfo cv_coltennisRomDesc[] = {
    { "Coleco Tennis (2026)(Oldschool Is Beautiful).rom",	32768, 0xac3fc1d2, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_coltennis, cv_coltennis, cv_coleco)
STD_ROM_FN(cv_coltennis)

struct BurnDriver BurnDrvcv_coltennis = {
    "cv_coltennis", NULL, "cv_coleco", NULL, "2026",
    "Coleco Tennis (HB)\0", NULL, "Oldschool Is Beautiful", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_SPORTSMISC, 0,
    CVGetZipName, cv_coltennisRomInfo, cv_coltennisRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
// CrackPots (HB)
static struct BurnRomInfo cv_crackpotsRomDesc[] = {
	{ "CrackPots (2026)(Electric Dreams).rom",	131072, 0x91e0fa0f, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_crackpots, cv_crackpots, cv_coleco)
STD_ROM_FN(cv_crackpots)

struct BurnDriver BurnDrvcv_crackpots = {
	"cv_crackpots", NULL, "cv_coleco", NULL, "2026",
	"CrackPots (HB)\0", NULL, "Electric Dreams", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
	CVGetZipName, cv_crackpotsRomInfo, cv_crackpotsRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Cure, The (HB)
static struct BurnRomInfo cv_cureRomDesc[] = {
    { "Cure, The (2020)(Team Pixelboy).rom",	131072, 0x78e07081, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_cure, cv_cure, cv_coleco)
STD_ROM_FN(cv_cure)

struct BurnDriver BurnDrvcv_cure = {
    "cv_cure", NULL, "cv_coleco", NULL, "2020",
    "Cure, The (HB)\0", "Published by Team Pixelboy", "XL2S Entertainment", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PLATFORM | GBF_ACTION, 0,
    CVGetZipName, cv_cureRomInfo, cv_cureRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_cso = {
    ...
    "C_So! (HB)\0", "Published by Team Pixelboy", "Sega - Claus Baekkel", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_ACTION, 0,
...
static struct BurnRomInfo cv_dacman2RomDesc[] = {
	{ "Dacman II Rev B (2026)(Amy Bienvenu).rom",	14982, 0x1595410d, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_dacman2 = {
	...
	"Dacman II (HB, Rev. B)\0", NULL, "Amy Bienvenu", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION | GBF_MAZE, 0,
...
// Death Race (HB, Prototype)
static struct BurnRomInfo cv_deathraceRomDesc[] = {
    { "Death Race (Proto) (2011)(unknown).rom",	8192, 0xda6d5616, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_deathrace, cv_deathrace, cv_coleco)
STD_ROM_FN(cv_deathrace)

struct BurnDriver BurnDrvcv_deathrace = {
    "cv_deathrace", NULL, "cv_coleco", NULL, "2011",
    "Death Race (HB, Prototype)\0", NULL, "<unknown>", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_PROTOTYPE | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
    CVGetZipName, cv_deathraceRomInfo, cv_deathraceRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
// Demon Attack (HB)
static struct BurnRomInfo cv_demonattackRomDesc[] = {
	{ "Demon Attack (1983-2023)(CollectorVision).rom", 32768, 0xba7049b7, BRF_ESS | BRF_PRG },
};

STDROMPICKEXT(cv_demonattack, cv_demonattack, cv_coleco)
STD_ROM_FN(cv_demonattack)

struct BurnDriver BurnDrvcv_demonattack = {
	"cv_demonattack", NULL, "cv_coleco", NULL, "1983-2023",
	"Demon Attack (HB)\0", "Published by CollectorVision Games", "Imagic", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_VERSHOOT, 0,
	CVGetZipName, cv_demonattackRomInfo, cv_demonattackRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
static struct BurnRomInfo cv_digdugsgmRomDesc[] = {
    { "Dig Dug SGM (2017)(Opcode Games).rom",	32768, 0x59d08879, BRF_PRG | BRF_ESS },
};
...
static struct BurnRomInfo cv_DkarcadeRomDesc[] = {
   { "DK Arcade SGM (2023)(Opcode Games).rom", 131072, 0x76004C98, BRF_ESS | BRF_PRG },
};
...
struct BurnDriver BurnDrvcv_Dkarcade = {
   "cv_dkarcade", NULL, "cv_coleco", NULL, "1981-2023",
   "DK Arcade (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - Nintendo", "ColecoVision",
   NULL, NULL, NULL, NULL,
   BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
struct BurnDriver BurnDrvcv_Dkjrarcade = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
	CVGetZipName, cv_DkjrarcadeRomInfo, cv_DkjrarcadeRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitOCM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_dkongarcade = {
    "cv_dkongarcade", NULL, "cv_coleco", NULL, "1983-2018",
    "Donkey Kong Arcade (SGM) (HB)\0", "Press '/' to add coins, '1' for P1 mode, '2' for P2 mode", "Opcode Games - Coleco", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
// Dorodon (SGM) (HB)
static struct BurnRomInfo cv_dorodonRomDesc[] = {
	{ "Dorodon SGM (2017)(Opcode Games).rom",	32768, 0xe3d61921, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_dorodon, cv_dorodon, cv_coleco)
STD_ROM_FN(cv_dorodon)

struct BurnDriver BurnDrvcv_dorodon = {
	"cv_dorodon", NULL, "cv_coleco", NULL, "1984-2017",
	"Dorodon (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - UPL", "ColecoVision",
	NULL, NULL, NULL, NULL,
...
// EA Classics (HB)
static struct BurnRomInfo cv_eaclassicsRomDesc[] = {
	{ "Electric Adventures Classics (2013)(CollectorVideo).rom",	21479, 0x21b05b8a, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_eaclassics, cv_eaclassics, cv_coleco)
STD_ROM_FN(cv_eaclassics)

struct BurnDriver BurnDrvcv_eaclassics = {
	"cv_eaclassics", NULL, "cv_coleco", NULL, "2013",
	"EA Classics (HB)\0", "Published by CollectorVision Games", "Electric Adventures", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_MINIGAMES, 0,
	CVGetZipName, cv_eaclassicsRomInfo, cv_eaclassicsRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_elevactionsgm = {
	"cv_elevactionsgm", NULL, "cv_coleco", NULL, "1985-2021",
	"Elevator Action (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - Taito Corp.", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
static struct BurnRomInfo cv_flstoryRomDesc[] = {
	{ "Fairyland Story, The SGM (1987-2023)(CollectorVision).rom",	131072, 0x87f3f556, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_flstory, cv_flstory, cv_coleco)
STD_ROM_FN(cv_flstory)

struct BurnDriver BurnDrvcv_flstory = {
	"cv_flstory", NULL, "cv_coleco", NULL, "1987-2023",
	"Fairyland Story, The (HB)\0", "SGM - Published by CollectorVision Games", "Taito", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PLATFORM, 0,
	CVGetZipName, cv_flstoryRomInfo, cv_flstoryRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Fantasy (HB)
static struct BurnRomInfo cv_fantasyRomDesc[] = {
	{ "Fantasy (1981-2025)(CollectorVision).rom",	131072, 0x45dd259a, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_fantasy, cv_fantasy, cv_coleco)
STD_ROM_FN(cv_fantasy)

struct BurnDriver BurnDrvcv_fantasy = {
	"cv_fantasy", NULL, "cv_coleco", NULL, "1981-2025",
	"Fantasy (HB)\0", "Published by CollectorVision Games", "SNK", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION | GBF_ADV, 0,
	CVGetZipName, cv_fantasyRomInfo, cv_fantasyRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Fireworks Factory (HB)
static struct BurnRomInfo cv_ffactoryRomDesc[] = {
	{ "Fireworks Factory (1984)(Nice Ideas).rom",	24576, 0x9425a648, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_ffactory, cv_ffactory, cv_coleco)
STD_ROM_FN(cv_ffactory)

struct BurnDriver BurnDrvcv_ffactory = {
	"cv_ffactory", NULL, "cv_coleco", NULL, "1984",
	"Fireworks Factory (HB)\0", NULL, "Nice Ideas", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
	CVGetZipName, cv_ffactoryRomInfo, cv_ffactoryRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Food Fight (HB)
static struct BurnRomInfo cv_foodfightRomDesc[] = {
    { "Food Fight (2021)(CollectorVision).rom",	32643, 0xb5447ec5, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_foodfight, cv_foodfight, cv_coleco)
STD_ROM_FN(cv_foodfight)

struct BurnDriver BurnDrvcv_foodfight = {
    "cv_foodfight", NULL, "cv_coleco", NULL, "2021",
    "Food Fight (HB)\0", NULL, "CollectorVision Games", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
    CVGetZipName, cv_foodfightRomInfo, cv_foodfightRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
// Front Line (SGM) (HB)
static struct BurnRomInfo cv_frontlinsgmRomDesc[] = {
	{ "Front Line SGM (2019)(Opcode Games).rom",	65536, 0xe544a5f9, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_frontlinsgm, cv_frontlinsgm, cv_coleco)
STD_ROM_FN(cv_frontlinsgm)

struct BurnDriver BurnDrvcv_frontlinsgm = {
	"cv_frontlinsgm", NULL, "cv_coleco", NULL, "1984-2019",
	"Front Line (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - Taito", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_RUNGUN, 0,
	CVGetZipName, cv_frontlinsgmRomInfo, cv_frontlinsgmRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Game & Watch Collection (HB, v0.33)
static struct BurnRomInfo cv_gamewatchRomDesc[] = {
	{ "Game & Watch Collection v0.33 (2025)(Electric Dreams).rom",	131072, 0x2f3a1c8d, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_gamewatch, cv_gamewatch, cv_coleco)
STD_ROM_FN(cv_gamewatch)

struct BurnDriver BurnDrvcv_gamewatch = {
	"cv_gamewatch", NULL, "cv_coleco", NULL, "2025",
	"Game & Watch Collection (HB, v0.33)\0", NULL, "Electric Dreams", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
	CVGetZipName, cv_gamewatchRomInfo, cv_gamewatchRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_ggarden = {
    ...
    "Girl's Garden (HB)\0", "Published by Team Pixelboy", "Sega - Bruce Tomlin", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
struct BurnDriver BurnDrvcv_golgo13 = {
    ...
    "Golgo 13 (HB)\0", "Published by Team Pixelboy", "Sega - Eduardo Mello", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_SHOOT, 0,
...
struct BurnDriver BurnDrvcv_gulkave = {
    ...
    "Gulkave (HB)\0", "Published by Team Pixelboy", "Sega - Eduardo Mello", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_HORSHOOT, 0,
...
// Guntus (HB)
static struct BurnRomInfo cv_guntusRomDesc[] = {
	{ "Guntus (2022)(Inufuto).rom",	11740, 0x64488291, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_guntus, cv_guntus, cv_coleco)
STD_ROM_FN(cv_guntus)

struct BurnDriver BurnDrvcv_guntus = {
	"cv_guntus", NULL, "cv_coleco", NULL, "2023",
	"Guntus (HB)\0", NULL, "Inufuto", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_VERSHOOT, 0,
	CVGetZipName, cv_guntusRomInfo, cv_guntusRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Hamurabi (The Sumer Game) (HB)
static struct BurnRomInfo cv_hamurabiRomDesc[] = {
	{ "Hamurabi (The Sumer Game) (2025)(Electric Dreams).rom",	9744, 0xcd4328ce, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_hamurabi, cv_hamurabi, cv_coleco)
STD_ROM_FN(cv_hamurabi)

struct BurnDriver BurnDrvcv_hamurabi = {
	"cv_hamurabi", NULL, "cv_coleco", NULL, "2025",
	"Hamurabi (The Sumer Game) (HB)\0", NULL, "Electric Dreams", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_STRATEGY, 0,
	CVGetZipName, cv_hamurabiRomInfo, cv_hamurabiRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Hang-On II (HB)
static struct BurnRomInfo cv_hangon2RomDesc[] = {
    { "Hang-On II (1985-2016)(CollectorVision).rom",	32768, 0x27818d93, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_hangon2, cv_hangon2, cv_coleco)
STD_ROM_FN(cv_hangon2)

struct BurnDriver BurnDrvcv_hangon2 = {
    "cv_hangon2", NULL, "cv_coleco", NULL, "1985-2016",
    "Hang-On II (HB)\0", "Published by CollectorVision Games", "Sega", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_RACING, 0,
    CVGetZipName, cv_hangon2RomInfo, cv_hangon2RomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
STDROMPICKEXT(cv_hardhatmack, cv_hardhatmack, cv_coleco)
STD_ROM_FN(cv_hardhatmack)

struct BurnDriver BurnDrvcv_hardhatmack = {
	"cv_hardhatmack", NULL, "cv_coleco", NULL, "1983-2023",
	"Hard Hat Mack (SGM) (HB)\0", "SGM - Published by CollectorVision Games", "Electronic Arts", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
	CVGetZipName, cv_hardhatmackRomInfo, cv_hardhatmackRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Jet Ready (HB)
static struct BurnRomInfo cv_jetreadyRomDesc[] = {
	{ "Jet Ready (2019)(CollectorVision - Maltanto).rom",	32768, 0x90a15086, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_jetready, cv_jetready, cv_coleco)
STD_ROM_FN(cv_jetready)

struct BurnDriver BurnDrvcv_jetready = {
	"cv_jetready", NULL, "cv_coleco", NULL, "2019",
	"Jet Ready (HB)\0", "Published by CollectorVision Games", "Maltanto", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PLATFORM, 0,
	CVGetZipName, cv_jetreadyRomInfo, cv_jetreadyRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Jewel Panic (HB)
static struct BurnRomInfo cv_jewelpanicRomDesc[] = {
	{ "Jewel Panic (2020)(Team Pixelboy).rom",	65536, 0x9f74b0e9, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_jewelpanic, cv_jewelpanic, cv_coleco)
STD_ROM_FN(cv_jewelpanic)

struct BurnDriver BurnDrvcv_jewelpanic = {
	"cv_jewelpanic", NULL, "cv_coleco", NULL, "2020",
	"Jewel Panic (HB)\0", NULL, "Team Pixelboy", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PUZZLE, 0,
	CVGetZipName, cv_jewelpanicRomInfo, cv_jewelpanicRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitI2C, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Joe The Eskimo (HB, Prototype)
static struct BurnRomInfo cv_joeskimoRomDesc[] = {
	{ "Joe The Eskimo (Proto)(2022)(8 bit Milli Games).rom", 32768, 0xc644860a, BRF_ESS | BRF_PRG },
};

STDROMPICKEXT(cv_joeskimo, cv_joeskimo, cv_coleco)
STD_ROM_FN(cv_joeskimo)

struct BurnDriver BurnDrvcv_joeskimo = {
	"cv_joeskimo", NULL, "cv_coleco", NULL, "2022",
	"Joe The Eskimo (HB, Prototype)\0", NULL, "8 bit Milli Games", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_PROTOTYPE | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
	CVGetZipName, cv_joeskimoRomInfo, cv_joeskimoRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
static struct BurnRomInfo cv_junkwallRomDesc[] = {
    { "Junkwall (2016)(CollectorVision - Silicon Sex).rom",	0x08000, 0x28257c4a, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_junkwall = {
    ...
    "Junkwall (HB)\0", "Published by CollectorVision Games", "Silicon Sex", "ColecoVision",
    L"Junkwall (HB)\0\u30b8\u30e3\u30f3\u30af\u58c1\0", NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
...
// Killer Instinct (HB, Demo)
static struct BurnRomInfo cv_kinstinctRomDesc[] = {
    { "Killer Instinct (Demo) (1997)(Daniel Bienvenu).rom",	9494, 0x58f10c63, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_kinstinct, cv_kinstinct, cv_coleco)
STD_ROM_FN(cv_kinstinct)

struct BurnDriver BurnDrvcv_kinstinct = {
    "cv_kinstinct", NULL, "cv_coleco", NULL, "1997",
    "Killer Instinct (HB, Demo)\0", NULL, "Daniel Bienvenu", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_DEMO | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_SHOOT, 0,
    CVGetZipName, cv_kinstinctRomInfo, cv_kinstinctRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_kungfumstr = {
    ...
    "Kung-Fu Master (SGM) (HB)\0", "SGM - Published by CollectorVision Games", "Irem Corp.", "ColecoVision",
    L"Kung-Fu Master (SGM) (HB)\0\u8056\u62f3\u30a2\u30c1\u30e7\u30fc\0", NULL, NULL, NULL,
...
struct BurnDriver BurnDrvcv_loder2013 = {
	...
	"Lode Runner 2013 (HB)\0", NULL, "CollectorVision Games", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
// Lunar Ball (SGM) (HB)
static struct BurnRomInfo cv_lunarballRomDesc[] = {
	{ "Lunar Ball SGM (1985-2023)(CollectorVision).rom",	32768, 0xe7922c9b, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_lunarball, cv_lunarball, cv_coleco)
STD_ROM_FN(cv_lunarball)

struct BurnDriver BurnDrvcv_lunarball = {
	"cv_lunarball", NULL, "cv_coleco", NULL, "1985-2023",
	"Lunar Ball (SGM) (HB)\0", "SGM - Published by CollectorVision Games", "Pony", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_SPORTSMISC, 0,
	CVGetZipName, cv_lunarballRomInfo, cv_lunarballRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Lunar Leeper (HB)
static struct BurnRomInfo cv_lunaleepRomDesc[] = {
	{ "Lunar Leeper (1982-2019)(Nanochess).rom",	32768, 0x6cab2432, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_lunaleep, cv_lunaleep, cv_coleco)
STD_ROM_FN(cv_lunaleep)

struct BurnDriver BurnDrvcv_lunaleep = {
	"cv_lunaleep", NULL, "cv_coleco", NULL, "1982-2019",
	"Lunar Leeper (HB)\0", NULL, "Sierra On-Line - Nanochess", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_HORSHOOT, 0,
	CVGetZipName, cv_lunaleepRomInfo, cv_lunaleepRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_magtree = {
    "cv_magtree", NULL, "cv_coleco", NULL, "1984-2006",
    "Magical Tree (HB)\0", NULL, "Opcode Games - Konami", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
static struct BurnRomInfo cv_magtreepRomDesc[] = {
    { "Magical Tree (Proto)(2004)(Opcode Games).rom",	32768, 0x9f53f9cc, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_magtreep, cv_magtreep, cv_coleco)
STD_ROM_FN(cv_magtreep)

struct BurnDriver BurnDrvcv_magtreep = {
    "cv_magtreep", "cv_magtree", "cv_coleco", NULL, "1984-2004",
    "Magical Tree (HB, Prototype)\0", NULL, "Opcode Games - Konami", "ColecoVision",
    NULL, NULL, NULL, NULL,
...
static struct BurnRomInfo cv_MkidwizRomDesc[] = {
	{ "Magical Kid WIZ SGM (2018)(Opcode Games).rom", 131072, 0xaeefdb96, BRF_ESS | BRF_PRG },
};
...
struct BurnDriver BurnDrvcv_Mkidwiz = {
	"cv_mkidwiz", NULL, "cv_coleco", NULL, "1986-2018",
	"Magical Kid WIZ (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - Sony", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 1, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
// Masters of the Universe: The Power of He-Man (HB)
static struct BurnRomInfo cv_mastersRomDesc[] = {
	{ "Masters of the Universe - The Power of He-Man (1983-2022)(CollectorVision).rom",	32768, 0x838a9742, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_masters = {
	"cv_masters", NULL, "cv_coleco", NULL, "1983-2022",
	"Masters of the Universe: The Power of He-Man (HB)\0", "Published by CollectorVision Games", "Mattel Electronics", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION | GBF_HORSHOOT, 0,
...
// Math Quest (SGM) (HB)
static struct BurnRomInfo cv_mathquestRomDesc[] = {
	{ "Math Quest SGM (2021)(CollectorVision).rom",	32768, 0x0d5581cb, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_mathquest, cv_mathquest, cv_coleco)
STD_ROM_FN(cv_mathquest)

struct BurnDriver BurnDrvcv_mathquest = {
	"cv_mathquest", NULL, "cv_coleco", NULL, "2021",
	"Math Quest (SGM) (HB)\0", "SGM - Published by CollectorVision Games", "Paul Crowley", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_MISC, 0,
	CVGetZipName, cv_mathquestRomInfo, cv_mathquestRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_mecha8 = {
	...
	NULL, NULL, L"\u00d3scar Toledo G.", NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_VERSHOOT, 0,
...
struct BurnDriver BurnDrvcv_mikie = {
	...
	"Mikie (HB)\0", "Published by Team Pixelboy", "Sega", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_ACTION, 0,
...
struct BurnDriver BurnDrvcv_mobplansty = {
    ...
    L"Mobile Planet Styllus (SGM) (HB)\0\u6a5f\u52d5\u60d1\u661f \u30b9\u30c6\u30a3\u30eb\u30b9\0", NULL, NULL, NULL,
...
// Mouser (SGM) (HB)
static struct BurnRomInfo cv_mouserRomDesc[] = {
	{ "Mouser SGM (2017)(Opcode Games).rom", 32768, 0xb9a8d81e, BRF_ESS | BRF_PRG },
};

STDROMPICKEXT(cv_mouser, cv_mouser, cv_coleco)
STD_ROM_FN(cv_mouser)

struct BurnDriver BurnDrvcv_mouser = {
	"cv_mouser", NULL, "cv_coleco", NULL, "1983-2017",
	"Mouser (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - UPL", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
	CVGetZipName, cv_mouserRomInfo, cv_mouserRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
static struct BurnRomInfo cv_multiverseRomDesc[] = {
    { "MultiVerse (2019)(Team Pixelboy - Hikaru Games).rom",	32768, 0xd45475ac, BRF_PRG | BRF_ESS },
};
...
static struct BurnRomInfo cv_nibbliRomDesc[] = {
    { "Nibbli - Son of Nibbler (2014)(CollectorVision).rom",	0x08000, 0x41555f66, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_ninjaprincess = {
    ...
    "Ninja Princess (SGM) (HB)\0", "SGM - Published by Team Pixelboy", "Sega - Eduardo Mello", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_RUNGUN, 0,
...
// Oil Panic (HB, v0.72)
static struct BurnRomInfo cv_oilpanicRomDesc[] = {
	{ "Oil Panic v0.72 (2026)(Electric Dreams).rom",	24576, 0x4dc66df0, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_oilpanic, cv_oilpanic, cv_coleco)
STD_ROM_FN(cv_oilpanic)

struct BurnDriver BurnDrvcv_oilpanic = {
	"cv_oilpanic", NULL, "cv_coleco", NULL, "2026",
	"Oil Panic (HB, v0.72)\0", NULL, "Electric Dreams", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
	CVGetZipName, cv_oilpanicRomInfo, cv_oilpanicRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
static struct BurnRomInfo cv_opwolfRomDesc[] = {
    { "Operation Wolf SGM (2016)(Team Pixelboy - Lemonize).rom",	0x8000, 0xc177bfd4, BRF_PRG | BRF_ESS },
};
...
// Osotos (HB)
static struct BurnRomInfo cv_osotosRomDesc[] = {
	{ "Osotos (2024)(Inufuto).rom",	9398, 0x8c5b9d1f, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_osotos, cv_osotos, cv_coleco)
STD_ROM_FN(cv_osotos)

struct BurnDriver BurnDrvcv_osotos = {
...
static struct BurnRomInfo cv_pangRomDesc[] = {
	{ "Pang RC2.0 (2012)(CollectorVision).rom",	32558, 0x18aced43, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_pang = {
	...
	"Pang (HB, RC2.0)\0", NULL, "CollectorVision Games", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
...
static struct BurnRomInfo cv_peekabooRomDesc[] = {
    { "Peek-A-Boo (2010)(Team Pixelboy - Dvik & Joyrex).rom",	0x8000, 0x32c52187, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_Penguinadv = {
	...
	"Penguin Adventure (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - Konami", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
...
static struct BurnRomInfo cv_penguinlandRomDesc[] = {
    { "Penguin Land (2010)(CollectorVision - Steve Begin).rom",	31788, 0x2357c3e3, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_penguinland = {
    ...
    "Penguin Land (HB)\0", "Published by CollectorVision Games", "Steve Begin", "ColecoVision",
    NULL, NULL, L"Steve B\u00e9gin", NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
...
// Penguin Wars (SGM) (HB)
static struct BurnRomInfo cv_penguinwarsRomDesc[] = {
	{ "Penguin Wars SGM (2018)(Opcode Games).rom", 65536, 0x4008a425, BRF_ESS | BRF_PRG },
};

STDROMPICKEXT(cv_penguinwars, cv_penguinwars, cv_coleco)
STD_ROM_FN(cv_penguinwars)

struct BurnDriver BurnDrvcv_penguinwars = {
	"cv_penguinwars", NULL, "cv_coleco", NULL, "1985-2018",
	"Penguin Wars (SGM) (HB)\0", "SGM - Super Game Module", "Opcode Games - ASCII", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_ACTION | GBF_SPORTSMISC, 0,
	CVGetZipName, cv_penguinwarsRomInfo, cv_penguinwarsRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Pioneer Balloon (HB, v0.21)
static struct BurnRomInfo cv_pballoonRomDesc[] = {
	{ "Pioneer Balloon v0.21 (2025)(Electric Dreams).rom",	24576, 0x2da26709, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_pballoon, cv_pballoon, cv_coleco)
STD_ROM_FN(cv_pballoon)

struct BurnDriver BurnDrvcv_pballoon = {
	"cv_pballoon", NULL, "cv_coleco", NULL, "2025",
	"Pioneer Balloon (HB, v0.21)\0", NULL, "Electric Dreams", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_HORSHOOT, 0,
	CVGetZipName, cv_pballoonRomInfo, cv_pballoonRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_pitfall2a = {
    ...
    "Pitfall II Arcade (HB)\0", "Published by Team Pixelboy", "Sega - Stephen Seehorn", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
static struct BurnRomInfo cv_pvszRomDesc[] = {
	{ "Plants Vs Zombies (2022)(CollectorVision).rom",	32768, 0x68e6c9a1, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_pvsz, cv_pvsz, cv_coleco)
STD_ROM_FN(cv_pvsz)

struct BurnDriver BurnDrvcv_pvsz = {
	"cv_pvsz", NULL, "cv_coleco", NULL, "2022",
	"Plants Vs Zombies (HB)\0", NULL, "CollectorVision Games", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_STRATEGY, 0,
	CVGetZipName, cv_pvszRomInfo, cv_pvszRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Pong (HB)
static struct BurnRomInfo cv_pongRomDesc[] = {
	{ "Pong (2014)(CollectorVision).rom",	32750, 0x8aad0831, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_pong, cv_pong, cv_coleco)
STD_ROM_FN(cv_pong)

struct BurnDriver BurnDrvcv_pong = {
	"cv_pong", NULL, "cv_coleco", NULL, "2014",
	"Pong (HB)\0", "Published by CollectorVision Games", "Atari Games Ltd.", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_ACTION, 0,
	CVGetZipName, cv_pongRomInfo, cv_pongRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Pre-Astro (HB)
static struct BurnRomInfo cv_preastroRomDesc[] = {
    { "Pre-Astro (2025)(Haranni).rom",	30054, 0xbb02d475, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_preastro, cv_preastro, cv_coleco)
STD_ROM_FN(cv_preastro)

struct BurnDriver BurnDrvcv_preastro = {
    "cv_preastro", NULL, "cv_coleco", NULL, "2025",
    "Pre-Astro (HB)\0", NULL, "Haranni", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_HORSHOOT, 0,
    CVGetZipName, cv_preastroRomInfo, cv_preastroRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
static struct BurnRomInfo cv_puzzliRomDesc[] = {
    { "Puzzli RC1.4b (CollectorVision)(2011).rom",	32061, 0x58f53b6e, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_puzzli = {
    ...
    "Puzzli (HB, RC1.4b)\0", NULL, "CollectorVision Games", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PUZZLE, 0,
...
// Quatre (HB)
static struct BurnRomInfo cv_quatreRomDesc[] = {
	{ "Quatre (2017)(Nicam Shilova).rom",	65536, 0xb6df4148, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_quatre, cv_quatre, cv_coleco)
STD_ROM_FN(cv_quatre)

struct BurnDriver BurnDrvcv_quatre = {
	"cv_quatre", NULL, "cv_coleco", NULL, "2017",
	"Quatre (HB)\0", NULL, "Nicam Shilova", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PUZZLE, 0,
	CVGetZipName, cv_quatreRomInfo, cv_quatreRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_rtype = {
    ...
    "R-Type (SGM) (HB)\0", "SGM - Published by Team Pixelboy", "Irem Corp.", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_HORSHOOT, 0,
...
static struct BurnRomInfo cv_rallyxRomDesc[] = {
	{ "Rally-X (2026)(unhuman).rom",	131072, 0xc6b9b5a9, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_rallyx = {
	"cv_rallyx", NULL, "cv_coleco", NULL, "2026",
	"Rally-X (HB)\0", NULL, "unhuman", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION | GBF_MAZE, 0,
...
// Rally-X (SGM) (HB)
static struct BurnRomInfo cv_rallyxsgmRomDesc[] = {
    { "Rally-X SGM (2016)(Team Pixelboy).rom",	0x8000, 0xfb5dd80d, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_rallyxsgm, cv_rallyxsgm, cv_coleco)
STD_ROM_FN(cv_rallyxsgm)

struct BurnDriver BurnDrvcv_rallyxsgm = {
    "cv_rallyxsgm", NULL, "cv_coleco", NULL, "1984-2016",
    "Rally-X (SGM) (HB)\0", "SGM - Published by Team Pixelboy", "Namco", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION | GBF_MAZE, 0,
    CVGetZipName, cv_rallyxsgmRomInfo, cv_rallyxsgmRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_roadfght = {
    "cv_roadfght", NULL, "cv_coleco", NULL, "1985-2007",
...
// Ruptus (HB)
static struct BurnRomInfo cv_ruptusRomDesc[] = {
	{ "Ruptus (2022)(Inufuto).rom",	12302, 0x9aac320b, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_ruptus, cv_ruptus, cv_coleco)
STD_ROM_FN(cv_ruptus)

struct BurnDriver BurnDrvcv_ruptus = {
	"cv_ruptus", NULL, "cv_coleco", NULL, "2022",
	"Ruptus (HB)\0", NULL, "Inufuto", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_MULTISHOOT, 0,
...
// Safari Race (HB)
static struct BurnRomInfo cv_safaraceRomDesc[] = {
	{ "Safari Race (2022)(Mystery Man).rom",	32768, 0x53dc76f4, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_safarace, cv_safarace, cv_coleco)
STD_ROM_FN(cv_safarace)

struct BurnDriver BurnDrvcv_safarace = {
	"cv_safarace", NULL, "cv_coleco", NULL, "1988-2022",
	"Safari Race (HB)\0", "Published by CollectorVision Games", "Mystery Man - Sega", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_RACING, 0,
	CVGetZipName, cv_safaraceRomInfo, cv_safaraceRomName, NULL, NULL, NULL, NULL, ROLLERInputInfo, ROLLERDIPInfo,
	DrvInitROLLER, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_shouganai = {
	...
	L"Shouganai (SGM) (HB)\0\u3057\u3087\u3046\u304c\u306a\u3044\0", NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
...
// Sir Ababol (HB, 20200918)
static struct BurnRomInfo cv_sirababolRomDesc[] = {
	{ "Sir Ababol 20200918 (2020)(Cote Gamers).rom",	0x08000, 0xfd0dc225, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_sirababol = {
	...
	"Sir Ababol (HB, 20200918)\0", "Published by Cote Gamers", "The Mojon Twins - Alekmaul", "ColecoVision",
...
// Sir Ababol (HB, 20200415 v1.1)
static struct BurnRomInfo cv_sirababolaRomDesc[] = {
	{ "Sir Ababol 20200415 v1.1 (2020)(The Mojon Twins - Alekmaul).rom",	0x07fff, 0x690e8dd5, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_sirababola, cv_sirababola, cv_coleco)
STD_ROM_FN(cv_sirababola)

struct BurnDriver BurnDrvcv_sirababola = {
	"cv_sirababola", "cv_sirababol", "cv_coleco", NULL, "2020",
	"Sir Ababol (HB, 20200415 v1.1)\0", NULL, "The Mojon Twins - Alekmaul", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PLATFORM, 0,
	CVGetZipName, cv_sirababolaRomInfo, cv_sirababolaRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_skyjag = {
    "cv_skyjag", NULL, "cv_coleco", NULL, "1984-2004",
    "Sky Jaguar (HB)\0", NULL, "Opcode Games - Konami", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_VERSHOOT, 0,
...
// Super MineField (HB)
static struct BurnRomInfo cv_smfieldRomDesc[] = {
    { "Super MineField (1983-2013)(CollectorVision).rom",	13794, 0xf26ea356, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_smfield, cv_smfield, cv_coleco)
STD_ROM_FN(cv_smfield)

struct BurnDriver BurnDrvcv_smfield = {
    "cv_smfield", NULL, "cv_coleco", NULL, "1983-2013",
    "Super MineField (HB)\0", "Published by CollectorVision Games", "Memotech MTX", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PUZZLE, 0,
    CVGetZipName, cv_smfieldRomInfo, cv_smfieldRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
// Space Invaders (HB)
static struct BurnRomInfo cv_spaceinvRomDesc[] = {
    { "Space Invaders (200X)(CollectorVision Games).rom",	16384, 0x5191bba9, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_spaceinv, cv_spaceinv, cv_coleco)
STD_ROM_FN(cv_spaceinv)

struct BurnDriver BurnDrvcv_spaceinv = {
    "cv_spaceinv", NULL, "cv_coleco", NULL, "200X",
    "Space Invaders (HB)\0", "Published by CollectorVision Games", "Taito", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_VERSHOOT, 0,
    CVGetZipName, cv_spaceinvRomInfo, cv_spaceinvRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
// Space Quest: Chapter I - The Sarien Encounter (SGM) (HB)
static struct BurnRomInfo cv_spacequestRomDesc[] = {
	{ "Space Quest - Chapter I - The Sarien Encounter SGM (1986-2025)(CollectorVision).rom",	524288, 0x2a4f3b7d, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_spacequest, cv_spacequest, cv_coleco)
STD_ROM_FN(cv_spacequest)

struct BurnDriver BurnDrvcv_spacequest = {
	"cv_spacequest", NULL, "cv_coleco", NULL, "1986-2025",
	"Space Quest: Chapter I - The Sarien Encounter (SGM) (HB)\0", "SGM - Published by CollectorVision Games", "Sierra On-Line", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION | GBF_ADV, 0,
	CVGetZipName, cv_spacequestRomInfo, cv_spacequestRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Space Trouble (SGM) (HB)
static struct BurnRomInfo cv_spacetroubleRomDesc[] = {
	{ "Space Trouble SGM (2026)(kamshaft).rom",	16384, 0xfc6cac16, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_spacetrouble, cv_spacetrouble, cv_coleco)
STD_ROM_FN(cv_spacetrouble)

struct BurnDriver BurnDrvcv_spacetrouble = {
	"cv_spacetrouble", NULL, "cv_coleco", NULL, "2026",
	"Space Trouble (SGM) (HB)\0", NULL, "kamshaft", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_VERSHOOT, 0,
	CVGetZipName, cv_spacetroubleRomInfo, cv_spacetroubleRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInitSGM, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
static struct BurnRomInfo cv_starcomRomDesc[] = {
	{ "Starcom (1986-2012)(CollectorVision).rom",	32768, 0x61c98628, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_starforce = {
    ...
    "Star Force (HB)\0", "Published by Team Pixelboy", "Sega - Eduardo Mello", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_VERSHOOT, 0,
...
// Star Jump (HB)
static struct BurnRomInfo cv_starjumpRomDesc[] = {
    { "Star Jump (2013)(Nicam Shilova).rom",	11250, 0xa3e1301f, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_starjump, cv_starjump, cv_coleco)
STD_ROM_FN(cv_starjump)

struct BurnDriver BurnDrvcv_starjump = {
    "cv_starjump", NULL, "cv_coleco", NULL, "2013",
    "Star Jump (HB)\0", NULL, "Nicam Shilova", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ACTION, 0,
    CVGetZipName, cv_starjumpRomInfo, cv_starjumpRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_sudoku = {
    ...
    L"Sudoku (HB)\0\u6570\u72ec\0", NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_PUZZLE, 0,
...
// Suite Macabre (HB)
static struct BurnRomInfo cv_smacabreRomDesc[] = {
    { "Suite Macabre (2020)(CollectorVision - Maltanto).rom",	262144, 0x02a600cd, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_smacabre, cv_smacabre, cv_coleco)
STD_ROM_FN(cv_smacabre)

struct BurnDriver BurnDrvcv_smacabre = {
    "cv_smacabre", NULL, "cv_coleco", NULL, "2020",
    "Suite Macabre (HB)\0", "Published by CollectorVision Games", "Maltanto", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ADV | GBF_PLATFORM, 0,
    CVGetZipName, cv_smacabreRomInfo, cv_smacabreRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};

// Super Action Bowling (SGM) (HB)
static struct BurnRomInfo cv_sabowlingRomDesc[] = {
	{ "Super Action Bowling SGM (1986-2022)(Coleco).rom",	131072, 0x6875c8d1, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_sabowling, cv_sabowling, cv_coleco)
STD_ROM_FN(cv_sabowling)

struct BurnDriver BurnDrvcv_sabowling = {
	"cv_sabowling", NULL, "cv_coleco", NULL, "1986-2022",
	"Super Action Bowling (SGM) (HB)\0", "SGM - Published by CollectorVision Games", "Access Software", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_SPORTSMISC, 0,
	CVGetZipName, cv_sabowlingRomInfo, cv_sabowlingRomName, NULL, NULL, NULL, NULL, SACInputInfo, SACDIPInfo,
	DrvInitSAC, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Super Uwol! (HB)
static struct BurnRomInfo cv_suwolRomDesc[] = {
	{ "Super Uwol (2016-2021)(CollectorVision).rom",	131072, 0x13462ba5, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_suwol, cv_suwol, cv_coleco)
STD_ROM_FN(cv_suwol)

struct BurnDriver BurnDrvcv_suwol = {
	"cv_suwol", NULL, "cv_coleco", NULL, "2016-2021",
	"Super Uwol! (HB)\0", "Published by CollectorVision Games", "The Mojon Twins - Alekmaul", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
	CVGetZipName, cv_suwolRomInfo, cv_suwolRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Telebunny (HB, Alt)
static struct BurnRomInfo cv_telebunnyaRomDesc[] = {
    { "Telebunny (Alt)(2014)(CollectorVision).rom",	30641, 0x26896d4b, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_telebunnya, cv_telebunnya, cv_coleco)
STD_ROM_FN(cv_telebunnya)

struct BurnDriver BurnDrvcv_telebunnya = {
    "cv_telebunnya", "cv_telebunny", "cv_coleco", NULL, "2014",
    "Telebunny (HB, Alt)\0", NULL, "CollectorVision Games", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_CLONE | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_ACTION | GBF_MAZE, 0,
    CVGetZipName, cv_telebunnyaRomInfo, cv_telebunnyaRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
// Treasure Hunt (HB)
static struct BurnRomInfo cv_trehuntRomDesc[] = {
	{ "Treasure Hunt (1983-2022)(CollectorVision).rom",	20464, 0x0ac0067c, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_trehunt, cv_trehunt, cv_coleco)
STD_ROM_FN(cv_trehunt)

struct BurnDriver BurnDrvcv_trehunt = {
	"cv_trehunt", NULL, "cv_coleco", NULL, "1983-2022",
	"Treasure Hunt (HB)\0", "Published by CollectorVision Games", "Soundic", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_ACTION, 0,
	CVGetZipName, cv_trehuntRomInfo, cv_trehuntRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};

// Tunnels & Trolls (HB, Demo)
static struct BurnRomInfo cv_tunnelstrollsRomDesc[] = {
	{ "Tunnels & Trolls (Demo) (2010)(CollectorVision Games).rom",	16384, 0xa82ca225, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_tunnelstrolls, cv_tunnelstrolls, cv_coleco)
STD_ROM_FN(cv_tunnelstrolls)

struct BurnDriver BurnDrvcv_tunnelstrolls = {
	"cv_tunnelstrolls", NULL, "cv_coleco", NULL, "2010",
	"Tunnels & Trolls (HB, Demo)\0", "Not playable Demo", "Coleco", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_DEMO | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_MISC, 0,
	CVGetZipName, cv_tunnelstrollsRomInfo, cv_tunnelstrollsRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Victory S.C.E. (Hack)
static struct BurnRomInfo cv_victorysceRomDesc[] = {
	{ "Victory S.C.E. (2010)(Daniel Bienvenu).rom",	19506, 0x4157b347, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_victorysce, cv_victorysce, cv_coleco)
STD_ROM_FN(cv_victorysce)

struct BurnDriver BurnDrvcv_victorysce = {
	"cv_victorysce", "cv_victory", "cv_coleco", NULL, "2010",
	"Victory S.C.E. (Hack, Standard Controller Edition)\0", NULL, "Daniel Bienvenu", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK, 2, HARDWARE_COLECO, GBF_MULTISHOOT, 0,
...
// Warren Cave (HB)
static struct BurnRomInfo cv_warrencaveRomDesc[] = {
	{ "Warren Cave (2026)(Electric Dreams).rom",	16384, 0xa2351d5b, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_warrencave, cv_warrencave, cv_coleco)
STD_ROM_FN(cv_warrencave)

struct BurnDriver BurnDrvcv_warrencave = {
	"cv_warrencave", NULL, "cv_coleco", NULL, "2026",
	"Warren Cave (HB)\0", NULL, "Electric Dreams", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_ADV, 0,
	CVGetZipName, cv_warrencaveRomInfo, cv_warrencaveRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
	DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
	272, 228, 4, 3
};
...
// Wild Western (Prototype)
static struct BurnRomInfo cv_wwesternRomDesc[] = {
    { "Wild Western (Proto) (1984)(Taito).rom",	32768, 0x7dc4d155, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_wwestern, cv_wwestern, cv_coleco)
STD_ROM_FN(cv_wwestern)

struct BurnDriver BurnDrvcv_wwestern = {
    "cv_wwestern", NULL, "cv_coleco", NULL, "1984",
    "Wild Western (Prototype)\0", NULL, "Taito", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_PROTOTYPE, 1, HARDWARE_COLECO, GBF_SHOOT, 0,
    CVGetZipName, cv_wwesternRomInfo, cv_wwesternRomName, NULL, NULL, NULL, NULL, ColecoInputInfo, ColecoDIPInfo,
    DrvInit, DrvExit, DrvFrame, TMS9928ADraw, DrvScan, NULL, TMS9928A_PALETTE_SIZE,
    272, 228, 4, 3
};
...
struct BurnDriver BurnDrvcv_wonderboy = {
    ...
    "Wonder Boy (SGM) (HB)\0", "Published by Team Pixelboy", "Sega - Eduardo Mello", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PLATFORM, 0,
...
// Wordle (HB, v1.7)
static struct BurnRomInfo cv_wordleRomDesc[] = {
	{ "Wordle v1.7 (2022)(CollectorVision).rom",	32768, 0x35db2611, BRF_PRG | BRF_ESS },
};

STDROMPICKEXT(cv_wordle, cv_wordle, cv_coleco)
STD_ROM_FN(cv_wordle)

struct BurnDriver BurnDrvcv_wordle = {
	"cv_wordle", NULL, "cv_coleco", NULL, "2022",
	"Wordle (HB, v1.7)\0", "Published by CollectorVision Games", "Dragon Fly Amusement", "ColecoVision",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_HOMEBREW, 2, HARDWARE_COLECO, GBF_PUZZLE, 0,
...
static struct BurnRomInfo cv_yieariiRomDesc[] = {
    { "Yie Ar Kung Fu II SGM (2018)(Opcode Games).rom",	65536, 0xf5f722df, BRF_PRG | BRF_ESS },
};
...
static struct BurnRomInfo cv_zippyracRomDesc[] = {
    { "Zippy Race (2009)(Dvik & Joyrex).rom",	32768, 0x44e6948c, BRF_PRG | BRF_ESS },
};
...
struct BurnDriver BurnDrvcv_zippyrac = {
    ...
    "Zippy Race (HB)\0", "Published by CollectorVision Games", "Dvik & Joyrex - Sega", "ColecoVision",
    NULL, NULL, NULL, NULL,
    BDF_GAME_WORKING | BDF_HOMEBREW, 1, HARDWARE_COLECO, GBF_RACING, 0,
