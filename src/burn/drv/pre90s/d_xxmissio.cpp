...
{
	DIP_OFFSET(0x10)
	{0x00, 0xff, 0xff, 0xd7, nullptr},
	{0x01, 0xff, 0xff, 0xef, nullptr},
	...
	case 0xa002:
		{
			...
			switch (data)
			{
			case 0x00: cpu_status |= 0x20;
				break;
			case 0x80: cpu_status |= 0x04;
				break;
	...
	case 0xa002:
		{
			...
			switch (data)
			{
			case 0x00: cpu_status |= 0x10;
				break;
			case 0x40: cpu_status |= 0x08;
				break;
...
struct BurnDriver BurnDrvXxmissio = {
	"xxmissio", nullptr, nullptr, nullptr, "1986",
	"XX Mission\0", nullptr, "UPL", "Miscellaneous",
	...
	nullptr, xxmissioRomInfo, xxmissioRomName, nullptr, nullptr, nullptr, nullptr, XxmissioInputInfo, XxmissioDIPInfo,
