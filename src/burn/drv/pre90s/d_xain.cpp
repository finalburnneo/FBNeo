...
static void xain_main_write(UINT16 address, UINT8 data)
{
	...
	case 0x3a04:
	case 0x3a05:
		scrollx[((address / 4) & 1) ^ 1] = ((data << ((address & 1) * 8)) | (scrollx[((address / 4) & 1) ^ 1] & (0xff00
			>> ((address & 1) * 8)))) & 0x1ff;
		return;
	...
	case 0x3a06:
	case 0x3a07:
		scrolly[((address / 4) & 1) ^ 1] = ((data << ((address & 1) * 8)) | (scrolly[((address / 4) & 1) ^ 1] & (0xff00
			>> ((address & 1) * 8)))) & 0x1ff;
		return;
...
static INT32 DrvDraw()
{
	...
	constexpr INT32 lut[8][4] = {
		{0, 1, 2, 3}, {1, 0, 2, 3}, {3, 0, 2, 1},
	...
	for (INT32 i = 0; i < 4; i++)
	{
		if ((lut[xain_pri & 0x07][i] == 0) && (nBurnLayer & 1)) GenericTilemapDraw(
			1, 0, (i == 0) ? TMAP_FORCEOPAQUE : 0);
		if ((lut[xain_pri & 0x07][i] == 1) && (nBurnLayer & 2)) GenericTilemapDraw(
			2, 0, (i == 0) ? TMAP_FORCEOPAQUE : 0);
		if ((lut[xain_pri & 0x07][i] == 2) && (nSpriteEnable & 1)) draw_sprites();
		if ((lut[xain_pri & 0x07][i] == 3) && (nBurnLayer & 4)) GenericTilemapDraw(
			0, 0, (i == 0) ? TMAP_FORCEOPAQUE : 0);
	}
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[4] = {
		static_cast<INT32>((double)1500000 / 57.44), static_cast<INT32>((double)1500000 / 57.44),
		static_cast<INT32>((double)1500000 / 57.44), static_cast<INT32>((double)3000000 / 57.44)
	};
...
struct BurnDriver BurnDrvXsleena = {
	"xsleena", nullptr, nullptr, nullptr, "1986",
	"Xain'd Sleena (World)\0", nullptr, "Technos Japan (Taito license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_TECHNOS, GBF_RUNGUN, 0,
	nullptr, xsleenaRomInfo, xsleenaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvXsleenaj = {
	"xsleenaj", "xsleena", nullptr, nullptr, "1986",
	"Xain'd Sleena (Japan)\0", nullptr, "Technos Japan", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_TECHNOS, GBF_RUNGUN, 0,
	nullptr, xsleenajRomInfo, xsleenajRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 0x200,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvSolrwarr = {
	"solrwarr", "xsleena", nullptr, nullptr, "1986",
	"Solar-Warrior (US)\0", nullptr, "Technos Japan (Taito / Memetron license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_TECHNOS, GBF_RUNGUN, 0,
	nullptr, solrwarrRomInfo, solrwarrRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 0x200,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvXsleenab = {
	"xsleenab", "xsleena", nullptr, nullptr, "1986",
	"Xain'd Sleena (bootleg, set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_TECHNOS, GBF_RUNGUN, 0,
	nullptr, xsleenabRomInfo, xsleenabRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 0x200,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvXsleenaba = {
	"xsleenaba", "xsleena", nullptr, nullptr, "1987",
	"Xain'd Sleena (bootleg, bugfixed)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_TECHNOS, GBF_RUNGUN, 0,
	nullptr, xsleenabaRomInfo, xsleenabaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 0x200,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvXsleenabb = {
	"xsleenabb", "xsleena", nullptr, nullptr, "1987",
	"Xain'd Sleena (bootleg, set 2)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_TECHNOS, GBF_RUNGUN, 0,
	nullptr, xsleenabbRomInfo, xsleenabbRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 0x200,
	256, 240, 4, 3
};
