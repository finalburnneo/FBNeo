...
{
	{0x0c, 0xff, 0xff, 0xbf, nullptr},
	{0x0d, 0xff, 0xff, 0x80, nullptr},
...
static INT32 MemIndex()
{
	...
	DrvGfxROM0 = Next;
	Next += nGraphicsLen0 * 2 * 2 * 2;
	DrvGfxROM1 = Next;
	Next += nGraphicsLen1 * 2;
	...
	DrvNVRAM = Next;
	Next += 0x000800; // this is work-ram and nvram (HS, service mode options)
	...
	Next += 0x000800;
	DrvZ80RAM1 = Next;
	Next += 0x001000; // 0x400 ssio, 0x1000 tcs
	DrvPalRAM16 = (UINT16*)Next;
	Next += 0x40 * sizeof(UINT16);
...
static INT32 DrvGfxDecode()
{
	...
	auto tmp = BurnMalloc((nGraphicsLen1 > nGraphicsLen0) ? nGraphicsLen1 : nGraphicsLen0);
	if (tmp == nullptr)
	{
		return 1;
	}
	...
	for (INT32 i = 0; i < nGraphicsLen0 * 2; i += 0x40)
	{
...
static INT32 DrvInit(INT32 cpu_board)
{
	...
	DrvZ80ROM0 = DrvZ80ROM1 = DrvTCSROM = nullptr;
	DrvGfxROM0 = DrvGfxROM1 = nullptr;
	...
	z80ctc_init(nMainClock, 0, ctc_interrupt, ctc_trigger, nullptr, nullptr);
...
static INT32 DrvDraw()
{
	...
	{
		if (nSpriteEnable & 1) render_sprites_91464((sprite_config >> 16) & 0xff, (sprite_config >> 8) & 0xff,
		                                            sprite_config & 0xff);
	}
...
struct BurnDriver BurnDrvSsioprom = {
	"midssio", nullptr, nullptr, nullptr, "1981",
	...
	nullptr, SsiopromRomInfo, SsiopromRomName, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
...
struct BurnDriver BurnDrvSolarfox = {
	"solarfox", nullptr, "midssio", nullptr, "1981",
	"Solar Fox (upright)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_MAZE | GBF_ACTION, 0,
	nullptr, solarfoxRomInfo, solarfoxRomName, nullptr, nullptr, nullptr, nullptr, SolarfoxInputInfo, SolarfoxDIPInfo,
...
struct BurnDriver BurnDrvKick = {
	"kick", nullptr, "midssio", nullptr, "1981",
	"Kick (upright)\0", nullptr, "Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_BREAKOUT, 0,
	nullptr, kickRomInfo, kickRomName, nullptr, nullptr, nullptr, nullptr, KickInputInfo, KickDIPInfo,
...
struct BurnDriver BurnDrvKickman = {
	"kickman", "kick", "midssio", nullptr, "1981",
	"Kickman (upright)\0", nullptr, "Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_BREAKOUT, 0,
	nullptr, kickmanRomInfo, kickmanRomName, nullptr, nullptr, nullptr, nullptr, KickInputInfo, KickDIPInfo,
	KickInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x20,
	480, 512, 3, 4
};
...
struct BurnDriver BurnDrvKickc = {
	"kickc", "kick", "midssio", nullptr, "1981",
	"Kick (cocktail)\0", nullptr, "Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_BREAKOUT, 0,
	nullptr, kickcRomInfo, kickcRomName, nullptr, nullptr, nullptr, nullptr, KickInputInfo, KickDIPInfo,
	//, KickcInputInfo, KickcDIPInfo,
...
struct BurnDriverD BurnDrvDpoker = {
	"dpoker", nullptr, "midssio", nullptr, "1985",
	"Draw Poker (Bally, 03-20)\0", nullptr, "Bally", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_CASINO, 0,
	nullptr, dpokerRomInfo, dpokerRomName, nullptr, nullptr, nullptr, nullptr, KickInputInfo, KickDIPInfo,
	//DpokerInputInfo, DpokerDIPInfo,
...
struct BurnDriver BurnDrvShollow = {
	"shollow", nullptr, "midssio", nullptr, "1981",
	"Satan's Hollow (set 1)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION | GBF_SHOOT, 0,
	nullptr, shollowRomInfo, shollowRomName, nullptr, nullptr, nullptr, nullptr, ShollowInputInfo, ShollowDIPInfo,
...
struct BurnDriver BurnDrvShollow2 = {
	"shollow2", "shollow", "midssio", nullptr, "1981",
	"Satan's Hollow (set 2)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION | GBF_SHOOT, 0,
	nullptr, shollow2RomInfo, shollow2RomName, nullptr, nullptr, nullptr, nullptr, ShollowInputInfo, ShollowDIPInfo,
	ShollowInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	480, 512, 3, 4
};
...
struct BurnDriver BurnDrvTron = {
	"tron", nullptr, "midssio", nullptr, "1982",
	"Tron (8/9)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, tronRomInfo, tronRomName, nullptr, nullptr, nullptr, nullptr, TronInputInfo, TronDIPInfo,
...
struct BurnDriver BurnDrvTron2 = {
	"tron2", "tron", "midssio", nullptr, "1982",
	"Tron (6/25)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION, 0,
	nullptr, tron2RomInfo, tron2RomName, nullptr, nullptr, nullptr, nullptr, TronInputInfo, TronDIPInfo,
	TronInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	480, 512, 3, 4
};
...
struct BurnDriver BurnDrvTron3 = {
	"tron3", "tron", "midssio", nullptr, "1982",
	"Tron (6/17)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION, 0,
	nullptr, tron3RomInfo, tron3RomName, nullptr, nullptr, nullptr, nullptr, TronInputInfo, TronDIPInfo,
	// Tron3InputInfo, Tron3DIPInfo,
	TronInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	480, 512, 3, 4
};
...
struct BurnDriver BurnDrvTron4 = {
	"tron4", "tron", "midssio", nullptr, "1982",
	"Tron (6/15)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION, 0,
	nullptr, tron4RomInfo, tron4RomName, nullptr, nullptr, nullptr, nullptr, TronInputInfo, TronDIPInfo,
	//, Tron3InputInfo, Tron3DIPInfo,
	TronInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	480, 512, 3, 4
};
...
struct BurnDriver BurnDrvTron5 = {
	"tron5", "tron", "midssio", nullptr, "1982",
	"Tron (5/12)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION, 0,
	nullptr, tron5RomInfo, tron5RomName, nullptr, nullptr, nullptr, nullptr, TronInputInfo, TronDIPInfo,
	//, Tron3InputInfo, Tron3DIPInfo,
	TronInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	480, 512, 3, 4
};
...
struct BurnDriver BurnDrvTronger = {
	"tronger", "tron", "midssio", nullptr, "1982",
	"Tron (Germany)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION, 0,
	nullptr, trongerRomInfo, trongerRomName, nullptr, nullptr, nullptr, nullptr, TronInputInfo, TronDIPInfo,
	//, Tron3InputInfo, Tron3DIPInfo,
	TronInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	480, 512, 3, 4
};
...
struct BurnDriver BurnDrvDomino = {
	"domino", nullptr, "midssio", nullptr, "1982",
	"Domino Man (set 1)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_PUZZLE, 0,
	nullptr, dominoRomInfo, dominoRomName, nullptr, nullptr, nullptr, nullptr, DominoInputInfo, DominoDIPInfo,
...
struct BurnDriver BurnDrvDominoa = {
	"dominoa", "domino", "midssio", nullptr, "1982",
	"Domino Man (set 2)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_PUZZLE, 0,
	nullptr, dominoaRomInfo, dominoaRomName, nullptr, nullptr, nullptr, nullptr, DominoInputInfo, DominoDIPInfo,
	DominoInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvWacko = {
	"wacko", nullptr, "midssio", nullptr, "1982",
	"Wacko\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_ACTION, 0,
	nullptr, wackoRomInfo, wackoRomName, nullptr, nullptr, nullptr, nullptr, WackoInputInfo, WackoDIPInfo,
...
struct BurnDriver BurnDrvTwotiger = {
	"twotiger", nullptr, "midssio", "twotiger", "1984",
	"Two Tigers (dedicated)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, twotigerRomInfo, twotigerRomName, nullptr, nullptr, TwotigerSampleInfo, TwotigerSampleName,
	TwotigerInputInfo, TwotigerDIPInfo,
...
struct BurnDriverD BurnDrvTwotigerc = {
	"twotigerc", "twotiger", "midssio", nullptr, "1984",
	"Two Tigers (Tron conversion)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, twotigercRomInfo, twotigercRomName, nullptr, nullptr, nullptr, nullptr, TronInputInfo, TronDIPInfo,
	//, TwotigrcInputInfo, TwotigrcDIPInfo,
...
struct BurnDriver BurnDrvTapper = {
	"tapper", nullptr, "midssio", nullptr, "1983",
	"Tapper (Budweiser, 1/27/84)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, tapperRomInfo, tapperRomName, nullptr, nullptr, nullptr, nullptr, TapperInputInfo, TapperDIPInfo,
...
struct BurnDriver BurnDrvTapperg = {
	"tapperg", "tapper", "midssio", nullptr, "1983",
	"Tapper (Budweiser, 1/27/84 - Alternate graphics)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, tappergRomInfo, tappergRomName, nullptr, nullptr, nullptr, nullptr, TapperInputInfo, TapperDIPInfo,
	TapperInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvTappera = {
	"tappera", "tapper", "midssio", nullptr, "1983",
	"Tapper (Budweiser, 1/12/84)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, tapperaRomInfo, tapperaRomName, nullptr, nullptr, nullptr, nullptr, TapperInputInfo, TapperDIPInfo,
	TapperInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvTapperb = {
	"tapperb", "tapper", "midssio", nullptr, "1983",
	"Tapper (Budweiser, 12/9/83)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, tapperbRomInfo, tapperbRomName, nullptr, nullptr, nullptr, nullptr, TapperInputInfo, TapperDIPInfo,
	TapperInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvSutapper = {
	"sutapper", "tapper", "midssio", nullptr, "1983",
	"Tapper (Suntory)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, sutapperRomInfo, sutapperRomName, nullptr, nullptr, nullptr, nullptr, TapperInputInfo, TapperDIPInfo,
	TapperInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvRbtapper = {
	"rbtapper", "tapper", "midssio", nullptr, "1984",
	"Tapper (Root Beer)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, rbtapperRomInfo, rbtapperRomName, nullptr, nullptr, nullptr, nullptr, TapperInputInfo, TapperDIPInfo,
	TapperInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvKroozr = {
	"kroozr", nullptr, "midssio", nullptr, "1982",
	"Kozmik Kroozr\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_SHOOT, 0,
	nullptr, kroozrRomInfo, kroozrRomName, nullptr, nullptr, nullptr, nullptr, KroozrInputInfo, KroozrDIPInfo,
...
struct BurnDriver BurnDrvJourney = {
	"journey", nullptr, "midssio", "journey", "1983",
	"Journey\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, journeyRomInfo, journeyRomName, nullptr, nullptr, JourneySampleInfo, JourneySampleName, JourneyInputInfo,
	JourneyDIPInfo,
...
struct BurnDriver BurnDrvTimber = {
	"timber", nullptr, "midssio", nullptr, "1984",
	"Timber\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, timberRomInfo, timberRomName, nullptr, nullptr, nullptr, nullptr, TimberInputInfo, TimberDIPInfo,
...
struct BurnDriver BurnDrvDotron = {
	"dotron", nullptr, "midssio", nullptr, "1983",
	"Discs of Tron (Upright, 10/4/83)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_SHOOT, 0,
	nullptr, dotronRomInfo, dotronRomName, nullptr, nullptr, nullptr, nullptr, DotronInputInfo, DotronDIPInfo,
...
struct BurnDriver BurnDrvDotrona = {
	"dotrona", "dotron", "midssio", nullptr, "1983",
	"Discs of Tron (Upright, 9/22/83)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_SHOOT, 0,
	nullptr, dotronaRomInfo, dotronaRomName, nullptr, nullptr, nullptr, nullptr, DotronInputInfo, DotronDIPInfo,
	DotronInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvDotrone = {
	"dotrone", "dotron", "midssio", nullptr, "1983",
	"Discs of Tron (Environmental)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_SHOOT, 0,
	nullptr, dotroneRomInfo, dotroneRomName, nullptr, nullptr, nullptr, nullptr, DotronInputInfo, DotroneDIPInfo,
...
struct BurnDriver BurnDrvDemoderb = {
	"demoderb", nullptr, nullptr, nullptr, "1984",
	"Demolition Derby\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, demoderbRomInfo, demoderbRomName, nullptr, nullptr, nullptr, nullptr, DemoderbInputInfo, DemoderbDIPInfo,
...
struct BurnDriver BurnDrvDemoderbc = {
	"demoderbc", "demoderb", nullptr, nullptr, "1984",
	"Demolition Derby (cocktail)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, demoderbcRomInfo, demoderbcRomName, nullptr, nullptr, nullptr, nullptr, DemoderbInputInfo, DemoderbDIPInfo,
	DemoderbInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	512, 480, 4, 3
};
...
struct BurnDriverD BurnDrvNflfoot = {
	"nflfoot", nullptr, "midssio", nullptr, "1983",
	"NFL Football\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, nflfootRomInfo, nflfootRomName, nullptr, nullptr, nullptr, nullptr, TronInputInfo, TronDIPInfo,
	// NflfootInputInfo, NflfootDIPInfo,
