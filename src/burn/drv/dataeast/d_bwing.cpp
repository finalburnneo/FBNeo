...
{
	return static_cast<INT32>(static_cast<float>(nBurnSoundLen * (M6502TotalCycles() / (2000000.0000 / (nBurnFPS /
		100.0000)))));
}
...
static void draw_sprites(INT32 pri)
{
	for (INT32 i = 0; i < 0x200; i += 4)
	{
		...
		if (attr & 0x10)
		{
			RenderZoomedTile(pTransDraw, DrvGfxROM1, code, (color << 3) + 0x20, 0, sx, sy - 8, flipx, flipy, 16, 16,
			                 1 << 16, 2 << 16);
		}
		else
		{
...
struct BurnDriver BurnDrvBwings = {
	"bwings", nullptr, nullptr, nullptr, "1984",
	"B-Wings (Japan new Ver.)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_DATAEAST, GBF_VERSHOOT, 0,
	nullptr, bwingsRomInfo, bwingsRomName, nullptr, nullptr, nullptr, nullptr, BwingInputInfo, BwingDIPInfo,
...
struct BurnDriver BurnDrvBwingso = {
	"bwingso", "bwings", nullptr, nullptr, "1984",
	"B-Wings (Japan old Ver.)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_DATAEAST, GBF_VERSHOOT, 0,
	nullptr, bwingsoRomInfo, bwingsoRomName, nullptr, nullptr, nullptr, nullptr, BwingInputInfo, BwingDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvBwingsa = {
	"bwingsa", "bwings", nullptr, nullptr, "1984",
	"B-Wings (Alt Ver.?)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_DATAEAST, GBF_VERSHOOT, 0,
	nullptr, bwingsaRomInfo, bwingsaRomName, nullptr, nullptr, nullptr, nullptr, BwingInputInfo, BwingDIPInfo,
...
struct BurnDriver BurnDrvZaviga = {
	"zaviga", nullptr, nullptr, nullptr, "1984",
	"Zaviga\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_DATAEAST, GBF_VERSHOOT, 0,
	nullptr, zavigaRomInfo, zavigaRomName, nullptr, nullptr, nullptr, nullptr, BwingInputInfo, BwingDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvZavigaj = {
	"zavigaj", "zaviga", nullptr, nullptr, "1984",
	"Zaviga (Japan)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_DATAEAST, GBF_VERSHOOT, 0,
	nullptr, zavigajRomInfo, zavigajRomName, nullptr, nullptr, nullptr, nullptr, BwingInputInfo, BwingDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	240, 256, 3, 4
};
