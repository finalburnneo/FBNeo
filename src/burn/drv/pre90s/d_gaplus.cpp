...
static struct BurnDIPInfo GaplusDIPList[] =
{
	...
	{0x12, 0xff, 0xff, 0x0f, nullptr},
	{0x13, 0xff, 0xff, 0x0f, nullptr},
...
static INT32 MemIndex()
{
	...
	custom_io = Next;
	Next += 0x000010;
	starfield_control = Next;
	Next += 0x000010;
	stars = (star*)Next;
	Next += 130 * sizeof(star);
...
static INT32 DrvInit(INT32 gaplusd)
{
	...
	namcoio_init(0, gaplusd ? NAMCO58xx : NAMCO56xx, nio0_i0, nio0_i1, nio0_i2, nio0_i3, nullptr, nullptr);
	// lamps not hooked up
	namcoio_init(1, gaplusd ? NAMCO56xx : NAMCO58xx, nio1_i0, nio1_i1, nio1_i2, nio1_i3, nullptr, nullptr);
		...
		if ((spriteram_3[offs + 1] & 2) == 0)
		{
			...
			for (INT32 y = 0; y <= sizey; y++)
			{
				for (INT32 x = 0; x <= sizex; x++)
				{
					...
					RenderTileTranstab(pTransDraw, DrvGfxROM1, code, (color * 8) + 0x100, 0xff, sx + 16 * x,
					                   sy + 16 * y, flipx, flipy, 16, 16, DrvColPROM + 0x300);
				}
			}
		}
	}
...
static void starfield_render()
{
	...
	{
		INT32 x = static_cast<INT32>(stars[i].x);
		INT32 y = static_cast<INT32>(stars[i].y);
...
static void vblank_update()
{
	...
	for (INT32 i = 0; i < total_stars; i++)
	{
		...
		{
		case 0x85: stars[i].x += 1.0f;
			break;
		case 0x86: stars[i].x += 1.0f;
			break;
		case 0x06: stars[i].x += 2.0f;
			break;
		case 0x80: stars[i].x -= 1.0f;
			break;
		case 0x82: stars[i].x -= 2.0f;
			break;
		case 0x81: stars[i].x -= 3.0f;
			break;
		case 0x9f: stars[i].y += 3.0f;
			break;
		case 0xaf: stars[i].y -= 3.0f;
			break;
		}

		if (stars[i].x < STARFIELD_CLIPPING_X) stars[i].x = static_cast<float>(nScreenWidth - STARFIELD_CLIPPING_X * 2)
			+ stars[i].x;
		if (stars[i].x >= static_cast<float>(nScreenWidth - STARFIELD_CLIPPING_X)) stars[i].x -= static_cast<float>(
			nScreenWidth - STARFIELD_CLIPPING_X * 2);
		if (stars[i].y < 0) stars[i].y = static_cast<float>(nScreenHeight) + stars[i].y;
		if (stars[i].y >= static_cast<float>(nScreenHeight)) stars[i].y -= static_cast<float>(nScreenHeight);
	}
}
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[3] = {
		static_cast<INT32>(static_cast<double>(1536000) / 60.606061),
		static_cast<INT32>(static_cast<double>(1536000) / 60.606061),
		static_cast<INT32>(static_cast<double>(1536000) / 60.606061)
	};
...
struct BurnDriver BurnDrvGaplus = {
	"gaplus", nullptr, nullptr, "gaplus", "1984",
	"Gaplus (GP2 rev. B)\0", nullptr, "Namco", "Miscellaneous",
	...
	nullptr, gaplusRomInfo, gaplusRomName, nullptr, nullptr, GaplusSampleInfo, GaplusSampleName, GaplusInputInfo,
	GaplusDIPInfo,
...
struct BurnDriver BurnDrvGaplusa = {
	"gaplusa", "gaplus", nullptr, "gaplus", "1984",
	"Gaplus (GP2)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, gaplusaRomInfo, gaplusaRomName, nullptr, nullptr, GaplusSampleInfo, GaplusSampleName, GaplusInputInfo,
	GaplusDIPInfo,
	GaplusInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGaplusd = {
	"gaplusd", "gaplus", nullptr, "gaplus", "1984",
	"Gaplus (GP2 rev D, alternate hardware)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, gaplusdRomInfo, gaplusdRomName, nullptr, nullptr, GaplusSampleInfo, GaplusSampleName, GaplusInputInfo,
	GaplusDIPInfo,
...
struct BurnDriver BurnDrvGapluse = {
	"gapluse", "gaplus", nullptr, "gaplus", "1984",
	"Gaplus (GP7)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, gapluseRomInfo, gapluseRomName, nullptr, nullptr, GaplusSampleInfo, GaplusSampleName, GaplusInputInfo,
	GaplusDIPInfo,
	GaplusInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGaplust = {
	"gaplust", "gaplus", nullptr, "gaplus", "1992",
	"Gaplus (Tecfri PCB)\0", nullptr, "bootleg (Tecfri)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, gaplustRomInfo, gaplustRomName, nullptr, nullptr, GaplusSampleInfo, GaplusSampleName, GaplusInputInfo,
	Galaga3mDIPInfo,
	GaplusInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGalaga3 = {
	"galaga3", "gaplus", nullptr, "gaplus", "1984",
	"Galaga 3 (GP3 rev. D)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, galaga3RomInfo, galaga3RomName, nullptr, nullptr, GaplusSampleInfo, GaplusSampleName, GaplusInputInfo,
	GaplusDIPInfo,
	GaplusInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGalaga3a = {
	"galaga3a", "gaplus", nullptr, "gaplus", "1984",
	"Galaga 3 (GP3 rev. C)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, galaga3aRomInfo, galaga3aRomName, nullptr, nullptr, GaplusSampleInfo, GaplusSampleName, GaplusInputInfo,
	GaplusDIPInfo,
	GaplusInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGalaga3b = {
	"galaga3b", "gaplus", nullptr, "gaplus", "1984",
	"Galaga 3 (GP3)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, galaga3bRomInfo, galaga3bRomName, nullptr, nullptr, GaplusSampleInfo, GaplusSampleName, GaplusInputInfo,
	GaplusDIPInfo,
	GaplusInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGalaga3c = {
	"galaga3c", "gaplus", nullptr, "gaplus", "1984",
	"Galaga 3 (set 4)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, galaga3cRomInfo, galaga3cRomName, nullptr, nullptr, GaplusSampleInfo, GaplusSampleName, GaplusInputInfo,
	Galaga3cDIPInfo,
	GaplusInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvGalaga3m = {
	"galaga3m", "gaplus", nullptr, "gaplus", "1984",
	"Galaga 3 (set 5)\0", nullptr, "Namco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, galaga3mRomInfo, galaga3mRomName, nullptr, nullptr, GaplusSampleInfo, GaplusSampleName, GaplusInputInfo,
	Galaga3mDIPInfo,
	GaplusInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
