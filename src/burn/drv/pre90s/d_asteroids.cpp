...
static struct BurnInputInfo LlanderInputList[] = {
	...
	{"P1 Left", BIT_DIGITAL, DrvJoy2 + 7, "p1 left"},
	{"P1 Right", BIT_DIGITAL, DrvJoy2 + 6, "p1 right"},
	{"P1 Select Game", BIT_DIGITAL, DrvJoy2 + 4, "p2 start"},
	// yes, p2,3 start instead of fire to avoid accidental pressing of these in-game
...
static INT32 MemIndex()
{
	...
	DrvVectorROM = Next;
	Next += 0x001800; // needs to be after DrvVectorRAM(!)
...
struct BurnDriver BurnDrvAsteroid = {
	"asteroid", nullptr, nullptr, nullptr, "1979",
	"Asteroids (rev 4)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, asteroidRomInfo, asteroidRomName, nullptr, nullptr, nullptr, nullptr, AsteroidInputInfo, AsteroidDIPInfo,
...
struct BurnDriver BurnDrvAsteroid2 = {
	"asteroid2", "asteroid", nullptr, nullptr, "1979",
	"Asteroids (rev 2)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, asteroid2RomInfo, asteroid2RomName, nullptr, nullptr, nullptr, nullptr, AsteroidInputInfo, AsteroidDIPInfo,
	AsteroidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvAsteroid1 = {
	"asteroid1", "asteroid", nullptr, nullptr, "1979",
	"Asteroids (rev 1)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, asteroid1RomInfo, asteroid1RomName, nullptr, nullptr, nullptr, nullptr, AsteroidInputInfo, AsteroidDIPInfo,
	AsteroidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvAsteroidb1 = {
	"asteroidb1", "asteroid", nullptr, nullptr, "1979",
	"Asteroids (bootleg on Lunar Lander hardware, set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, asteroidb1RomInfo, asteroidb1RomName, nullptr, nullptr, nullptr, nullptr, AsteroidbInputInfo,
	AsteroidbDIPInfo,
...
struct BurnDriver BurnDrvAsteroidb2 = {
	"asteroidb2", "asteroid", nullptr, nullptr, "1979",
	"Asteroids (bootleg on Lunar Lander hardware, set 2)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, asteroidb2RomInfo, asteroidb2RomName, nullptr, nullptr, nullptr, nullptr, AsteroidInputInfo,
	AsteroidDIPInfo,
	AsteroidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvSpcrocks = {
	"spcrocks", "asteroid", nullptr, nullptr, "1981",
	"Space Rocks (Spanish clone of Asteroids)\0", nullptr, "Atari (J.Estevez license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, spcrocksRomInfo, spcrocksRomName, nullptr, nullptr, nullptr, nullptr, AsteroidInputInfo, AerolitosDIPInfo,
	AsteroidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvAerolitos = {
	"aerolitos", "asteroid", nullptr, nullptr, "1980",
	"Aerolitos (Spanish bootleg of Asteroids)\0", nullptr, "bootleg (Rodmar Elec.)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, aerolitosRomInfo, aerolitosRomName, nullptr, nullptr, nullptr, nullptr, AsteroidInputInfo,
	AerolitosDIPInfo,
	AsteroidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvAsterock = {
	"asterock", "asteroid", nullptr, nullptr, "1979",
	"Asterock (Sidam bootleg of Asteroids)\0", nullptr, "bootleg (Sidam)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, asterockRomInfo, asterockRomName, nullptr, nullptr, nullptr, nullptr, AsterockInputInfo, AsterockDIPInfo,
...
struct BurnDriver BurnDrvAsterockv = {
	"asterockv", "asteroid", nullptr, nullptr, "1979",
	"Asterock (Videotron bootleg of Asteroids)\0", nullptr, "bootleg (Videotron)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, asterockvRomInfo, asterockvRomName, nullptr, nullptr, nullptr, nullptr, AsterockInputInfo, AsterockDIPInfo,
	AsterockInt, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvMeteorite = {
	"meteorite", "asteroid", nullptr, nullptr, "1979",
	"Meteorite (Proel bootleg of Asteroids)\0", nullptr, "bootleg (Proel)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, meteoriteRomInfo, meteoriteRomName, nullptr, nullptr, nullptr, nullptr, AsterockInputInfo, AsterockDIPInfo,
	AsterockInt, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvMeteorts = {
	"meteorts", "asteroid", nullptr, nullptr, "1979",
	"Meteorites (VGG bootleg of Asteroids)\0", nullptr, "bootleg (VGG)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, meteortsRomInfo, meteortsRomName, nullptr, nullptr, nullptr, nullptr, AsteroidInputInfo, AsteroidDIPInfo,
	AsteroidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvMeteorho = {
	"meteorho", "asteroid", nullptr, nullptr, "1979",
	"Meteor (Hoei bootleg of Asteroids)\0", nullptr, "bootleg (Hoei)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, meteorhoRomInfo, meteorhoRomName, nullptr, nullptr, nullptr, nullptr, AsteroidInputInfo, AsteroidDIPInfo,
	AsteroidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvMeteorbl = {
	"meteorbl", "asteroid", nullptr, nullptr, "1979",
	"Meteor (bootleg of Asteroids)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, meteorblRomInfo, meteorblRomName, nullptr, nullptr, nullptr, nullptr, AsterockInputInfo, AsterockDIPInfo,
	AsterockInt, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvHyperspc = {
	"hyperspc", "asteroid", nullptr, nullptr, "1979",
	"Hyperspace (bootleg of Asteroids)\0", nullptr, "bootleg (Rumiano)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR,
	0,
	nullptr, hyperspcRomInfo, hyperspcRomName, nullptr, nullptr, nullptr, nullptr, AsteroidInputInfo, AsteroidDIPInfo,
	AsteroidInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvAstdelux = {
	"astdelux", nullptr, nullptr, nullptr, "1980",
	"Asteroids Deluxe (rev 3)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING /* | BDF_HISCORE_SUPPORTED */, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, astdeluxRomInfo, astdeluxRomName, nullptr, nullptr, nullptr, nullptr, AstdeluxInputInfo, AstdeluxDIPInfo,
...
struct BurnDriver BurnDrvAstdelux2 = {
	"astdelux2", "astdelux", nullptr, nullptr, "1980",
	"Asteroids Deluxe (rev 2)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE /* | BDF_HISCORE_SUPPORTED */, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, astdelux2RomInfo, astdelux2RomName, nullptr, nullptr, nullptr, nullptr, AstdeluxInputInfo, AstdeluxDIPInfo,
	AstdeluxInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvAstdelux1 = {
	"astdelux1", "astdelux", nullptr, nullptr, "1980",
	"Asteroids Deluxe (rev 1)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE /* | BDF_HISCORE_SUPPORTED */, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, astdelux1RomInfo, astdelux1RomName, nullptr, nullptr, nullptr, nullptr, AstdeluxInputInfo, AstdeluxDIPInfo,
	AstdeluxInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvLlander = {
	"llander", nullptr, nullptr, nullptr, "1979",
	"Lunar Lander (rev 2)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC | GBF_VECTOR, 0,
	nullptr, llanderRomInfo, llanderRomName, nullptr, nullptr, nullptr, nullptr, LlanderInputInfo, LlanderDIPInfo,
...
struct BurnDriver BurnDrvLlander1 = {
	"llander1", "llander", nullptr, nullptr, "1979",
	"Lunar Lander (rev 1)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC | GBF_VECTOR, 0,
	nullptr, llander1RomInfo, llander1RomName, nullptr, nullptr, nullptr, nullptr, LlanderInputInfo, Llander1DIPInfo,
	LlanderInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriverD BurnDrvLlandert = {
	"llandert", "llander", nullptr, nullptr, "1979",
	"Lunar Lander (screen test)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC | GBF_VECTOR, 0,
	nullptr, llandertRomInfo, llandertRomName, nullptr, nullptr, nullptr, nullptr, LlandertInputInfo, LlandertDIPInfo,
	LlanderInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
