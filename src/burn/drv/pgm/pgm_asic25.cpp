...
static void olds_protection_calculate_hilo() // calculated in routine $12dbc2 in olds
{
	...
	source = source_data[m_olds_region][m_olds_prot_hilo_select];
...
static UINT16 __fastcall olds_protection_r(UINT32 offset)
{
	...
	if (offset)
	{
		...
		{
			case 0x00:
				return BITSWAP08((kb_swap + 1) & 0x7f, 0, 1, 2, 3, 4, 5, 6, 7);
...
static void reset_olds()
{
	...
	m_olds_region = PgmInput[7] - 1;
	m_olds_game_id = PgmInput[7] | 0x900000;
}
