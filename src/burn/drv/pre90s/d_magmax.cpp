...
static void DrvGfxDecode()
{
	...
	INT32 SpriteXOffsets[16] = {
		4, 0, 4 + 512 * 64 * 8, 0 + 512 * 64 * 8, 12, 8, 12 + 512 * 64 * 8, 8 + 512 * 64 * 8, 20, 16, 20 + 512 * 64 * 8,
		16 + 512 * 64 * 8, 28, 24, 28 + 512 * 64 * 8, 24 + 512 * 64 * 8
	};
...
static INT32 DrvInit()
{
	...
	AY8910SetPorts(0, nullptr, nullptr, &ay8910_write_A, &ay8910_write_B);
...
static void draw_sprites()
{
	...
	for (INT32 offs = 0x100 - 4; offs >= 0; offs -= 4)
	{
		...
		RenderPrioMaskTranstabSpriteOffset(pTransDraw, DrvGfxROM[1], code, (color << 4), 0x0f, sx, sy - 16, flipx,
		                                   flipy, 16, 16, DrvColPROM + 0x300, 0x10, 4);
	}
}
...
struct BurnDriver BurnDrvMagmax = {
	"magmax", nullptr, nullptr, nullptr, "1985",
	"Mag Max (set 1)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, magmaxRomInfo, magmaxRomName, nullptr, nullptr, nullptr, nullptr, MagmaxInputInfo, MagmaxDIPInfo,
...
struct BurnDriver BurnDrvMagmaxa = {
	"magmaxa", "magmax", nullptr, nullptr, "1985",
	"Mag Max (set 2)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, magmaxaRomInfo, magmaxaRomName, nullptr, nullptr, nullptr, nullptr, MagmaxInputInfo, MagmaxDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &BurnRecalc, 0x210,
	256, 224, 4, 3
};
