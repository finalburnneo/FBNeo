...
m68705_interface pitnrun_m68705_interface = {
	nullptr /* portA */, m68705_portB_out /* portB */, nullptr /* portC */,
	nullptr /* ddrA  */, nullptr /* ddrB  */, nullptr /* ddrC  */,
	nullptr /* portA */, nullptr /* portB */, standard_m68705_portC_in /* portC */
};
...
static INT32 DrvInit(INT32 game)
{
	...
	AY8910SetPorts(0, &AY8910_read, &AY8910_read, nullptr, nullptr);
	AY8910SetPorts(1, &AY8910_read, &AY8910_read, nullptr, nullptr);
...
static void draw_sprites()
{
	for (INT32 offs = 0; offs < 0x100; offs += 4)
	{
		...
		INT32 code = (DrvSprRAM[offs + 1] & 0x3f) | ((DrvSprRAM[offs + 2] & 0x80) >> 1) | ((DrvSprRAM[offs + 2] & 0x40)
			<< 1);
...
struct BurnDriver BurnDrvPitnrun = {
	"pitnrun", nullptr, nullptr, nullptr, "1984",
	"Pit & Run - F-1 Race (set 1)\0", "Missing analog sounds and some gfx effects", "Taito Corporation",
	"Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_TAITO, GBF_RACING, 0,
	nullptr, pitnrunRomInfo, pitnrunRomName, nullptr, nullptr, nullptr, nullptr, PitnrunInputInfo, PitnrunDIPInfo,
	PitnrunInit, DrvExit, DrvFrame, DrvDraw, nullptr, &DrvRecalc, 0,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvPitnruna = {
	"pitnruna", "pitnrun", nullptr, nullptr, "1984",
	"Pit & Run - F-1 Race (set 2)\0", "Missing analog sounds and some gfx effects", "Taito Corporation",
	"Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_TAITO, GBF_RACING, 0,
	nullptr, pitnrunaRomInfo, pitnrunaRomName, nullptr, nullptr, nullptr, nullptr, PitnrunInputInfo, PitnrunDIPInfo,
	PitnrunInit, DrvExit, DrvFrame, DrvDraw, nullptr, &DrvRecalc, 0,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvPitnrunb = {
	"pitnrunb", "pitnrun", nullptr, nullptr, "1984",
	"Pit & Run - F-1 Race (set 3)\0", "Missing analog sounds and some gfx effects", "Taito Corporation",
	"Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_TAITO, GBF_RACING, 0,
	nullptr, pitnrunbRomInfo, pitnrunbRomName, nullptr, nullptr, nullptr, nullptr, PitnrunInputInfo, PitnrunDIPInfo,
	PitnrunInit, DrvExit, DrvFrame, DrvDraw, nullptr, &DrvRecalc, 0,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvJumpkun = {
	"jumpkun", nullptr, nullptr, nullptr, "1984",
	"Jump Kun (prototype)\0", nullptr, "Kaneko", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_PROTOTYPE, 2, HARDWARE_PREFIX_TAITO,
	GBF_PLATFORM, 0,
	nullptr, jumpkunRomInfo, jumpkunRomName, nullptr, nullptr, nullptr, nullptr, JumpkunInputInfo, JumpkunDIPInfo,
