...
static INT32 DrvGfxDecode()
{
	...
	INT32 XOffs[16] = {
		...
		32 * 8 + 2 * 4, 32 * 8 + 3 * 4, 32 * 8 + 0 * 4, 32 * 8 + 1 * 4, 32 * 8 + 6 * 4, 32 * 8 + 7 * 4, 32 * 8 + 4 * 4,
		32 * 8 + 5 * 4
	};
	INT32 YOffs[16] = {
		0 * 32, 1 * 32, 2 * 32, 3 * 32, 4 * 32, 5 * 32, 6 * 32, 7 * 32,
		64 * 8 + 0 * 32, 64 * 8 + 1 * 32, 64 * 8 + 2 * 32, 64 * 8 + 3 * 32, 64 * 8 + 4 * 32, 64 * 8 + 5 * 32,
		64 * 8 + 6 * 32, 64 * 8 + 7 * 32
	};
...
struct BurnDriver BurnDrvGrdius3 = {
	"gradius3", nullptr, nullptr, nullptr, "1989",
	"Gradius III (World, program code R)\0", nullptr, "Konami", "GX945",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	nullptr, grdius3RomInfo, grdius3RomName, nullptr, nullptr, nullptr, nullptr, Gradius3InputInfo, Gradius3DIPInfo,
...
struct BurnDriver BurnDrvGradius3j = {
	"gradius3j", "gradius3", nullptr, nullptr, "1989",
	"Gradius III (Japan, program code S)\0", nullptr, "Konami", "GX945",
	L"Gradius III \u4F1D\u8AAC\u304B\u3089\u795E\u8A71\u3078 (Japan, program code S)\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	nullptr, gradius3jRomInfo, gradius3jRomName, nullptr, nullptr, nullptr, nullptr, Gradius3InputInfo, Gradius3DIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvGradius3js = {
	"gradius3js", "gradius3", nullptr, nullptr, "1989",
	"Gradius III (Japan, program code S, split)\0", nullptr, "Konami", "GX945",
	L"Gradius III \u4F1D\u8AAC\u304B\u3089\u795E\u8A71\u3078 (Japan, program code S, split)\0", nullptr, nullptr,
	nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	nullptr, gradius3jsRomInfo, gradius3jsRomName, nullptr, nullptr, nullptr, nullptr, Gradius3InputInfo,
	Gradius3DIPInfo,
...
struct BurnDriver BurnDrvGrdius3a = {
	"gradius3a", "gradius3", nullptr, nullptr, "1989",
	"Gradius III (Asia)\0", nullptr, "Konami", "GX945",
	L"Gradius III \u4F1D\u8AAC\u304B\u3089\u795E\u8A71\u3078 (Asia)\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	nullptr, grdius3aRomInfo, grdius3aRomName, nullptr, nullptr, nullptr, nullptr, Gradius3InputInfo, Gradius3DIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 224, 4, 3
};
