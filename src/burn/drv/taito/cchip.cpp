...
/*************************************************************************
  ...
  Additional thanks to Robert Gallagher and stephh.
	...
	Taken from MAME 0.96 Aug 1, 2016.  Current C-chip prot for Bonze will
	cause the game to crash / freeze if you die in certain places.  Don't
	update until this is fixed in MAME.  - dink
...
static void WriteRestartPos(void)
{
	...
	for (INT32 n = 0; n < sizeof CMAP / sizeof CMAP[0]; n++)
	{
...
UINT16 BonzeReadCChipRam(INT32 offset)
{
	...
	if (current_bank == 0)
	{
		...
		if (offset == 0x0e)
		{
			return 0; //restart_status; /* 0xff signals error, 0 signals ok */
		}
