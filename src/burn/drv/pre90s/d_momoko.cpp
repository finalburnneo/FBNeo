...
static void draw_bg_layer(int pri)
{
	...
	for (INT32 offs = 0; offs < 32 * 32; offs++)
	{
		...
		{
			RenderTileTranstab(pTransDraw, DrvGfxROM1, code, ((color & 0x0f) << 4) + 0x100, 0, sx - 8, sy, 0, 0, 8, 8,
			                   DrvTransTab[1]);
		}
	}
}
...
struct BurnDriver BurnDrvMomoko = {
	"momoko", nullptr, nullptr, nullptr, "1986",
	"Momoko 120% (Japanese text)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, momokoRomInfo, momokoRomName, nullptr, nullptr, nullptr, nullptr, MomokoInputInfo, MomokoDIPInfo,
...
struct BurnDriver BurnDrvMomokoe = {
	"momokoe", "momoko", nullptr, nullptr, "1986",
	"Momoko 120% (English text)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, momokoeRomInfo, momokoeRomName, nullptr, nullptr, nullptr, nullptr, MomokoInputInfo, MomokoDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	240, 216, 4, 3
};
...
struct BurnDriver BurnDrvMomokob = {
	"momokob", "momoko", nullptr, nullptr, "1986",
	"Momoko 120% (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, momokobRomInfo, momokobRomName, nullptr, nullptr, nullptr, nullptr, MomokoInputInfo, MomokoDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	240, 216, 4, 3
};
