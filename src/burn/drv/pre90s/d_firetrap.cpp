...
static void firetrap_8751_write(UINT8 data)
{
	...
	static constexpr int i8751_coin_data[2] = {0x00, 0xb7};
	static constexpr int i8751_36_data[2] = {0x00, 0xbc};
...
static void firetrap_sound_write(UINT16 address, UINT8 data)
{
	...
	case 0x2000:
		msm5205next = data;
		if (MSM5205Last == 0x8 && msm5205next == 0x8)
		{
			// clears up hissing & clicking noise
...
static INT32 DrvInit()
{
	...
	BurnYM3526Init(3000000, nullptr, &SynchroniseStream, 0);
...
static inline void draw_16x16_tile(UINT8* gfx, INT32 code, INT32 color, INT32 sx, INT32 sy, INT32 flipx, INT32 flipy,
                                   INT32 transparent)
{
...
struct BurnDriver BurnDrvFiretrap = {
	"firetrap", nullptr, nullptr, nullptr, "1986",
	"Fire Trap (US, rev A)\0", nullptr, "Woodplace Inc. (Data East USA license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 4,
	HARDWARE_PREFIX_DATAEAST, GBF_MAZE, 0,
	nullptr, firetrapRomInfo, firetrapRomName, nullptr, nullptr, nullptr, nullptr, FiretrapInputInfo, FiretrapDIPInfo,
...
struct BurnDriver BurnDrvFiretrapa = {
	"firetrapa", "firetrap", nullptr, nullptr, "1986",
	"Fire Trap (US)\0", nullptr, "Woodplace Inc. (Data East USA license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 4,
	HARDWARE_PREFIX_DATAEAST, GBF_MAZE, 0,
	nullptr, firetrapaRomInfo, firetrapaRomName, nullptr, nullptr, nullptr, nullptr, FiretrapInputInfo, FiretrapDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvFiretrapj = {
	"firetrapj", "firetrap", nullptr, nullptr, "1986",
	"Fire Trap (Japan)\0", nullptr, "Woodplace Inc.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 4,
	HARDWARE_PREFIX_DATAEAST, GBF_MAZE, 0,
	nullptr, firetrapjRomInfo, firetrapjRomName, nullptr, nullptr, nullptr, nullptr, FiretrapInputInfo,
	FiretrapjDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvFiretrapbl = {
	"firetrapbl", "firetrap", nullptr, nullptr, "1986",
	"Fire Trap (Japan bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_BOOTLEG |
	BDF_HISCORE_SUPPORTED,
	4, HARDWARE_PREFIX_DATAEAST, GBF_MAZE, 0,
	nullptr, firetrapblRomInfo, firetrapblRomName, nullptr, nullptr, nullptr, nullptr, FiretrapblInputInfo,
	FiretrapblDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	240, 256, 3, 4
};
