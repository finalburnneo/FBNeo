...
static void b800_write(UINT8 data)
{
	switch (data)
	{
	case 0xc4: b000_ret = AY8910Read(0);
		break;
	case 0x94: b000_ret = AY8910Read(1);
		break;
	case 0x86: b000_ret = AY8910Read(2);
		break;

	case 0x80:
		switch (b800_prev)
		{
		case 0xe0: AY8910Write(0, 0, b000_val);
			break;
		case 0x98: AY8910Write(1, 0, b000_val);
			break;
		case 0x83: AY8910Write(2, 0, b000_val);
			break;
		case 0xa0: AY8910Write(0, 1, b000_val);
			break;
		case 0x88: AY8910Write(1, 1, b000_val);
			break;
		case 0x81: AY8910Write(2, 1, b000_val);
			break;
		}
		break;
	}
...
static INT32 DrvInit()
{
	...
	AY8910Init(1, 2000000, 1);
	AY8910SetPorts(1, &AY8910_1_portA_read, nullptr, nullptr, nullptr);
	AY8910SetPorts(2, &AY8910_2_portA_read, nullptr, nullptr, nullptr);
...
struct BurnDriver BurnDrvPromutrv = {
	"promutrv", nullptr, nullptr, nullptr, "1985",
	"Progressive Music Trivia (Question set 1)\0", nullptr, "Enerdyne Technologies Inc.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_QUIZ, 0,
	nullptr, promutrvRomInfo, promutrvRomName, nullptr, nullptr, nullptr, nullptr, EttriviaInputInfo, EttriviaDIPInfo,
...
struct BurnDriver BurnDrvPromutrva = {
	"promutrva", "promutrv", nullptr, nullptr, "1985",
	"Progressive Music Trivia (Question set 2)\0", nullptr, "Enerdyne Technologies Inc.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_QUIZ, 0,
	nullptr, promutrvaRomInfo, promutrvaRomName, nullptr, nullptr, nullptr, nullptr, EttriviaInputInfo, EttriviaDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvPromutrvb = {
	"promutrvb", "promutrv", nullptr, nullptr, "1985",
	"Progressive Music Trivia (Question set 3)\0", nullptr, "Enerdyne Technologies Inc.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_QUIZ, 0,
	nullptr, promutrvbRomInfo, promutrvbRomName, nullptr, nullptr, nullptr, nullptr, EttriviaInputInfo, EttriviaDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvPromutrvc = {
	"promutrvc", "promutrv", nullptr, nullptr, "1985",
	"Progressive Music Trivia (Question set 4)\0", nullptr, "Enerdyne Technologies Inc.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_QUIZ, 0,
	nullptr, promutrvcRomInfo, promutrvcRomName, nullptr, nullptr, nullptr, nullptr, EttriviaInputInfo, EttriviaDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvStrvmstr = {
	"strvmstr", nullptr, nullptr, nullptr, "1986",
	"Super Trivia Master\0", nullptr, "Enerdyne Technologies Inc.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_QUIZ, 0,
	nullptr, strvmstrRomInfo, strvmstrRomName, nullptr, nullptr, nullptr, nullptr, EttriviaInputInfo, EttriviaDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
