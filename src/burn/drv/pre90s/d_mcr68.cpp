...
static void (*control_write)(UINT16 offset) = nullptr;
...
static UINT16 __fastcall trisport_main_read_word(UINT32 address)
{
	if ((address & 0x1f0000) == 0x080000)
	{
		return 0xff | ((BurnTrackballReadInterpolated(0, scanline) & 0xf) << 8) | ((
			BurnTrackballReadInterpolated(1, scanline) & 0xf) << 12);
	}
	...
	for (INT32 i = 0; !BurnDrvGetRomName(&pRomName, i, 0); i++)
	{
		...
		if ((ri.nType & BRF_PRG) && ((ri.nType & 7) == 4))
		{
			...
			if (bLoad)
			{
				...
				for (INT32 j = ri.nLen; j < 0x20000; j += ri.nLen)
				{
					// mirror
...
static INT32 DrvGfxDecode()
{
	...
	auto tmp = BurnMalloc(nGraphicsLen[1]);
	if (tmp == nullptr)
	{
		return 1;
	}
...
static void draw_sprites(INT32 priority)
{
	...
	for (INT32 offs = spriteram_size / 2 - 4; offs >= 0; offs -= 4)
	{
		...
		RenderPrioMaskTranstabSprite(pTransDraw, DrvGfxROM1, code % codemask, (color * 16), 0xff, sx, sy, flipx, flipy,
		                             32, 32, DrvTransTab[0], 0);
		RenderPrioMaskTranstabSprite(pTransDraw, DrvGfxROM1, code % codemask, (color * 16), 0xff, sx, sy, flipx, flipy,
		                             32, 32, DrvTransTab[1], 2);
	}
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[5] = {
		7723800 / 30, 7723800 / 10 / 30 /*ptm*/, 8000000 / 30 /*sounds good*/, 2000000 / 30 /*cvsd*/,
		2000000 / 30 /*tcs*/
	};
	INT32 nCyclesDone[5] = {0, 0, 0, 0, 0};

	SekIdle(0, nCyclesExtra[0]);
	// when CPU_RUN_SYNCINT is used, we have to Idle extra cycles. (overflow from previous frame)
...
static INT32 DrvScan(INT32 nAction, INT32* pnMin)
{
	...
	if (nAction & ACB_NVRAM && is_trisport)
	{
		// trisport nvram
		ba.Data = Drv68KRAMA;
		ba.nLen = 0x04000;
...
static void xenophob_control_write(UINT16)
{
	...
	if (cycles >= 1) SekRun(static_cast<UINT32>(cycles));
...
struct BurnDriver BurnDrvXenophob = {
	"xenophob", nullptr, nullptr, nullptr, "1987",
	"Xenophobe\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 3, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, xenophobRomInfo, xenophobRomName, nullptr, nullptr, nullptr, nullptr, XenophobInputInfo, XenophobDIPInfo,
...
static void spyhunt2_control_write(UINT16)
{
	...
	if (cycles >= 1) M6809Run(static_cast<UINT32>(cycles));
...
struct BurnDriver BurnDrvSpyhunt2 = {
	"spyhunt2", nullptr, nullptr, nullptr, "1987",
	"Spy Hunter II (rev 2)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, spyhunt2RomInfo, spyhunt2RomName, nullptr, nullptr, nullptr, nullptr, Spyhunt2InputInfo, Spyhunt2DIPInfo,
...
struct BurnDriver BurnDrvSpyhunt2a = {
	"spyhunt2a", "spyhunt2", nullptr, nullptr, "1987",
	"Spy Hunter II (rev 1)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, spyhunt2aRomInfo, spyhunt2aRomName, nullptr, nullptr, nullptr, nullptr, Spyhunt2InputInfo, Spyhunt2DIPInfo,
	Spyhunt2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 64,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvBlasted = {
	"blasted", nullptr, nullptr, nullptr, "1988",
	"Blasted\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, blastedRomInfo, blastedRomName, nullptr, nullptr, nullptr, nullptr, BlastedInputInfo, BlastedDIPInfo,
...
struct BurnDriver BurnDrvIntlaser = {
	"intlaser", "blasted", nullptr, nullptr, "1987",
	"International Team Laser (prototype)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE, 4, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, intlaserRomInfo, intlaserRomName, nullptr, nullptr, nullptr, nullptr, IntlaserInputInfo, IntlaserDIPInfo,
	BlastedInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 64,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvArchrivl = {
	"archrivl", nullptr, nullptr, nullptr, "1989",
	"Arch Rivals (rev 4.0 6/29/89)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSFOOTBALL, 0,
	nullptr, archrivlRomInfo, archrivlRomName, nullptr, nullptr, nullptr, nullptr, ArchrivlInputInfo, ArchrivlDIPInfo,
...
struct BurnDriver BurnDrvArchrivla = {
	"archrivla", "archrivl", nullptr, nullptr, "1989",
	"Arch Rivals (rev 2.0 5/03/89)\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSFOOTBALL, 0,
	nullptr, archrivlaRomInfo, archrivlaRomName, nullptr, nullptr, nullptr, nullptr, ArchrivlInputInfo, ArchrivlDIPInfo,
	ArchrivlInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 64,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvArchrivlb = {
	"archrivlb", "archrivl", nullptr, nullptr, "1989",
	"Arch Rivals (rev 2.0 5/03/89, 8-way joystick bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSFOOTBALL, 0,
	nullptr, archrivlbRomInfo, archrivlbRomName, nullptr, nullptr, nullptr, nullptr, ArchrivlbInputInfo,
	ArchrivlbDIPInfo,
...
struct BurnDriver BurnDrvBasketbal = {
	"basketbal", "archrivl", nullptr, nullptr, "1989",
	"Basket Ball (8-way joystick bootleg of Arch Rivals)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSFOOTBALL, 0,
	nullptr, basketbalRomInfo, basketbalRomName, nullptr, nullptr, nullptr, nullptr, ArchrivlbInputInfo,
	ArchrivlbDIPInfo,
	ArchrivlbInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 64,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvPigskin = {
	"pigskin", nullptr, nullptr, nullptr, "1990",
	"Pigskin 621AD (rev 1.1K 8/01/90)\0", nullptr, "Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_SPORTSMISC, 0,
	nullptr, pigskinRomInfo, pigskinRomName, nullptr, nullptr, nullptr, nullptr, PigskinInputInfo, PigskinDIPInfo,
...
struct BurnDriver BurnDrvPigskina = {
	"pigskina", "pigskin", nullptr, nullptr, "1990",
	"Pigskin 621AD (rev 2.0 7/06/90)\0", nullptr, "Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_SPORTSMISC, 0,
	nullptr, pigskinaRomInfo, pigskinaRomName, nullptr, nullptr, nullptr, nullptr, PigskinInputInfo, PigskinDIPInfo,
	PigskinInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 64,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvPigskinb = {
	"pigskinb", "pigskin", nullptr, nullptr, "1990",
	"Pigskin 621AD (rev 1.1 6/05/90)\0", nullptr, "Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_SPORTSMISC, 0,
	nullptr, pigskinbRomInfo, pigskinbRomName, nullptr, nullptr, nullptr, nullptr, PigskinInputInfo, PigskinDIPInfo,
	PigskinInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 64,
	512, 480, 4, 3
};
...
struct BurnDriver BurnDrvTrisport = {
	"trisport", nullptr, nullptr, nullptr, "1989",
	"Tri-Sports\0", nullptr, "Bally Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, trisportRomInfo, trisportRomName, nullptr, nullptr, nullptr, nullptr, TrisportInputInfo, TrisportDIPInfo,
