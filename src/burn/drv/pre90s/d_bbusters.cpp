...
{
	{0x0e, 0xff, 0xff, 0xf9, nullptr},
	{0x0f, 0xff, 0xff, 0x8f, nullptr},
...
static INT32 MemIndex()
{
	...
	SpriteBitmap[0] = (UINT16*)Next;
	Next += 256 * 256 * sizeof(UINT16);
	SpriteBitmap[1] = (UINT16*)Next;
	Next += 256 * 256 * sizeof(UINT16);
...
static void draw_text_layer()
{
	...
	for (INT32 offs = 0; offs < 32 * 32; offs++)
	{
		...
		Render8x8Tile_Mask_Clip(pTransDraw, BURN_ENDIAN_SWAP_INT16(ram[offs]) & 0xfff, sx, sy - 16,
		                        BURN_ENDIAN_SWAP_INT16(ram[offs]) >> 12, 4, 0xf, 0, DrvGfxROM0);
	}
}

static void draw_layer(UINT8* rambase, UINT8* gfx, INT32 color_offset, INT32 transp, UINT8* scroll, INT32 wide)
{
	auto scr = (UINT16*)scroll;
	auto ram = (UINT16*)rambase;
	...
	for (INT32 offs = 0; offs < width * 32; offs++)
	{
		...
		if (transp)
		{
			Render16x16Tile_Mask_Clip(pTransDraw, BURN_ENDIAN_SWAP_INT16(ram[offs]) & 0xfff, sx, sy,
			                          BURN_ENDIAN_SWAP_INT16(ram[offs]) >> 12, 4, 0xf, color_offset, gfx);
		}
		else
		{
			Render16x16Tile_Clip(pTransDraw, BURN_ENDIAN_SWAP_INT16(ram[offs]) & 0xfff, sx, sy,
			                     BURN_ENDIAN_SWAP_INT16(ram[offs]) >> 12, 4, color_offset, gfx);
		}
	}
}
...
static void draw_block(INT32 chip, const UINT8* scale_table_ptr, INT32 scale_line_count, INT32 x, INT32 y, INT32 size,
                       INT32 flipx, INT32 flipy, UINT32 sprite, INT32 color, INT32 bank, INT32 block)
{
...
static void draw_sprites(INT32 chip, UINT8* source8, INT32 bank)
{
	...
	for (INT32 offs = 0; offs < 0x800; offs += 4)
	{
		...
		if ((colour == 0xf7 || colour == 0xffff || colour == 0x43f9) && (sprite == 0x3fff || sprite == 0xffff || sprite
			== 0x0001))
			continue;
		// sprite 1, color 0x43f9 is the dead sprite in the top-right of the screen in Mechanized Attack's High Score table.
		...
		if (y > 320 || y < -256) y &= 0x1ff;
		// fix for bbusters ending & "Zing!" attract-mode fullscreen zombie & Helicopter on the 3rd rotation of the attractmode sequence
...
static INT32 DrvScan(INT32 nAction, INT32* pnMin)
{
	...
	if (nAction & ACB_NVRAM && game_select == 0)
	{
		// bbusters only!
		ba.Data = DrvEeprom;
		ba.nLen = 0x00100;
...
struct BurnDriver BurnDrvBbusters = {
	"bbusters", nullptr, nullptr, nullptr, "1989",
	"Beast Busters (World)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, bbustersRomInfo, bbustersRomName, nullptr, nullptr, nullptr, nullptr, BbustersInputInfo, BbustersDIPInfo,
...
struct BurnDriver BurnDrvBbustersu = {
	"bbustersu", "bbusters", nullptr, nullptr, "1989",
	"Beast Busters (US, Version 3)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, bbustersuRomInfo, bbustersuRomName, nullptr, nullptr, nullptr, nullptr, BbustersInputInfo, BbustersDIPInfo,
	DrvInit, DrvExit, DrvFrame, BbustersDraw, DrvScan, &DrvRecalc, 0x600,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvBbustersua = {
	"bbustersua", "bbusters", nullptr, nullptr, "1989",
	"Beast Busters (US, Version 2)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, bbustersuaRomInfo, bbustersuaRomName, nullptr, nullptr, nullptr, nullptr, BbustersInputInfo,
	BbustersDIPInfo,
	DrvInit, DrvExit, DrvFrame, BbustersDraw, DrvScan, &DrvRecalc, 0x600,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvBbustersj = {
	"bbustersj", "bbusters", nullptr, nullptr, "1989",
	"Beast Busters (Japan, Version 2, 3 Player)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, bbustersjRomInfo, bbustersjRomName, nullptr, nullptr, nullptr, nullptr, Bbusters2pInputInfo,
	Bbusters2pDIPInfo,
	DrvInit, DrvExit, DrvFrame, BbustersDraw, DrvScan, &DrvRecalc, 0x600,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvBbustersja = {
	"bbustersja", "bbusters", nullptr, nullptr, "1989",
	"Beast Busters (Japan, Version 2, 2 Player)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, bbustersjaRomInfo, bbustersjaRomName, nullptr, nullptr, nullptr, nullptr, Bbusters2pInputInfo,
	Bbusters2pDIPInfo,
	DrvInit, DrvExit, DrvFrame, BbustersDraw, DrvScan, &DrvRecalc, 0x600,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvMechatt = {
	"mechatt", nullptr, "ym2608", nullptr, "1989",
	"Mechanized Attack (World)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, mechattRomInfo, mechattRomName, nullptr, nullptr, nullptr, nullptr, MechattInputInfo, MechattDIPInfo,
...
struct BurnDriver BurnDrvMechattj = {
	"mechattj", "mechatt", "ym2608", nullptr, "1989",
	"Mechanized Attack (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, mechattjRomInfo, mechattjRomName, nullptr, nullptr, nullptr, nullptr, MechattInputInfo, MechattDIPInfo,
...
struct BurnDriver BurnDrvMechattu = {
	"mechattu", "mechatt", "ym2608", nullptr, "1989",
	"Mechanized Attack (US)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, mechattuRomInfo, mechattuRomName, nullptr, nullptr, nullptr, nullptr, MechattInputInfo, MechattuDIPInfo,
	MechattInit, DrvExit, DrvFrame, MechattDraw, DrvScan, &DrvRecalc, 0x400,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvMechattu1 = {
	"mechattu1", "mechatt", "ym2608", nullptr, "1989",
	"Mechanized Attack (US, Version 1, Single Player)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, mechattu1RomInfo, mechattu1RomName, nullptr, nullptr, nullptr, nullptr, MechattInputInfo, MechattuDIPInfo,
	MechattjInit, DrvExit, DrvFrame, MechattDraw, DrvScan, &DrvRecalc, 0x400,
	256, 224, 4, 3
};
