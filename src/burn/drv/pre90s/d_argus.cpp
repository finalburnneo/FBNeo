...
static INT32 MemIndex()
{
	...
	DrvPalette32 = (UINT32*)Next;
	Next += 0x0400 * sizeof(UINT32);

	DrvTransBuffer = (UINT32*)Next;
	Next += 512 * 512 * sizeof(UINT32);
...
static void draw_sprite_blend(INT32 bgmask, INT32 code, INT32 sx, INT32 sy, INT32 flipx, INT32 flipy, INT32 color,
                              INT32 depth, INT32 mask, INT32 color_offset, UINT8* gfx)
{
	gfx += (code * 16 * 16);
		...
		for (INT32 x = 0; x < 16; x++)
		{
			...
			if (c != mask)
			{
				...
				if (a & 8)
				{
					...
					PutPix(pBurnDraw + (dst * nBurnBpp),
					       BurnHighCol((d / 0x10000) & 0xff, (d / 0x100) & 0xff, d & 0xff, 0));
				}
				else
				{
...
static void draw_mosaic()
{
	...
	{
		auto pTempDraw = (UINT16*)DrvTransBuffer;
		...
		else if (offs >= 0x580 && offs <= 0x61f)
		{
			for (INT32 i = 0; i <= 1; i++)
			{
				for (INT32 j = 0; j <= 1; j++)
				{
					...
					draw_sprite_blend(0x200, code + td, sx + j * 16, sy - i * 16, flipx, flipy, color, 4, 7, 0,
					                  DrvGfxROM0);
				}
			}
		}
...
struct BurnDriver BurnDrvArgus = {
	"argus", nullptr, nullptr, nullptr, "1986",
	"Argus\0", nullptr, "NMK (Jaleco license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, argusRomInfo, argusRomName, nullptr, nullptr, nullptr, nullptr, ArgusInputInfo, ArgusDIPInfo,
...
struct BurnDriver BurnDrvValtric = {
	"valtric", nullptr, nullptr, nullptr, "1986",
	"Valtric\0", nullptr, "NMK (Jaleco license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, valtricRomInfo, valtricRomName, nullptr, nullptr, nullptr, nullptr, ValtricInputInfo, ValtricDIPInfo,
...
struct BurnDriver BurnDrvButasan = {
	"butasan", nullptr, nullptr, nullptr, "1987",
	"Butasan - Pig's & Bomber's (Japan, English)\0", nullptr, "NMK (Jaleco license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, butasanRomInfo, butasanRomName, nullptr, nullptr, nullptr, nullptr, ButasanInputInfo, ButasanDIPInfo,
...
struct BurnDriver BurnDrvButasanj = {
	"butasanj", "butasan", nullptr, nullptr, "1987",
	"Butasan (Japan, Japanese)\0", nullptr, "NMK (Jaleco license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, butasanjRomInfo, butasanjRomName, nullptr, nullptr, nullptr, nullptr, ButasanInputInfo, ButasanDIPInfo,
	ButasanInit, DrvExit, DrvFrame, ButasanDraw, DrvScan, &DrvRecalc, 0x300,
	256, 240, 4, 3
};
