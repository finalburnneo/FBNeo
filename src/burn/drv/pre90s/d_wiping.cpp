...
static void draw_sprites()
{
	for (INT32 offs = 0; offs < 128; offs += 2)
	{
		...
		RenderTileTranstabOffset(pTransDraw, DrvGfxROM1, code, (color << 2), 0x1f, sx - 40, sy, flipx, flipy, 16, 16,
		                         DrvTransTab + 0x100, 0x100);
	}
}
	...
	{
		{
			...
			CompileInput(DrvJoy, DrvInputs, 2, 8, DrvJoyInit);
...
struct BurnDriver BurnDrvWiping = {
	"wiping", nullptr, nullptr, nullptr, "1982",
	"Wiping\0", nullptr, "Nichibutsu", "Miscellaneous",
	...
	nullptr, wipingRomInfo, wipingRomName, nullptr, nullptr, nullptr, nullptr, WipingInputInfo, WipingDIPInfo,
...
struct BurnDriver BurnDrvRugrats = {
	"rugrats", "wiping", nullptr, nullptr, "1983",
	"Rug Rats\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, rugratsRomInfo, rugratsRomName, nullptr, nullptr, nullptr, nullptr, WipingInputInfo, RugratsDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 288, 3, 4
};
