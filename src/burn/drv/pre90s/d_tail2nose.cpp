...
static void __fastcall tail2nose_main_write_byte(UINT32 address, UINT8 data)
{
	...
	case 0xfff001:
		{
			static constexpr INT32 banks[6] = {0, 1, -1, -1, 2, 2};
...
static INT32 MemIndex()
{
	...
	Next += 0x0800 * sizeof(int);

	AllRam = Next;

	soundlatch = Next;
	Next += 0x000001 + 3; // +3 align variable memory
	char_bank = Next;
	Next += 0x000001 + 3;
	video_enable = Next;
	Next += 0x000001 + 3;
...
static INT32 DrvInit()
{
	...
	AY8910SetPorts(0, nullptr, nullptr, nullptr, bankswitch); // Really YM2608
...
static void draw_sprites()
{
	...
	for (INT32 offs = 0; offs < 0x300 / 2; offs += 4)
	{
		...
		DrawCustomMaskTile(pTransDraw, 16, 32, 0, sx + 4, sy - 9 + 2, flipx, flipy, color, 4, 0x0f, 0,
		                   DrvGfxROM1 + (code * 0x200));
	}
}
...
struct BurnDriver BurnDrvTail2nos = {
	"tail2nos", nullptr, "ym2608", nullptr, "1989",
	"Tail to Nose - Great Championship / Super Formula\0", nullptr, "V-System Co.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, tail2nosRomInfo, tail2nosRomName, nullptr, nullptr, nullptr, nullptr, Tail2nosInputInfo, Tail2nosDIPInfo,
...
struct BurnDriver BurnDrvTail2nosa = {
	"tail2nosa", "tail2nos", "ym2608", nullptr, "1989",
	"Tail to Nose - Great Championship\0", nullptr, "V-System Co.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, tail2nosaRomInfo, tail2nosaRomName, nullptr, nullptr, nullptr, nullptr, Tail2nosInputInfo, Tail2nosDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvSformula = {
	"sformula", "tail2nos", "ym2608", nullptr, "1989",
	"Super Formula (Japan, set 1)\0", nullptr, "V-System Co.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, sformulaRomInfo, sformulaRomName, nullptr, nullptr, nullptr, nullptr, Tail2nosInputInfo, Tail2nosDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvSformulaa = {
	"sformulaa", "tail2nos", "ym2608", nullptr, "1989",
	"Super Formula (Japan, set 2)\0", nullptr, "V-System Co.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, sformulaaRomInfo, sformulaaRomName, nullptr, nullptr, nullptr, nullptr, Tail2nosInputInfo, Tail2nosDIPInfo,
