...
{
	static constexpr UINT8 coinage1[2][2] = {{1, 1}, {1, 2}};
	static constexpr UINT8 coinage2[2][2] = {{1, 5}, {2, 1}};
...
static INT32 DrvInit()
{
	...
	AY8910SetPorts(0, &ay8910_port_a_r, nullptr, nullptr, nullptr);
...
static void draw_layer()
{
	...
	for (INT32 i = 0; i < 0x4000; i++)
	{
		...
		{
			pTransDraw[sy * 232 + sx + (x ^ 3)] = (data & 1) | ((data >> 3) & 2) | ((data >> 6) & 4) | ((data >> 9) &
				8);
		}
	}
}
...
struct BurnDriver BurnDrvMeijinsn = {
	"meijinsn", nullptr, nullptr, nullptr, "1986",
	"Meijinsen (set 1)\0", nullptr, "SNK Electronics corp.", "Miscellaneous",
	L"\u540D\u4EBA\u6226\0Meijinsen (set 1)\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_PUZZLE, 0,
	nullptr, meijinsnRomInfo, meijinsnRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvMeijinsna = {
	"meijinsna", "meijinsn", nullptr, nullptr, "1986",
	"Meijinsen (set 2)\0", nullptr, "SNK Electronics corp.", "Miscellaneous",
	L"\u540D\u4EBA\u6226\0Meijinsen (set 2)\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_PUZZLE, 0,
	nullptr, meijinsnaRomInfo, meijinsnaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	232, 224, 4, 3
};
