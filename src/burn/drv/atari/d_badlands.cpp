...
static void __fastcall badlands_main_write_byte(UINT32 address, UINT8 data)
{
	if ((address & 0xfffc00) == 0xfff000)
	{
		...
		if ((address & 0x200) == 0)
		{
			AtariMoExpandedWrite(0, (address / 2) & 0xff,
			                     BURN_ENDIAN_SWAP_INT16(*((UINT16*)(Drv68KRAM + (address & 0xffe)))));
		}
		return;
	}
...
struct BurnDriver BurnDrvBadlands = {
	"badlands", nullptr, nullptr, nullptr, "1989",
	"Bad Lands\0", nullptr, "Atari Games", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, badlandsRomInfo, badlandsRomName, nullptr, nullptr, nullptr, nullptr, BadlandsInputInfo, BadlandsDIPInfo,
