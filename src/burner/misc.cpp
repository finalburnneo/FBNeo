...
void ComputeGammaLUT()
{
	...
	{
		GammaLUT[i] = static_cast<UINT8>(static_cast<double>(nMaxRGB) * pow((i / 255.0), nGamma));
	}
}
	...
	if (nGenre)
	{
		if (nGenre & GBF_HORSHOOT)
		{
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre),
			          FBALoadStringEx(hAppInst, IDS_GENRE_HORSHOOT, true));
		...
		{
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre),
			          FBALoadStringEx(hAppInst, IDS_GENRE_VERSHOOT, true));
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre), _T(", "));
		}
		...
		{
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre),
			          FBALoadStringEx(hAppInst, IDS_GENRE_SCRFIGHT, true));
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre), _T(", "));
		}
		...
		{
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre),
			          FBALoadStringEx(hAppInst, IDS_GENRE_BREAKOUT, true));
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre), _T(", "));
		}
		...
		{
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre),
			          FBALoadStringEx(hAppInst, IDS_GENRE_BALLPADDLE, true));
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre), _T(", "));
		}
		...
		{
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre),
			          FBALoadStringEx(hAppInst, IDS_GENRE_MINIGAMES, true));
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre), _T(", "));
		}
		...
		{
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre),
			          FBALoadStringEx(hAppInst, IDS_GENRE_PLATFORM, true));
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre), _T(", "));
		}
		...
		{
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre),
			          FBALoadStringEx(hAppInst, IDS_GENRE_SPORTSMISC, true));
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre), _T(", "));
		}
		...
		{
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre),
			          FBALoadStringEx(hAppInst, IDS_GENRE_SPORTSFOOTBALL, true));
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre), _T(", "));
		}
		...
		{
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre),
			          FBALoadStringEx(hAppInst, IDS_GENRE_STRATEGY, true));
			_stprintf(szDecoratedGenre + _tcslen(szDecoratedGenre), _T(", "));
		}
