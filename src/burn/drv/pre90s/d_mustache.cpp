...
static void decode_gfx()
{
	...
	/* SPR address lines */
	for (i = 0; i < 2 * G2; i++)
		gfx2[i] = buf[BITSWAP24(i, 23, 22, 21, 20, 19, 18, 17, 16, 15, 12, 11, 10, 9, 8, 7, 6, 5, 4, 13, 14, 3, 2, 1,
		                        0)];
...
static void draw_sprites()
{
	for (INT32 offs = 0; offs < 0x0800; offs += 4)
	{
		...
		if (flipscreen)
		{
			Render16x16Tile_Mask_FlipXY_Clip(pTransDraw, code, (232 - sx) - 8, (232 - sy) + 8, color, 4, 0, 0x80,
			                                 DrvGfxROM1);
		}
		else
		{
...
struct BurnDriver BurnDrvMustache = {
	"mustache", nullptr, nullptr, nullptr, "1987",
	"Mustache Boy (Japan)\0", nullptr, "Seibu Kaihatsu (March license)", "Miscellaneous",
	...
	nullptr, mustacheRomInfo, mustacheRomName, nullptr, nullptr, nullptr, nullptr, MustacheInputInfo, MustacheDIPInfo,
...
struct BurnDriver BurnDrvMustachei = {
	"mustachei", "mustache", nullptr, nullptr, "1987",
	"Mustache Boy (Italy)\0", nullptr, "Seibu Kaihatsu (IG SPA license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, mustacheiRomInfo, mustacheiRomName, nullptr, nullptr, nullptr, nullptr, MustacheInputInfo, MustacheDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	248, 240, 3, 4
};
