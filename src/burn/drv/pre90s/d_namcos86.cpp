...
{
	constexpr INT32 vol_table[4] = {26, 84, 200, 258};
		...
		if (v->playing)
		{
			...
			for (INT32 p = 0; p < samples; p++)
			{
				...
				else
				{
					...
					if (data == 0x00) // silence compression
					{
...
static INT32 CommonInit(INT32 nSubCPUConfig, INT32 pcmdata)
{
	...
	if (has_pcm)
	{
		stream.init(6000, nBurnSoundRate, 1, true, namco_63701x_update);
				...
				for (INT32 x = 0; x < sizex; x++, sx++)
				{
					...
					if (pxl != 0x0f)
					{
						if ((pri_mask & (1 << (pPrioDraw[(sy * nScreenWidth) + sx] & 0x1f))) == 0)
						{
							...
							// or enemies in wonder momo show up through the audience...
						}
					}
				}
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[3] = {
		(static_cast<double>(1536000) * 100 / nBurnFPS), (static_cast<double>(1536000) * 100 / nBurnFPS),
		(static_cast<double>(1536000) * 100 / nBurnFPS)
	};
...
struct BurnDriver BurnDrvSkykiddx = {
	"skykiddx", nullptr, nullptr, nullptr, "1986",
	"Sky Kid Deluxe (set 1)\0", nullptr, "Namco", "System 86",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, skykiddxRomInfo, skykiddxRomName, nullptr, nullptr, nullptr, nullptr, CommonInputInfo, SkykiddxDIPInfo,
...
struct BurnDriver BurnDrvSkykiddxo = {
	"skykiddxo", "skykiddx", nullptr, nullptr, "1986",
	"Sky Kid Deluxe (set 2)\0", nullptr, "Namco", "System 86",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_HORSHOOT, 0,
	nullptr, skykiddxoRomInfo, skykiddxoRomName, nullptr, nullptr, nullptr, nullptr, CommonInputInfo, SkykiddxDIPInfo,
	SkykiddxInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvHopmappy = {
	"hopmappy", nullptr, nullptr, nullptr, "1986",
	"Hopping Mappy\0", nullptr, "Namco", "System 86",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PUZZLE, 0,
	nullptr, hopmappyRomInfo, hopmappyRomName, nullptr, nullptr, nullptr, nullptr, HopmappyInputInfo, HopmappyDIPInfo,
...
struct BurnDriver BurnDrvRoishtar = {
	"roishtar", nullptr, nullptr, nullptr, "1986",
	"The Return of Ishtar\0", nullptr, "Namco", "System 86",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, roishtarRomInfo, roishtarRomName, nullptr, nullptr, nullptr, nullptr, RoishtarInputInfo, RoishtarDIPInfo,
...
struct BurnDriver BurnDrvGenpeitd = {
	"genpeitd", nullptr, nullptr, nullptr, "1986",
	"Genpei ToumaDen\0", nullptr, "Namco", "System 86",
	L"Genpei ToumaDen\0\u906E\u735E\u0E8A\u549B\u1D4F\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, genpeitdRomInfo, genpeitdRomName, nullptr, nullptr, nullptr, nullptr, CommonInputInfo, GenpeitdDIPInfo,
...
struct BurnDriver BurnDrvRthunder = {
	"rthunder", nullptr, nullptr, nullptr, "1986",
	"Rolling Thunder (rev 3)\0", nullptr, "Namco", "System 86",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, rthunderRomInfo, rthunderRomName, nullptr, nullptr, nullptr, nullptr, CommonInputInfo, RthunderDIPInfo,
...
struct BurnDriver BurnDrvRthundera = {
	"rthundera", "rthunder", nullptr, nullptr, "1986",
	"Rolling Thunder (rev 3, hack)\0", nullptr, "bootleg", "System 86",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, rthunderaRomInfo, rthunderaRomName, nullptr, nullptr, nullptr, nullptr, CommonInputInfo, Rthunder1DIPInfo,
	RthunderInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvRthunder2 = {
	"rthunder2", "rthunder", nullptr, nullptr, "1986",
	"Rolling Thunder (rev 2)\0", nullptr, "Namco", "System 86",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, rthunder2RomInfo, rthunder2RomName, nullptr, nullptr, nullptr, nullptr, CommonInputInfo, Rthunder1DIPInfo,
	RthunderInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvRthunder1 = {
	"rthunder1", "rthunder", nullptr, nullptr, "1986",
	"Rolling Thunder (rev 1)\0", nullptr, "Namco", "System 86",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, rthunder1RomInfo, rthunder1RomName, nullptr, nullptr, nullptr, nullptr, CommonInputInfo, Rthunder1DIPInfo,
	RthunderInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvRthunder0 = {
	"rthunder0", "rthunder", nullptr, nullptr, "1986",
	"Rolling Thunder (oldest)\0", nullptr, "Namco", "System 86",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, rthunder0RomInfo, rthunder0RomName, nullptr, nullptr, nullptr, nullptr, CommonInputInfo, Rthunder1DIPInfo,
	RthunderInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvWndrmomo = {
	"wndrmomo", nullptr, nullptr, nullptr, "1987",
	"Wonder Momo\0", nullptr, "Namco", "System 86",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, wndrmomoRomInfo, wndrmomoRomName, nullptr, nullptr, nullptr, nullptr, CommonInputInfo, WndrmomoDIPInfo,
