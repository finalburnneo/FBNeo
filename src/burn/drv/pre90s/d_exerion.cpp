...
static INT32 MemIndex()
{
	...
	Next += 0x008000;
	DrvGfxROM[1] = Next;
	Next += 0x010000; // 16x16 sprites
	DrvGfxROM[3] = Next;
	Next += 0x040000; // 32x32 sprites (doubled above)
	DrvGfxROM[2] = Next;
	Next += 0x008000;
	...
	background_latches = Next;
	Next += 0x000010;

	RamEnd = Next;

	Background = (UINT16*)Next;
	Next += 512 * 256 * sizeof(UINT16);
...
static INT32 DrvInit()
{
	...
	AY8910SetPorts(1, &AY8910_1_portA_read, nullptr, nullptr, &AY8910_1_portB_write);
...
static void draw_sprites()
{
	for (INT32 i = 0; i < 0x80; i += 4)
	{
		...
		if (wide)
		{
			...
			RenderTileTranstabOffset(pTransDraw, DrvGfxROM[(doubled) ? 3 : 1], code2, color << 2, 0x10, x, y + px - 16,
			                         xflip, yflip, px, px, DrvTransTab + 0x100, 0x100);
		}

		RenderTileTranstabOffset(pTransDraw, DrvGfxROM[(doubled) ? 3 : 1], code, color << 2, 0x10, x, y - 16, xflip,
		                         yflip, px, px, DrvTransTab + 0x100, 0x100);
...
struct BurnDriver BurnDrvExerion = {
	"exerion", nullptr, nullptr, nullptr, "1983",
	"Exerion\0", nullptr, "Jaleco", "Miscellaneous",
	...
	nullptr, exerionRomInfo, exerionRomName, nullptr, nullptr, nullptr, nullptr, ExerionInputInfo, ExerionDIPInfo,
...
struct BurnDriver BurnDrvExeriont = {
	"exeriont", "exerion", nullptr, nullptr, "1983",
	"Exerion (Taito)\0", nullptr, "Jaleco (Taito America license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, exeriontRomInfo, exeriontRomName, nullptr, nullptr, nullptr, nullptr, ExerionInputInfo, ExerionDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	224, 320, 3, 4
};
...
struct BurnDriver BurnDrvExerionb = {
	"exerionb", "exerion", nullptr, nullptr, "1983",
	"Exerion (bootleg, set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_CLONE | BDF_BOOTLEG |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, exerionbRomInfo, exerionbRomName, nullptr, nullptr, nullptr, nullptr, ExerionInputInfo, ExerionDIPInfo,
...
struct BurnDriver BurnDrvIrion = {
	"irion", "exerion", nullptr, nullptr, "1983",
	"Irion\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_CLONE | BDF_BOOTLEG |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, irionRomInfo, irionRomName, nullptr, nullptr, nullptr, nullptr, ExerionInputInfo, ExerionDIPInfo,
	ExerionbInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x300,
	224, 320, 3, 4
};
