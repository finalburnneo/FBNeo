...
static struct BurnInputInfo DadandrnInputList[] = {
	...
	{"Service",		BIT_DIGITAL,	DrvJoy1 + 13,	"service"},
	{"Dip A",		BIT_DIPSWITCH,	DrvDips + 0,	"dip"},
};
...
struct BurnDriver BurnDrvMystwarr = {
	...
	MystwarrInit, DrvExit, DrvFrame, DrvDraw, NULL, &DrvRecalc, 0x0800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvViostorm = {
	...
	ViostormInit, DrvExit, DrvFrame, DrvDraw, NULL, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvMetamrph = {
	...
	MetamrphInit, DrvExit, DrvFrame, DrvDraw, NULL, &DrvRecalc, 0x0800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMtlchamp = {
	...
	MartchmpInit, DrvExit, DrvFrame, DrvDraw, NULL, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvGaiapols = {
	...
	GaiapolisInit, DrvExit, DrvFrame, DrvDraw, NULL, &DrvRecalc, 0x800,
	224, 376, 3, 4
};
...
struct BurnDriver BurnDrvMmaulers = {
	...
	DadandrnInit, DrvExit, DrvFrame, DrvDraw, NULL, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
