...
static void draw_background_and_text()
{
	...
	for (INT32 y = 0; y < nScreenHeight; y++)
	{
		...
		for (INT32 x = 0; x < nScreenWidth; x += 2)
		{
			...
			switch (sx & 0x06)
			{
			case 0x00: bg_col = ((bg_data1 & 0x80) >> 4) | ((bg_data1 & 0x08) >> 1) | ((bg_data2 & 0x80) >> 6) | ((
					bg_data2 & 0x08) >> 3);
				break;
			case 0x02: bg_col = ((bg_data1 & 0x40) >> 3) | ((bg_data1 & 0x04) >> 0) | ((bg_data2 & 0x40) >> 5) | ((
					bg_data2 & 0x04) >> 2);
				break;
			case 0x04: bg_col = ((bg_data1 & 0x20) >> 2) | ((bg_data1 & 0x02) << 1) | ((bg_data2 & 0x20) >> 4) | ((
					bg_data2 & 0x02) >> 1);
				break;
			default: bg_col = ((bg_data1 & 0x10) >> 1) | ((bg_data1 & 0x01) << 2) | ((bg_data2 & 0x10) >> 3) | ((
					bg_data2 & 0x01) >> 0);
				break;
			}
...
struct BurnDriver BurnDrvJedi = {
	"jedi", nullptr, nullptr, nullptr, "1984",
	"Return of the Jedi\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_RACING | GBF_ACTION, 0,
	nullptr, jediRomInfo, jediRomName, nullptr, nullptr, nullptr, nullptr, JediInputInfo, JediDIPInfo,
