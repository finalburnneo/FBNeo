	...
	else
	{
		...
		case 0:
			...
			case 9: // background loop
				BurnSampleSetLoop(address, false);
				BurnSampleStop(address);
				return;
			case 8: // thrust
				BurnSampleStop(address);
		...
		case 1:
			...
			case 9: // background loop
				BurnSampleStop(address);
				BurnSampleSetLoop(address, true);
				BurnSamplePlay(address);
				return;
			case 8: // thrust
...
struct BurnDriver BurnDrvZerohour = {
	"zerohour", nullptr, nullptr, "zerohour", "1980",
	"Zero Hour (set 1)\0", nullptr, "Universal", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, zerohourRomInfo, zerohourRomName, nullptr, nullptr, zerohourSampleInfo, zerohourSampleName,
	RedclashInputInfo, ZerohourDIPInfo,
...
struct BurnDriver BurnDrvZerohoura = {
	"zerohoura", "zerohour", nullptr, "zerohour", "1980",
	"Zero Hour (set 2)\0", nullptr, "Universal", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, zerohouraRomInfo, zerohouraRomName, nullptr, nullptr, zerohourSampleInfo, zerohourSampleName,
	RedclashInputInfo, ZerohourDIPInfo,
	ZerohourInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x80,
	192, 248, 3, 4
};
...
struct BurnDriver BurnDrvZerohouri = {
	"zerohouri", "zerohour", nullptr, "zerohour", "1980",
	"Zero Hour (bootleg)\0", nullptr, "bootleg (Inder SA)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, zerohouriRomInfo, zerohouriRomName, nullptr, nullptr, zerohourSampleInfo, zerohourSampleName,
	RedclashInputInfo, ZerohourDIPInfo,
	ZerohourInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x80,
	192, 248, 3, 4
};
...
struct BurnDriver BurnDrvRedclash = {
	"redclash", nullptr, nullptr, nullptr, "1981",
	"Red Clash\0", "NO Sound", "Kaneko", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, redclashRomInfo, redclashRomName, nullptr, nullptr, nullptr, nullptr, RedclashInputInfo, RedclashDIPInfo,
...
struct BurnDriver BurnDrvRedclasht = {
	"redclasht", "redclash", nullptr, nullptr, "1981",
	"Red Clash (Tehkan, set 1)\0", "NO Sound", "Kaneko (Tehkan license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, redclashtRomInfo, redclashtRomName, nullptr, nullptr, nullptr, nullptr, RedclashInputInfo, RedclashDIPInfo,
...
struct BurnDriver BurnDrvRedclashta = {
	"redclashta", "redclash", nullptr, nullptr, "1981",
	"Red Clash (Tehkan, set 2)\0", "NO Sound", "Kaneko (Tehkan license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, redclashtaRomInfo, redclashtaRomName, nullptr, nullptr, nullptr, nullptr, RedclashInputInfo,
	RedclashDIPInfo,
	RedclashtInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x80,
	192, 248, 3, 4
};
...
struct BurnDriver BurnDrvRedclashs = {
	"redclashs", "redclash", nullptr, nullptr, "1982",
	"Red Clash (Suntronics)\0", "NO Sound", "Kaneko (Suntronics license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, redclashsRomInfo, redclashsRomName, nullptr, nullptr, nullptr, nullptr, RedclashInputInfo, RedclashDIPInfo,
	RedclashtInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x80,
	192, 248, 3, 4
};
