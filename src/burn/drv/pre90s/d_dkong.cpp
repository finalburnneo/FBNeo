...
static constexpr double cd4049_vl = 1.5 / 5.0;
static constexpr double cd4049_vh = 3.5 / 5.0;
static constexpr double cd4049_al = 0.01;
static const double cd4049_b = (log(0.0 - log(cd4049_al)) - log(0.0 - log((1.0 - cd4049_al)))) / log(
	cd4049_vh / cd4049_vl);
...
{
	{0x0a, 0xff, 0xff, 0x80, nullptr},
	{0x0b, 0xff, 0xff, 0x03, nullptr},
...
{
	{0x10, 0xff, 0xff, 0x81, nullptr},
	{0x11, 0xff, 0xff, 0x01, nullptr},
...
{
	INT32 cyc = static_cast<INT64>(ZetTotalCycles(0)) * (6000000 / 15) / 3072000;
...
static inline void dkongjr_sample_play(INT32 offs, UINT8 data, INT32 stop)
// jump, land[s], roar, snapjaw[s], death[s], drop
{
...
static constexpr eeprom_interface braze_eeprom_intf =
{
	7, // address bits
	8, // data bits
	"*110", // read command
...
static void braze_decrypt_rom()
{
	...
	{
		tmp[(BITSWAP08(i >> 8, 7, 2, 3, 1, 0, 6, 4, 5) << 8) | (i & 0xff)] = BITSWAP08(
			DrvZ80ROM[i], 1, 4, 5, 7, 6, 0, 3, 2);
	}
...
{
	DACWrite(0, static_cast<INT32>(data * exp(-envelope_ctr)));
	if (decay)
	{
		envelope_ctr += 0.001;
	}
...
static INT32 MemIndex()
{
	...
	Next += 0x000400;
	DrvMapROM = Next;
	Next += 0x000200; // for s2650 sets

	DrvRevMap = (INT32*)Next;
	Next += 0x000200 * sizeof(INT32);

	DrvPalette = (UINT32*)Next;
	Next += 0x0209 * sizeof(UINT32);
...
static constexpr res_net_decode_info dkong_decode_info = {
	2, 0, 255,
	{256, 256, 0, 0, 0, 0},
	{1, -2, 0, 0, 2, 0},
...
static constexpr res_net_info dkong_net_info = {
...
static constexpr res_net_info dkong_net_bg_info = {
	RES_NET_VCC_5V | RES_NET_VBIAS_5V | RES_NET_VIN_MB7052 | RES_NET_MONITOR_SANYO_EZV20,
	{
...
static constexpr res_net_info radarscp_net_info = {
...
static constexpr res_net_info radarscp_net_bck_info = {
	RES_NET_VCC_5V | RES_NET_VBIAS_TTL | RES_NET_VIN_MB7052 | RES_NET_MONITOR_SANYO_EZV20,
	{
...
static constexpr res_net_info radarscp_stars_net_info = {
...
static constexpr res_net_info radarscp_blue_net_info = {
...
static constexpr res_net_info radarscp_grid_net_info = {
	RES_NET_VCC_5V | RES_NET_VBIAS_5V | RES_NET_VIN_TTL_OUT | RES_NET_MONITOR_SANYO_EZV20,
	{
...
static constexpr res_net_info radarscp1_net_info = {
	RES_NET_VCC_5V | RES_NET_VBIAS_5V | RES_NET_VIN_TTL_OUT | RES_NET_MONITOR_SANYO_EZV20,
	{
...
static constexpr res_net_decode_info dkong3_decode_info = {
	1, 0, 255,
	{0, 0, 256},
	{4, 0, 0},
	{0x0F, 0x0F, 0x0F}
...
static constexpr res_net_info dkong3_net_info = {
	RES_NET_VCC_5V | RES_NET_VBIAS_5V | RES_NET_VIN_MB7052 | RES_NET_MONITOR_SANYO_EZV20,
	{
...
static void radarscpPaletteInit()
{
	for (INT32 i = 0; i < 256; i++)
	{
		...
		INT32 g = compute_res_net(((DrvColPROM[i + 256] << 2) & 0x04) | ((DrvColPROM[i] >> 2) & 0x03), 1,
		                          radarscp_net_info);
...
static void update_palette_type(INT32 dip_offset)
{
	if (palette_type != (DrvDips[dip_offset]))
	{
		...
		switch (palette_type)
		{
		case 0x00: DrvPaletteUpdate = radarscpPaletteInit;
			break; // radarscpPaletteInit in conversion mode
		case 0x01: DrvPaletteUpdate = dkongNewPaletteInit;
			break;
		case 0x02: DrvPaletteUpdate = dkongPaletteInit;
			break;
		case 0x03: DrvPaletteUpdate = radarscpPaletteInit;
			break; // radarscpPaletteInit in normal mode
		case 0x04: DrvPaletteUpdate = radarscp1PaletteInit;
			break;
		case 0x05: DrvPaletteUpdate = dkong3NewPaletteInit;
			break;
		case 0x06: DrvPaletteUpdate = dkong3PaletteInit;
			break;
		}
	}
}
...
static ior_in_functs dkong_dma_read_functions[4] = {nullptr, p8257ControlRead, nullptr, nullptr};
static ior_out_functs dkong_dma_write_functions[4] = {p8257ControlWrite, nullptr, nullptr, nullptr};
...
static INT32 s2650DkongInit(INT32 (*pRomLoadCallback)())
{
	...
	i8257Init();
	i8257Config(hb_dma_read_byte, hb_dma_write_byte, /*s2650Idle*/nullptr, dkong_dma_read_functions,
	            dkong_dma_write_functions);
...
static void radarscp_step(INT32 line_cnt)
{
	...
	{
		double f = static_cast<double>(j) / 100.0;
	...
	{
		double f = static_cast<double>(j) / 40.0;
	...
	blue_level = static_cast<INT32>(vo / 5.0 * 255);
	...
	while (scanline < 264)
	{
		...
		while (pBurnDraw && col < 384)
		{
			...
			UINT8 draw_ok = !(pTransDraw[(y) * nScreenWidth + x] & 0x01) && !(pTransDraw[(y) * nScreenWidth + x] & 0x02)
				&& (y >= 0 && y < nScreenHeight && x >= 0 && x < nScreenWidth);
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[2] = {
		static_cast<INT32>(static_cast<double>(3072000) / 60.606061),
		static_cast<INT32>(static_cast<double>(6000000) / 15 / 60.606061)
	};
	...
	nExtraCycles[0] = ZetTotalCycles() - nCyclesTotal[0];
	// ZetTotalCycles() because _SYNCINT and calling ZetIdle() by the dma engine.
...
struct BurnDriver BurnDrvRadarscp = {
	"radarscp", nullptr, nullptr, "radarscp", "1980",
	"Radar Scope (TRS02, rev. D)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, radarscpRomInfo, radarscpRomName, nullptr, nullptr, RadarscpSampleInfo, RadarscpSampleName,
	RadarscpInputInfo, RadarscpDIPInfo,
...
struct BurnDriver BurnDrvRadarscpc = {
	"radarscpc", "radarscp", nullptr, "radarscp", "1980",
	"Radar Scope (TRS02?, rev. C)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, radarscpcRomInfo, radarscpcRomName, nullptr, nullptr, RadarscpSampleInfo, RadarscpSampleName,
	RadarscpInputInfo, RadarscpDIPInfo,
	radarscpInit, DrvExit, DrvFrame, radarscpDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvRadarscp1 = {
	"radarscp1", "radarscp", nullptr, "radarscp", "1980",
	"Radar Scope (TRS01)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, radarscp1RomInfo, radarscp1RomName, nullptr, nullptr, RadarscpSampleInfo, RadarscpSampleName,
	RadarscpInputInfo, Radarscp1DIPInfo,
...
struct BurnDriver BurnDrvDkong = {
	"dkong", nullptr, nullptr, "dkong", "1981",
	"Donkey Kong (US set 1)\0", nullptr, "Nintendo of America", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongRomInfo, dkongRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
...
struct BurnDriver BurnDrvDkonghrd = {
	"dkonghrd", "dkong", nullptr, "dkong", "1981",
	"Donkey Kong (hard kit)\0", nullptr, "Nintendo of America", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkonghrdRomInfo, dkonghrdRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongo = {
	"dkongo", "dkong", nullptr, "dkong", "1981",
	"Donkey Kong (US set 2)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongoRomInfo, dkongoRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongj = {
	"dkongj", "dkong", nullptr, "dkong", "1981",
	"Donkey Kong (Japan set 1)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongjRomInfo, dkongjRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongjo = {
	"dkongjo", "dkong", nullptr, "dkong", "1981",
	"Donkey Kong (Japan set 2)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongjoRomInfo, dkongjoRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongjo1 = {
	"dkongjo1", "dkong", nullptr, "dkong", "1981",
	"Donkey Kong (Japan set 3)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongjo1RomInfo, dkongjo1RomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongf = {
	"dkongf", "dkong", nullptr, "dkong", "2004",
	"Donkey Kong Foundry (hack)\0", nullptr, "hack (Jeff Kulczycki)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongfRomInfo, dkongfRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkcbarrel = {
	"dkcbarrel", "dkong", nullptr, "dkong", "2019",
	"Donkey Kong Crazy Barrels Edition\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkcbarrelRomInfo, dkcbarrelRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkfreerun = {
	"dkfreerun", "dkong", nullptr, "dkong", "2019",
	"Donkey Kong Freerun Edition\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkfreerunRomInfo, dkfreerunRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongran1 = {
	"dkongran1", "dkong", nullptr, "dkong", "2020",
	"Donkey Kong Randomized Edition v1.01\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongran1RomInfo, dkongran1RomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongchm = {
	"dkongchm", "dkong", nullptr, "dkong", "2020",
	"Donkey Kong League Championship v1.00\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongchmRomInfo, dkongchmRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongchm1 = {
	"dkongchm1", "dkong", nullptr, "dkong", "2020",
	"Donkey Kong Championship Edition v1.01\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongchm1RomInfo, dkongchm1RomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongst = {
	"dkongst", "dkong", nullptr, "dkong", "2019",
	"Donkey Kong Springs Trainer\0", nullptr, "Sock Master", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongstRomInfo, dkongstRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongst2 = {
	"dkongst2", "dkong", nullptr, "dkong", "2020",
	"Donkey Kong Springs Trainer 2\0", nullptr, "Sock Master", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongst2RomInfo, dkongst2RomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongss = {
	"dkongss", "dkong", nullptr, "dkong", "2020",
	"Donkey Kong Skip Start v1.00\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongssRomInfo, dkongssRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongotr = {
	"dkongotr", "dkong", nullptr, "dkong", "2020",
	"Donkey Kong On the Run v1.02\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongotrRomInfo, dkongotrRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongitd = {
	"dkongitd", "dkong", nullptr, "dkong", "2020",
	"Donkey Kong In the Dark v1.02\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongitdRomInfo, dkongitdRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongtj = {
	"dkongtj", "dkong", nullptr, "dkong", "2021",
	"Donkey Kong Twisted Jungle v1.05\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongtjRomInfo, dkongtjRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongbp = {
	"dkongbp", "dkong", nullptr, "dkong", "2021",
	"Donkey Kong Barrelpalooza v1.06\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongbpRomInfo, dkongbpRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongbp1 = {
	"dkongbp1", "dkong", nullptr, "dkong", "2021",
	"Donkey Kong Barrelpalooza v1.07\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongbp1RomInfo, dkongbp1RomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongpe = {
	"dkongpe", "dkong", nullptr, "dkong", "2013",
	"Donkey Kong: Pauline Edition Rev 5 (2013-04-22)\0", nullptr, "hack (Clay Cowgill and Mike Mika)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongpeRomInfo, dkongpeRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkrainbow = {
	"dkrainbow", "dkong", nullptr, "dkong", "2015",
	"Donkey Kong - Arcade Rainbow (hack)\0", nullptr, "hack (john Kowalski)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkrainbowRomInfo, dkrainbowRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvKong2600 = {
	"kong2600", "dkong", nullptr, "dkong", "1999",
	"Donkey Kong (2600 graphics, hack)\0", nullptr, "Vic Twenty George", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, kong2600RomInfo, kong2600RomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongrev = {
	"dkongrev", "dkong", nullptr, "dkong", "2019",
	"Donkey Kong Reverse (Hack)\0", nullptr, "Hack (Paul Goes)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongrevRomInfo, dkongrevRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvdkrndmzr = {
	"dkrndmzr", "dkong", nullptr, "dkong", "2022",
	"Donkey Kong RNDMZR\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkrndmzrRomInfo, dkrndmzrRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvdkwizardry = {
	"dkwizardry", "dkong", nullptr, "dkong", "2022",
	"Donkey Kong Wizardry\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkwizardryRomInfo, dkwizardryRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvdkhrthnt = {
	"dkhrthnt", "dkong", nullptr, "dkong", "2022",
	"Donkey Kong Hearthunt\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkhrthntRomInfo, dkhrthntRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvdkaccel = {
	"dkaccel", "dkong", nullptr, "dkong", "2023",
	"Donkey Kong Accelerate\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkaccelRomInfo, dkaccelRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvdkong40y = {
	"dkong40y", "dkong", nullptr, "dkong", "2021",
	"Donkey Kong Anniversary Edition\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkong40yRomInfo, dkong40yRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvdkduel = {
	"dkduel", "dkong", nullptr, "dkong", "2021",
	"Donkey Kong Duel\0", nullptr, "Paul Goes", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkduelRomInfo, dkduelRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongfDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongx = {
	"dkongx", "dkong", nullptr, "dkong", "2006",
	"Donkey Kong II: Jumpman Returns (hack, V1.2)\0", nullptr, "hack (Braze Technologies)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongxRomInfo, dkongxRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongNoDipDIPInfo,
...
struct BurnDriver BurnDrvDkongx11 = {
	"dkongx11", "dkong", nullptr, "dkong", "2006",
	"Donkey Kong II: Jumpman Returns (hack, V1.1)\0", nullptr, "hack (Braze Technologies)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongx11RomInfo, dkongx11RomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongNoDipDIPInfo,
	dkongxInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkchrmx = {
	"dkchrmx", "dkong", nullptr, "dkong", "2017",
	"Donkey Kong Christmas Remix (Hack)\0", nullptr, "Sock Master", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkchrmxRomInfo, dkchrmxRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongNoDipDIPInfo,
	dkongxInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkspkyrmx = {
	"dkspkyrmx", "dkong", nullptr, "dkong", "2018",
	"Donkey Kong Spooky Remix (Hack)\0", nullptr, "Sock Master", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkspkyrmxRomInfo, dkspkyrmxRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongNoDipDIPInfo,
	dkongxInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongp = {
	"dkongp", "dkong", nullptr, "dkong", "2007",
	"Donkey Kong (Patched)\0", nullptr, "Hack (Don Hodges)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongpRomInfo, dkongpRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkrdemo = {
	"dkrdemo", "dkong", nullptr, "dkong", "2015",
	"Donkey Kong Remix (Demo)\0", nullptr, "Hack (Sockmaster)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkrdemoRomInfo, dkrdemoRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongpac = {
	"dkongpac", "dkong", nullptr, "dkong", "2001",
	"Donkey Kong (Pacman Graphics)\0", nullptr, "Hack (Tim Appleton)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongpacRomInfo, dkongpacRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDktrainer = {
	"dktrainer", "dkong", nullptr, "dkong", "2016",
	"Donkey Kong Trainer 1.01\0", nullptr, "Hack (Sock Master)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dktrainerRomInfo, dktrainerRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkpace = {
	"dkpace", "dkong", nullptr, "dkong", "2016",
	"Donkey Kong Pace\0", nullptr, "Hack (Sock Master)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkpaceRomInfo, dkpaceRomName, nullptr, nullptr, DkongSampleInfo, DkongSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongjr = {
	"dkongjr", nullptr, nullptr, "dkongjr", "1982",
	"Donkey Kong Junior (US set F-2)\0", nullptr, "Nintendo of America", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongjrRomInfo, dkongjrRomName, nullptr, nullptr, DkongjrSampleInfo, DkongjrSampleName, DkongInputInfo,
	DkongDIPInfo,
...
struct BurnDriver BurnDrvDkongjr2 = {
	"dkongjr2", "dkongjr", nullptr, "dkongjr", "1982",
	"Donkey Kong Junior (US, bootleg?)\0", nullptr, "Nintendo of America", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongjr2RomInfo, dkongjr2RomName, nullptr, nullptr, DkongjrSampleInfo, DkongjrSampleName, DkongInputInfo,
	DkongDIPInfo,
...
struct BurnDriver BurnDrvDkongjrj = {
	"dkongjrj", "dkongjr", nullptr, "dkongjr", "1982",
	"Donkey Kong Jr. (Japan)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongjrjRomInfo, dkongjrjRomName, nullptr, nullptr, DkongjrSampleInfo, DkongjrSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongjrInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongjnrj = {
	"dkongjnrj", "dkongjr", nullptr, "dkongjr", "1982",
	"Donkey Kong Junior (Japan set F-1)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongjnrjRomInfo, dkongjnrjRomName, nullptr, nullptr, DkongjrSampleInfo, DkongjrSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongjrInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkongjrb = {
	"dkongjrb", "dkongjr", nullptr, "dkongjr", "1982",
	"Donkey Kong Jr. (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongjrbRomInfo, dkongjrbRomName, nullptr, nullptr, DkongjrSampleInfo, DkongjrSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongjrInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvJrking = {
	"jrking", "dkongjr", nullptr, "dkongjr", "1982",
	"Junior King (bootleg of Donkey Kong Jr.)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, jrkingRomInfo, jrkingRomName, nullptr, nullptr, DkongjrSampleInfo, DkongjrSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongjrInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkingjr = {
	"dkingjr", "dkongjr", nullptr, "dkongjr", "1982",
	"Donkey King Jr. (bootleg of Donkey Kong Jr.)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkingjrRomInfo, dkingjrRomName, nullptr, nullptr, DkongjrSampleInfo, DkongjrSampleName, DkongInputInfo,
	DkongDIPInfo,
...
struct BurnDriverD BurnDrvDkongjre = {
	"dkongjre", "dkongjr", nullptr, "dkongjr", "1982",
	"Donkey Kong Junior (E kit)\0", nullptr, "Nintendo of America", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongjreRomInfo, dkongjreRomName, nullptr, nullptr, DkongjrSampleInfo, DkongjrSampleName, DkongInputInfo,
	DkongDIPInfo,
...
struct BurnDriverD BurnDrvDkongjrpb = {
	"dkongjrpb", "dkongjr", nullptr, "dkongjr", "1982",
	"Donkey Kong Junior (P kit, bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_BOOTLEG | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkongjrpbRomInfo, dkongjrpbRomName, nullptr, nullptr, DkongjrSampleInfo, DkongjrSampleName, DkongInputInfo,
	DkongDIPInfo,
	dkongjrInit, DrvExit, DrvFrame, dkongDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvPestplce = {
	"pestplce", "mario", nullptr, nullptr, "1983",
	"Pest Place\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, pestplceRomInfo, pestplceRomName, nullptr, nullptr, nullptr, nullptr, PestplceInputInfo, PestplceDIPInfo,
...
struct BurnDriver BurnDrvDkong3 = {
	"dkong3", nullptr, nullptr, nullptr, "1983",
	"Donkey Kong 3 (US)\0", nullptr, "Nintendo of America", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkong3RomInfo, dkong3RomName, nullptr, nullptr, nullptr, nullptr, Dkong3InputInfo, Dkong3DIPInfo,
...
struct BurnDriver BurnDrvDkong3j = {
	"dkong3j", "dkong3", nullptr, nullptr, "1983",
	"Donkey Kong 3 (Japan)\0", nullptr, "Nintendo", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkong3jRomInfo, dkong3jRomName, nullptr, nullptr, nullptr, nullptr, Dkong3InputInfo, Dkong3DIPInfo,
	Dkong3Init, Dkong3Exit, Dkong3Frame, dkongDraw, Dkong3Scan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvDkong3b = {
	"dkong3b", "dkong3", nullptr, nullptr, "1984",
	"Donkey Kong 3 (bootleg on Donkey Kong Jr. hardware)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, dkong3bRomInfo, dkong3bRomName, nullptr, nullptr, nullptr, nullptr, DkongInputInfo, Dkong3bDIPInfo,
...
struct BurnDriver BurnDrvHerbiedk = {
	"herbiedk", "huncholy", nullptr, nullptr, "1984",
	"Herbie at the Olympics (DK conversion)\0", "No sound", "Seatongrove UK, Ltd.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, herbiedkRomInfo, herbiedkRomName, nullptr, nullptr, nullptr, nullptr, DkongInputInfo, HerbiedkDIPInfo,
...
struct BurnDriverD BurnDrvHunchbkd = {
	"hunchbkd", "hunchbak", nullptr, nullptr, "1983",
	"Hunchback (DK conversion)\0", "No sound", "Century Electronics", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PLATFORM, 0,
	nullptr, hunchbkdRomInfo, hunchbkdRomName, nullptr, nullptr, nullptr, nullptr, DkongInputInfo, HunchbkdDIPInfo,
...
struct BurnDriver BurnDrvHerodk = {
	"herodk", "hero", nullptr, nullptr, "1984",
	"Hero in the Castle of Doom (DK conversion)\0", "No sound", "Seatongrove UK, Ltd. (Crown license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, herodkRomInfo, herodkRomName, nullptr, nullptr, nullptr, nullptr, HerodkInputInfo, HerodkDIPInfo,
...
struct BurnDriver BurnDrvHerodku = {
	"herodku", "hero", nullptr, nullptr, "1984",
	"Hero in the Castle of Doom (DK conversion, not encrypted)\0", nullptr, "Seatongrove UK, Ltd. (Crown license)",
	"Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, herodkuRomInfo, herodkuRomName, nullptr, nullptr, nullptr, nullptr, HerodkInputInfo, HerodkDIPInfo,
...
struct BurnDriver BurnDrvDrakton = {
	"drakton", nullptr, nullptr, nullptr, "1984",
	"Drakton (DK conversion)\0", "No sound", "Epos Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, draktonRomInfo, draktonRomName, nullptr, nullptr, nullptr, nullptr, DkongInputInfo, DraktonDIPInfo,
...
struct BurnDriver BurnDrvDrktnjr = {
	"drktnjr", "drakton", nullptr, nullptr, "1984",
	"Drakton (DKJr conversion)\0", "No sound", "Epos Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, drktnjrRomInfo, drktnjrRomName, nullptr, nullptr, nullptr, nullptr, DkongInputInfo, DraktonDIPInfo,
