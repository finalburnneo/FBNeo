...
{
	INT32 todo = (static_cast<double>(E132XSTotalCycles()) * (1000000) / cpu_clock) - mcs51TotalCycles();
...
void Drvqs1000_serial_in(UINT8 data)
{
...

	{
		...
		mcs51Close();
		mcs51Open(0);
		INT32 todo = (static_cast<double>(sndcpu_cyc) * (2000000) / 1000000) - mcs51TotalCycles();
...
static void eolith_write_long(UINT32 address, UINT32 data)
{
	if ((address & 0xfffc0000) == 0x90000000)
	{
		...
		*((UINT32*)(DrvVidRAM + (address & 0x3fffc) + (vidrambank * 0x40000))) = BURN_ENDIAN_SWAP_INT32(
			(x & xmask) | (data & dmask));
		return;
	}
...
static void eolith_write_word(UINT32 address, UINT16 data)
{
	if ((address & 0xfffc0000) == 0x90000000)
	{
		...
		*((UINT16*)(DrvVidRAM + (address & 0x3fffe) + (vidrambank * 0x40000))) = BURN_ENDIAN_SWAP_INT16(
			(x & xmask) | (data & dmask));
		return;
	}
...
{
	auto ram = (UINT16*)(DrvVidRAM + (vidrambank ^ 1) * 0x40000);
...
{
	auto rombase = (UINT32*)DrvBootROM;
...
static INT32 IronfortInit()
{
	...
	return CommonInit(49000000, nullptr);
}

struct BurnDriver BurnDrvIronfort = {
	"ironfort", nullptr, nullptr, nullptr, "1998",
	"Iron Fortress\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, ironfortRomInfo, ironfortRomName, nullptr, nullptr, nullptr, nullptr, IronfortInputInfo, IronfortDIPInfo,
...
struct BurnDriver BurnDrvIronfortc = {
	"ironfortc", "ironfort", nullptr, nullptr, "1998",
	"Gongtit Jiucoi Iron Fortress (Hong Kong)\0", nullptr, "Eolith (Excellent Competence Ltd. license)",
	"Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, ironfortcRomInfo, ironfortcRomName, nullptr, nullptr, nullptr, nullptr, IronfortcInputInfo,
	IronfortcDIPInfo,
...
static INT32 LinkypipInit()
{
	...
	return CommonInit(45000000, nullptr);
}

struct BurnDriver BurnDrvLinkypip = {
	"linkypip", nullptr, nullptr, nullptr, "1998",
	"Linky Pipe\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, linkypipRomInfo, linkypipRomName, nullptr, nullptr, nullptr, nullptr, LinkypipInputInfo, LinkypipDIPInfo,
...
static INT32 HidnctchInit()
{
	...
	return CommonInit(50000000, nullptr);
}

struct BurnDriver BurnDrvHidnctch = {
	"hidnctch", nullptr, nullptr, nullptr, "1998",
	"Hidden Catch (World) / Tul Lin Gu Lim Chat Ki '98 (Korea) (pcb ver 3.03)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hidnctchRomInfo, hidnctchRomName, nullptr, nullptr, nullptr, nullptr, HidnctchInputInfo, HidnctchDIPInfo,
...
struct BurnDriver BurnDrvHidnctcha = {
	"hidnctcha", "hidnctch", nullptr, nullptr, "1998",
	"Hidden Catch (World) / Tul Lin Gu Lim Chat Ki '98 (Korea) (pcb ver 3.02)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hidnctchaRomInfo, hidnctchaRomName, nullptr, nullptr, nullptr, nullptr, HidnctchInputInfo, HidnctchDIPInfo,
	HidnctchInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvNhidctch = {
	"nhidctch", nullptr, nullptr, nullptr, "1999",
	"New Hidden Catch (World) / New Tul Lin Gu Lim Chat Ki '98 (Korea) (pcb ver 3.02)\0", nullptr, "Eolith",
	"Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, nhidctchRomInfo, nhidctchRomName, nullptr, nullptr, nullptr, nullptr, Hidctch2InputInfo, Hidctch2DIPInfo,
...
struct BurnDriver BurnDrvHidctch2 = {
	"hidctch2", nullptr, nullptr, nullptr, "1999",
	"Hidden Catch 2 (pcb ver 3.03) (Kor/Eng) (AT89c52 protected)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hidctch2RomInfo, hidctch2RomName, nullptr, nullptr, nullptr, nullptr, Hidctch2InputInfo, Hidctch2DIPInfo,
...
struct BurnDriver BurnDrvHidctch2a = {
	"hidctch2a", "hidctch2", nullptr, nullptr, "1999",
	"Hidden Catch 2 (pcb ver 1.00) (Kor/Eng/Jpn/Chi)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hidctch2aRomInfo, hidctch2aRomName, nullptr, nullptr, nullptr, nullptr, Hidctch2InputInfo, Hidctch2DIPInfo,
...
struct BurnDriver BurnDrvHidnc2k = {
	"hidnc2k", nullptr, nullptr, nullptr, "1999",
	"Hidden Catch 2000 (AT89c52 protected)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hidnc2kRomInfo, hidnc2kRomName, nullptr, nullptr, nullptr, nullptr, Hidctch2InputInfo, Hidctch2DIPInfo,
...
struct BurnDriver BurnDrvRaccoon = {
	"raccoon", nullptr, nullptr, nullptr, "1998",
	"Raccoon World\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, raccoonRomInfo, raccoonRomName, nullptr, nullptr, nullptr, nullptr, RaccoonInputInfo, RaccoonDIPInfo,
...
struct BurnDriver BurnDrvLandbrk = {
	"landbrk", nullptr, nullptr, nullptr, "1999",
	"Land Breaker (World) / Miss Tang Ja Ru Gi (Korea) (pcb ver 3.02)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, landbrkRomInfo, landbrkRomName, nullptr, nullptr, nullptr, nullptr, LandbrkInputInfo, LandbrkDIPInfo,
...
struct BurnDriver BurnDrvLandbrka = {
	"landbrka", "landbrk", nullptr, nullptr, "1999",
	"Land Breaker (World) / Miss Tang Ja Ru Gi (Korea) (pcb ver 3.03) (AT89c52 protected)\0", nullptr, "Eolith",
	"Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, landbrkaRomInfo, landbrkaRomName, nullptr, nullptr, nullptr, nullptr, LandbrkInputInfo, LandbrkDIPInfo,
...
struct BurnDriver BurnDrvLandbrkb = {
	"landbrkb", "landbrk", nullptr, nullptr, "1999",
	"Land Breaker (World) / Miss Tang Ja Ru Gi (Korea) (pcb ver 1.0) (AT89c52 protected)\0", nullptr, "Eolith",
	"Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, landbrkbRomInfo, landbrkbRomName, nullptr, nullptr, nullptr, nullptr, LandbrkInputInfo, LandbrkDIPInfo,
...
struct BurnDriver BurnDrvPenfan = {
	"penfan", nullptr, nullptr, nullptr, "1999",
	"Penfan Girls - Step1. Mild Mind (set 1)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, penfanRomInfo, penfanRomName, nullptr, nullptr, nullptr, nullptr, PenfanInputInfo, PenfanDIPInfo,
...
struct BurnDriver BurnDrvPenfana = {
	"penfana", "penfan", nullptr, nullptr, "1999",
	"Penfan Girls - Step1. Mild Mind (set 2)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, penfanaRomInfo, penfanaRomName, nullptr, nullptr, nullptr, nullptr, PenfanInputInfo, PenfanDIPInfo,
...
struct BurnDriver BurnDrvStealsee = {
	"stealsee", nullptr, nullptr, nullptr, "2000",
	"Steal See\0", nullptr, "Moov Generation / Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, stealseeRomInfo, stealseeRomName, nullptr, nullptr, nullptr, nullptr, StealseeInputInfo, StealseeDIPInfo,
...
struct BurnDriver BurnDrvCandy = {
	"candy", nullptr, nullptr, nullptr, "1999",
	"Candy Candy\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, candyRomInfo, candyRomName, nullptr, nullptr, nullptr, nullptr, CandyInputInfo, CandyDIPInfo,
...
struct BurnDriver BurnDrvFort2b = {
	"fort2b", nullptr, nullptr, nullptr, "2001",
	"Fortress 2 Blue Arcade (World) (ver 1.01 / pcb ver 3.05)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, fort2bRomInfo, fort2bRomName, nullptr, nullptr, nullptr, nullptr, PenfanInputInfo, Fort2bDIPInfo,
...
struct BurnDriver BurnDrvFort2ba = {
	"fort2ba", "fort2b", nullptr, nullptr, "2001",
	"Fortress 2 Blue Arcade (Korea) (ver 1.00 / pcb ver 3.05)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, fort2baRomInfo, fort2baRomName, nullptr, nullptr, nullptr, nullptr, PenfanInputInfo, Fort2bDIPInfo,
	Fort2bInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x8000,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvPuzzlekg = {
	"puzzlekg", nullptr, nullptr, nullptr, "1998",
	"Puzzle King (Dance & Puzzle)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, puzzlekgRomInfo, puzzlekgRomName, nullptr, nullptr, nullptr, nullptr, PuzzlekgInputInfo, PuzzlekgDIPInfo,
...
struct BurnDriver BurnDrvHidctch3 = {
	"hidctch3", nullptr, nullptr, nullptr, "2000",
	"Hidden Catch 3 (ver 1.00 / pcb ver 3.05)\0", nullptr, "Eolith", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, hidctch3RomInfo, hidctch3RomName, nullptr, nullptr, nullptr, nullptr, Hidctch3InputInfo, Hidctch3DIPInfo,
