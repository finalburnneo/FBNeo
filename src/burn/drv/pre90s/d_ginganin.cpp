...
{
	return static_cast<INT64>(M6809TotalCycles()) * nSoundRate / 1000000;
}
...
static INT32 DrvInit()
{
	...
	BurnY8950Init(1, 3579545, DrvSndROM, 0x20000, nullptr, 0, nullptr, &DrvSynchroniseStream, 1);
...
static void draw_layer(UINT8* ram, UINT8* gfx, INT32 color_offset, INT32 wide, INT32 scroll_offset, INT32 transparent)
{
	...
	for (INT32 offs = 0; offs < 16 * 16 + 16; offs++)
	{
		...
		if (*flipscreen)
		{
			if (transparent)
			{
				Render16x16Tile_Mask_FlipXY_Clip(pTransDraw, attr & 0x3ff, 240 - sx, 240 - sy - 16, attr >> 12, 4, 0x0f,
				                                 color_offset, gfx);
			}
			else
			{
				Render16x16Tile_FlipXY_Clip(pTransDraw, attr & 0x3ff, 240 - sx, 240 - sy - 16, attr >> 12, 4,
				                            color_offset, gfx);
			}
		}
		else
		{
			if (transparent)
			{
				Render16x16Tile_Mask_Clip(pTransDraw, attr & 0x3ff, sx, sy - 16, attr >> 12, 4, 0x0f, color_offset,
				                          gfx);
			}
			else
			{
...
static void draw_txt_layer()
{
	...
	for (INT32 offs = 0; offs < 32 * 32; offs++)
	{
		...
		if (*flipscreen)
		{
			Render8x8Tile_Mask_FlipXY(pTransDraw, attr & 0x1ff, sx ^ 0xf8, (sy ^ 0xf8) - 16, attr >> 12, 4, 0x0f, 0x000,
			                          DrvGfxROM2);
		}
		else
		{
...
struct BurnDriver BurnDrvGinganin = {
	"ginganin", nullptr, nullptr, nullptr, "1987",
	"Ginga Ninkyouden (set 1)\0", nullptr, "Jaleco", "Miscellaneous",
	L"\u9280\u6CB3\u4EFB\u4FA0\u4F1D\0Ginga NinkyouDen (set 1)\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, ginganinRomInfo, ginganinRomName, nullptr, nullptr, nullptr, nullptr, GinganinInputInfo, GinganinDIPInfo,
...
struct BurnDriver BurnDrvGinganina = {
	"ginganina", "ginganin", nullptr, nullptr, "1987",
	"Ginga Ninkyouden (set 2)\0", nullptr, "Jaleco", "Miscellaneous",
	L"\u9280\u6CB3\u4EFB\u4FA0\u4F1D\0Ginga NinkyouDen (set 2)\0", nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, ginganinaRomInfo, ginganinaRomName, nullptr, nullptr, nullptr, nullptr, GinganinInputInfo, GinganinDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 224, 4, 3
};
