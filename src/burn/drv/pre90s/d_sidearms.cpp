...
{
	{0x14, 0xff, 0xff, 0xbd, nullptr},
	{0x15, 0xff, 0xff, 0xeb, nullptr},
...
static void DrvGfxDecode()
{
	...
	INT32 XOffs1[32] = {
		STEP4(0, 1), STEP4(8, 1), STEP4(512, 1), STEP4(512+8, 1), STEP4(1024, 1), STEP4(1024+8, 1), STEP4(1536, 1),
		STEP4(1536+8, 1)
	};
...
static void sidearms_draw_starfield()
{
	...
	for (INT32 y = 16; y < (16 + nScreenHeight); y++)
	{
		...
		for (INT32 x = 0; x < nScreenWidth; lineptr++, x++)
		{
			...
			*lineptr = static_cast<UINT16>((latch_374 >> 5) | 0x378);
		}
	}
}
...
static void draw_bg_layer(INT32 type)
{
	...
	for (INT32 y = 0; y < 256; y += 32)
	{
		...
		for (INT32 x = 0; x < 416; x += 32)
		{
			...
			if (type)
			{
				Draw32x32Tile(pTransDraw, code | ((attr & 0x80) << 2), sx, sy, flipx, flipy, color & 0x0f, 4, 0,
				              DrvGfxROM1);
			}
			else
			{
...
struct BurnDriver BurnDrvSidearms = {
	"sidearms", nullptr, nullptr, nullptr, "1986",
	"Side Arms - Hyper Dyne (World, 861129)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_HORSHOOT, 0,
	nullptr, sidearmsRomInfo, sidearmsRomName, nullptr, nullptr, nullptr, nullptr, SidearmsInputInfo, SidearmsDIPInfo,
...
struct BurnDriver BurnDrvSidearmsu = {
	"sidearmsu", "sidearms", nullptr, nullptr, "1986",
	"Side Arms - Hyper Dyne (US, 861202)\0", nullptr, "Capcom (Romstar license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_HORSHOOT, 0,
	nullptr, sidearmsuRomInfo, sidearmsuRomName, nullptr, nullptr, nullptr, nullptr, SidearmsInputInfo, SidearmsDIPInfo,
	SidearmsInit, DrvExit, DrvFrame, SidearmsDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvSidearmsur1 = {
	"sidearmsur1", "sidearms", nullptr, nullptr, "1986",
	"Side Arms - Hyper Dyne (US, 861128)\0", nullptr, "Capcom (Romstar license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_HORSHOOT, 0,
	nullptr, sidearmsur1RomInfo, sidearmsur1RomName, nullptr, nullptr, nullptr, nullptr, SidearmsInputInfo,
	SidearmsDIPInfo,
	SidearmsInit, DrvExit, DrvFrame, SidearmsDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvSidearmsj = {
	"sidearmsj", "sidearms", nullptr, nullptr, "1986",
	"Side Arms - Hyper Dyne (Japan, 861128)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_HORSHOOT, 0,
	nullptr, sidearmsjRomInfo, sidearmsjRomName, nullptr, nullptr, nullptr, nullptr, SidearmsInputInfo, SidearmsDIPInfo,
	SidearmsInit, DrvExit, DrvFrame, SidearmsDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
static struct BurnRomInfo turtshipRomDesc[] = {
	...
	{"82s123.9e", 0x00020, 0xc5817816, 7 | BRF_OPT},
	// 18 Tied to the sound Z80 and without it there's no sound on the real PCB
};
...
struct BurnDriver BurnDrvTurtship = {
	"turtship", nullptr, nullptr, nullptr, "1988",
	"Turtle Ship (North America)\0", nullptr, "Philko (Sharp Image license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, turtshipRomInfo, turtshipRomName, nullptr, nullptr, nullptr, nullptr, TurtshipInputInfo, TurtshipDIPInfo,
...
struct BurnDriver BurnDrvTurtshipj = {
	"turtshipj", "turtship", nullptr, nullptr, "1988",
	"Turtle Ship (Japan)\0", nullptr, "Philko (Pacific Games license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, turtshipjRomInfo, turtshipjRomName, nullptr, nullptr, nullptr, nullptr, TurtshipInputInfo, TurtshipDIPInfo,
	TurtshipInit, DrvExit, DrvFrame, TurtshipDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvTurtshipk = {
	"turtshipk", "turtship", nullptr, nullptr, "1988",
	"Turtle Ship (Korea)\0", nullptr, "Philko", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, turtshipkRomInfo, turtshipkRomName, nullptr, nullptr, nullptr, nullptr, TurtshipInputInfo, TurtshipDIPInfo,
...
struct BurnDriver BurnDrvTurtshipko = {
	"turtshipko", "turtship", nullptr, nullptr, "1988",
	"Turtle Ship (Korea, older)\0", nullptr, "Philko", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, turtshipkoRomInfo, turtshipkoRomName, nullptr, nullptr, nullptr, nullptr, TurtshipInputInfo,
	TurtshipDIPInfo,
	TurtshipInit, DrvExit, DrvFrame, TurtshipDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvTurtshipkn = {
	"turtshipkn", "turtship", nullptr, nullptr, "1988",
	"Turtle Ship (Korea, 88/9)\0", nullptr, "Philko", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, turtshipknRomInfo, turtshipknRomName, nullptr, nullptr, nullptr, nullptr, TurtshipInputInfo,
	TurtshipDIPInfo,
	TurtshipInit, DrvExit, DrvFrame, TurtshipDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvDyger = {
	"dyger", nullptr, nullptr, nullptr, "1989",
	"Dyger (Korea set 1)\0", nullptr, "Philko", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, dygerRomInfo, dygerRomName, nullptr, nullptr, nullptr, nullptr, DygerInputInfo, DygerDIPInfo,
...
struct BurnDriver BurnDrvDygera = {
	"dygera", "dyger", nullptr, nullptr, "1989",
	"Dyger (Korea set 2)\0", nullptr, "Philko", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, dygeraRomInfo, dygeraRomName, nullptr, nullptr, nullptr, nullptr, DygerInputInfo, DygerDIPInfo,
	DygerInit, DrvExit, DrvFrame, DygerDraw, DrvScan, &DrvRecalc, 0x800,
	224, 384, 3, 4
};
...
struct BurnDriver BurnDrvTwinfalc = {
	"twinfalc", nullptr, nullptr, nullptr, "1989",
	"Twin Falcons\0", nullptr, "Philko (Poara Enterprises license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, twinfalcRomInfo, twinfalcRomName, nullptr, nullptr, nullptr, nullptr, WhizzInputInfo, WhizzDIPInfo,
...
struct BurnDriver BurnDrvWhizz = {
	"whizz", "twinfalc", nullptr, nullptr, "1989",
	"Whizz\0", nullptr, "Philko", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, whizzRomInfo, whizzRomName, nullptr, nullptr, nullptr, nullptr, WhizzInputInfo, WhizzDIPInfo,
	WhizzInit, DrvExit, DrvFrame, DygerDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
