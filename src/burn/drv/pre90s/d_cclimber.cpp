...
static void cclimber_render(INT16* buffer, INT32 nLen)
{
	...
	while (pos < nLen)
	{
		INT32 sample = static_cast<INT32>(rom[(sample_pos >> 16)] * 0.2);
...
static INT32 MemIndex()
{
	...
	samplebuf = (INT16*)Next;
	Next += 0x0010000 * sizeof(INT16); //decoded sample
...
static INT32 DrvGfxDecode(UINT8* gfx_base, UINT8* gfx_dest, INT32 len, INT32 size)
{
	...
	{
		// swimmer, guzzler
		GfxDecode(((len * 8) / 3) / (size * size), 3, size, size, PlaneSwimmer, XOffs, YOffs, (size * size), tmp,
		          gfx_dest);
	}
	else
	{
...
static INT32 GetRoms()
{
	...
	for (INT32 i = 0; !BurnDrvGetRomName(&pRomName, i, 0); i++)
	{
		...
		if ((ri.nType & 7) == 2)
		{
			...
			if (gfx0_cont800)
			{
				// loads 0x800 bytes at 0x0000 and 0x1000
...
static INT32 DrvInit()
{
	...
	// 9800 - 981f colscroll, 9880 989f sprram, 98dc - 98df bigspritecontrol
	...
	AY8910SetPorts(0, nullptr, nullptr, &cclimber_sample_select_w, nullptr);
...
static INT32 DrvFrame()
{
...

	{
		...
		CompileInput(DrvJoys, DrvInputs, 4, 8, JoyInit);
...
struct BurnDriver BurnDrvCclimber = {
	"cclimber", nullptr, nullptr, nullptr, "1980",
	"Crazy Climber (US set 1)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, cclimberRomInfo, cclimberRomName, nullptr, nullptr, nullptr, nullptr, CclimberInputInfo, CclimberDIPInfo,
...
struct BurnDriver BurnDrvCclimbera = {
	"cclimbera", "cclimber", nullptr, nullptr, "1980",
	"Crazy Climber (US set 2)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, cclimberaRomInfo, cclimberaRomName, nullptr, nullptr, nullptr, nullptr, CclimberInputInfo, CclimberDIPInfo,
	cclimberInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x60,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvCclimberj = {
	"cclimberj", "cclimber", nullptr, nullptr, "1980",
	"Crazy Climber (Japan)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, cclimberjRomInfo, cclimberjRomName, nullptr, nullptr, nullptr, nullptr, CclimberInputInfo,
	CclimberjDIPInfo,
...
struct BurnDriver BurnDrvCkongpt2 = {
	"ckongpt2", nullptr, nullptr, nullptr, "1981",
	"Crazy Kong Part II (set 1)\0", nullptr, "Falcon", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, ckongpt2RomInfo, ckongpt2RomName, nullptr, nullptr, nullptr, nullptr, CkongInputInfo, CkongDIPInfo,
...
struct BurnDriver BurnDrvCkongpt2a = {
	"ckongpt2a", "ckongpt2", nullptr, nullptr, "1981",
	"Crazy Kong Part II (set 2)\0", nullptr, "Falcon", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PLATFORM, 0,
	nullptr, ckongpt2aRomInfo, ckongpt2aRomName, nullptr, nullptr, nullptr, nullptr, CkongInputInfo, CkongDIPInfo,
	ckongInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x60,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCkongpt2j = {
	"ckongpt2j", "ckongpt2", nullptr, nullptr, "1981",
	"Crazy Kong Part II (Japan)\0", nullptr, "Falcon", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PLATFORM, 0,
	nullptr, ckongpt2jRomInfo, ckongpt2jRomName, nullptr, nullptr, nullptr, nullptr, CkongInputInfo, CkongDIPInfo,
	ckongInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x60,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCkongpt2jeu = {
	"ckongpt2jeu", "ckongpt2", nullptr, nullptr, "1981",
	"Crazy Kong Part II (Jeutel bootleg)\0", nullptr, "bootleg (Jeutel)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, ckongpt2jeuRomInfo, ckongpt2jeuRomName, nullptr, nullptr, nullptr, nullptr, CkongInputInfo, CkongDIPInfo,
	ckongInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x60,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCkongpt2b = {
	"ckongpt2b", "ckongpt2", nullptr, nullptr, "1981",
	"Crazy Kong Part II (alternative levels)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, ckongpt2bRomInfo, ckongpt2bRomName, nullptr, nullptr, nullptr, nullptr, CkongInputInfo, CkongbDIPInfo,
...
struct BurnDriver BurnDrvCkongpt2b2 = {
	"ckongpt2b2", "ckongpt2", nullptr, nullptr, "1981",
	"Crazy Kong Part II (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, ckongpt2b2RomInfo, ckongpt2b2RomName, nullptr, nullptr, nullptr, nullptr, CkongInputInfo, Ckongb2DIPInfo,
	ckongInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x60,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCkong = {
	"ckong", nullptr, nullptr, nullptr, "1981",
	"Crazy Kong\0", nullptr, "Kyoei / Falcon", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, ckongRomInfo, ckongRomName, nullptr, nullptr, nullptr, nullptr, CkongInputInfo, CkongDIPInfo,
	ckongInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x60,
	224, 256, 3, 4
};
...
{
	static constexpr UINT8 convtable[32][4] =
	{
		/*       opcode                   data                     address      */
		/*  A    B    C    D         A    B    C    D                           */
...
struct BurnDriver BurnDrvYamato = {
	"yamato", nullptr, nullptr, nullptr, "1983",
	"Yamato (US)\0", nullptr, "Sega", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, yamatoRomInfo, yamatoRomName, nullptr, nullptr, nullptr, nullptr, YamatoInputInfo, YamatoDIPInfo,
...
struct BurnDriver BurnDrvYamato2 = {
	"yamato2", "yamato", nullptr, nullptr, "1983",
	"Yamato (World?)\0", nullptr, "Sega", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, yamato2RomInfo, yamato2RomName, nullptr, nullptr, nullptr, nullptr, YamatoInputInfo, YamatoDIPInfo,
	yamatoInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvGuzzler = {
	"guzzler", nullptr, nullptr, nullptr, "1983",
	"Guzzler\0", nullptr, "Tehkan", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_MAZE | GBF_ACTION, 0,
	nullptr, guzzlerRomInfo, guzzlerRomName, nullptr, nullptr, nullptr, nullptr, GuzzlerInputInfo, GuzzlerDIPInfo,
...
struct BurnDriver BurnDrvSwimmer = {
	"swimmer", nullptr, nullptr, nullptr, "1982",
	"Swimmer (set 1)\0", nullptr, "Tehkan", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, swimmerRomInfo, swimmerRomName, nullptr, nullptr, nullptr, nullptr, SwimmerInputInfo, SwimmerDIPInfo,
	guzzlerInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvRpatrol = {
	"rpatrol", nullptr, nullptr, nullptr, "1981",
	"River Patrol (Japan)\0", nullptr, "Orca", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, rpatrolRomInfo, rpatrolRomName, nullptr, nullptr, nullptr, nullptr, RpatrolInputInfo, RpatrolDIPInfo,
...
struct BurnDriver BurnDrvRpatroln = {
	"rpatroln", "rpatrol", nullptr, nullptr, "1981",
	"River Patrol (Japan, unprotected)\0", nullptr, "Orca", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, rpatrolnRomInfo, rpatrolnRomName, nullptr, nullptr, nullptr, nullptr, RpatrolInputInfo, RpatrolDIPInfo,
...
struct BurnDriver BurnDrvRpatrolb = {
	"rpatrolb", "rpatrol", nullptr, nullptr, "1981",
	"River Patrol (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, rpatrolbRomInfo, rpatrolbRomName, nullptr, nullptr, nullptr, nullptr, RpatrolInputInfo, RpatrolDIPInfo,
...
struct BurnDriver BurnDrvSilvland = {
	"silvland", "rpatrol", nullptr, nullptr, "1981",
	"Silver Land (hack of River Patrol)\0", nullptr, "Falcon", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, silvlandRomInfo, silvlandRomName, nullptr, nullptr, nullptr, nullptr, RpatrolInputInfo, RpatrolDIPInfo,
