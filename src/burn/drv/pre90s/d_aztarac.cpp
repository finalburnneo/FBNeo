			...
			if (c & 0xff00)
			{
				...
				while (ndefs--)
				{
					...
					if ((c & 0xff00) == 0)
						...
						vector_add_point((xcenter + ((x + xoffset) << 16)), (ycenter - ((y + yoffset) << 16)), color,
						                 intensity);
				}
			}
			else
...
static INT32 DrvFrame()
{
	...
	for (INT32 i = 0; i < nInterleave; i++, sound_irq_timer++)
	{
		...
		if ((sound_irq_timer % 40) == 39)
		{
			// every 20000 cycles, 50000 / frame
			sound_status ^= 0x10;
...
struct BurnDriver BurnDrvAztarac = {
	"aztarac", nullptr, nullptr, nullptr, "1983",
	"Aztarac\0", "Vector graphics", "Centuri", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, aztaracRomInfo, aztaracRomName, nullptr, nullptr, nullptr, nullptr, AztaracInputInfo, AztaracDIPInfo,
