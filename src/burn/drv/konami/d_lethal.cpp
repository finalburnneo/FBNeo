...
static constexpr eeprom_interface lethalen_eeprom_interface =
{
	7,
	8,
	"011000",
...
static INT32 DrvGfxDecode()
{
	...
	INT32 XOffs1[16] = {
		0, 1, 2, 3, 4, 5, 6, 7, 8 * 32 + 0, 8 * 32 + 1, 8 * 32 + 2, 8 * 32 + 3, 8 * 32 + 4, 8 * 32 + 5, 8 * 32 + 6,
		8 * 32 + 7
	};
	INT32 YOffs1[16] = {
		0 * 32, 1 * 32, 2 * 32, 3 * 32, 4 * 32, 5 * 32, 6 * 32, 7 * 32, 16 * 32, 17 * 32, 18 * 32, 19 * 32, 20 * 32,
		21 * 32, 22 * 32, 23 * 32
	};
...
static INT32 DrvFrame()
{
...

	{
		...
		if (ReloadGun0)
		{
			// for simulated reload-gun button
			DrvJoy1[4] = 1;
		}
		if (ReloadGun1)
		{
...
struct BurnDriver BurnDrvLethalen = {
	"lethalen", nullptr, nullptr, nullptr, "1992",
	"Lethal Enforcers (ver UAE, 11/19/92 15:04)\0", nullptr, "Konami", "GX191",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, lethalenRomInfo, lethalenRomName, nullptr, nullptr, nullptr, nullptr, LethalenInputInfo, LethalenDIPInfo,
...
struct BurnDriver BurnDrvLethalenub = {
	"lethalenub", "lethalen", nullptr, nullptr, "1992",
	"Lethal Enforcers (ver UAB, 09/01/92 11:12)\0", nullptr, "Konami", "GX191",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, lethalenubRomInfo, lethalenubRomName, nullptr, nullptr, nullptr, nullptr, LethalenInputInfo,
	LethalenDIPInfo,
	LethalenInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvLethalenua = {
	"lethalenua", "lethalen", nullptr, nullptr, "1992",
	"Lethal Enforcers (ver UAA, 08/17/92 21:38)\0", nullptr, "Konami", "GX191",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, lethalenuaRomInfo, lethalenuaRomName, nullptr, nullptr, nullptr, nullptr, LethalenInputInfo,
	LethalenDIPInfo,
	LethalenInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvLethalenux = {
	"lethalenux", "lethalen", nullptr, nullptr, "1992",
	"Lethal Enforcers (ver unknown, US, 08/06/92 15:11, hacked/proto?)\0", nullptr, "Konami", "GX191",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, lethalenuxRomInfo, lethalenuxRomName, nullptr, nullptr, nullptr, nullptr, LethalenInputInfo,
	LethalenDIPInfo,
	LethalenInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvLethaleneaa = {
	"lethaleneaa", "lethalen", nullptr, nullptr, "1992",
	"Lethal Enforcers (ver EAA, 09/09/92 09:44)\0", nullptr, "Konami", "GX191",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, lethaleneaaRomInfo, lethaleneaaRomName, nullptr, nullptr, nullptr, nullptr, LethalenInputInfo,
	LethalenDIPInfo,
	LethalenInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvLethaleneab = {
	"lethaleneab", "lethalen", nullptr, nullptr, "1992",
	"Lethal Enforcers (ver EAB, 10/14/92 19:53)\0", nullptr, "Konami", "GX191",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, lethaleneabRomInfo, lethaleneabRomName, nullptr, nullptr, nullptr, nullptr, LethalenInputInfo,
	LethalenDIPInfo,
	LethalenInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvLethalenead = {
	"lethalenead", "lethalen", nullptr, nullptr, "1992",
	"Lethal Enforcers (ver EAD, 11/11/92 10:52)\0", nullptr, "Konami", "GX191",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, lethaleneadRomInfo, lethaleneadRomName, nullptr, nullptr, nullptr, nullptr, LethalenInputInfo,
	LethalenDIPInfo,
	LethalenInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvLethaleneae = {
	"lethaleneae", "lethalen", nullptr, nullptr, "1992",
	"Lethal Enforcers (ver EAE, 11/19/92 16:24)\0", nullptr, "Konami", "GX191",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	nullptr, lethaleneaeRomInfo, lethaleneaeRomName, nullptr, nullptr, nullptr, nullptr, LethalenInputInfo,
	LethalenDIPInfo,
	LethalenInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	288, 224, 4, 3
};
...
struct BurnDriverD BurnDrvLethalenj = {
	"lethalenj", "lethalen", nullptr, nullptr, "1992",
	...
	nullptr, lethalenjRomInfo, lethalenjRomName, nullptr, nullptr, nullptr, nullptr, LethalenInputInfo, LethalenDIPInfo,
