...
static UINT16* pMystwarrRozBitmap = nullptr;
...
{
	{0x26, 0xff, 0xff, 0xe0, nullptr},
	{0x27, 0xff, 0xff, 0x00, nullptr},
...
static void K055550_word_write(INT32 offset, UINT16 data, UINT16 mask)
{
	...
	if (offset == 0 && (mask & 0x00ff))
	{
		...
		// let's hope GCC will inline the mem24bew calls
			...
			{
				cx1 = static_cast<INT16>(SekReadWord(src));
				sx1 = static_cast<INT16>(SekReadWord(src + 2));
				wx1 = static_cast<INT16>(SekReadWord(src + 4));

				cy1 = static_cast<INT16>(SekReadWord(src + 6));
				sy1 = static_cast<INT16>(SekReadWord(src + 8));
				wy1 = static_cast<INT16>(SekReadWord(src + 10));

				cz1 = static_cast<INT16>(SekReadWord(src + 12));
				sz1 = static_cast<INT16>(SekReadWord(src + 14));
				wz1 = static_cast<INT16>(SekReadWord(src + 16));

				count = i = src + skip;
				tgt = src + bsize;

				for (; count < static_cast<UINT32>(tgt); count++) SekWriteByte(count, 0);

				for (; tgt < tgtend; i++, tgt += bsize)
				{
					c2 = static_cast<INT16>(SekReadWord(tgt));
					s2 = static_cast<INT16>(SekReadWord(tgt + 2));
					w2 = static_cast<INT16>(SekReadWord(tgt + 4));
					if (abs((cx1 + sx1) - (c2 + s2)) >= wx1 + w2) continue; // X rejection

					c2 = static_cast<INT16>(SekReadWord(tgt + 6));
					s2 = static_cast<INT16>(SekReadWord(tgt + 8));
					w2 = static_cast<INT16>(SekReadWord(tgt + 10));
					if (abs((cy1 + sy1) - (c2 + s2)) >= wy1 + w2) continue; // Y rejection

					c2 = static_cast<INT16>(SekReadWord(tgt + 12));
					s2 = static_cast<INT16>(SekReadWord(tgt + 14));
					w2 = static_cast<INT16>(SekReadWord(tgt + 16));
		...
		case 0xc0: // calculate object "homes-in" vector (Violent Storm at 0x03da9e)
			dx = static_cast<INT16>(prot_data[0xc]);
			dy = static_cast<INT16>(prot_data[0xd]);
		...
		// only calls the service once per enemy per frame.
			if (dx)
			{
				if (dy)
				{
					angle = static_cast<INT32>((atan(static_cast<double>(dy) / dx) * 128.0) / M_PI);
					if (dx < 0) angle += 128;
					i = (angle - 0x40) & 0xff;
				}
				else
...
static constexpr eeprom_interface mystwarr_eeprom_interface =
{
	7, /* address bits */
	8, /* data bits */
	"011000", /*  read command */
...
static constexpr eeprom_interface gaiapolis_eeprom_interface =
{
	7, /* address bits */
	8, /* data bits */
	"011000", /*  read command */
...
static void decode_gfx1(UINT8* src, UINT8* d, INT32 len)
{
	...
	while (s < pFinish)
	{
		INT32 d0 = ((s[0] & 0x80) << 0) | ((s[0] & 0x08) << 3) | ((s[1] & 0x80) >> 2) | ((s[1] & 0x08) << 1) | ((s[2] &
			0x80) >> 4) | ((s[2] & 0x08) >> 1) | ((s[3] & 0x80) >> 6) | ((s[3] & 0x08) >> 3);
		INT32 d1 = ((s[0] & 0x40) << 1) | ((s[0] & 0x04) << 4) | ((s[1] & 0x40) >> 1) | ((s[1] & 0x04) << 2) | ((s[2] &
			0x40) >> 3) | ((s[2] & 0x04) >> 0) | ((s[3] & 0x40) >> 5) | ((s[3] & 0x04) >> 2);
		INT32 d2 = ((s[0] & 0x20) << 2) | ((s[0] & 0x02) << 5) | ((s[1] & 0x20) << 0) | ((s[1] & 0x02) << 3) | ((s[2] &
			0x20) >> 2) | ((s[2] & 0x02) << 1) | ((s[3] & 0x20) >> 4) | ((s[3] & 0x02) >> 1);
		INT32 d3 = ((s[0] & 0x10) << 3) | ((s[0] & 0x01) << 6) | ((s[1] & 0x10) << 1) | ((s[1] & 0x01) << 4) | ((s[2] &
			0x10) >> 1) | ((s[2] & 0x01) << 2) | ((s[3] & 0x10) >> 3) | ((s[3] & 0x01) >> 0);
...
static INT32 GaiapolisInit()
{
...

	{
		...
		if ((pMystwarrRozBitmap = (UINT16*)BurnMalloc(((512 * 16) * 2) * (512 * 16) * 2)) == nullptr) return 1;
...
static INT32 DrvDraw()
{
	...
	if (nGame == 1)
	{
...

		{
			...
			case 0x18:
				{
					// alpha on for sure, except endboss death scene (see: superblendoff)
					superblend = 0xfff;
					break;
				}
			...
			default:
				{
					// alpha off, but only if tilecount isn't rising
			...
			if ((superblend || oldsuperblend) && !superblendoff)
			{
				...
				// using "|| oldsuperblend" for 1 frame latency, to avoid flickers on the water level when he gets "flushed" into the boss part
			}
	...
	if (nGame == 4)
	{
		...
		blendmode = (oinprion == 0xef && K054338_read_register(K338_REG_PBLEND))
			            ? ((1 << 16 | GXMIX_BLEND_FORCE) << 2)
			            : 0;
		sprite_colorbase = K055555GetPaletteIndex(4) << 5;
	}
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[3] = {
		static_cast<INT32>(static_cast<double>(16000000) / 59.185606 + 0.5),
		static_cast<INT32>(static_cast<double>(8000000) / 59.185606),
		static_cast<INT32>(static_cast<double>(18432000) / 59.185606)
	};
	if (nGame == 4)
	{
		// martchmp
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		if (nGame == 1) // mystwarr
		{
			if (mw_irq_control & 1)
			{
				...
				if (i == ((nInterleave * (240 + 10)) / 256))
				{
					// +10 otherwise flickers on char.selection screen (mystwarr)
...
struct BurnDriver BurnDrvMystwarr = {
	"mystwarr", nullptr, nullptr, nullptr, "1993",
	"Mystic Warriors (ver EAA)\0", nullptr, "Konami", "GX128",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, mystwarrRomInfo, mystwarrRomName, nullptr, nullptr, nullptr, nullptr, MystwarrInputInfo, MystwarrDIPInfo,
...
struct BurnDriver BurnDrvMystwarru = {
	"mystwarru", "mystwarr", nullptr, nullptr, "1993",
	"Mystic Warriors (ver UAA)\0", nullptr, "Konami", "GX128",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI,
	GBF_SCRFIGHT, 0,
	nullptr, mystwarruRomInfo, mystwarruRomName, nullptr, nullptr, nullptr, nullptr, MystwarrInputInfo, MystwarrDIPInfo,
	MystwarrInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x0800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMystwarrj = {
	"mystwarrj", "mystwarr", nullptr, nullptr, "1993",
	"Mystic Warriors (ver JAA)\0", nullptr, "Konami", "GX128",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI,
	GBF_SCRFIGHT, 0,
	nullptr, mystwarrjRomInfo, mystwarrjRomName, nullptr, nullptr, nullptr, nullptr, MystwarrInputInfo, MystwarrDIPInfo,
	MystwarrInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x0800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMystwarra = {
	"mystwarra", "mystwarr", nullptr, nullptr, "1993",
	"Mystic Warriors (ver AAB)\0", nullptr, "Konami", "GX128",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI,
	GBF_SCRFIGHT, 0,
	nullptr, mystwarraRomInfo, mystwarraRomName, nullptr, nullptr, nullptr, nullptr, MystwarrInputInfo, MystwarrDIPInfo,
	MystwarrInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x0800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMystwarraa = {
	"mystwarraa", "mystwarr", nullptr, nullptr, "1993",
	"Mystic Warriors (ver AAA)\0", nullptr, "Konami", "GX128",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI,
	GBF_SCRFIGHT, 0,
	nullptr, mystwarraaRomInfo, mystwarraaRomName, nullptr, nullptr, nullptr, nullptr, MystwarrInputInfo,
	MystwarrDIPInfo,
	MystwarrInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x0800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvViostorm = {
	"viostorm", nullptr, nullptr, nullptr, "1993",
	"Violent Storm (ver EAC)\0", nullptr, "Konami", "GX224",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, viostormRomInfo, viostormRomName, nullptr, nullptr, nullptr, nullptr, ViostormInputInfo, ViostormDIPInfo,
...
struct BurnDriver BurnDrvViostormeb = {
	"viostormeb", "viostorm", nullptr, nullptr, "1993",
	"Violent Storm (ver EAB)\0", nullptr, "Konami", "GX168",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, viostormebRomInfo, viostormebRomName, nullptr, nullptr, nullptr, nullptr, ViostormInputInfo,
	ViostormDIPInfo,
	ViostormInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvViostormu = {
	"viostormu", "viostorm", nullptr, nullptr, "1993",
	"Violent Storm (ver UAC)\0", nullptr, "Konami", "GX168",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, viostormuRomInfo, viostormuRomName, nullptr, nullptr, nullptr, nullptr, ViostormInputInfo, ViostormDIPInfo,
	ViostormInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvViostormub = {
	"viostormub", "viostorm", nullptr, nullptr, "1993",
	"Violent Storm (ver UAB)\0", nullptr, "Konami", "GX168",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, viostormubRomInfo, viostormubRomName, nullptr, nullptr, nullptr, nullptr, ViostormInputInfo,
	ViostormDIPInfo,
	ViostormInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvViostorma = {
	"viostorma", "viostorm", nullptr, nullptr, "1993",
	"Violent Storm (ver AAC)\0", nullptr, "Konami", "GX168",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, viostormaRomInfo, viostormaRomName, nullptr, nullptr, nullptr, nullptr, ViostormInputInfo, ViostormDIPInfo,
	ViostormInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvViostormab = {
	"viostormab", "viostorm", nullptr, nullptr, "1993",
	"Violent Storm (ver AAB)\0", nullptr, "Konami", "GX168",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, viostormabRomInfo, viostormabRomName, nullptr, nullptr, nullptr, nullptr, ViostormInputInfo,
	ViostormDIPInfo,
	ViostormInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvViostormj = {
	"viostormj", "viostorm", nullptr, nullptr, "1993",
	"Violent Storm (ver JAC)\0", nullptr, "Konami", "GX168",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 3, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, viostormjRomInfo, viostormjRomName, nullptr, nullptr, nullptr, nullptr, ViostormInputInfo, ViostormDIPInfo,
	ViostormInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvMetamrph = {
	"metamrph", nullptr, nullptr, nullptr, "1993",
	"Metamorphic Force (ver EAA)\0", nullptr, "Konami", "GX224",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, metamrphRomInfo, metamrphRomName, nullptr, nullptr, nullptr, nullptr, MetamrphInputInfo, MetamrphDIPInfo,
...
struct BurnDriver BurnDrvMetamrphe = {
	"metamrphe", "metamrph", nullptr, nullptr, "1993",
	"Metamorphic Force (ver EAA - alternate)\0", nullptr, "Konami", "GX224",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, metamrpheRomInfo, metamrpheRomName, nullptr, nullptr, nullptr, nullptr, MetamrphInputInfo, MetamrphDIPInfo,
	MetamrphInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x0800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMetamrpha = {
	"metamrpha", "metamrph", nullptr, nullptr, "1993",
	"Metamorphic Force (ver AAA)\0", nullptr, "Konami", "GX224",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, metamrphaRomInfo, metamrphaRomName, nullptr, nullptr, nullptr, nullptr, MetamrphInputInfo, MetamrphDIPInfo,
	MetamrphInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x0800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMetamrphu = {
	"metamrphu", "metamrph", nullptr, nullptr, "1993",
	"Metamorphic Force (ver UAA)\0", nullptr, "Konami", "GX224",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, metamrphuRomInfo, metamrphuRomName, nullptr, nullptr, nullptr, nullptr, MetamrphInputInfo, MetamrphDIPInfo,
	MetamrphInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x0800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMetamrphj = {
	"metamrphj", "metamrph", nullptr, nullptr, "1993",
	"Metamorphic Force (ver JAA)\0", nullptr, "Konami", "GX224",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, metamrphjRomInfo, metamrphjRomName, nullptr, nullptr, nullptr, nullptr, MetamrphInputInfo, MetamrphDIPInfo,
	MetamrphInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x0800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvMtlchamp = {
	"mtlchamp", nullptr, nullptr, nullptr, "1993",
	"Martial Champion (ver EAB)\0", nullptr, "Konami", "GX234",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_VSFIGHT, 0,
	nullptr, mtlchampRomInfo, mtlchampRomName, nullptr, nullptr, nullptr, nullptr, MartchmpInputInfo, MartchmpDIPInfo,
...
struct BurnDriver BurnDrvMtlchamp1 = {
	"mtlchamp1", "mtlchamp", nullptr, nullptr, "1993",
	"Martial Champion (ver EAA)\0", nullptr, "Konami", "GX234",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_VSFIGHT, 0,
	nullptr, mtlchamp1RomInfo, mtlchamp1RomName, nullptr, nullptr, nullptr, nullptr, MartchmpInputInfo, MartchmpDIPInfo,
	MartchmpInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvMtlchampa = {
	"mtlchampa", "mtlchamp", nullptr, nullptr, "1993",
	"Martial Champion (ver AAA)\0", nullptr, "Konami", "GX234",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_VSFIGHT, 0,
	nullptr, mtlchampaRomInfo, mtlchampaRomName, nullptr, nullptr, nullptr, nullptr, MartchmpInputInfo, MartchmpDIPInfo,
	MartchmpInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvMtlchampj = {
	"mtlchampj", "mtlchamp", nullptr, nullptr, "1993",
	"Martial Champion (ver JAA)\0", nullptr, "Konami", "GX234",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_VSFIGHT, 0,
	nullptr, mtlchampjRomInfo, mtlchampjRomName, nullptr, nullptr, nullptr, nullptr, MartchmpInputInfo, MartchmpDIPInfo,
	MartchmpInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvMtlchampu = {
	"mtlchampu", "mtlchamp", nullptr, nullptr, "1993",
	"Martial Champion (ver UAE)\0", nullptr, "Konami", "GX234",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_VSFIGHT, 0,
	nullptr, mtlchampuRomInfo, mtlchampuRomName, nullptr, nullptr, nullptr, nullptr, MartchmpInputInfo, MartchmpDIPInfo,
	MartchmpInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvMtlchampu1 = {
	"mtlchampu1", "mtlchamp", nullptr, nullptr, "1993",
	"Martial Champion (ver UAD)\0", nullptr, "Konami", "GX234",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_VSFIGHT, 0,
	nullptr, mtlchampu1RomInfo, mtlchampu1RomName, nullptr, nullptr, nullptr, nullptr, MartchmpInputInfo,
	MartchmpDIPInfo,
	MartchmpInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvGaiapols = {
	"gaiapols", nullptr, nullptr, nullptr, "1993",
	"Gaiapolis (ver EAF)\0", nullptr, "Konami", "GX123",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, gaiapolsRomInfo, gaiapolsRomName, nullptr, nullptr, nullptr, nullptr, DadandrnInputInfo, DadandrnDIPInfo,
...
struct BurnDriver BurnDrvGaiapolsu = {
	"gaiapolsu", "gaiapols", nullptr, nullptr, "1993",
	"Gaiapolis (ver UAF)\0", nullptr, "Konami", "GX123",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, gaiapolsuRomInfo, gaiapolsuRomName, nullptr, nullptr, nullptr, nullptr, DadandrnInputInfo, DadandrnDIPInfo,
	GaiapolisInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	224, 376, 3, 4
};
...
struct BurnDriver BurnDrvGaiapolsj = {
	"gaiapolsj", "gaiapols", nullptr, nullptr, "1993",
	"Gaiapolis (ver JAF)\0", nullptr, "Konami", "GX123",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, gaiapolsjRomInfo, gaiapolsjRomName, nullptr, nullptr, nullptr, nullptr, DadandrnInputInfo, DadandrnDIPInfo,
	GaiapolisInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	224, 376, 3, 4
};
...
struct BurnDriver BurnDrvMmaulers = {
	"mmaulers", nullptr, nullptr, nullptr, "1993",
	"Monster Maulers (ver EAA)\0", nullptr, "Konami", "GX170",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, mmaulersRomInfo, mmaulersRomName, nullptr, nullptr, nullptr, nullptr, DadandrnInputInfo, DadandrnDIPInfo,
...
struct BurnDriver BurnDrvDadandrn = {
	"dadandrn", "mmaulers", nullptr, nullptr, "1993",
	"Kyukyoku Sentai Dadandarn (ver JAA)\0", nullptr, "Konami", "GX170",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, dadandrnRomInfo, dadandrnRomName, nullptr, nullptr, nullptr, nullptr, DadandrnInputInfo, DadandrnDIPInfo,
	DadandrnInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
