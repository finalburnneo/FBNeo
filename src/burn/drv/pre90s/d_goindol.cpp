...
static void draw_sprites(UINT8* ram, UINT8* gfx)
{
	for (INT32 offs = 0; offs < 0x40; offs += 4)
	{
		...
		if ((ram[offs + 1] >> 3) && (sx < 248))
		{
			...
			Draw8x8MaskTile(pTransDraw, code + 1, sx, sy + (flipscreen ? -8 : 8) - 16, flipscreen, flipscreen, color, 3,
			                0, 0, gfx);
		}
	}
}
...
struct BurnDriver BurnDrvGoindol = {
	"goindol", nullptr, nullptr, nullptr, "1987",
	"Goindol (World)\0", nullptr, "SunA", "Miscellaneous",
	...
	nullptr, goindolRomInfo, goindolRomName, nullptr, nullptr, nullptr, nullptr, GoindolInputInfo, GoindolDIPInfo,
...
struct BurnDriver BurnDrvGoindolu = {
	"goindolu", "goindol", nullptr, nullptr, "1987",
	"Goindol (US)\0", nullptr, "SunA", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_BREAKOUT, 0,
	nullptr, goindoluRomInfo, goindoluRomName, nullptr, nullptr, nullptr, nullptr, GoindolInputInfo, GoindolDIPInfo,
	GoindolInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvGoindolj = {
	"goindolj", "goindol", nullptr, nullptr, "1987",
	"Goindol (Japan)\0", nullptr, "SunA", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_BREAKOUT, 0,
	nullptr, goindoljRomInfo, goindoljRomName, nullptr, nullptr, nullptr, nullptr, GoindolInputInfo, GoindolDIPInfo,
	GoindolInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvHomo = {
	"homo", "goindol", nullptr, nullptr, "1987",
	"Homo\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_MISC_PRE90S, GBF_BREAKOUT, 0,
	nullptr, homoRomInfo, homoRomName, nullptr, nullptr, nullptr, nullptr, GoindolInputInfo, GoindolDIPInfo,
