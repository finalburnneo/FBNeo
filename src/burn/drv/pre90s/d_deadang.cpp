...
static void draw_sprites(INT32 /*flipscreen*/)
{
	...
	for (INT32 offs = 0; offs < 0x800 / 2; offs += 4)
	{
		...
		case 0xc000: pri = 0;
			break; // Unknown
		case 0x8000: pri = 0;
			break; // Over all playfields
		case 0x4000: pri = 0xf0;
			break; // Under top playfield
		case 0x0000: pri = 0xfc;
			break; // Under middle playfield
		}
...
static INT32 DrvDraw()
{
	...
	auto scroll_ram = (UINT16*)DrvScrollRAM;

	INT32 layer_enable = BURN_ENDIAN_SWAP_INT16(scroll_ram[0x34]) ^ 0xff;
	INT32 flipscreen = (layer_enable & 0x40) ? 0 : TMAP_FLIPXY;

	GenericTilemapSetScrollY(
		3, ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x01]) & 0xf0) << 4) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x02]) & 0x7f)
			<< 1) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x02]) & 0x80) >> 7));
	GenericTilemapSetScrollX(
		3, ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x09]) & 0xf0) << 4) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x0a]) & 0x7f)
			<< 1) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x0a]) & 0x80) >> 7));
	GenericTilemapSetScrollY(
		1, ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x11]) & 0x10) << 4) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x12]) & 0x7f)
			<< 1) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x12]) & 0x80) >> 7));
	GenericTilemapSetScrollX(
		1, ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x19]) & 0x10) << 4) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x1a]) & 0x7f)
			<< 1) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x1a]) & 0x80) >> 7));
	GenericTilemapSetScrollY(
		2, ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x21]) & 0xf0) << 4) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x22]) & 0x7f)
			<< 1) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x22]) & 0x80) >> 7));
	GenericTilemapSetScrollX(
		2, ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x29]) & 0xf0) << 4) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x2a]) & 0x7f)
			<< 1) + ((BURN_ENDIAN_SWAP_INT16(scroll_ram[0x2a]) & 0x80) >> 7));
...
struct BurnDriver BurnDrvDeadang = {
	"deadang", nullptr, nullptr, nullptr, "1988",
	"Dead Angle\0", nullptr, "Seibu Kaihatsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, deadangRomInfo, deadangRomName, nullptr, nullptr, nullptr, nullptr, DeadangInputInfo, DeadangDIPInfo,
...
struct BurnDriver BurnDrvLeadang = {
	"leadang", "deadang", nullptr, nullptr, "1988",
	"Lead Angle (Japan)\0", nullptr, "Seibu Kaihatsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, leadangRomInfo, leadangRomName, nullptr, nullptr, nullptr, nullptr, DeadangInputInfo, DeadangDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x801,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvGhunter = {
	"ghunter", "deadang", nullptr, nullptr, "1988",
	"Gang Hunter / Dead Angle\0", nullptr, "Seibu Kaihatsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, ghunterRomInfo, ghunterRomName, nullptr, nullptr, nullptr, nullptr, DeadangInputInfo, GhunterDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x801,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvGhunters = {
	"ghunters", "deadang", nullptr, nullptr, "1988",
	"Gang Hunter / Dead Angle (Spain)\0", nullptr, "Seibu Kaihatsu (SegaSA / Sonic license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, ghuntersRomInfo, ghuntersRomName, nullptr, nullptr, nullptr, nullptr, DeadangInputInfo, GhunterDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x801,
	256, 224, 4, 3
};
