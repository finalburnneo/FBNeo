...
static INT32 MemIndex()
{
	...
	pSoundBuffer[0] = (INT16*)Next;
	Next += nBurnSoundLen * sizeof(INT16) * 2;
	pSoundBuffer[1] = (INT16*)Next;
	Next += nBurnSoundLen * sizeof(INT16) * 2;
	pSoundBuffer[2] = (INT16*)Next;
	Next += nBurnSoundLen * sizeof(INT16) * 2;
...
struct BurnDriver BurnDrvTp84 = {
	"tp84", nullptr, nullptr, nullptr, "1984",
	"Time Pilot '84 (set 1)\0", nullptr, "Konami", "GX388",
	...
	nullptr, tp84RomInfo, tp84RomName, nullptr, nullptr, nullptr, nullptr, Tp84InputInfo, Tp84DIPInfo,
...
struct BurnDriver BurnDrvTp84a = {
	"tp84a", "tp84", nullptr, nullptr, "1984",
	"Time Pilot '84 (set 2)\0", nullptr, "Konami", "GX388",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_VERSHOOT, 0,
	nullptr, tp84aRomInfo, tp84aRomName, nullptr, nullptr, nullptr, nullptr, Tp84InputInfo, Tp84aDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvTp84b = {
	"tp84b", "tp84", nullptr, nullptr, "1984",
	"Time Pilot '84 (set 3)\0", nullptr, "Konami", "GX388",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_VERSHOOT, 0,
	nullptr, tp84bRomInfo, tp84bRomName, nullptr, nullptr, nullptr, nullptr, Tp84InputInfo, Tp84DIPInfo,
