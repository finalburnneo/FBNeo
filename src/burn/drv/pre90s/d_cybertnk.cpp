...
static struct BurnDIPInfo CybertnkDIPList[]=
{
	...
	{0x0b, 0x01, 0x0c, 0x0c, "Very Easy"		},
	{0x0b, 0x01, 0x0c, 0x04, "Easy"			},
	{0x0b, 0x01, 0x0c, 0x08, "Hard"			},
	{0x0b, 0x01, 0x0c, 0x00, "Very Hard"		},

	{0   , 0xfe, 0   ,    2, "Coin B Value"		},
	{0x0b, 0x01, 0x10, 0x10, "Set by Dipswitches"	},
	{0x0b, 0x01, 0x10, 0x00, "Same Value as Coin A"	},
	...
	{0x0c, 0x01, 0xf0, 0x00, "5 Coins 3 Credits"	},
...
static UINT8 __fastcall cybertnk_main_read_byte(UINT32 address)
{
	switch (address)
	{
		...
		case 0x1100d5:
			return 0; // cybertnk_mux_r (mux_data) analog inputs
	}
