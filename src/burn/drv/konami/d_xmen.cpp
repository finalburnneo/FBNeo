...
static INT32 MemIndex()
{
	...
	DrvBitmaps[0] = (UINT32*)Next;
	Next += 512 * 256 * sizeof(UINT32);
	DrvBitmaps[1] = (UINT32*)Next;
	Next += 512 * 256 * sizeof(UINT32);
...
static constexpr eeprom_interface xmen_eeprom_intf =
{
	7, // address bits
	8, // data bits
	"011000", // read command
...
static INT32 DrvFrame()
{
...

	{
...

		{
			...
			constexpr INT32 sb_times[6] = {0 + 4, 10 + 4, 20 + 4, 30 + 4, 40 + 4, 50 + 4};
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		if (i == 239)
		{
			if (nScreenWidth != 288) interrupt_enable = BURN_ENDIAN_SWAP_INT16(*((UINT16*)(DrvTMapRAM[0] + 0x3a00))) &
				0x0004;
...
struct BurnDriver BurnDrvXmen = {
	"xmen", nullptr, nullptr, nullptr, "1992",
	"X-Men (4 Players ver EBA)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmenRomInfo, xmenRomName, nullptr, nullptr, nullptr, nullptr, XmenInputInfo, nullptr,
...
struct BurnDriver BurnDrvXmenu = {
	"xmenu", "xmen", nullptr, nullptr, "1992",
	"X-Men (4 Players ver UBB)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmenuRomInfo, xmenuRomName, nullptr, nullptr, nullptr, nullptr, XmenInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvXmenua = {
	"xmenua", "xmen", nullptr, nullptr, "1992",
	"X-Men (4 Players ver UEB)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmenuaRomInfo, xmenuaRomName, nullptr, nullptr, nullptr, nullptr, XmenInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvXmena = {
	"xmena", "xmen", nullptr, nullptr, "1992",
	"X-Men (4 Players ver AEA)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmenaRomInfo, xmenaRomName, nullptr, nullptr, nullptr, nullptr, XmenInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvXmenaa = {
	"xmenaa", "xmen", nullptr, nullptr, "1992",
	"X-Men (4 Players ver ADA)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmenaaRomInfo, xmenaaRomName, nullptr, nullptr, nullptr, nullptr, XmenInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvXmenj = {
	"xmenj", "xmen", nullptr, nullptr, "1992",
	"X-Men (4 Players ver JBA)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmenjRomInfo, xmenjRomName, nullptr, nullptr, nullptr, nullptr, XmenInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvXmenja = {
	"xmenja", "xmen", nullptr, nullptr, "1992",
	"X-Men (4 Players ver JEA)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmenjaRomInfo, xmenjaRomName, nullptr, nullptr, nullptr, nullptr, XmenInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvXmen2pe = {
	"xmen2pe", "xmen", nullptr, nullptr, "1992",
	"X-Men (2 Players ver EAA)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmen2peRomInfo, xmen2peRomName, nullptr, nullptr, nullptr, nullptr, Xmen2pInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvXmen2pu = {
	"xmen2pu", "xmen", nullptr, nullptr, "1992",
	"X-Men (2 Players ver UAB)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmen2puRomInfo, xmen2puRomName, nullptr, nullptr, nullptr, nullptr, Xmen2pInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvXmen2pa = {
	"xmen2pa", "xmen", nullptr, nullptr, "1992",
	"X-Men (2 Players ver AAA)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmen2paRomInfo, xmen2paRomName, nullptr, nullptr, nullptr, nullptr, Xmen2pInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvXmen2pj = {
	"xmen2pj", "xmen", nullptr, nullptr, "1992",
	"X-Men (2 Players ver JAA)\0", nullptr, "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, xmen2pjRomInfo, xmen2pjRomName, nullptr, nullptr, nullptr, nullptr, Xmen2pInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvXmen6p = {
	"xmen6p", "xmen", nullptr, nullptr, "1992",
	"X-Men (6 Players ver ECB)\0", "After leaving service mode, a reset is necessary", "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_CLONE | BDF_HISCORE_SUPPORTED, 6, HARDWARE_PREFIX_KONAMI,
	GBF_SCRFIGHT, 0,
	nullptr, xmen6pRomInfo, xmen6pRomName, nullptr, nullptr, nullptr, nullptr, Xmen6pInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288 * 2, 224, 8, 3
};
...
struct BurnDriver BurnDrvXmen6pu = {
	"xmen6pu", "xmen", nullptr, nullptr, "1992",
	"X-Men (6 Players ver UCB)\0", "After leaving service mode, a reset is necessary", "Konami", "GX065",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_CLONE | BDF_HISCORE_SUPPORTED, 6, HARDWARE_PREFIX_KONAMI,
	GBF_SCRFIGHT, 0,
	nullptr, xmen6puRomInfo, xmen6puRomName, nullptr, nullptr, nullptr, nullptr, Xmen6pInputInfo, nullptr,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288 * 2, 224, 8, 3
};
