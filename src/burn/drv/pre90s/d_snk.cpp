...
{
	DIP_OFFSET(0x12)
	{0x00, 0xff, 0xff, 0x3b, nullptr},
	{0x01, 0xff, 0xff, 0x0f, nullptr},
	{0x02, 0xff, 0xff, 0x30, nullptr},
...
static struct BurnDIPInfo GwarbDIPList[] =
{
	...
	{0x14, 0xff, 0xff, 0x0a, nullptr},
	{0x15, 0xff, 0xff, 0x30, nullptr},
...
{
	{0x10, 0xff, 0xff, 0xc6, nullptr},
	{0x11, 0xff, 0xff, 0xa8, nullptr},
...
{
	{0x10, 0xff, 0xff, 0x3d, nullptr},
	{0x11, 0xff, 0xff, 0xb4, nullptr},
	{0x12, 0xff, 0xff, 0xc1, nullptr},
...
{
	{0x11, 0xff, 0xff, 0x3d, nullptr},
	{0x12, 0xff, 0xff, 0xf6, nullptr},
	{0x13, 0xff, 0xff, 0xc1, nullptr},
...
{
	{0x12, 0xff, 0xff, 0x39, nullptr},
	{0x13, 0xff, 0xff, 0xcb, nullptr},
	{0x14, 0xff, 0xff, 0x34, nullptr},
...
static struct BurnDIPInfo Tnk3DIPList[] =
{
	...
	{0x00, 0xff, 0xff, 0x3d, nullptr},
	{0x01, 0xff, 0xff, 0x34, nullptr},
	{0x02, 0xff, 0xff, 0xc1, nullptr},
	{0x03, 0xff, 0xff, 0x00, nullptr},
...
{
	{0x14, 0xff, 0xff, 0x9c, nullptr},
	{0x15, 0xff, 0xff, 0xf6, nullptr},
...
{
	stream.init(8000000 >> CLOCK_SHIFT, nBurnSoundRate, 1, true, snkwave_update);
...
static inline UINT8 common_read(UINT16 offset, UINT16 real_address, INT32 sound_status_val, INT32 sound_status_select,
                                UINT16 hi_dips)
{
...
static UINT8 __fastcall ikari_main_read(UINT16 address)
{
	...
	case 0xcee0:
		return (turbofront_check8(1, 6 * 8) << 0) | (turbofront_check8(1, 6 * 8) << 4) | (
			turbofront_check8(1, 6 * 8 + 1) << 1) | (turbofront_check8(1, 6 * 8 + 1) << 5);
	}
...
static INT32 DrvGfxDecode(INT32 gfx, INT32 nType, UINT8* src, INT32 nLen)
{
	...
	INT32 XOffs1[16] = {
		4 * 1, 4 * 0, 4 * 3, 4 * 2, 4 * 5, 4 * 4, 4 * 7, 4 * 6, 32 + 4 * 1, 32 + 4 * 0, 32 + 4 * 3, 32 + 4 * 2,
	...
	{
		if (i >= static_cast<UINT32>(DrvGfxMask[gfx]))
		{
			DrvGfxMask[gfx] = i - 1;
			break;
		}
...
static INT32 DrvRomLoad()
{
	...
	for (INT32 i = 0; !BurnDrvGetRomName(&pRomName, i, 0); i++)
	{
		...
		if ((ri.nType & 0xf) == 5 || (ri.nType & 0xf) == 6)
		{
			// bg layer
		...
		if ((ri.nType & 0xf) == 7 || (ri.nType & 0xf) == 9)
		{
			// 16x16 4 bpp sprite / 3 bpp sprite
		...
		if ((ri.nType & 0xf) == 8 || (ri.nType & 0xf) == 10)
		{
			// 32x32 4 bpp sprite / 3 bpp sprite
...
static INT32 PsychosInit()
{
	...
	BurnY8950Init(1, 4000000, DrvSndROM0, nSampleLen, nullptr, 0, &DrvFMIRQHandler_CB2, 1);
...
static INT32 AthenaInit()
{
	...
	BurnY8950Init(1, 4000000, nullptr, 0, nullptr, 0, &DrvFMIRQHandler_CB2, 1);
	BurnY8950SetRoute(0, BURN_SND_Y8950_ROUTE, 2.00, BURN_SND_ROUTE_BOTH);
...
static INT32 IkarijoyInit()
{
	ikarijoy = 1;
	return IkariCommonInit(1);
}
...
static INT32 DrvExit()
{
	...
	rotate_gunpos[0] = rotate_gunpos[1] = nullptr;
...
static void ikari_draw_layer_tx(INT32)
{
	for (INT32 offs = 0; offs < 36 * 28; offs++)
	{
		...
		{
			Render8x8Tile_Mask_Clip(pTransDraw, code & DrvGfxMask[0], sx, sy, 0, 4, 0xf, txt_palette_offset + 0x180,
			                        DrvGfxROM0);
		}
	}
}
...
static void marvins_draw_layer(UINT8* ram, UINT8* gfx, INT32 scrollx, INT32 scrolly, INT32 color_offset,
                               INT32 transparent)
{
	scrollx &= 0x1ff;
	scrolly &= 0x0ff;
...
static void gwar_draw_layer_bg(INT32 color_offset, INT32 xoffset, INT32 yoffset)
{
	...
	for (INT32 offs = 0; offs < 32 * 32; offs++)
	{
		...
		if (code > DrvGfxMask[1]) code = DrvGfxMask[1] + 1;
...
static void marvins_draw_sprites(INT32 scrollx, INT32 scrolly, INT32 from, INT32 to)
{
	...
	while (source < finish)
	{
...

		{
			...
			UINT8* gfxbase = DrvGfxROM2 + ((tile_number * 0x100) /*& DrvGfxMask[2]*/);
			// this mask causes the sprites to not animate in marvins & vanguard II
...
static void tdfever_draw_sprites(INT32 xscroll, INT32 yscroll, UINT8* source, UINT8* gfx, const int hw_xflip,
                                 const int from, const int to, INT32 color_offset)
{
...
static INT32 GwarDraw()
{
	...
	if (nSpriteEnable & 1) tdfever_draw_sprites(sp16_scrollx, sp16_scrolly, DrvSprRAM + 0x800, DrvGfxROM2, 0, 0,
	                                            sprite_split_point, 0x100);
	if (nSpriteEnable & 2) tdfever_draw_sprites(sp32_scrollx, sp32_scrolly, DrvSprRAM, DrvGfxROM3, 0, 0, 32, 0x200);
	if (nSpriteEnable & 4) tdfever_draw_sprites(sp16_scrollx, sp16_scrolly, DrvSprRAM + 0x800, DrvGfxROM2, 0,
	                                            sprite_split_point, 64, 0x100);
...
static INT32 Tnk3Frame()
{
...

	{
		...
		if (game_rotates)
		{
			if (~DrvDips[0] & 2)
			{
				// TNK3 Upright Mode (P1 joy for both players)
				INT32 Player = (DrvTxtRAM[0x458] & 0x10) >> 4; // (0xFC58 & 0x10) == P2
				constexpr INT32 pl_rot[2] = {0x547, 0x58d};
...
struct BurnDriver BurnDrvMarvins = {
	"marvins", nullptr, nullptr, nullptr, "1983",
	"Marvin's Maze\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, marvinsRomInfo, marvinsRomName, nullptr, nullptr, nullptr, nullptr, MarvinsInputInfo, MarvinsDIPInfo,
...
struct BurnDriver BurnDrvMadcrash = {
	"madcrash", nullptr, nullptr, nullptr, "1984",
	"Mad Crasher\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, madcrashRomInfo, madcrashRomName, nullptr, nullptr, nullptr, nullptr, MadcrashInputInfo, MadcrashDIPInfo,
...
struct BurnDriver BurnDrvMadcrush = {
	"madcrush", "madcrash", nullptr, nullptr, "1984",
	"Mad Crusher (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, madcrushRomInfo, madcrushRomName, nullptr, nullptr, nullptr, nullptr, MadcrashInputInfo, MadcrashDIPInfo,
...
struct BurnDriver BurnDrvVangrd2 = {
	"vangrd2", nullptr, nullptr, nullptr, "1984",
	"Vanguard II\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, vangrd2RomInfo, vangrd2RomName, nullptr, nullptr, nullptr, nullptr, Vangrd2InputInfo, Vangrd2DIPInfo,
	MadcrashInit, DrvExit, MarvinsFrame, MarvinsDraw, DrvScan, &DrvRecalc, 0x400,
	216, 288, 3, 4
};
...
struct BurnDriver BurnDrvJcross = {
	"jcross", nullptr, nullptr, nullptr, "1984",
	"Jumping Cross (set 1)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, jcrossRomInfo, jcrossRomName, nullptr, nullptr, nullptr, nullptr, JcrossInputInfo, JcrossDIPInfo,
...
struct BurnDriver BurnDrvJcrossa = {
	"jcrossa", "jcross", nullptr, nullptr, "1984",
	"Jumping Cross (set 2)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RACING, 0,
	nullptr, jcrossaRomInfo, jcrossaRomName, nullptr, nullptr, nullptr, nullptr, JcrossInputInfo, JcrossDIPInfo,
	JcrossInit, DrvExit, JcrossFrame, JcrossDraw, DrvScan, &DrvRecalc, 0x400,
	216, 288, 3, 4
};
...
struct BurnDriver BurnDrvSgladiat = {
	"sgladiat", nullptr, nullptr, nullptr, "1984",
	"Gladiator 1984\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, sgladiatRomInfo, sgladiatRomName, nullptr, nullptr, nullptr, nullptr, SgladiatInputInfo, SgladiatDIPInfo,
...
struct BurnDriver BurnDrvHal21 = {
	"hal21", nullptr, nullptr, nullptr, "1985",
	"HAL21\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, hal21RomInfo, hal21RomName, nullptr, nullptr, nullptr, nullptr, Hal21InputInfo, Hal21DIPInfo,
...
struct BurnDriver BurnDrvHal21j = {
	"hal21j", "hal21", nullptr, nullptr, "1985",
	"HAL21 (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, hal21jRomInfo, hal21jRomName, nullptr, nullptr, nullptr, nullptr, Hal21InputInfo, Hal21DIPInfo,
	Hal21Init, DrvExit, JcrossFrame, Hal21Draw, DrvScan, &DrvRecalc, 0x400,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvPsychos = {
	"psychos", nullptr, nullptr, nullptr, "1987",
	"Psycho Soldier (US)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, psychosRomInfo, psychosRomName, nullptr, nullptr, nullptr, nullptr, PsychosInputInfo, PsychosDIPInfo,
...
struct BurnDriver BurnDrvPsychosj = {
	"psychosj", "psychos", nullptr, nullptr, "1987",
	"Psycho Soldier (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, psychosjRomInfo, psychosjRomName, nullptr, nullptr, nullptr, nullptr, PsychosInputInfo, PsychosDIPInfo,
	PsychosInit, DrvExit, GwarFrame, GwarDraw, DrvScan, &DrvRecalc, 0x400,
	400, 224, 4, 3
};
...
struct BurnDriver BurnDrvBermudat = {
	"bermudat", nullptr, nullptr, nullptr, "1987",
	"Bermuda Triangle (World?)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, bermudatRomInfo, bermudatRomName, nullptr, nullptr, nullptr, nullptr, BermudatInputInfo, BermudatDIPInfo,
...
struct BurnDriver BurnDrvBermudatj = {
	"bermudatj", "bermudat", nullptr, nullptr, "1987",
	"Bermuda Triangle (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, bermudatjRomInfo, bermudatjRomName, nullptr, nullptr, nullptr, nullptr, BermudatInputInfo, BermudatDIPInfo,
	BermudatInit, DrvExit, GwarFrame, GwarDraw, DrvScan, &DrvRecalc, 0x400,
	224, 400, 3, 4
};
...
struct BurnDriver BurnDrvWorldwar = {
	"worldwar", nullptr, nullptr, nullptr, "1987",
	"World Wars (World?)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, worldwarRomInfo, worldwarRomName, nullptr, nullptr, nullptr, nullptr, BermudatInputInfo, BermudatDIPInfo,
...
struct BurnDriver BurnDrvBermudata = {
	"bermudata", "worldwar", nullptr, nullptr, "1987",
	"Bermuda Triangle (World Wars) (US)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, bermudataRomInfo, bermudataRomName, nullptr, nullptr, nullptr, nullptr, BermudatInputInfo, BermudatDIPInfo,
	BermudatwwInit, DrvExit, GwarFrame, GwarDraw, DrvScan, &DrvRecalc, 0x400,
	224, 400, 3, 4
};
...
struct BurnDriver BurnDrvGwar = {
	"gwar", nullptr, nullptr, nullptr, "1987",
	"Guerrilla War (US)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, gwarRomInfo, gwarRomName, nullptr, nullptr, nullptr, nullptr, GwarInputInfo, GwarDIPInfo,
...
struct BurnDriver BurnDrvGwarj = {
	"gwarj", "gwar", nullptr, nullptr, "1987",
	"Guevara (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, gwarjRomInfo, gwarjRomName, nullptr, nullptr, nullptr, nullptr, GwarInputInfo, GwarDIPInfo,
	GwarInit, DrvExit, GwarFrame, GwarDraw, DrvScan, &DrvRecalc, 0x400,
	224, 400, 3, 4
};
...
struct BurnDriver BurnDrvGwara = {
	"gwara", "gwar", nullptr, nullptr, "1987",
	"Guerrilla War (Version 1, set 1)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, gwaraRomInfo, gwaraRomName, nullptr, nullptr, nullptr, nullptr, GwarInputInfo, GwarDIPInfo,
...
struct BurnDriver BurnDrvGwarab = {
	"gwarab", "gwar", nullptr, nullptr, "1987",
	"Guerrilla War (Version 1, set 2)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, gwarabRomInfo, gwarabRomName, nullptr, nullptr, nullptr, nullptr, GwarInputInfo, GwarDIPInfo,
	GwaraInit, DrvExit, GwarFrame, GwarDraw, DrvScan, &DrvRecalc, 0x400,
	224, 400, 3, 4
};
...
struct BurnDriver BurnDrvGwarb = {
	"gwarb", "gwar", nullptr, nullptr, "1987",
	"Guerrilla War (Joystick hack bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, gwarbRomInfo, gwarbRomName, nullptr, nullptr, nullptr, nullptr, GwarbInputInfo, GwarbDIPInfo,
...
struct BurnDriver BurnDrvTnk3 = {
	"tnk3", nullptr, nullptr, nullptr, "1985",
	"T.N.K III (US)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, tnk3RomInfo, tnk3RomName, nullptr, nullptr, nullptr, nullptr, Tnk3InputInfo, Tnk3DIPInfo,
...
struct BurnDriver BurnDrvTnk3j = {
	"tnk3j", "tnk3", nullptr, nullptr, "1985",
	"T.A.N.K (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, tnk3jRomInfo, tnk3jRomName, nullptr, nullptr, nullptr, nullptr, Tnk3InputInfo, Tnk3DIPInfo,
	Tnk3Init, DrvExit, Tnk3Frame, Tnk3Draw, DrvScan, &DrvRecalc, 0x400,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvTnk3b = {
	"tnk3b", "tnk3", nullptr, nullptr, "1985",
	"T.A.N.K (bootleg, 8-way joystick)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, tnk3bRomInfo, tnk3bRomName, nullptr, nullptr, nullptr, nullptr, Tnk3InputInfo, Tnk3DIPInfo,
...
struct BurnDriver BurnDrvAthena = {
	"athena", nullptr, nullptr, nullptr, "1986",
	"Athena\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, athenaRomInfo, athenaRomName, nullptr, nullptr, nullptr, nullptr, AthenaInputInfo, AthenaDIPInfo,
...
struct BurnDriver BurnDrvAthenab = {
	"athenab", "athena", nullptr, nullptr, "1986",
	"Athena (bootleg)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, athenabRomInfo, athenabRomName, nullptr, nullptr, nullptr, nullptr, AthenaInputInfo, AthenaDIPInfo,
	AthenaInit, DrvExit, AthenaFrame, Tnk3Draw, DrvScan, &DrvRecalc, 0x400,
	288, 216, 4, 3
};
...
struct BurnDriver BurnDrvSathena = {
	"sathena", "athena", nullptr, nullptr, "1987",
	"Super Athena (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, sathenaRomInfo, sathenaRomName, nullptr, nullptr, nullptr, nullptr, AthenaInputInfo, AthenaDIPInfo,
	AthenaInit, DrvExit, AthenaFrame, Tnk3Draw, DrvScan, &DrvRecalc, 0x400,
	288, 216, 4, 3
};
...
struct BurnDriver BurnDrvAso = {
	"aso", nullptr, nullptr, nullptr, "1985",
	"ASO - Armored Scrum Object\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, asoRomInfo, asoRomName, nullptr, nullptr, nullptr, nullptr, AsoInputInfo, AsoDIPInfo,
...
struct BurnDriver BurnDrvAlphamis = {
	"alphamis", "aso", nullptr, nullptr, "1985",
	"Alpha Mission\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, alphamisRomInfo, alphamisRomName, nullptr, nullptr, nullptr, nullptr, AlphamisInputInfo, AlphamisDIPInfo,
...
struct BurnDriver BurnDrvArian = {
	"arian", "aso", nullptr, nullptr, "1985",
	"Arian Mission\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, arianRomInfo, arianRomName, nullptr, nullptr, nullptr, nullptr, AlphamisInputInfo, AlphamisDIPInfo,
	AlphamisInit, DrvExit, Tnk3Frame, AsoDraw, DrvScan, &DrvRecalc, 0x400,
	216, 288, 3, 4
};
...
struct BurnDriver BurnDrvFitegolf = {
	"fitegolf", nullptr, nullptr, nullptr, "1988",
	"Lee Trevino's Fighting Golf (World?)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, fitegolfRomInfo, fitegolfRomName, nullptr, nullptr, nullptr, nullptr, FitegolfInputInfo, FitegolfDIPInfo,
...
struct BurnDriver BurnDrvFitegolfu = {
	"fitegolfu", "fitegolf", nullptr, nullptr, "1988",
	"Lee Trevino's Fighting Golf (US, Ver 2, set 1)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, fitegolfuRomInfo, fitegolfuRomName, nullptr, nullptr, nullptr, nullptr, FitegolfInputInfo, FitegolfDIPInfo,
	FitegolfInit, DrvExit, FitegolfFrame, Tnk3Draw, DrvScan, &DrvRecalc, 0x400,
	288, 216, 4, 3
};
...
struct BurnDriver BurnDrvFitegolfua = {
	"fitegolfua", "fitegolf", nullptr, nullptr, "1988",
	"Lee Trevino's Fighting Golf (US, Ver 2, set 2)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, fitegolfuaRomInfo, fitegolfuaRomName, nullptr, nullptr, nullptr, nullptr, FitegolfInputInfo,
	FitegolfDIPInfo,
	FitegolfInit, DrvExit, FitegolfFrame, Tnk3Draw, DrvScan, &DrvRecalc, 0x400,
	288, 216, 4, 3
};
...
struct BurnDriver BurnDrvCountryc = {
	"countryc", nullptr, nullptr, nullptr, "1988",
	...
	nullptr, countrycRomInfo, countrycRomName, nullptr, nullptr, nullptr, nullptr, FitegolfInputInfo, FitegolfDIPInfo,
	// wrong
	FitegolfInit, DrvExit, FitegolfFrame, Tnk3Draw, DrvScan, &DrvRecalc, 0x400,
	288, 216, 4, 3
};
...
struct BurnDriver BurnDrvIkari = {
	"ikari", nullptr, nullptr, nullptr, "1986",
	"Ikari Warriors (US JAMMA)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, ikariRomInfo, ikariRomName, nullptr, nullptr, nullptr, nullptr, IkariInputInfo, IkariDIPInfo,
...
struct BurnDriver BurnDrvIkaria = {
	"ikaria", "ikari", nullptr, nullptr, "1986",
	"Ikari Warriors (US, set 1)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, ikariaRomInfo, ikariaRomName, nullptr, nullptr, nullptr, nullptr, IkariaInputInfo, IkariDIPInfo,
...
struct BurnDriver BurnDrvIkaria2 = {
	"ikaria2", "ikari", nullptr, nullptr, "1986",
	"Ikari Warriors (US, set 2)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, ikaria2RomInfo, ikaria2RomName, nullptr, nullptr, nullptr, nullptr, IkariaInputInfo, IkariDIPInfo,
	IkariaInit, DrvExit, AthenaFrame, IkariDraw, DrvScan, &DrvRecalc, 0x400,
	216, 288, 3, 4
};
...
struct BurnDriver BurnDrvIkarinc = {
	"ikarinc", "ikari", nullptr, nullptr, "1986",
	"Ikari Warriors (US No Continues)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, ikarincRomInfo, ikarincRomName, nullptr, nullptr, nullptr, nullptr, IkariaInputInfo, IkariDIPInfo,
	IkariInit, DrvExit, AthenaFrame, IkariDraw, DrvScan, &DrvRecalc, 0x400,
	216, 288, 3, 4
};
...
struct BurnDriver BurnDrvIkarijp = {
	"ikarijp", "ikari", nullptr, nullptr, "1986",
	"Ikari (Japan No Continues)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, ikarijpRomInfo, ikarijpRomName, nullptr, nullptr, nullptr, nullptr, IkariaInputInfo, IkariDIPInfo,
	IkariaInit, DrvExit, AthenaFrame, IkariDraw, DrvScan, &DrvRecalc, 0x400,
	216, 288, 3, 4
};
...
struct BurnDriver BurnDrvIkarijpb = {
	"ikarijpb", "ikari", nullptr, nullptr, "1986",
	"Ikari (Joystick hack bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, ikarijpbRomInfo, ikarijpbRomName, nullptr, nullptr, nullptr, nullptr, IkariaInputInfo, IkariDIPInfo,
...
struct BurnDriver BurnDrvIkariram = {
	"ikariram", "ikari", nullptr, nullptr, "1986",
	"Rambo 3 (bootleg of Ikari, Joystick hack)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, ikariramRomInfo, ikariramRomName, nullptr, nullptr, nullptr, nullptr, IkariaInputInfo, IkariDIPInfo,
	IkarijoyInit, DrvExit, AthenaFrame, IkariDraw, DrvScan, &DrvRecalc, 0x400,
	216, 288, 3, 4
};
...
struct BurnDriver BurnDrvVictroad = {
	"victroad", nullptr, nullptr, nullptr, "1986",
	"Victory Road\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, victroadRomInfo, victroadRomName, nullptr, nullptr, nullptr, nullptr, VictroadInputInfo, VictroadDIPInfo,
...
struct BurnDriver BurnDrvDogosoke = {
	"dogosoke", "victroad", nullptr, nullptr, "1986",
	"Dogou Souken\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, dogosokeRomInfo, dogosokeRomName, nullptr, nullptr, nullptr, nullptr, VictroadInputInfo, VictroadDIPInfo,
	VictroadInit, DrvExit, AthenaFrame, IkariDraw, DrvScan, &DrvRecalc, 0x400,
	216, 288, 3, 4
};
...
struct BurnDriver BurnDrvDogosokb = {
	"dogosokb", "victroad", nullptr, nullptr, "1986",
	"Dogou Souken (Joystick hack bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, dogosokbRomInfo, dogosokbRomName, nullptr, nullptr, nullptr, nullptr, VictroadInputInfo, VictroadDIPInfo,
	VictroadInit, DrvExit, AthenaFrame, IkariDraw, DrvScan, &DrvRecalc, 0x400,
	216, 288, 3, 4
};
...
struct BurnDriver BurnDrvChopper = {
	"chopper", nullptr, nullptr, nullptr, "1988",
	"Chopper I (US Ver 2)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, chopperRomInfo, chopperRomName, nullptr, nullptr, nullptr, nullptr, ChopperaInputInfo, ChopperaDIPInfo,
...
struct BurnDriver BurnDrvChoppera = {
	"choppera", "chopper", nullptr, nullptr, "1988",
	"Chopper I (US Ver 1?)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, chopperaRomInfo, chopperaRomName, nullptr, nullptr, nullptr, nullptr, ChopperInputInfo, ChopperDIPInfo,
...
struct BurnDriver BurnDrvChopperb = {
	"chopperb", "chopper", nullptr, nullptr, "1988",
	"Chopper I (US)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, chopperbRomInfo, chopperbRomName, nullptr, nullptr, nullptr, nullptr, ChopperInputInfo, ChopperDIPInfo,
	Chopper1Init, DrvExit, ChopperFrame, GwarDraw, DrvScan, &DrvRecalc, 0x400,
	224, 400, 3, 4
};
...
struct BurnDriver BurnDrvLegofair = {
	"legofair", "chopper", nullptr, nullptr, "1988",
	"Koukuu Kihei Monogatari - The Legend of Air Cavalry (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, legofairRomInfo, legofairRomName, nullptr, nullptr, nullptr, nullptr, ChopperInputInfo, ChopperDIPInfo,
	Chopper1Init, DrvExit, ChopperFrame, GwarDraw, DrvScan, &DrvRecalc, 0x400,
	224, 400, 3, 4
};
...
struct BurnDriver BurnDrvTdfever = {
	"tdfever", nullptr, nullptr, nullptr, "1987",
	"TouchDown Fever (US)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	/*BDF_GAME_WORKING |*/0, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, tdfeverRomInfo, tdfeverRomName, nullptr, nullptr, nullptr, nullptr, ChopperInputInfo, ChopperDIPInfo,
	//TdfeverInputInfo, TdfeverDIPInfo,
...
struct BurnDriver BurnDrvTdfeverj = {
	"tdfeverj", "tdfever", nullptr, nullptr, "1987",
	"TouchDown Fever (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	/*BDF_GAME_WORKING |*/0 | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, tdfeverjRomInfo, tdfeverjRomName, nullptr, nullptr, nullptr, nullptr, ChopperInputInfo, ChopperDIPInfo,
	//TdfeverInputInfo, TdfeverDIPInfo,
	TdfeverInit, DrvExit, GwarFrame, TdfeverDraw, DrvScan, &DrvRecalc, 0x400,
	400, 224, 4, 3
};
...
struct BurnDriver BurnDrvTdfever2 = {
	"tdfever2", "tdfever", nullptr, nullptr, "1988",
	"TouchDown Fever 2\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	/*BDF_GAME_WORKING |*/0 | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, tdfever2RomInfo, tdfever2RomName, nullptr, nullptr, nullptr, nullptr, ChopperInputInfo, ChopperDIPInfo,
	//TdfeverInputInfo, TdfeverDIPInfo,
	TdfeverInit, DrvExit, GwarFrame, TdfeverDraw, DrvScan, &DrvRecalc, 0x400,
	400, 224, 4, 3
};
...
struct BurnDriver BurnDrvTdfever2b = {
	"tdfever2b", "tdfever", nullptr, nullptr, "1988",
	"TouchDown Fever 2 (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	/*BDF_GAME_WORKING |*/0 | BDF_CLONE | BDF_BOOTLEG, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, tdfever2bRomInfo, tdfever2bRomName, nullptr, nullptr, nullptr, nullptr, ChopperInputInfo, ChopperDIPInfo,
	//TdfeverInputInfo, TdfeverDIPInfo,
	TdfeverInit, DrvExit, GwarFrame, TdfeverDraw, DrvScan, &DrvRecalc, 0x400,
	400, 224, 4, 3
};
...
struct BurnDriver BurnDrvFsoccer = {
	"fsoccer", nullptr, nullptr, nullptr, "1988",
	"Fighting Soccer (version 4)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	/*BDF_GAME_WORKING |*/0, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, fsoccerRomInfo, fsoccerRomName, nullptr, nullptr, nullptr, nullptr, ChopperInputInfo, ChopperDIPInfo,
	//FsoccerInputInfo, FsoccerDIPInfo,
...
struct BurnDriver BurnDrvFsoccerj = {
	"fsoccerj", "fsoccer", nullptr, nullptr, "1988",
	"Fighting Soccer (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	/* |*/ BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, fsoccerjRomInfo, fsoccerjRomName, nullptr, nullptr, nullptr, nullptr, ChopperInputInfo, ChopperDIPInfo,
	//FsoccerInputInfo, FsoccerDIPInfo,
	TdfeverInit, DrvExit, GwarFrame, FsoccerDraw, DrvScan, &DrvRecalc, 0x400,
	400, 224, 4, 3
};
...
struct BurnDriver BurnDrvFsoccerb = {
	"fsoccerb", "fsoccer", nullptr, nullptr, "1988",
	"Fighting Soccer (Joystick hack bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, fsoccerbRomInfo, fsoccerbRomName, nullptr, nullptr, nullptr, nullptr, FsoccerInputInfo, FsoccerDIPInfo,
	TdfeverInit, DrvExit, GwarFrame, FsoccerDraw, DrvScan, &DrvRecalc, 0x400,
	400, 224, 4, 3
};
...
struct BurnDriver BurnDrvFsoccerba = {
	"fsoccerba", "fsoccer", nullptr, nullptr, "1988",
	"Fighting Soccer (Joystick hack bootleg, alt)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, fsoccerbaRomInfo, fsoccerbaRomName, nullptr, nullptr, nullptr, nullptr, FsoccerInputInfo, FsoccerDIPInfo,
	TdfeverInit, DrvExit, GwarFrame, FsoccerDraw, DrvScan, &DrvRecalc, 0x400,
	400, 224, 4, 3
};
