...
static INT32 CommonInit(INT32 nLoadType)
{
	...
	BurnYM2203Init(2, 3000000, nullptr, 0);
...
static void draw_layer(INT32 layer, INT32 category)
{
	...
	for (INT32 iiter = 0; iiter < (((follower & 0x100) >> 8) + 1); iiter++)
	{
		...
		for (INT32 offs = 0; offs < 32 * 32; offs++)
		{
			...
			INT32 bank = ((attr >> 7) & 1) | ((attr >> b0) & 2) | ((attr >> b1) & 4) | ((attr >> b2) & 8) | ((attr >>
				b3) & 0x10) | ((c3 & 1) << 5);
...
static INT32 DrvDraw()
{
	...
	if (nSpriteEnable & 1) k007121_draw(0, pTransDraw, DrvGfxROM, DrvSprTranspLut, DrvSprRAM,
	                                    (k007121_ctrl_read(0, 6) & 0x30) * 2, 40, 16, 0,
	                                    (k007121_ctrl_read(0, 3) & 0x40) >> 5, 0);
...
struct BurnDriver BurnDrvTricktrp = {
	"tricktrp", nullptr, nullptr, nullptr, "1987",
	"Trick Trap (World?)\0", nullptr, "Konami", "GX771",
	...
	nullptr, tricktrpRomInfo, tricktrpRomName, nullptr, nullptr, nullptr, nullptr, LabyrunrInputInfo, LabyrunrDIPInfo,
...
struct BurnDriver BurnDrvLabyrunr = {
	"labyrunr", "tricktrp", nullptr, nullptr, "1987",
	"Labyrinth Runner (Japan)\0", nullptr, "Konami", "GX771",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, labyrunrRomInfo, labyrunrRomName, nullptr, nullptr, nullptr, nullptr, LabyrunrInputInfo, LabyrunrDIPInfo,
...
struct BurnDriver BurnDrvLabyrunrk = {
	"labyrunrk", "tricktrp", nullptr, nullptr, "1987",
	"Labyrinth Runner (World Ver. K)\0", nullptr, "Konami", "GX771",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, labyrunrkRomInfo, labyrunrkRomName, nullptr, nullptr, nullptr, nullptr, LabyrunrInputInfo, LabyrunrDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	224, 280, 3, 4
};
