...
{
	{0x0b, 0xff, 0xff, 0x90, nullptr},
	{0x0c, 0xff, 0xff, 0xa0, nullptr},
...
static UINT8 nitedrvr_in1_r(UINT8 offset)
{
	...
	case 0x04:
		{
			if (m_track == 1) return 0x80;
			return 0x00;
		}

	case 0x05:
		{
			if (m_track == 0) return 0x80;
			return 0x00;
		}
...
static void draw_car() // bitmap image is 256*110
{
	...
	{
		UINT16* dst = pTransDraw + (((nScreenHeight - 110) + (109 - y)) * nScreenWidth) + ((nScreenWidth / 2) - (256 /
			2));
...
struct BurnDriver BurnDrvNitedrvr = {
	"nitedrvr", nullptr, nullptr, "nitedrvr", "1976",
	"Night Driver\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, nitedrvrRomInfo, nitedrvrRomName, nullptr, nullptr, nitedrvrSampleInfo, nitedrvrSampleName,
	NitedrvrInputInfo, NitedrvrDIPInfo,
