...
{
	DIP_OFFSET(0x10)
	{0x00, 0xff, 0xff, 0x11, nullptr},
	{0x01, 0xff, 0xff, 0x01, nullptr},
	{0x02, 0xff, 0xff, 0xd6, nullptr},
...
{
	INT32 cyc = static_cast<INT64>(ZetTotalCycles()) * 3579545 / 3072000;
...
static void __fastcall zaccaria_write(UINT16 address, UINT8 data)
{
	if (address > 0x6000 && address <= 0x67ff)
	{
		...
		if (game_select == 1)
		{
			...
			switch (address)
			{
			case 0x404: data |= 0x40;
				break;
			case 0x406: data |= 0xa0;
				break;
			}
		}
		else
		{
			...
			switch (address)
			{
			case 0x400: data |= 0x50;
				break;
			case 0x406: data |= 0x70;
				break;
			}
		}
...
static INT32 MemIndex()
{
	...
	tempsound = (INT16*)Next;
	Next += (96000 / 60) * 2 * sizeof(INT16);
...
static INT32 DrvInit(INT32 load_type)
{
	...
	ppi8255_set_write_ports(0, nullptr, nullptr, ppi0_port_C_write);

	{
		static pia6821_interface tms_pia = {
			tms_pia_in_a, nullptr, nullptr, nullptr, nullptr, nullptr,
			tms_pia_out_a, tms_pia_out_b, nullptr, nullptr, nullptr, nullptr
		};
		static pia6821_interface mel_pia = {
			mel_pia_in_a, nullptr, nullptr, nullptr, nullptr, nullptr,
			mel_pia_out_a, mel_pia_out_b, nullptr, nullptr, mel_pia_irqa, mel_pia_irqb
		};
		pia_init();
	...
	AY8910SetPorts(0, nullptr, &AY8910_0_portB_read, &AY8910_0_portA_write, nullptr);
	AY8910SetPorts(1, nullptr, nullptr, &AY8910_1_portA_write, &AY8910_1_portB_write);
...
static void disty(INT16* buf_in, INT32 buf_len)
{
	for (INT32 i = 0; i < buf_len; i++)
	{
		double x = static_cast<double>(buf_in[i]) * 0.00001;
		double y = 0;
		y = tanh(sin(x));
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[4] = {
		static_cast<INT32>(3072000 / 60.57), static_cast<INT32>(3579545 / 4 / 60.57),
		static_cast<INT32>(3579545 / 4 / 60.57), static_cast<INT32>(3579545 / 60.57)
	};
...
struct BurnDriver BurnDrvMonymony = {
	"monymony", nullptr, nullptr, nullptr, "1983",
	"Money Money (set 1)\0", nullptr, "Zaccaria", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_MAZE, 0,
	nullptr, monymonyRomInfo, monymonyRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MonymonyDIPInfo,
...
struct BurnDriver BurnDrvMonymony2 = {
	"monymony2", "monymony", nullptr, nullptr, "1983",
	"Money Money (set 2)\0", nullptr, "Zaccaria", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_MAZE, 0,
	nullptr, monymony2RomInfo, monymony2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, MonymonyDIPInfo,
	monymonyInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvJackrabt = {
	"jackrabt", nullptr, nullptr, nullptr, "1984",
	"Jack Rabbit (set 1)\0", nullptr, "Zaccaria", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_MAZE, 0,
	nullptr, jackrabtRomInfo, jackrabtRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, JackrabtDIPInfo,
...
struct BurnDriver BurnDrvJackrabt2 = {
	"jackrabt2", "jackrabt", nullptr, nullptr, "1984",
	"Jack Rabbit (set 2)\0", nullptr, "Zaccaria", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_MAZE, 0,
	nullptr, jackrabt2RomInfo, jackrabt2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, JackrabtDIPInfo,
...
struct BurnDriver BurnDrvJackrabts = {
	"jackrabts", "jackrabt", nullptr, nullptr, "1984",
	"Jack Rabbit (special)\0", nullptr, "Zaccaria", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_MAZE, 0,
	nullptr, jackrabtsRomInfo, jackrabtsRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, JackrabtDIPInfo,
	jackrabt2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 256, 3, 4
};
