...
{
	INT32 count;
	for (count = 0; static_cast<INT32>(val) >= 0; count++) val <<= 1;
	return count;
}
...
struct BurnDriver BurnDrvPunchkid = {
	"punchkid", "olibochu", nullptr, nullptr, "1981",
	"Punching Kid (Japan)\0", nullptr, "Irem", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_IREM_MISC, GBF_MAZE, 0,
	nullptr, punchkidRomInfo, punchkidRomName, nullptr, nullptr, nullptr, nullptr, OlibochuInputInfo, PunchkidDIPInfo,
...
struct BurnDriver BurnDrvOlibochu = {
	"olibochu", nullptr, nullptr, nullptr, "1981",
	"Oli-Boo-Chu (USA)\0", nullptr, "Irem (GDI license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_IREM_MISC, GBF_MAZE, 0,
	nullptr, olibochuRomInfo, olibochuRomName, nullptr, nullptr, nullptr, nullptr, OlibochuInputInfo, OlibochuDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	240, 256, 3, 4
};
