						...
						case 'S':
							{
								...
								if (bMute)
								{
									...
									_stprintf(buffer, FBNLoadStringEx(hAppInst, IDS_SOUND_MUTE, true),
									          nAudVolume / 100);
								}
								else
								{
									nAudVolume = nOldAudVolume; // restore volume
									_stprintf(buffer, FBNLoadStringEx(hAppInst, IDS_SOUND_MUTE_OFF, true),
									          nAudVolume / 100);
								}
						...
						case VK_OEM_PLUS:
							{
								...
								{
									_stprintf(buffer, FBNLoadStringEx(hAppInst, IDS_SOUND_VOLUMESET, true),
									          nAudVolume / 100);
									VidSNewShortMsg(buffer);
								}
								break;
