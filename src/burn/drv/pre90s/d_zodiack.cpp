...
{
	// The first 0x100 bytes is either encrypted or has an overlay over it with the correct
	// data. Patch this in from the parent. 
	static const UINT8 data[256] = {
		
	};
...
struct BurnDriver BurnDrvBounty2 = {
	...
	NULL, bounty2RomInfo, bounty2RomName, NULL, NULL, BountyInputInfo, BountyDIPInfo,
