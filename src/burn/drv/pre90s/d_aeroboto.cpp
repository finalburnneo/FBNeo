...
{
	DIP_OFFSET(0x10)
	{0x00, 0xff, 0xff, 0x6c, nullptr},
	{0x01, 0xff, 0xff, 0x08, nullptr},
...
static INT32 DrvInit()
{
	...
	AY8910SetPorts(0, &aeroboto_AY8910_0_portA, &aeroboto_AY8910_0_portB, nullptr, nullptr);
...
static void draw_layer(INT32 miny, INT32 maxy, INT32 yscroll)
{
	for (INT32 offs = 0; offs < 64 * 32; offs++)
	{
		...
		if (flipscreen)
		{
			Render8x8Tile_Mask_FlipXY_Clip(pTransDraw, code, (248 - sx) - 8, (248 - sy) - 16, color, 2, category, 0,
			                               DrvGfxROM0);
		}
		else
		{
...
#define SCROLL_SPEED	1
	...
	if (!stardisable)
	{
		...
		m_sx += static_cast<char>(starx - m_ox);
		m_ox = starx;
		INT32 x = m_sx / SCROLL_SPEED;

		if (scrolly != 0xff)
			m_sy += static_cast<char>(stary - m_oy);
		m_oy = stary;
		...
		for (INT32 i = 0; i < 248; i++)
		{
			...
			for (INT32 j = 16; j < 240; j++)
			{
				...
				if (!(static_cast<unsigned>(*src_rowptr) & src_colmask))
...
static void draw_sprites()
{
	for (INT32 offs = 0; offs < 0x100; offs += 4)
	{
		...
		if (flipscreen)
		{
			RenderCustomTile_Mask_FlipXY_Clip(pTransDraw, 8, 16, code, (((248 - sx) + 8) & 0xff) - 8, (240 - sy) - 16,
			                                  color, 3, 0, 0, DrvGfxROM2);
		}
		else
		{
			RenderCustomTile_Mask_Clip(pTransDraw, 8, 16, code, ((sx + 8) & 0xff) - 8, sy - 16, color, 3, 0, 0,
			                           DrvGfxROM2);
		}
	}
}
...
struct BurnDriver BurnDrvFormatz = {
	"formatz", nullptr, nullptr, nullptr, "1984",
	"Formation Z\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, formatzRomInfo, formatzRomName, nullptr, nullptr, nullptr, nullptr, FormatzInputInfo, FormatzDIPInfo,
...
struct BurnDriver BurnDrvAeroboto = {
	"aeroboto", "formatz", nullptr, nullptr, "1984",
	"Aeroboto\0", nullptr, "Jaleco (Williams license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, aerobotoRomInfo, aerobotoRomName, nullptr, nullptr, nullptr, nullptr, FormatzInputInfo, FormatzDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	248, 224, 4, 3
};
