...
{
	DIP_OFFSET(0x0b)
	{0x00, 0xff, 0xff, 0xd0, nullptr},
	{0x01, 0xff, 0xff, 0x40, nullptr},
...
static void __fastcall lockon_main_write(UINT32 address, UINT8 data)
{
	...
	if ((address & 0xff000) == 0x0b000)
	{
		...
		{
		case 0: grab_16bit(m_xsal, address, data, 0x1ff);
			break;
		case 1: grab_16bit(m_x0ll, address, data, 0xff);
			break;
		case 2: grab_16bit(m_dx0ll, address, data, 0x1ff);
			break;
		case 3: grab_16bit(m_dxll, address, data, 0x1ff);
			break;
		case 4: grab_16bit(m_ysal, address, data, 0x1ff);
			break;
		case 5: grab_16bit(m_y0ll, address, data, 0xff);
			break;
		case 6: grab_16bit(m_dy0ll, address, data, 0x1ff);
			break;
		case 7: grab_16bit(m_dyll, address, data, 0x3ff);
			break;
		}
		return;
	}
	...
	if ((address & 0xf0001) == 0x20000)
	{
		// 8 bit! &~1 is the low bit on LE-cpu (Vez)
...
static constexpr double vols[0x10] = {
	0.46, 0.44, 0.43, 0.41, 0.39, 0.37, 0.35, 0.32, 0.27, 0.25, 0.22, 0.19, 0.14, 0.10, 0.06, 0.01
};
...
{
	constexpr res_net_info lockon_net_info =
	{
	...
	constexpr res_net_info lockon_pd_net_info =
	{
		RES_NET_VCC_5V | RES_NET_VBIAS_5V | RES_NET_VIN_TTL_OUT,
		{
...
static void scene_draw()
{
	...
	auto sceneram = (UINT16*)DrvSceneRAM;
...
static void ground_draw(INT32 from_drvdraw)
{
	...
	auto m_ground_ram = (UINT16*)DrvGroundRAM;
		...
		if (!(m_ground_ram[offs] & 0x8000))
		{
			...
			for (x = 0; x < 431; x++)
			{
				...
				*bmpaddr++ = 0x800 + color;
				...
				/* Update the counters */
				tz2213_cy = tz2213_dx > static_cast<UINT8>(~(tz2213_x));
...
static void objects_draw()
{
	...
	auto m_object_ram = (UINT16*)DrvSpriteRAM;
...
static void hud_draw()
{
	...
	auto m_hud_ram = (UINT16*)DrvHudRAM;
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[5] = {
		static_cast<INT32>(8000000 / 55.803571), static_cast<INT32>(8000000 / 55.803571),
		static_cast<INT32>(8000000 / 55.803571), static_cast<INT32>(4000000 / 55.803571),
		static_cast<INT32>(10000000 / 55.803571)
	};
	...
	{
		VezOpen(0);
		if (i == (239 * 8) + 4 && main_inten) VezSetIRQLineAndVector(0, 0, 0xff, CPU_IRQSTATUS_ACK);
		// should be 239y, 168x (hits at 239y 160x)
		CPU_RUN(0, Vez);
		VezClose();
...
struct BurnDriver BurnDrvLockon = {
	"lockon", nullptr, nullptr, nullptr, "1986",
	"Lock-On (rev. E)\0", nullptr, "Tatsumi", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, lockonRomInfo, lockonRomName, nullptr, nullptr, nullptr, nullptr, LockonInputInfo, LockonDIPInfo,
...
struct BurnDriver BurnDrvLockonc = {
	"lockonc", "lockon", nullptr, nullptr, "1986",
	"Lock-On (rev. C)\0", nullptr, "Tatsumi", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, lockoncRomInfo, lockoncRomName, nullptr, nullptr, nullptr, nullptr, LockonInputInfo, LockoneDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0xc00,
	320, 240, 4, 3
};
