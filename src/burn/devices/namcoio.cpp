...
void namcoio_init(INT32 chip, INT32 type, UINT8 (*in0)(UINT8), UINT8 (*in1)(UINT8), UINT8 (*in2)(UINT8),
                  UINT8 (*in3)(UINT8), void (*out0)(UINT8, UINT8), void (*out1)(UINT8, UINT8))
{
	...
	switch (type)
	{
	case NAMCO56xx: ptr->run_func = namco56xx_customio_run;
		break;
	case NAMCO58xx: ptr->run_func = namco58xx_customio_run;
		break;
	case NAMCO59xx: ptr->run_func = namco59xx_customio_run;
		break;
	}
}
...
void namco56xx_customio_run(INT32 chip)
{
	...
	case 1: // read switch inputs
		...
		ptr->out_0_cb(static_cast<UINT8>(0), IORAM_READ(9)); // output to pins 13-16 (motos, pacnpal, gaplus)
		ptr->out_1_cb(static_cast<UINT8>(0), IORAM_READ(10)); // output to pins 17-20 (gaplus)
		break;
	...
	case 9: // read dip switches and inputs
		ptr->out_0_cb(static_cast<UINT8>(0), 0 & 0x0f); // set pin 13 = 0
		...
		ptr->out_0_cb(static_cast<UINT8>(0), 1 & 0x0f); // set pin 13 = 1
...
void namco58xx_customio_run(INT32 chip)
{
	...
	case 1: // read switch inputs
		...
		IORAM_WRITE(6, ~ptr->in_2_cb(0 & 0x0f)); // pins 26-29
		IORAM_WRITE(7, ~ptr->in_3_cb(0 & 0x0f)); // pins 30-33
		ptr->out_0_cb(static_cast<UINT8>(0), IORAM_READ(9)); // output to pins 13-16 (toypop)
		ptr->out_1_cb(static_cast<UINT8>(0), IORAM_READ(10)); // output to pins 17-20 (toypop)
		break;
