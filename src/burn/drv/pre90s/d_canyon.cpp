...
static void draw_sprites()
{
	for (INT32 i = 0; i < 2; i++)
	{
		...
		if (flipx)
		{
			RenderCustomTile_Mask_FlipX_Clip(pTransDraw, 32, 16, (code >> 3) & 3, 224 - sx, 240 - sy, i, 1, 0, 0,
			                                 DrvGfxROM1);
		}
		else
		{
...
struct BurnDriver BurnDrvCanyon = {
	"canyon", nullptr, nullptr, nullptr, "1977",
	...
	nullptr, canyonRomInfo, canyonRomName, nullptr, nullptr, nullptr, nullptr, CanyonInputInfo, CanyonDIPInfo,
...
struct BurnDriver BurnDrvCanyonp = {
	"canyonp", "canyon", nullptr, nullptr, "1977",
	...
	nullptr, canyonpRomInfo, canyonpRomName, nullptr, nullptr, nullptr, nullptr, CanyonInputInfo, CanyonDIPInfo,
