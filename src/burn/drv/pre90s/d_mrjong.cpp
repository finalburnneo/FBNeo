...
static void DrvGfxDecode()
{
	...
	INT32 XOffs1[16] = {
		8 * 8 + 0, 8 * 8 + 1, 8 * 8 + 2, 8 * 8 + 3, 8 * 8 + 4, 8 * 8 + 5, 8 * 8 + 6, 8 * 8 + 7, 0, 1, 2, 3, 4, 5, 6, 7
	}; /* pretty straightforward layout */
	INT32 YOffs1[16] = {
		23 * 8, 22 * 8, 21 * 8, 20 * 8, 19 * 8, 18 * 8, 17 * 8, 16 * 8, 7 * 8, 6 * 8, 5 * 8, 4 * 8, 3 * 8, 2 * 8, 1 * 8,
		0 * 8
	};
...
struct BurnDriver BurnDrvMrjong = {
	"mrjong", nullptr, nullptr, nullptr, "1983",
	"Mr. Jong (Japan)\0", nullptr, "Kiwako", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, mrjongRomInfo, mrjongRomName, nullptr, nullptr, nullptr, nullptr, MrjongInputInfo, MrjongDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 512,
	224, 240, 3, 4
};

struct BurnDriver BurnDrvCrazyblk = {
	"crazyblk", "mrjong", nullptr, nullptr, "1983",
	"Crazy Blocks\0", nullptr, "Kiwako (ECI license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE,
	0,
	nullptr, crazyblkRomInfo, crazyblkRomName, nullptr, nullptr, nullptr, nullptr, MrjongInputInfo, MrjongDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 512,
	224, 240, 3, 4
};

struct BurnDriver BurnDrvBlkbustr = {
	"blkbustr", "mrjong", nullptr, nullptr, "1983",
	"BlockBuster\0", nullptr, "Kiwako (ECI license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE,
	0,
	nullptr, blkbustrRomInfo, blkbustrRomName, nullptr, nullptr, nullptr, nullptr, MrjongInputInfo, MrjongDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 512,
	224, 240, 3, 4
};
