...
static INT32 CommonInit(INT32 (*pRomLoad)(INT32*, INT32*), void (*pMap)(), INT32 msm, UINT32 speedhack)
{
	...
	MSM6295Init(0, 1006875 / 132, false);
	MSM6295Init(1, 2013750 / 132 / msm, true);
	...
	deco16_set_graphics(DrvGfxROM0, gfx0len * 2, DrvGfxROM1, gfx0len * 2, nullptr, 0);
...
static void draw_sprites()
{
	...
	for (INT32 offs = (0x1400 / 4) - 4; offs >= 0; offs -= 4)
	{
		...
		while (multi >= 0)
		{
			deco16_draw_prio_sprite(pTransDraw, DrvGfxROM2, code - multi * inc, (color << 4) + 0x200, sx,
			                        sy + mult * multi, flipx, flipy, pri);
...
struct BurnDriver BurnDrvJoemacr = {
	"joemacr", nullptr, nullptr, nullptr, "1994",
	"Joe & Mac Returns (World, Version 1.1, 1994.05.27)\0", nullptr, "Data East Corporation", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, joemacrRomInfo, joemacrRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
...
struct BurnDriver BurnDrvJoemacra = {
	"joemacra", "joemacr", nullptr, nullptr, "1994",
	"Joe & Mac Returns (World, Version 1.0, 1994.05.19)\0", nullptr, "Data East Corporation", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, joemacraRomInfo, joemacraRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
...
struct BurnDriver BurnDrvJoemacrj = {
	"joemacrj", "joemacr", nullptr, nullptr, "1994",
	"Joe & Mac Returns (Japan, Version 1.2, 1994.06.06)\0", nullptr, "Data East Corporation", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM, 0,
	nullptr, joemacrjRomInfo, joemacrjRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
...
struct BurnDriver BurnDrvChainrec = {
	"chainrec", nullptr, nullptr, nullptr, "1995",
	"Chain Reaction (World, Version 2.2, 1995.09.25)\0", nullptr, "Data East Corporation", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PUZZLE, 0,
	nullptr, chainrecRomInfo, chainrecRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
...
struct BurnDriver BurnDrvMagdrop = {
	"magdrop", "chainrec", nullptr, nullptr, "1995",
	"Magical Drop (Japan, Version 1.1, 1995.06.21)\0", nullptr, "Data East Corporation", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PUZZLE, 0,
	nullptr, magdropRomInfo, magdropRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
...
struct BurnDriver BurnDrvMagdropp = {
	"magdropp", "chainrec", nullptr, nullptr, "1995",
	"Magical Drop Plus 1 (Japan, Version 2.1, 1995.09.12)\0", nullptr, "Data East Corporation", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PUZZLE, 0,
	nullptr, magdroppRomInfo, magdroppRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
...
struct BurnDriver BurnDrvCharlien = {
	"charlien", nullptr, nullptr, nullptr, "1995",
	"Charlie Ninja\0", nullptr, "Mitchell", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM | GBF_RUNGUN, 0,
	nullptr, charlienRomInfo, charlienRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
...
struct BurnDriver BurnDrvPrtytime = {
	"prtytime", nullptr, nullptr, nullptr, "1995",
	"Party Time: Gonta the Diver II / Ganbare! Gonta!! 2 (World Release)\0", nullptr, "Mitchell", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, prtytimeRomInfo, prtytimeRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
...
struct BurnDriver BurnDrvGangonta = {
	"gangonta", "prtytime", nullptr, nullptr, "1995",
	"Ganbare! Gonta!! 2 / Party Time: Gonta the Diver II (Japan Release)\0", nullptr, "Mitchell", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_DATAEAST, GBF_MAZE, 0,
	nullptr, gangontaRomInfo, gangontaRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
	prtytimeInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvOsman = {
	"osman", nullptr, nullptr, nullptr, "1996",
	"Osman (World)\0", nullptr, "Mitchell", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, osmanRomInfo, osmanRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
...
struct BurnDriver BurnDrvCandance = {
	"candance", "osman", nullptr, nullptr, "1996",
	"Cannon Dancer (Japan)\0", nullptr, "Mitchell (Atlus license)", "Simple 156",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, candanceRomInfo, candanceRomName, nullptr, nullptr, nullptr, nullptr, Simpl156InputInfo, Simpl156DIPInfo,
	osmanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	320, 240, 4, 3
};
