...
void tms34061_init(UINT8 rowshift, UINT32 ram_size, void (*partial_update)(), void (*callback)(INT32 state))
{
	...
	m_vram = m_vram_orig = BurnMalloc(m_vramsize + 256 * 2);

	/* allocate memory for latch RAM */
	m_latchram = m_latchram_orig = BurnMalloc(m_vramsize + 256 * 2);
...
static void register_w(INT32 offset, UINT8 data)
{
	...
	case TMS34061_XYOFFSET:
		...
		{
		case 0x01: m_yshift = 2;
			break;
		case 0x02: m_yshift = 3;
			break;
		case 0x04: m_yshift = 4;
			break;
		case 0x08: m_yshift = 5;
			break;
		case 0x10: m_yshift = 6;
			break;
		case 0x20: m_yshift = 7;
			break;
		case 0x40: m_yshift = 8;
			break;
		case 0x80: m_yshift = 9;
			break;
...
void tms34061_write(INT32 col, INT32 row, INT32 func, UINT8 data)
{
	...
	case 4:
		...
		memcpy(&m_vram[offs], m_shiftreg, static_cast<size_t>(1) << m_rowshift);
		memset(&m_latchram[offs], m_latchdata, static_cast<size_t>(1) << m_rowshift);
		break;
