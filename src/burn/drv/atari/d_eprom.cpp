...
static void __fastcall eprom_main_write_byte(UINT32 address, UINT8 data)
{
	if ((address & 0xffe000) == 0x3f2000)
	{
		...
		if (address & 1)
			AtariMoWrite(0, (address & 0x1fff) >> 1,
...
{
	INT32 Plane0[4] = {
		RGN_FRAC(0x100000, 0, 4), RGN_FRAC(0x100000, 1, 4), RGN_FRAC(0x100000, 2, 4), RGN_FRAC(0x100000, 3, 4)
	};
...
static INT32 DrvInit()
{
	...
	SekMapMemory(nullptr, 0x16cc00, 0x16cfff, MAP_WRITE); // unmap write!
...
{
	auto scr = (UINT16*)(DrvAlphaRAM + 0xf00);
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[3] = {
		static_cast<INT32>(static_cast<double>(7159090) / 59.92),
		static_cast<INT32>(static_cast<double>(7159090) / 59.92),
		static_cast<INT32>(static_cast<double>(1789773) / 59.92)
	};
...
struct BurnDriver BurnDrvEprom = {
	"eprom", nullptr, nullptr, nullptr, "1989",
	"Escape from the Planet of the Robot Monsters (set 1)\0", nullptr, "Atari Games", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, epromRomInfo, epromRomName, nullptr, nullptr, nullptr, nullptr, EpromInputInfo, EpromDIPInfo,
