...
{
	static constexpr char pal_data[] =
	...
	if (digit0 >= 'A') digit0 += 10 - 'A';
	else digit0 -= '0';
	if (digit1 >= 'A') digit1 += 10 - 'A';
	else digit1 -= '0';
...
{
	static constexpr INT32 xpos[8] = {10, 7, 0, -7, -10, -7, 0, 7};
	static constexpr INT32 ypos[8] = {0, 7, 10, 7, 0, -7, -10, -7};
	INT32 best_dist = 0;
	INT32 best_dir = 0;
	INT32 x, y;
...
static INT32 DrvGfxDecode()
{
	...
	INT32 Plane1[4] = {RGN_FRAC(spritelen, 1, 2) + 4, RGN_FRAC(spritelen, 1, 2) + 0, 4, 0};
	//0x080004, 0x080000, 0x000004, 0x000000 };
...
{
	return static_cast<INT64>(static_cast<double>(ZetTotalCycles()) * nSoundRate / (3000000));
}
...
static INT32 FballInit()
{
	...
	MSM6295Init(0, 1000000 / 132, false);
...
static void draw_16x16_with_mask(INT32 sx, INT32 sy, INT32 code, INT32 color, UINT8* gfxbase, UINT8* mask, INT32 flipx,
                                 INT32 flipy)
{
...
struct BurnDriver BurnDrvSectionz = {
	"sectionz", nullptr, nullptr, nullptr, "1985",
	"Section Z (set 1)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_HORSHOOT, 0,
	nullptr, sectionzRomInfo, sectionzRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, SectionzDIPInfo,
...
struct BurnDriver BurnDrvSectionza = {
	"sectionza", "sectionz", nullptr, nullptr, "1985",
	"Section Z (set 2 rev. A)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_HORSHOOT, 0,
	nullptr, sectionzaRomInfo, sectionzaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, SectionzDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvLwings = {
	"lwings", nullptr, nullptr, nullptr, "1986",
	"Legendary Wings (US set 1)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, lwingsRomInfo, lwingsRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, LwingsDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvLwings2 = {
	"lwings2", "lwings", nullptr, nullptr, "1986",
	"Legendary Wings (US set 2)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARWARE_CAPCOM_MISC, GBF_VERSHOOT, 0,
	nullptr, lwings2RomInfo, lwings2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, LwingsDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvLwingsj = {
	"lwingsj", "lwings", nullptr, nullptr, "1986",
	"Ares no Tsubasa (Japan, rev. B)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARWARE_CAPCOM_MISC, GBF_VERSHOOT, 0,
	nullptr, lwingsjRomInfo, lwingsjRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, LwingsDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvLwingsja = {
	"lwingsja", "lwings", nullptr, nullptr, "1986",
	"Ares no Tsubasa (Japan, rev. A)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARWARE_CAPCOM_MISC, GBF_VERSHOOT, 0,
	nullptr, lwingsjaRomInfo, lwingsjaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, LwingsDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvLwingsb = {
	"lwingsb", "lwings", nullptr, nullptr, "1986",
	"Legendary Wings (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARWARE_CAPCOM_MISC, GBF_VERSHOOT, 0,
	nullptr, lwingsbRomInfo, lwingsbRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, LwingsbDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvTrojan = {
	"trojan", nullptr, nullptr, nullptr, "1986",
	"Trojan (US set 1)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, trojanRomInfo, trojanRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, TrojanlsDIPInfo,
...
struct BurnDriver BurnDrvTrojana = {
	"trojana", "trojan", nullptr, nullptr, "1986",
	"Trojan (US set 2)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, trojanaRomInfo, trojanaRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, TrojanDIPInfo,
	TrojanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvTrojanr = {
	"trojanr", "trojan", nullptr, nullptr, "1986",
	"Trojan (Romstar)\0", nullptr, "Capcom (Romstar license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, trojanrRomInfo, trojanrRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, TrojanDIPInfo,
	TrojanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvTrojanb = {
	"trojanb", "trojan", nullptr, nullptr, "1986",
	"Trojan (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, trojanbRomInfo, trojanbRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, TrojanDIPInfo,
	TrojanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvTrojanj = {
	"trojanj", "trojan", nullptr, nullptr, "1986",
	"Tatakai no Banka (Japan)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, trojanjRomInfo, trojanjRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, TrojanDIPInfo,
	TrojanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvTrojanjo = {
	"trojanjo", "trojan", nullptr, nullptr, "1986",
	"Tatakai no Banka (Japan, old ver.)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, trojanjoRomInfo, trojanjoRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, TrojanDIPInfo,
	TrojanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvTrojanlt = {
	"trojanlt", "trojan", nullptr, nullptr, "1986",
	"Trojan (location test)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, trojanltRomInfo, trojanltRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, TrojanDIPInfo,
	TrojanInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvAvengers = {
	"avengers", nullptr, nullptr, nullptr, "1987",
	"Avengers (US, revision C)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARWARE_CAPCOM_MISC, GBF_SCRFIGHT, 0,
	nullptr, avengersRomInfo, avengersRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, AvengersDIPInfo,
...
struct BurnDriver BurnDrvAvengera = {
	"avengersa", "avengers", nullptr, nullptr, "1987",
	"Avengers (US, revision A)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARWARE_CAPCOM_MISC, GBF_SCRFIGHT, 0,
	nullptr, avengeraRomInfo, avengeraRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, AvengersDIPInfo,
	AvengersInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvAvengerb = {
	"avengersb", "avengers", nullptr, nullptr, "1987",
	"Avengers (US)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARWARE_CAPCOM_MISC, GBF_SCRFIGHT, 0,
	nullptr, avengerbRomInfo, avengerbRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, AvengersDIPInfo,
	AvengersInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvAvengerc = {
	"avengersc", "avengers", nullptr, nullptr, "1987",
	"Avengers (US, unknown revision)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARWARE_CAPCOM_MISC, GBF_SCRFIGHT, 0,
	nullptr, avengercRomInfo, avengercRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, AvengersDIPInfo,
	AvengersInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvBuraiken = {
	"buraiken", "avengers", nullptr, nullptr, "1987",
	"Hissatsu Buraiken (Japan, rev. A)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARWARE_CAPCOM_MISC, GBF_SCRFIGHT, 0,
	nullptr, buraikenRomInfo, buraikenRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, AvengersDIPInfo,
	AvengersInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvFball = {
	"fball", nullptr, nullptr, nullptr, "1992",
	...
	nullptr, fballRomInfo, fballRomName, nullptr, nullptr, nullptr, nullptr, FballInputInfo, FballDIPInfo,
