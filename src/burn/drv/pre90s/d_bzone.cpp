...
static struct BurnDIPInfo BzoneDIPList[] =
{
	...
	{0x00, 0xff, 0xff, 0x15, nullptr},
	{0x01, 0xff, 0xff, 0x02, nullptr},
	{0x02, 0xff, 0xff, 0x10, nullptr},
...
{
	{0x0b, 0xff, 0xff, 0xfd, nullptr},
	{0x0c, 0xff, 0xff, 0xe7, nullptr},
	{0x0d, 0xff, 0xff, 0x10, nullptr},
...
{
	{0x12, 0xff, 0xff, 0x15, nullptr},
	{0x13, 0xff, 0xff, 0x02, nullptr},
	{0x14, 0xff, 0xff, 0x10, nullptr},
...
static void bzone_write(UINT16 address, UINT8 data)
{
	...
	case 0x1848: analog_data = x_adder;
		break;
	case 0x1849: analog_data = y_adder;
		break;
	case 0x184a: analog_data = ProcessAnalog(DrvAnalogPort2, 1, 1, 0x10, 0xf0);
		break;
...
static INT32 MemIndex()
{
	...
	DrvVectorROM = Next;
	Next += 0x001000; // needs to be after DrvVectorRAM(!)
...
{
	constexpr INT32 hud_end[2] = {92, 92 * 1080 / 480}; // hud_end[1] is 100pix scaled to the new size
...
static INT32 DrvFrame()
{
...

	{
		...
		if (DrvFakeInput[0] && DrvFakeInput[2])
		{
			DrvJoy2[0] = 0;
			DrvJoy2[1] = 1;
			DrvJoy2[3] = 0;
		...
		else if (DrvFakeInput[0] && DrvFakeInput[3])
		{
			DrvJoy2[3] = 1;
			DrvJoy2[2] = 0;
			DrvJoy2[0] = 0;
		...
		else if (DrvFakeInput[1] && DrvFakeInput[2])
		{
			DrvJoy2[0] = 1;
			DrvJoy2[1] = 0;
			DrvJoy2[3] = 0;
		...
		else if (DrvFakeInput[1] && DrvFakeInput[3])
		{
			DrvJoy2[3] = 0;
			DrvJoy2[2] = 1;
			DrvJoy2[0] = 0;
		...
		else if (DrvFakeInput[0])
		{
			DrvJoy2[3] = 1;
			DrvJoy2[1] = 1;
		}
		else if (DrvFakeInput[1])
		{
			DrvJoy2[2] = 1;
			DrvJoy2[0] = 1;
		}
		else if (DrvFakeInput[2])
		{
			DrvJoy2[2] = 1;
			DrvJoy2[1] = 1;
		}
		else if (DrvFakeInput[3])
		{
			DrvJoy2[3] = 1;
			DrvJoy2[0] = 1;
		}
...
struct BurnDriver BurnDrvBzone = {
	"bzone", nullptr, nullptr, nullptr, "1980",
	...
	nullptr, bzoneRomInfo, bzoneRomName, nullptr, nullptr, nullptr, nullptr, BzoneInputInfo, BzoneDIPInfo,
...
struct BurnDriver BurnDrvBzonea = {
	"bzonea", "bzone", nullptr, nullptr, "1980",
	...
	nullptr, bzoneaRomInfo, bzoneaRomName, nullptr, nullptr, nullptr, nullptr, BzoneInputInfo, BzoneDIPInfo,
	BzoneInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvBzonec = {
	"bzonec", "bzone", nullptr, nullptr, "1980",
	"Battle Zone (cocktail)\0", "GFX/Sound Issues", "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, bzonecRomInfo, bzonecRomName, nullptr, nullptr, nullptr, nullptr, BzoneInputInfo, BzoneDIPInfo,
	BzoneInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	640, 480, 4, 3
};
...
struct BurnDriver BurnDrvBradley = {
	"bradley", nullptr, nullptr, nullptr, "1980",
	"Bradley Trainer\0", "GFX/Sound Issues", "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, bradleyRomInfo, bradleyRomName, nullptr, nullptr, nullptr, nullptr, BradleyInputInfo, BradleyDIPInfo,
...
struct BurnDriver BurnDrvRedbaron = {
	"redbaron", nullptr, nullptr, nullptr, "1980",
	"Red Baron (revised hardware)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, redbaronRomInfo, redbaronRomName, nullptr, nullptr, nullptr, nullptr, RedbaronInputInfo, RedbaronDIPInfo,
...
struct BurnDriver BurnDrvRedbarona = {
	"redbarona", "redbaron", nullptr, nullptr, "1980",
	"Red Baron\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, redbaronaRomInfo, redbaronaRomName, nullptr, nullptr, nullptr, nullptr, RedbaronInputInfo, RedbaronDIPInfo,
