...
static struct BurnDIPInfo VastarDIPList[] =
{
	...
	{0x00, 0x01, 0x20, 0x20, "20000 50000"},
	{0x00, 0x01, 0x20, 0x00, "40000 70000"},
	...
	{0, 0xfe, 0, 8, "Coin A"},
	{0x01, 0x01, 0x07, 0x02, "2 Coins 1 Credits"},
	{0x01, 0x01, 0x07, 0x01, "3 Coins 2 Credits"},
	...
	{0x01, 0x01, 0x07, 0x03, "1 Coin  6 Credits"},
...
static struct BurnDIPInfo PprobeDIPList[] =
{
	...
	{0, 0xfe, 0, 2, "Bonus Life"},
	{0x00, 0x01, 0x20, 0x20, "20000 then every 40000"},
	{0x00, 0x01, 0x20, 0x00, "30000 then every 70000"},
...
static INT32 DrvInit(INT32 load_type)
{
	...
	AY8910SetPorts(0, &vastar_ay8910_read_A, &vastar_ay8910_read_B, nullptr, nullptr);
...
static void draw_layer(UINT8* ram, UINT8* gfx, UINT8* cscroll, INT32 ofst0, INT32 ofst1, INT32 opaque)
{
	...
	for (INT32 offs = 0; offs < 32 * 32; offs++)
	{
		...
		Draw8x8MaskTile(pTransDraw, code, sx, sy, flipx, flipy, color, 2, trans, 0, gfx);
	}
}
...
static INT32 DrvDraw()
{
	...
	case 0:
		...
		if (nBurnLayer & 4) draw_layer(DrvVidRAM2, DrvGfxROM0, nullptr, 0x400, 0, 0);
		break;
...
struct BurnDriver BurnDrvVastar = {
	"vastar", nullptr, nullptr, nullptr, "1983",
	"Vastar (set 1)\0", nullptr, "Orca (Sesame Japan license)", "Miscellaneous",
	...
	nullptr, vastarRomInfo, vastarRomName, nullptr, nullptr, nullptr, nullptr, VastarInputInfo, VastarDIPInfo,
...
struct BurnDriver BurnDrvVastar2 = {
	"vastar2", "vastar", nullptr, nullptr, "1983",
	"Vastar (set 2)\0", nullptr, "Orca (Sesame Japan license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, vastar2RomInfo, vastar2RomName, nullptr, nullptr, nullptr, nullptr, VastarInputInfo, VastarDIPInfo,
	vastarInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvVastar3 = {
	"vastar3", "vastar", nullptr, nullptr, "1983",
	"Vastar (set 3)\0", nullptr, "Orca (Sesame Japan license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, vastar3RomInfo, vastar3RomName, nullptr, nullptr, nullptr, nullptr, VastarInputInfo, VastarDIPInfo,
...
struct BurnDriver BurnDrvVastar4 = {
	"vastar4", "vastar", nullptr, nullptr, "1983",
	"Vastar (set 4)\0", nullptr, "Orca (Sesame Japan license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, vastar4RomInfo, vastar4RomName, nullptr, nullptr, nullptr, nullptr, VastarInputInfo, Vastar4DIPInfo,
	vastarInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvPprobe = {
	"pprobe", nullptr, nullptr, nullptr, "1985",
	"Planet Probe (prototype?)\0", nullptr, "Crux / Kyugo?", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, pprobeRomInfo, pprobeRomName, nullptr, nullptr, nullptr, nullptr, PprobeInputInfo, PprobeDIPInfo,
