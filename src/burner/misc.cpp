...
{
	UINT32 t = (r << 7) & 0x7c00; // 0rrr rr00 0000 0000
...
{
	UINT32 t = (r << 8) & 0xf800; // rrrr r000 0000 0000
...
{
	UINT32 t = (GammaLUT[r] << 7) & 0x7C00; // 0rrr rr00 0000 0000
...
{
	UINT32 t = (GammaLUT[r] << 8) & 0xF800; // rrrr r000 0000 0000
