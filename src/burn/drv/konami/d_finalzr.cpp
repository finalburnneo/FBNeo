...
{
	INT32 cyc = (static_cast<INT64>(M6809TotalCycles()) * (6144000 / 15) / 1536000) - mcs48TotalCycles();
	if (cyc > 0)
	{
		mcs48Run(cyc);
	}
...
static void draw_16x16(INT32 code, INT32 color, INT32 sx, INT32 sy, INT32 flipx, INT32 flipy)
{
	...
	for (INT32 i = 0; i < 4; i++)
	{
		Draw8x8MaskTile(pTransDraw, code + (flip ^ i), sx + (i & 1) * 8, sy + (i & 2) * 4, flipx, flipy, color, 4, 0,
		                0x100, DrvGfxROM0);
	}
}
...
struct BurnDriver BurnDrvFinalizr = {
	"finalizr", nullptr, nullptr, nullptr, "1985",
	"Finalizer - Super Transformation (set 1)\0", nullptr, "Konami", "GX523",
	...
	nullptr, finalizrRomInfo, finalizrRomName, nullptr, nullptr, nullptr, nullptr, FinalizrInputInfo, FinalizrDIPInfo,
...
struct BurnDriver BurnDrvFinalizra = {
	"finalizra", "finalizr", nullptr, nullptr, "1985",
	"Finalizer - Super Transformation (set 2)\0", nullptr, "Konami", "GX523",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_VERSHOOT, 0,
	nullptr, finalizraRomInfo, finalizraRomName, nullptr, nullptr, nullptr, nullptr, FinalizrInputInfo, FinalizrDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 272, 3, 4
};
...
struct BurnDriver BurnDrvFinalizrb = {
	"finalizrb", "finalizr", nullptr, nullptr, "1985",
	"Finalizer - Super Transformation (bootleg)\0", nullptr, "bootleg", "GX523",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED |
	BDF_HISCORE_SUPPORTED,
	2, HARDWARE_PREFIX_KONAMI, GBF_VERSHOOT, 0,
	nullptr, finalizrbRomInfo, finalizrbRomName, nullptr, nullptr, nullptr, nullptr, FinalizrInputInfo, FinalizrDIPInfo,
