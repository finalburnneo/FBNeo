...
static void DrvSpriteDraw()
{
	for (INT32 i = 0; i < 0x200; i += 8)
	{
		...
		Draw16x16MaskTile(pTransDraw, code & 0xff, sx - 37, (240 - sy) - 16, flipscreen, flipscreen, color, 4, 0xf, 0,
		                  DrvGfxROM0);
	}
}
...
static INT32 DrvFrame()
{
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		if (i == 240)
		{
			...
			if (pBurnDraw)
			{
				// broken sprites on bike legs/pedals when street is on an incline fixed by drawing here
				BurnDrvRedraw();
			}
		}
		ZetClose();
...
struct BurnDriver BurnDrvFirebatl = {
	"firebatl", nullptr, nullptr, nullptr, "1984",
	"Fire Battle\0", nullptr, "Woodplace Inc. (Taito license)", "Miscellaneous",
	...
	nullptr, firebatlRomInfo, firebatlRomName, nullptr, nullptr, nullptr, nullptr, FirebatlInputInfo, FirebatlDIPInfo,
...
struct BurnDriver BurnDrvClshroad = {
	"clshroad", nullptr, nullptr, nullptr, "1986",
	"Clash-Road\0", nullptr, "Woodplace Inc.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, clshroadRomInfo, clshroadRomName, nullptr, nullptr, nullptr, nullptr, ClshroadInputInfo, ClshroadDIPInfo,
...
struct BurnDriver BurnDrvClshroadd = {
	"clshroadd", "clshroad", nullptr, nullptr, "1986",
	"Clash-Road (Data East license)\0", nullptr, "Woodplace Inc. (Data East license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, clshroaddRomInfo, clshroaddRomName, nullptr, nullptr, nullptr, nullptr, ClshroadInputInfo, ClshroadDIPInfo,
	ClshroadInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvClshroads = {
	"clshroads", "clshroad", nullptr, nullptr, "1986",
	"Clash-Road (Status license)\0", nullptr, "Woodplace Inc. (Status Game Corp. license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, clshroadsRomInfo, clshroadsRomName, nullptr, nullptr, nullptr, nullptr, ClshroadInputInfo, ClshroadDIPInfo,
