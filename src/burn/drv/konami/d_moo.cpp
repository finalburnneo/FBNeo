...
static struct BurnInputInfo MooInputList[] = {
	...
	{"Service Mode", BIT_DIGITAL, DrvJoy5 + 3, "diag"},
...
{
	INT32 num_inactive;
	auto dst = (UINT16*)K053247Ram;
	auto src = (UINT16*)DrvSprRAM;
...
{
	auto m_protram = (UINT16*)DrvProtRAM;
...
static constexpr eeprom_interface moo_eeprom_interface =
{
	7, /* address bits */
	8, /* data bits */
	"011000", /* read command */
...
static INT32 MooInit()
{
	...
	BurnYM2151InitBuffered(4000000, 1, nullptr, 0);
	...
	if (moomesabl)
	{
		MSM6295Init(0, 1056000 / MSM6295_PIN7_HIGH, false);
...
static INT32 DrvDraw()
{
	...
	static constexpr INT32 K053251_CI[4] = {1, 2, 3, 4};
	INT32 layers[3];
	INT32 plane;
	...
	if (255 - alpha > 0 && K053251GetPriority(2) != 0x07)
	{
		// normal draw
	...
	if (255 - alpha > -1 && ((K053251GetPriority(2) == 0x07) || (fogcnt)))
	{
		// Bucky title, draw layer after sprites for alpha over sprites effect
		if (nBurnLayer & (1 << layers[2])) K056832Draw(layers[2], K056832_SET_ALPHA(255-alpha), 4);
	}
...
struct BurnDriver BurnDrvMoomesa = {
	"moomesa", nullptr, nullptr, nullptr, "1992",
	"Wild West C.O.W.-Boys of Moo Mesa (ver EAB)\0", nullptr, "Konami", "GX151",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, moomesaRomInfo, moomesaRomName, nullptr, nullptr, nullptr, nullptr, MooInputInfo, MooDIPInfo,
...
struct BurnDriver BurnDrvMoomesauac = {
	"moomesauac", "moomesa", nullptr, nullptr, "1992",
	"Wild West C.O.W.-Boys of Moo Mesa (ver UAC)\0", nullptr, "Konami", "GX151",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN,
	0,
	nullptr, moomesauacRomInfo, moomesauacRomName, nullptr, nullptr, nullptr, nullptr, MooInputInfo, MooDIPInfo,
	MooInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvMoomesauab = {
	"moomesauab", "moomesa", nullptr, nullptr, "1992",
	"Wild West C.O.W.-Boys of Moo Mesa (ver UAB)\0", nullptr, "Konami", "GX151",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN,
	0,
	nullptr, moomesauabRomInfo, moomesauabRomName, nullptr, nullptr, nullptr, nullptr, MooInputInfo, MooDIPInfo,
	MooInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvMoomesaaab = {
	"moomesaaab", "moomesa", nullptr, nullptr, "1992",
	"Wild West C.O.W.-Boys of Moo Mesa (ver AAB)\0", nullptr, "Konami", "GX151",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN,
	0,
	nullptr, moomesaaabRomInfo, moomesaaabRomName, nullptr, nullptr, nullptr, nullptr, MooInputInfo, MooDIPInfo,
	MooInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	384, 224, 4, 3
};
...
struct BurnDriverD BurnDrvMoomesabl = {
	"moomesabl", "moomesa", nullptr, nullptr, "1992",
	"Wild West C.O.W.-Boys of Moo Mesa (bootleg)\0", nullptr, "bootleg", "GX151",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING | BDF_RUNAHEAD_DRAWSYNC | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 4,
	HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, moomesablRomInfo, moomesablRomName, nullptr, nullptr, nullptr, nullptr, MooInputInfo, MooDIPInfo,
...
struct BurnDriver BurnDrvBucky = {
	"bucky", nullptr, nullptr, nullptr, "1992",
	"Bucky O'Hare (ver EAB)\0", nullptr, "Konami", "GX173",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, buckyRomInfo, buckyRomName, nullptr, nullptr, nullptr, nullptr, BuckyInputInfo, BuckyDIPInfo,
...
struct BurnDriver BurnDrvBuckyea = {
	"buckyea", "bucky", nullptr, nullptr, "1992",
	"Bucky O'Hare (ver EA)\0", nullptr, "Konami", "GX173",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, buckyeaRomInfo, buckyeaRomName, nullptr, nullptr, nullptr, nullptr, BuckyInputInfo, BuckyDIPInfo,
	BuckyInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvBuckyjaa = {
	"buckyjaa", "bucky", nullptr, nullptr, "1992",
	"Bucky O'Hare (ver JAA)\0", nullptr, "Konami", "GX173",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, buckyjaaRomInfo, buckyjaaRomName, nullptr, nullptr, nullptr, nullptr, BuckyInputInfo, BuckyDIPInfo,
	BuckyInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvBuckyaa = {
	"buckyaa", "bucky", nullptr, nullptr, "1992",
	"Bucky O'Hare (ver AA)\0", nullptr, "Konami", "GX173",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, buckyaaRomInfo, buckyaaRomName, nullptr, nullptr, nullptr, nullptr, BuckyInputInfo, BuckyDIPInfo,
	BuckyInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvBuckyuab = {
	"buckyuab", "bucky", nullptr, nullptr, "1992",
	"Bucky O'Hare (ver UAB)\0", nullptr, "Konami", "GX173",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, buckyuabRomInfo, buckyuabRomName, nullptr, nullptr, nullptr, nullptr, BuckyInputInfo, BuckyDIPInfo,
	BuckyInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	384, 224, 4, 3
};
...
struct BurnDriver BurnDrvBuckyaab = {
	"buckyaab", "bucky", nullptr, nullptr, "1992",
	"Bucky O'Hare (ver AAB)\0", nullptr, "Konami", "GX173",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, buckyaabRomInfo, buckyaabRomName, nullptr, nullptr, nullptr, nullptr, BuckyInputInfo, BuckyDIPInfo,
	BuckyInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	384, 224, 4, 3
};
