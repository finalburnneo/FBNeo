...
{
	{0x11, 0xff, 0xff, 0x30, nullptr},
	{0x12, 0xff, 0xff, 0x40, nullptr},
...
static void draw_sprites()
{
	for (INT32 x = 0x400; x >= 0; x -= 4)
	{
		...
		DrawCustomMaskTile(pTransDraw, gfx->width, gfx->height, code % gfx->code_mask, sx, sy - 31, flipx, flipy,
		                   color & gfx->color_mask, gfx->depth, 0, gfx->color_offset, gfx->gfxbase);
	}
}
...
{
	static constexpr UINT8 swaptable[24][4] =
	{
	...
	{
		7, 1, 11, 23, 17, 23, 0, 15, 19, 20, 12, 10, 0, 18, 18, 5, 20, 13, 0, 18, 14, 5, 6, 10, 21, 1, 11, 9, 3, 21, 4,
		1, 17,
		5, 7, 16, 13, 19, 23, 20, 2, 10, 23, 23, 15, 10, 12, 0, 22, 14, 6, 15, 11, 17, 15, 21, 0, 6, 1, 1, 18, 5, 15,
		15, 20,
	};

	static const INT32 opcode_swap_select[2 + 64] =
	{
		7, 12, 18, 8, 21, 0, 22, 21, 13, 21, 20, 13, 20, 14, 6, 3, 5, 20, 8, 20, 4, 8, 17, 22, 0, 0, 6, 17, 17, 9, 0,
		16, 13, 21,
...
struct BurnDriver BurnDrvCalorie = {
	"calorie", nullptr, nullptr, nullptr, "1986",
	"Calorie Kun vs Moguranian\0", nullptr, "Sega", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, calorieRomInfo, calorieRomName, nullptr, nullptr, nullptr, nullptr, CalorieInputInfo, CalorieDIPInfo,
...
struct BurnDriver BurnDrvCalorieb = {
	"calorieb", "calorie", nullptr, nullptr, "1986",
	"Calorie Kun vs Moguranian (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, caloriebRomInfo, caloriebRomName, nullptr, nullptr, nullptr, nullptr, CalorieInputInfo, CalorieDIPInfo,
