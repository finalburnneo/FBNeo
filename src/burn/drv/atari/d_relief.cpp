...
static INT32 DrvInit()
{
	...
	MSM6295Init(0, 1193181 / MSM6295_PIN7_LOW, true);
...
static INT32 DrvDraw()
{
	if (DrvRecalc)
	{
		// bpp changed, let's not present a blank screen
		DrvDrawBegin();
	}
...
static INT32 DrvFrame()
{
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		// run to hblank
		nCyclesDone[0] += SekRun(static_cast<INT32>(static_cast<double>(sek_line) * 0.9));
		hblank = 1;
...
struct BurnDriver BurnDrvRelief = {
	"relief", nullptr, nullptr, nullptr, "1992",
	"Relief Pitcher (Rev D, 07 Jun 1992 / 28 May 1992)\0", nullptr, "Atari Games", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, reliefRomInfo, reliefRomName, nullptr, nullptr, nullptr, nullptr, ReliefInputInfo, ReliefDIPInfo,
...
struct BurnDriver BurnDrvRelief2 = {
	"relief2", "relief", nullptr, nullptr, "1992",
	"Relief Pitcher (Rev C, 26 Apr 1992 / 08 Apr 1992)\0", nullptr, "Atari Games", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, relief2RomInfo, relief2RomName, nullptr, nullptr, nullptr, nullptr, ReliefInputInfo, ReliefDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	336, 240, 4, 3
};
...
struct BurnDriver BurnDrvRelief3 = {
	"relief3", "relief", nullptr, nullptr, "1992",
	"Relief Pitcher (Rev B, 10 Apr 1992 / 08 Apr 1992)\0", nullptr, "Atari Games", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, relief3RomInfo, relief3RomName, nullptr, nullptr, nullptr, nullptr, ReliefInputInfo, ReliefDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	336, 240, 4, 3
};
