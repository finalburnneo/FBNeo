...
static INT32 DrvInit()
{
	...
	deco16SoundInit(DrvHucROM, DrvHucRAM, 4026500, 1, nullptr, 0.45, 1023924, 0.50, 2047848, 0.25);
	...
	for (INT32 offs = 0; offs < 0x800 / 2; offs += 4)
	{
		...
		if ((flash == 0) || (nCurrentFrame & 1))
		{
			for (INT32 x = 0; x < wide; x++)
			{
				...
				{
					Draw16x16MaskTile(pTransDraw, code - y * incy, sx + (-16 * x), sy + (-16 * y), flipx, flipy, color,
					                  4, 0, 0x100, DrvGfxROM3);
				}
			}
		}
	}
...
static INT32 DrvDraw()
{
	...
	if (nBurnLayer & 4) bac06_draw_layer(DrvPfRAM2, pf_control[2], nullptr, nullptr, DrvGfxROM0, 0x000, 0xfff,
	                                     DrvGfxROM2, 0x300, 0xfff, 1, 1);
	if (nBurnLayer & 2) bac06_draw_layer(DrvPfRAM1, pf_control[1], nullptr, nullptr, DrvGfxROM0, 0x000, 0xfff,
	                                     DrvGfxROM1, 0x200, 0x7ff, 0, 0);

	draw_sprites();

	if (nBurnLayer & 1) bac06_draw_layer(DrvPfRAM0, pf_control[0], DrvRowScroll, DrvColScroll, DrvGfxROM0, 0x000, 0xfff,
	                                     DrvGfxROM0, 0x000, 0x000, 0, 0);
...
struct BurnDriver BurnDrvMadmotor = {
	"madmotor", nullptr, nullptr, nullptr, "1989",
	"Mad Motor (prototype)\0", nullptr, "Mitchell", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, madmotorRomInfo, madmotorRomName, nullptr, nullptr, nullptr, nullptr, MadmotorInputInfo, MadmotorDIPInfo,
