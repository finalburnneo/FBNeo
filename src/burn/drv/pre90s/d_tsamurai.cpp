...
static struct BurnDIPInfo TsamuraiDIPList[]=
{
	...
	{0x01, 0xff, 0xff, 0xfc, NULL			},

	{0   , 0xfe, 0   ,    8, "Coin A"		},
	{0x00, 0x01, 0x07, 0x07, "6 Coins 1 Credits"	},
	{0x00, 0x01, 0x07, 0x06, "3 Coins 1 Credits"	},
	{0x00, 0x01, 0x07, 0x04, "2 Coins 1 Credits"	},
	{0x00, 0x01, 0x07, 0x00, "1 Coin  1 Credits"	},
	{0x00, 0x01, 0x07, 0x05, "2 Coins 3 Credits"	},
	{0x00, 0x01, 0x07, 0x01, "1 Coin  2 Credits"	},
	{0x00, 0x01, 0x07, 0x02, "1 Coin  3 Credits"	},
	{0x00, 0x01, 0x07, 0x03, "1 Coin  6 Credits"	},

	{0   , 0xfe, 0   ,    8, "Coin B"		},
	{0x00, 0x01, 0x38, 0x38, "6 Coins 1 Credits"	},
	{0x00, 0x01, 0x38, 0x30, "3 Coins 1 Credits"	},
	{0x00, 0x01, 0x38, 0x20, "2 Coins 1 Credits"	},
	{0x00, 0x01, 0x38, 0x00, "1 Coin  1 Credits"	},
	{0x00, 0x01, 0x38, 0x28, "2 Coins 3 Credits"	},
	{0x00, 0x01, 0x38, 0x08, "1 Coin  2 Credits"	},
	{0x00, 0x01, 0x38, 0x10, "1 Coin  3 Credits"	},
	...
	{0x01, 0x01, 0x03, 0x02, "7"			},
	{0x01, 0x01, 0x03, 0x03, "254 (Cheat)"		},
...
static struct BurnDIPInfo TsamuraihDIPList[]=
{
	DIP_OFFSET(0x12)
	{0x00, 0xff, 0xff, 0x00, NULL			},
	{0x01, 0xff, 0xff, 0xfc, NULL			},
...
static struct BurnDIPInfo YamagchiDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    2, "Language"		},
	{0x01, 0x01, 0x10, 0x10, "English"		},
	{0x01, 0x01, 0x10, 0x00, "Japanese"		},
...
static struct BurnDIPInfo M660DIPList[]=
{
	...
	{0x00, 0x01, 0x07, 0x00, "1 Coin  1 Credits"	},
	{0x00, 0x01, 0x07, 0x07, "2 Coins 3 Credits"	},
	{0x00, 0x01, 0x07, 0x05, "1 Coin  2 Credits"	},
	{0x00, 0x01, 0x07, 0x06, "1 Coin  3 Credits"	},

	{0   , 0xfe, 0   ,    8, "Coin B"		},
	{0x00, 0x01, 0x38, 0x20, "5 Coins 1 Credits"	},
	{0x00, 0x01, 0x38, 0x18, "4 Coins 1 Credits"	},
	{0x00, 0x01, 0x38, 0x10, "3 Coins 1 Credits"	},
	{0x00, 0x01, 0x38, 0x08, "2 Coins 1 Credits"	},
	{0x00, 0x01, 0x38, 0x00, "1 Coin  1 Credits"	},
	{0x00, 0x01, 0x38, 0x38, "2 Coins 3 Credits"	},
	{0x00, 0x01, 0x38, 0x28, "1 Coin  2 Credits"	},
	{0x00, 0x01, 0x38, 0x30, "1 Coin  3 Credits"	},
	...
	{0   , 0xfe, 0   ,    4, "Bonus"		},
	{0x01, 0x01, 0x0c, 0x00, "10,30,50"		},
	{0x01, 0x01, 0x0c, 0x04, "20,50,80"		},
	{0x01, 0x01, 0x0c, 0x08, "30,70,110"		},
	{0x01, 0x01, 0x0c, 0x0c, "50,100,150"		},
...
static INT32 DrvInit(INT32 game)
{
	...
	DACInit(0, 0, 0, ZetTotalCycles, 3000000);
	DACInit(1, 1, 0, ZetTotalCycles, 3000000);
...
{;
	...
	while (source >= finish)
	{
		...
		Draw32x32MaskTile(pTransDraw, code & 0x7f, sx, sy - 16, flipscreen, flipy, color, 3, 0, 0, DrvGfxROM2);
...
struct BurnDriver BurnDrvTsamuraih = {
	...
	NULL, tsamuraihRomInfo, tsamuraihRomName, NULL, NULL, NULL, NULL, TsamuraiInputInfo, TsamuraihDIPInfo,
	tsamuraiInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
