...
{
	{0x0d, 0xff, 0xff, 0x9c, nullptr},
	{0x0e, 0xff, 0xff, 0xc4, nullptr},
...
{
	{0x0d, 0xff, 0xff, 0x71, nullptr},
	{0x0e, 0xff, 0xff, 0xc0, nullptr},
...
static INT32 DrvGfxDecode()
{
	...
	INT32 YOffs0[16] = {
		0 * 16, 0 * 16, 1 * 16, 1 * 16, 2 * 16, 2 * 16, 3 * 16, 3 * 16, 4 * 16, 4 * 16, 5 * 16, 5 * 16, 6 * 16, 6 * 16,
		7 * 16, 7 * 16
	};
	...
	INT32 Plane2[2] = {4, 0};
	INT32 XOffs2[32] = {
		0, 2, 1, 3, 1 * 8 + 0, 1 * 8 + 2, 1 * 8 + 1, 1 * 8 + 3, 2 * 8 + 0, 2 * 8 + 2, 2 * 8 + 1, 2 * 8 + 3, 3 * 8 + 0,
		3 * 8 + 2, 3 * 8 + 1, 3 * 8 + 3,
		4 * 8 + 0, 4 * 8 + 2, 4 * 8 + 1, 4 * 8 + 3, 5 * 8 + 0, 5 * 8 + 2, 5 * 8 + 1, 5 * 8 + 3, 6 * 8 + 0, 6 * 8 + 2,
		6 * 8 + 1, 6 * 8 + 3, 7 * 8 + 0, 7 * 8 + 2, 7 * 8 + 1, 7 * 8 + 3
	};
	INT32 YOffs2[32] = {
		0, 4 * 64, (0x2000 * 8), (0x2000 * 8) + 4 * 64, (0x4000 * 8), (0x4000 * 8) + 4 * 64, (0x6000 * 8),
		(0x6000 * 8) + 4 * 64,
		1 * 64, 5 * 64, (0x2000 * 8) + 1 * 64, (0x2000 * 8) + 5 * 64, (0x4000 * 8) + 1 * 64, (0x4000 * 8) + 5 * 64,
		(0x6000 * 8) + 1 * 64, (0x6000 * 8) + 5 * 64,
		2 * 64, 6 * 64, (0x2000 * 8) + 2 * 64, (0x2000 * 8) + 6 * 64, (0x4000 * 8) + 2 * 64, (0x4000 * 8) + 6 * 64,
		(0x6000 * 8) + 2 * 64, (0x6000 * 8) + 6 * 64,
		3 * 64, 7 * 64, (0x2000 * 8) + 3 * 64, (0x2000 * 8) + 7 * 64, (0x4000 * 8) + 3 * 64, (0x4000 * 8) + 7 * 64,
		(0x6000 * 8) + 3 * 64, (0x6000 * 8) + 7 * 64
	};
	...
	INT32 YOffs3[16] = {
		(0x6000 * 8) + 0 * 16, (0x4000 * 8) + 0 * 16, (0x2000 * 8) + 0 * 16, 0 + 0 * 16,
...
static INT32 DrvInit(INT32 game)
{
	...
	AY8910SetPorts(0, &ay8910_0_read_A, &ay8910_0_read_B, nullptr, nullptr);
	AY8910SetPorts(1, &ay8910_1_read_A, &ay8910_1_read_B, nullptr, nullptr);
	if (game == 0)
	{
...
struct BurnDriver BurnDrvHoleland = {
	"holeland", nullptr, nullptr, nullptr, "1984",
	"Hole Land (Japan)\0", nullptr, "Tecfri", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_ACTION, 0,
	nullptr, holelandRomInfo, holelandRomName, nullptr, nullptr, nullptr, nullptr, HolelandInputInfo, HolelandDIPInfo,
...
struct BurnDriver BurnDrvHoleland2 = {
	"holeland2", "holeland", nullptr, nullptr, "1984",
	"Hole Land (Spain)\0", nullptr, "Tecfri", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_ACTION, 0,
	nullptr, holeland2RomInfo, holeland2RomName, nullptr, nullptr, nullptr, nullptr, HolelandInputInfo,
	Holeland2DIPInfo,
	HolelandInit, DrvExit, DrvFrame, HolelandDraw, DrvScan, &DrvRecalc, 0x100,
	512, 448, 4, 3
};
...
struct BurnDriver BurnDrvCrzrally = {
	"crzrally", nullptr, nullptr, nullptr, "1985",
	...
	nullptr, crzrallyRomInfo, crzrallyRomName, nullptr, nullptr, nullptr, nullptr, CrzrallyInputInfo, CrzrallyDIPInfo,
...
struct BurnDriver BurnDrvCrzrallya = {
	"crzrallya", "crzrally", nullptr, nullptr, "1985",
	...
	GBF_RACING, 0,
	nullptr, crzrallyaRomInfo, crzrallyaRomName, nullptr, nullptr, nullptr, nullptr, CrzrallyInputInfo, CrzrallyDIPInfo,
	CrzrallyInit, DrvExit, DrvFrame, CrzrallyDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCrzrallyg = {
	"crzrallyg", "crzrally", nullptr, nullptr, "1985",
	"Crazy Rally (Gecas license)\0", "Graphics issues on some levels", "Tecfri (Gecas license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RACING, 0,
	nullptr, crzrallygRomInfo, crzrallygRomName, nullptr, nullptr, nullptr, nullptr, CrzrallyInputInfo, CrzrallyDIPInfo,
	CrzrallyInit, DrvExit, DrvFrame, CrzrallyDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCrzrallyrf = {
	"crzrallyrf", "crzrally", nullptr, nullptr, "1985",
	"Crazy Rally (Recreativos Franco license)\0", "Graphics issues on some levels",
	"Tecfri (Recreativos Franco license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RACING, 0,
	nullptr, crzrallyrfRomInfo, crzrallyrfRomName, nullptr, nullptr, nullptr, nullptr, CrzrallyInputInfo,
	CrzrallyDIPInfo,
	CrzrallyInit, DrvExit, DrvFrame, CrzrallyDraw, DrvScan, &DrvRecalc, 0x100,
	224, 256, 3, 4
};
