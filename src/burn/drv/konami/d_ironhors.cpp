...
static INT32 DrvInit()
{
	...
	BurnYM2203Init(1, 3072000, nullptr, 0);
...
static void draw_sprites()
{
	...
	for (INT32 offs = 0; offs < 0x100 - 5; offs += 5)
	{
		...
		INT32 code = (spriteram[offs + 0] << 2) + ((spriteram[offs + 1] & 0x03) << 10) + ((spriteram[offs + 1] & 0x0c)
			>> 2);
...
static INT32 DrvFrame()
{
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		if (i == 240 && (~nCurrentFrame & 1) && (DrvIRQEnable[0] & 0x04)) M6809SetIRQLine(1, CPU_IRQSTATUS_HOLD);
		// firq
...
struct BurnDriver BurnDrvIronhors = {
	"ironhors", nullptr, nullptr, nullptr, "1986",
	"Iron Horse\0", nullptr, "Konami", "GX560",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, ironhorsRomInfo, ironhorsRomName, nullptr, nullptr, nullptr, nullptr, IronhorsInputInfo, IronhorsDIPInfo,
...
struct BurnDriver BurnDrvDairesya = {
	"dairesya", "ironhors", nullptr, nullptr, "1986",
	"Dai Ressya Goutou (Japan)\0", nullptr, "Konami (Kawakusu license)", "GX560",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, dairesyaRomInfo, dairesyaRomName, nullptr, nullptr, nullptr, nullptr, DairesyaInputInfo, IronhorsDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	240, 224, 4, 3
};
...
struct BurnDriverD BurnDrvFarwest = {
	"farwest", "ironhors", nullptr, nullptr, "1986",
	"Far West\0", nullptr, "bootleg?", "GX560",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, farwestRomInfo, farwestRomName, nullptr, nullptr, nullptr, nullptr, IronhorsInputInfo, IronhorsDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	240, 224, 4, 3
};
