...
static INT32 MemIndex()
{
	...
	Next += 0x001000;
	DrvSprRAM = Next;
	Next += 0x001000; // 0x200 shangkid,chinhero, 0xc00 dynamski
	DrvZ80RAM = Next;
	Next += 0x001000;
...
static INT32 DrvGfxDecode(UINT8* src, UINT8* dst, INT32 len, INT32 num, INT32 type)
{
	...
	GfxDecode(num, (type < 2) ? 2 : 3, (type > 0) ? 16 : 8, (type > 0) ? 16 : 8, Plane[type], XOffs, YOffs,
	          (type > 0) ? 0x200 : 0x80, tmp, dst);
...
static INT32 DrvInit(INT32 game, INT32 load_type)
{
	...
	AY8910SetPorts(0, nullptr, nullptr, ay8910_portA_write, ay8910_portB_write);
	...
	while (source > finish)
	{
		...
		for (INT32 r = 0; r <= ysize; r++)
		{
			for (INT32 c = 0; c <= xsize; c++)
			{
				...
				RenderZoomedTile(pTransDraw, gfx->gfxbase, (tile + c * 8 + r) % gfx->code_mask, color, transparent_pen,
				                 sx - 16, sy, xflip, yflip, gfx->width, gfx->height, (width << 16) / 16,
				                 (height << 16) / 16);
				RenderZoomedTile(pTransDraw, gfx->gfxbase, (tile + c * 8 + r) % gfx->code_mask, color, transparent_pen,
				                 sx - 16, sy + 256, xflip, yflip, gfx->width, gfx->height, (width << 16) / 16,
				                 (height << 16) / 16);
			}
		}
	}
...
struct BurnDriver BurnDrvChinhero = {
	"chinhero", nullptr, nullptr, nullptr, "1984",
	"Chinese Hero\0", nullptr, "Taiyo System", "Miscellaneous",
	...
	nullptr, chinheroRomInfo, chinheroRomName, nullptr, nullptr, nullptr, nullptr, ChinheroInputInfo, ChinheroDIPInfo,
...
struct BurnDriver BurnDrvChinhero2 = {
	"chinhero2", "chinhero", nullptr, nullptr, "1984",
	"Chinese Hero (older, set 1)\0", nullptr, "Taiyo System", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, chinhero2RomInfo, chinhero2RomName, nullptr, nullptr, nullptr, nullptr, ChinheroInputInfo, ChinheroDIPInfo,
...
struct BurnDriver BurnDrvChinhero3 = {
	"chinhero3", "chinhero", nullptr, nullptr, "1984",
	"Chinese Hero (older, set 2)\0", nullptr, "Taiyo System", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, chinhero3RomInfo, chinhero3RomName, nullptr, nullptr, nullptr, nullptr, ChinheroInputInfo, ChinheroDIPInfo,
	Chinhero2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvChinherot = {
	"chinherot", "chinhero", nullptr, nullptr, "1984",
	"Chinese Heroe (Taito)\0", nullptr, "Taiyo System (Taito license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, chinherotRomInfo, chinherotRomName, nullptr, nullptr, nullptr, nullptr, ChinheroInputInfo, ChinheroDIPInfo,
	Chinhero2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvShangkid = {
	"shangkid", nullptr, nullptr, nullptr, "1985",
	"Shanghai Kid\0", nullptr, "Taiyo System (Data East license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VSFIGHT, 0,
	nullptr, shangkidRomInfo, shangkidRomName, nullptr, nullptr, nullptr, nullptr, ShangkidInputInfo, ShangkidDIPInfo,
...
struct BurnDriver BurnDrvHiryuken = {
	"hiryuken", "shangkid", nullptr, nullptr, "1985",
	"Hokuha Syourin Hiryu no Ken\0", nullptr, "Taiyo System (Taito license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VSFIGHT, 0,
	nullptr, hiryukenRomInfo, hiryukenRomName, nullptr, nullptr, nullptr, nullptr, ShangkidInputInfo, ShangkidDIPInfo,
...
struct BurnDriver BurnDrvDynamski = {
	"dynamski", nullptr, nullptr, nullptr, "1984",
	"Dynamic Ski\0", nullptr, "Taiyo System (Nichibutsu license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, dynamskiRomInfo, dynamskiRomName, nullptr, nullptr, nullptr, nullptr, DynamskiInputInfo, DynamskiDIPInfo,
