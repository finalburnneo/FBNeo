...
static INT32 MemIndex()
{
	...
	DrvTmpBitmap0 = (UINT16*)Next;
	Next += 320 * 240 * sizeof(UINT16);
	DrvTmpBitmap1 = (UINT16*)Next;
	Next += 320 * 240 * sizeof(UINT16);
...
static void draw_sprites(UINT16* dest, UINT8* ram, UINT8* gfx, INT32 coloff)
{
	...
	for (INT32 offs = (0x1400 / 4) - 4; offs >= 0; offs -= 4)
	{
		...
		while (multi >= 0)
		{
			deco16_draw_prio_sprite(dest, gfx, sprite - multi * inc, (colour << 4) + coloff, x, y + mult * multi, fx,
			                        fy, pri);
...
struct BurnDriver BurnDrvBackfire = {
	"backfire", nullptr, nullptr, nullptr, "1995",
	"Backfire! (Japan, set 1)\0", nullptr, "Data East Corporation", "DECO IC16",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_DATAEAST, GBF_RACING, 0,
	nullptr, backfireRomInfo, backfireRomName, nullptr, nullptr, nullptr, nullptr, BackfireInputInfo, BackfireDIPInfo,
...
struct BurnDriverD BurnDrvBackfirea = {
	"backfirea", "backfire", nullptr, nullptr, "1995",
	...
	nullptr, backfireaRomInfo, backfireaRomName, nullptr, nullptr, nullptr, nullptr, BackfireInputInfo, BackfireDIPInfo,
