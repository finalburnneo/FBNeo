...
static INT32 DICore_GetFunctions()
{
	...
	_LOADFN(HRESULT, _DirectInput8Create, Empty_DirectInput8Create, (HINSTANCE, DWORD, REFIID, LPVOID*, LPUNKNOWN),
	        hDICore, "DirectInput8Create");
...
INT32 DICore_Init()
{
	...
	{
		MessageBox(NULL, _T("There was a problem while loading functions from DINPUT8.DLL"), _T("Error"),
		           MB_OK | MB_ICONERROR);
		return 0;
	}
