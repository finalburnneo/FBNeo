...
{
	DIP_OFFSET(0x11)
	{0x00, 0xff, 0xff, 0xa2, nullptr},
	{0x01, 0xff, 0xff, 0xf0, nullptr},
...
static void draw_sprites()
{
	for (INT32 i = 0; i < 0x100; i += 4)
	{
		...
		if ((code & 0x108) == 0x108)
		{
			constexpr INT32 mask[4] = {0x308, 0x300, 0x08, 0x00};
...
struct BurnDriver BurnDrvFcombat = {
	"fcombat", nullptr, nullptr, nullptr, "1985",
	"Field Combat\0", nullptr, "Jaleco", "Miscellaneous",
	...
	nullptr, fcombatRomInfo, fcombatRomName, nullptr, nullptr, nullptr, nullptr, FcombatInputInfo, FcombatDIPInfo,
