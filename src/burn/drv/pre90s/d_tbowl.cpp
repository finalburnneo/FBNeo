...
{
	{0x26, 0xff, 0xff, 0xbf, nullptr},
	{0x27, 0xff, 0xff, 0xff, nullptr},
	{0x28, 0xff, 0xff, 0xff, nullptr},
...
static void __fastcall tbowl_sound_write(UINT16 address, UINT8 data)
{
	...
	case 0xe005:
		data &= 0x7f;
		MSM5205SetRoute(address & 1, static_cast<double>(data) / 0x7f, BURN_SND_ROUTE_BOTH);
	}
}
			...
			for (INT32 y = 0; y < sizey; y++)
			{
				for (INT32 x = 0; x < sizex; x++)
				{
					...
					if (flipx)
					{
						...
						Render8x8Tile_Mask_FlipX_Clip(pTransDraw, tile, sx - 0x400, sy - 0x200, color, 4, 0, 0,
						                              DrvGfxROM2);
					}
					else
					{
...
struct BurnDriver BurnDrvTbowl = {
	"tbowl", nullptr, nullptr, nullptr, "1987",
	"Tecmo Bowl (World, set 1)\0", nullptr, "Tecmo", "hardware",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, tbowlRomInfo, tbowlRomName, nullptr, nullptr, nullptr, nullptr, TbowlInputInfo, TbowlDIPInfo,
...
struct BurnDriver BurnDrvTbowla = {
	"tbowla", "tbowl", nullptr, nullptr, "1987",
	"Tecmo Bowl (World, set 2)\0", nullptr, "Tecmo", "hardware",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, tbowlaRomInfo, tbowlaRomName, nullptr, nullptr, nullptr, nullptr, TbowlInputInfo, TbowlDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	512, 224, 8, 3
};
...
struct BurnDriver BurnDrvTbowlp = {
	"tbowlp", "tbowl", nullptr, nullptr, "1987",
	"Tecmo Bowl (World, prototype?)\0", nullptr, "Tecmo", "hardware",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, tbowlpRomInfo, tbowlpRomName, nullptr, nullptr, nullptr, nullptr, TbowlInputInfo, TbowlDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	512, 224, 8, 3
};
...
struct BurnDriver BurnDrvTbowlj = {
	"tbowlj", "tbowl", nullptr, nullptr, "1987",
	"Tecmo Bowl (Japan)\0", nullptr, "Tecmo", "hardware",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SPORTSMISC, 0,
	nullptr, tbowljRomInfo, tbowljRomName, nullptr, nullptr, nullptr, nullptr, TbowlInputInfo, TbowlDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	512, 224, 8, 3
};
