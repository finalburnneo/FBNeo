...
{
	if ((address & 0xfffff0) == 0x24000)
	{
		// terracre
		return TerracreCommonReadWord(address & 0xf);
	}

	if ((address & 0xfffff0) == 0x44000)
	{
		// amazon, horekid
...
{
	if ((address & 0xfffff0) == 0x26000)
	{
		// terracre
		TerracreCommonWriteWord(address & 0xf, data);
	}

	if ((address & 0xfffff0) == 0x46000)
	{
		// amazon, horekid
		TerracreCommonWriteWord(address & 0xf, data);
	}
	...
	case 0x070001:
		{
			...
			{
				return DrvProtROM[prot_data_address & 0x1fff] - ((0x43 - DrvProtROM[prot_subtract_address & 0x1fff]) &
					0xff);
			}
	...
	case 0x070001:
		{
			...
			case 0x33:
			case 0x34:
				prot_data_address = (data << ((prot_command & 1) * 8)) | (prot_data_address & (0xff << ((~prot_command &
					1) * 8)));
				break;

			case 0x35:
			case 0x36:
				prot_subtract_address = (data << ((prot_command & 1) * 8)) | (prot_subtract_address & (0xff << ((~
					prot_command & 1) * 8)));
				break;
			}
...
{
	auto ram = (UINT16*)(Drv68KROM + 0x18000);
	INT32 attr = ram[offs];
...
static INT32 DrvLoadRoms()
{
	...
	UINT8* pLoad[9] = {
		nullptr, Drv68KROM, DrvZ80ROM, DrvGfxROM[0], DrvGfxROM[1], DrvGfxROM[2], DrvColPROM, DrvSprPalBank, DrvProtROM
	};
	...
	BurnNibbleExpand(DrvGfxROM[0], nullptr, 0x02000, 1, 0);
	BurnNibbleExpand(DrvGfxROM[1], nullptr, 0x20000, 1, 0);
	BurnByteswap(DrvGfxROM[2], 0x20000);
	BurnNibbleExpand(DrvGfxROM[2], nullptr, 0x20000, 1, 0);
...
static void DrvSoundInit()
{
	...
	if (has_ym2203)
	{
		BurnYM2203Init(1, 4000000, nullptr, 0);
	...
	{
		BurnYM3526Init(4000000, nullptr, 0);
...
static void DrvCalcPalette()
{
	...
	{
		PalLookup[i] = BurnHighCol(pal4bit(DrvColPROM[i + 0x000]), pal4bit(DrvColPROM[i + 0x100]),
		                           pal4bit(DrvColPROM[i + 0x200]), 0);
	}
...
static void draw_sprites()
{
	...
	for (INT32 i = 0; i < 0x200; i += 8, spr16 += 4)
	{
		...
		if (is_horekid)
		{
			...
			color = (color & 0x0e) + ((DrvSprPalBank[((code & 0xfc) >> 1) | ((attr & 0x02) << 6) | ((attr & 0x10) >> 4)]
				& 0x0f) << 4);
		}
		else
		{
...
struct BurnDriver BurnDrvTerracre = {
	"terracre", nullptr, nullptr, nullptr, "1985",
	"Terra Cresta (YM3526 set 1)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, DrvRomInfo, DrvRomName, nullptr, nullptr, nullptr, nullptr, TerracreInputInfo, TerracreDIPInfo,
...
struct BurnDriver BurnDrvTerracreo = {
	"terracreo", "terracre", nullptr, nullptr, "1985",
	"Terra Cresta (YM3526 set 2)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, DrvoRomInfo, DrvoRomName, nullptr, nullptr, nullptr, nullptr, TerracreInputInfo, TerracreDIPInfo,
	TerracreInit, DrvExit, DrvFrame, DrvDraw, DrvScan,
	&BurnRecalc, 0x1110, 224, 256, 3, 4
};
...
struct BurnDriver BurnDrvTerracrea = {
	"terracrea", "terracre", nullptr, nullptr, "1985",
	"Terra Cresta (YM3526 set 3)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, DrvaRomInfo, DrvaRomName, nullptr, nullptr, nullptr, nullptr, TerracreInputInfo, TerracreDIPInfo,
	TerracreInit, DrvExit, DrvFrame, DrvDraw, DrvScan,
	&BurnRecalc, 0x1110, 224, 256, 3, 4
};
...
struct BurnDriver BurnDrvTerracren = {
	"terracren", "terracre", nullptr, nullptr, "1985",
	"Terra Cresta (YM2203)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, DrvnRomInfo, DrvnRomName, nullptr, nullptr, nullptr, nullptr, TerracreInputInfo, TerracreDIPInfo,
...
struct BurnDriver BurnDrvAmazon = {
	"amazon", nullptr, nullptr, nullptr, "1986",
	"Soldier Girl Amazon\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RUNGUN, 0,
	nullptr, AmazonRomInfo, AmazonRomName, nullptr, nullptr, nullptr, nullptr, AmazonInputInfo, AmazonDIPInfo,
...
struct BurnDriver BurnDrvAmazont = {
	"amazont", "amazon", nullptr, nullptr, "1986",
	"Soldier Girl Amazon (Tecfri license)\0", nullptr, "Nichibutsu (Tecfri license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, AmazontRomInfo, AmazontRomName, nullptr, nullptr, nullptr, nullptr, AmazonInputInfo, AmazonDIPInfo,
	AmazonInit, DrvExit, DrvFrame, DrvDraw, DrvScan,
	&BurnRecalc, 0x1110, 224, 256, 3, 4
};
...
struct BurnDriver BurnDrvAmatelas = {
	"amatelas", "amazon", nullptr, nullptr, "1986",
	"Sei Senshi Amatelass\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RUNGUN, 0,
	nullptr, AmatelasRomInfo, AmatelasRomName, nullptr, nullptr, nullptr, nullptr, AmazonInputInfo, AmazonDIPInfo,
	AmazonInit, DrvExit, DrvFrame, DrvDraw, DrvScan,
	&BurnRecalc, 0x1110, 224, 256, 3, 4
};
...
struct BurnDriver BurnDrvHorekid = {
	"horekid", nullptr, nullptr, nullptr, "1987",
	"Kid no Hore Hore Daisakusen\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, HorekidRomInfo, HorekidRomName, nullptr, nullptr, nullptr, nullptr, TerracreInputInfo, HorekidDIPInfo,
...
struct BurnDriver BurnDrvHorekidb = {
	"horekidb", "horekid", nullptr, nullptr, "1987",
	"Kid no Hore Hore Daisakusen (bootleg set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, HorekidbRomInfo, HorekidbRomName, nullptr, nullptr, nullptr, nullptr, TerracreInputInfo, HorekidDIPInfo,
	HorekidInit, DrvExit, DrvFrame, DrvDraw, DrvScan,
	&BurnRecalc, 0x1110, 224, 256, 3, 4
};
...
struct BurnDriver BurnDrvBoobhack = {
	"boobhack", "horekid", nullptr, nullptr, "1987",
	"Booby Kids (Italian manufactured graphic hack / bootleg of Kid no Hore Hore Daisakusen (bootleg))\0", nullptr,
	"bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, BoobhackRomInfo, BoobhackRomName, nullptr, nullptr, nullptr, nullptr, TerracreInputInfo, HorekidDIPInfo,
	HorekidInit, DrvExit, DrvFrame, DrvDraw, DrvScan,
	&BurnRecalc, 0x1110, 224, 256, 3, 4
};
