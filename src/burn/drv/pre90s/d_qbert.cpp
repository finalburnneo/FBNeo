...
static UINT8 game_type = 0;
// 0 = qbert, 6 = qbertcub, 4 = mplanets, 7 = curvebal, 8 = insector, 9 - argusg/krull, 10 - reactor
...
{
	DIP_OFFSET(0x14)
	{0x00, 0xff, 0xff, 0xc0, nullptr},
	{0x01, 0xff, 0xff, 0x11, nullptr},
...
{
	if (*vtqueuepos > 0x20 - 1 || static_cast<UINT32>(GetCurrentFrame()) > *vtqueuetime + 2)
		blank_queue();
...
{
	if (*vtqueuepos == 24 && !strncmp(
		"\xC1\xE4\xFF\xE7\xE8\xD2\xFC\xFC\xFC\xFC\xFC\xEA\xFF\xF6\xD6\xF3\xD5\xC5\xF5\xF2\xE1\xDB\xF2\xC0",
		(char*)vtqueue, 24))
	{
		blank_queue(); // "Hello, I'm turned on."
		return 1;
	}
	if (*vtqueuepos == 26 && !strncmp(
		"\x00\xFF\xD5\xFE\xD5\xC0\xD2\xCB\xD4\xF2\xD6\xEB\xC1\xE6\xCB\xD4\xC1\xCD\xF2\xE0\xFB\xDF\xF1\xCD\xE7\xC0",
		(char*)vtqueue, 26))
	{
	...
	case 0x2000:
		{
			...
			switch (check_queue())
			{
			case 1: BurnSamplePlay(42);
				break; // Say Hello
			case 11: BurnSamplePlay(5);
				break; // Warning Core Unstable
			}
			*soundcpu_do_nmi = 1;
			M6502RunEnd();
		}
...
static INT32 MemIndex()
{
	...
	DrvNVRAM = Next;
	Next += 0x01000; // Keep in ROM section.
	DrvDummyROM = Next;
	Next += 0x02000; // RAM or ROM depending on conf.
	...
	background_prio = Next;
	Next += 0x00001;
	spritebank = Next;
	Next += 0x00001;
	soundlatch = Next;
	Next += 0x00001;
	soundcpu_do_nmi = Next;
	Next += 0x00001;
...
static INT32 RomLoad()
{
	...
	for (INT32 i = 0; !BurnDrvGetRomName(&pRomName, i, 0); i++)
	{
		...
		if ((ri.nType & 0xf) == 9)
		{
			...
			{
			case 0x1000: DummyRegion[1] = MAP_ROM;
				break;
			case 0x2000: DummyRegion[0] = MAP_ROM;
				break;
			}
		}
	}
	...
	if ((dLoad - DrvDummyROM) == 0x1000)
	{
		// single-rom loads @ 0x2000
...
static void type2_sound_init()
{
	...
	BurnTimerInit(&t2_timer_cb, nullptr); // for high-freq dac&speech timer
	...
	sp0250_init(3120000, nullptr, M6502TotalCycles, 1000000);
	sp0250_volume(1.00);
}
...
static INT32 DrvInit()
{
	...
	else // standard
	{
		...
		VezMapMemory(DrvDummyROM + 0x0000, 0x1000, 0x1fff, DummyRegion[0]);
		// ROM for argus, krull, vidvince & 3stooges, RAM for all others
...
static INT32 DrvFrame()
{
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		if ((i % 64) == 63 && has_tball && game_type != 9)
		{
			// reactor, wizwarz, not argus
			BurnTrackballUpdate(0);
		}
	}
...
struct BurnDriver BurnDrvQbert = {
	"qbert", nullptr, nullptr, "qbert", "1982",
	"Q*bert (US set 1)\0", nullptr, "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, qbertRomInfo, qbertRomName, nullptr, nullptr, qbertSampleInfo, qbertSampleName, QbertInputInfo,
	QbertDIPInfo,
...
struct BurnDriver BurnDrvQberta = {
	"qberta", "qbert", nullptr, "qbert", "1982",
	"Q*bert (US set 2)\0", nullptr, "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, qbertaRomInfo, qbertaRomName, nullptr, nullptr, qbertSampleInfo, qbertSampleName, QbertInputInfo,
	QbertDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvQbertj = {
	"qbertj", "qbert", nullptr, "qbert", "1982",
	"Q*bert (Japan)\0", nullptr, "Gottlieb (Konami license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, qbertjRomInfo, qbertjRomName, nullptr, nullptr, qbertSampleInfo, qbertSampleName, QbertInputInfo,
	QbertDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvQberttst = {
	"qberttst", "qbert", nullptr, nullptr, "1982",
	"Q*bert (early test version)\0", nullptr, "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, qberttstRomInfo, qberttstRomName, nullptr, nullptr, nullptr, nullptr, QbertInputInfo, QbertDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	240, 256, 3, 4
};
...
struct BurnDriverD BurnDrvQbtrktst = {
	"qbtrktst", "qbert", nullptr, nullptr, "1982",
	"Q*bert Board Input Test Rom\0", nullptr, "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, qbtrktstRomInfo, qbtrktstRomName, nullptr, nullptr, nullptr, nullptr, QbertInputInfo, QbertDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvMyqbert = {
	"myqbert", "qbert", nullptr, "qbert", "1982",
	"Mello Yello Q*bert\0", nullptr, "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, myqbertRomInfo, myqbertRomName, nullptr, nullptr, qbertSampleInfo, qbertSampleName, QbertInputInfo,
	QbertDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvSqbert = {
	"sqbert", nullptr, nullptr, "qbert", "1983",
	"Faster, Harder, More Challenging Q*bert (prototype)\0", nullptr, "Mylstar", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, sqbertRomInfo, sqbertRomName, nullptr, nullptr, qbertSampleInfo, qbertSampleName, QbertInputInfo,
	QbertDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvMplanets = {
	"mplanets", nullptr, nullptr, nullptr, "1983",
	"Mad Planets\0", nullptr, "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, mplanetsRomInfo, mplanetsRomName, nullptr, nullptr, nullptr, nullptr, MplanetsInputInfo, MplanetsDIPInfo,
...
struct BurnDriver BurnDrvMplanetsuk = {
	"mplanetsuk", "mplanets", nullptr, nullptr, "1983",
	"Mad Planets (UK)\0", nullptr, "Gottlieb (Taitel license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, mplanetsukRomInfo, mplanetsukRomName, nullptr, nullptr, nullptr, nullptr, MplanetsInputInfo,
	MplanetsDIPInfo,
	DrvInitMplanets, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvQbertqub = {
	"qbertqub", nullptr, nullptr, "qbert", "1983",
	"Q*bert's Qubes\0", nullptr, "Mylstar", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, qbertqubRomInfo, qbertqubRomName, nullptr, nullptr, qbertSampleInfo, qbertSampleName, QbertqubInputInfo,
	QbertqubDIPInfo,
...
struct BurnDriver BurnDrvInsector = {
	"insector", nullptr, nullptr, nullptr, "1982",
	"Insector (prototype)\0", nullptr, "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, insectorRomInfo, insectorRomName, nullptr, nullptr, nullptr, nullptr, InsectorInputInfo, InsectorDIPInfo,
...
struct BurnDriver BurnDrvArgusg = {
	"argusg", nullptr, nullptr, nullptr, "1984",
	"Argus (Gottlieb, prototype)\0", nullptr, "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, argusgRomInfo, argusgRomName, nullptr, nullptr, nullptr, nullptr, ArgusgInputInfo, ArgusgDIPInfo,
...
struct BurnDriver BurnDrvKrull = {
	"krull", nullptr, nullptr, nullptr, "1983",
	"Krull\0", nullptr, "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, krullRomInfo, krullRomName, nullptr, nullptr, nullptr, nullptr, KrullInputInfo, KrullDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvCurvebal = {
	"curvebal", nullptr, nullptr, nullptr, "1984",
	"Curve Ball\0", nullptr, "Mylstar", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, curvebalRomInfo, curvebalRomName, nullptr, nullptr, nullptr, nullptr, CurvebalInputInfo, CurvebalDIPInfo,
...
struct BurnDriver BurnDrvTylz = {
	"tylz", nullptr, nullptr, nullptr, "1982",
	"Tylz (prototype)\0", nullptr, "Mylstar", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, tylzRomInfo, tylzRomName, nullptr, nullptr, nullptr, nullptr, TylzInputInfo, TylzDIPInfo,
...
struct BurnDriver BurnDrvKngtmare = {
	"kngtmare", nullptr, nullptr, nullptr, "1983",
	"Knightmare (prototype)\0", "Game has NO sound", "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, kngtmareRomInfo, kngtmareRomName, nullptr, nullptr, nullptr, nullptr, KngtmareInputInfo, KngtmareDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	256, 240, 4, 3
};
...
struct BurnDriver BurnDrvReactor = {
	"reactor", nullptr, nullptr, "reactor", "1982",
	"Reactor\0", nullptr, "Gottlieb", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, reactorRomInfo, reactorRomName, nullptr, nullptr, reactorSampleInfo, reactorSampleName, ReactorInputInfo,
	ReactorDIPInfo,
...
struct BurnDriver BurnDrvScrewloo = {
	"screwloo", nullptr, nullptr, nullptr, "1983",
	"Screw Loose (prototype)\0", nullptr, "Mylstar", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, screwlooRomInfo, screwlooRomName, nullptr, nullptr, nullptr, nullptr, ScrewlooInputInfo, ScrewlooDIPInfo,
...
struct BurnDriver BurnDrvWizwarz = {
	"wizwarz", nullptr, nullptr, nullptr, "1984",
	"Wiz Warz (prototype)\0", nullptr, "Mylstar", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_PROTOTYPE, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, wizwarzRomInfo, wizwarzRomName, nullptr, nullptr, nullptr, nullptr, WizwarzInputInfo, WizwarzDIPInfo,
...
struct BurnDriver BurnDrvVidvince = {
	"vidvince", nullptr, nullptr, nullptr, "1984",
	"Video Vince and the Game Factory (prototype)\0", nullptr, "Mylstar", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, vidvinceRomInfo, vidvinceRomName, nullptr, nullptr, nullptr, nullptr, VidvinceInputInfo, VidvinceDIPInfo,
...
struct BurnDriver BurnDrvStooges3 = {
	"3stooges", nullptr, nullptr, nullptr, "1984",
	"The Three Stooges In Brides Is Brides (set 1)\0", nullptr, "Mylstar", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, stooges3RomInfo, stooges3RomName, nullptr, nullptr, nullptr, nullptr, Stooges3InputInfo, Stooges3DIPInfo,
...
struct BurnDriver BurnDrvStooges3a = {
	"3stoogesa", "3stooges", nullptr, nullptr, "1984",
	"The Three Stooges In Brides Is Brides (set 2)\0", nullptr, "Mylstar", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, stooges3aRomInfo, stooges3aRomName, nullptr, nullptr, nullptr, nullptr, Stooges3InputInfo, Stooges3DIPInfo,
	DrvInitStooges3, DrvExit, Drv2Frame, DrvDraw, DrvScan, &DrvRecalc, 0x10,
	256, 240, 4, 3
};
