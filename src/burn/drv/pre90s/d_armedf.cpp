...
{
	{0x14, 0xff, 0xff, 0xdf, nullptr},
	{0x15, 0xff, 0xff, 0xff, nullptr},
	{0x16, 0xff, 0xff, 0x02, nullptr},
...
{
	{0x15, 0xff, 0xff, 0xdf, nullptr},
	{0x16, 0xff, 0xff, 0xcf, nullptr},
	{0x17, 0xff, 0xff, 0x02, nullptr},
...
{
	{0x17, 0xff, 0xff, 0xcf, nullptr},
	{0x18, 0xff, 0xff, 0xff, nullptr},
	{0x19, 0xff, 0xff, 0x02, nullptr},
...
{
	{0x15, 0xff, 0xff, 0xf7, nullptr},
	{0x16, 0xff, 0xff, 0xff, nullptr},
	{0x17, 0xff, 0xff, 0xff, nullptr},
	...
	case 0x7c000:
		{
			if (nb1414_blit_data)
			{
				if (data & 0x4000 && ((*DrvVidRegs & 0x40) == 0))
				{
					//0 -> 1 transition
					auto ram = (UINT16*)DrvTxRAM;
					nb_1414m4_exec(
						BURN_ENDIAN_SWAP_INT16((ram[0] << 8) | (ram[1] & 0xff)), (UINT16*)DrvTxRAM, &DrvScroll[2],
						&DrvScroll[3]);
				}
			}
...
{
	return static_cast<INT64>(ZetTotalCycles()) * nSoundRate / 6000000;
}
...
static INT32 MemIndex()
{
	...
	nb1414_blit_data = Next;
	Next += 0x004000; // nb1414m4 blitter data

	AllRam = Next;

	DrvSprRAM = Next;
	Next += 0x001000;
	DrvSprClut = (UINT16*)Next;
	Next += 0x002000;
	DrvSprBuf = Next;
	Next += 0x001000;
	DrvBgRAM = Next;
	...
	DrvVidRegs = Next;
	Next += 0x000001;
	DrvScroll = (UINT16*)Next;
	Next += 0x000004 * sizeof(UINT16);
	DrvMcuCmd = (UINT16*)Next;
	Next += 0x000020 * sizeof(UINT16);
...
static INT32 DrvGfxDecode()
{
	...
	INT32 XOffs1[16] = {
		0x000004, 0x000000, 0x100004, 0x100000, 0x00000c, 0x000008, 0x10000c, 0x100008,
...
static INT32 DrvInit(INT32 (*pLoadRoms)(), void (*p68KInit)(), INT32 zLen)
{
	...
	BurnYM3812Init(1, 4000000, nullptr, &DrvSynchroniseStream, 0);
...
static void draw_layer(UINT8* ram, UINT8* gfxbase, INT32 scrollx, INT32 scrolly, INT32 coloff, INT32 code_and)
{
	...
	for (INT32 offs = 0; offs < 64 * 32; offs++)
	{
		...
		if (*flipscreen)
		{
			Render16x16Tile_Mask_FlipXY_Clip(pTransDraw, code, (nScreenWidth - 16) - sx, (nScreenHeight - 16) - sy,
			                                 color, 4, 15, coloff, gfxbase);
		}
		else
		{
...
static void draw_txt_layer(INT32 transp, INT32 priority)
{
	...
	for (INT32 offs = 0; offs < 64 * 32; offs++)
	{
		...
		if (scroll_type == 3 && ofst < 0x12) continue;
		// ignore nb1414m4 params/fix text-garbage at the bottom of legion
		...
		if (transp)
		{
			if (*flipscreen)
			{
				Render8x8Tile_Mask_FlipXY_Clip(pTransDraw, code, (nScreenWidth - 8) - sx, (nScreenHeight - 8) - sy,
				                               attr >> 4, 4, 15, 0, DrvGfxROM0);
			}
			else
			{
		...
		else
		{
			if (*flipscreen)
			{
				Render8x8Tile_FlipXY_Clip(pTransDraw, code, (nScreenWidth - 8) - sx, (nScreenHeight - 8) - sy,
				                          attr >> 4, 4, 0, DrvGfxROM0);
			}
			else
			{
...
struct BurnDriver BurnDrvArmedf = {
	"armedf", nullptr, nullptr, nullptr, "1988",
	"Armed F (Japan)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, armedfRomInfo, armedfRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, ArmedfDIPInfo,
...
struct BurnDriver BurnDrvArmedff = {
	"armedff", "armedf", nullptr, nullptr, "1988",
	"Armed F (Fillmore license)\0", nullptr, "Nichibutsu (Fillmore license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, armedffRomInfo, armedffRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, ArmedfDIPInfo,
	ArmedfInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvCclimbr2 = {
	"cclimbr2", nullptr, nullptr, nullptr, "1988",
	"Crazy Climber 2 (Japan)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, cclimbr2RomInfo, cclimbr2RomName, nullptr, nullptr, nullptr, nullptr, Cclimbr2InputInfo, Cclimbr2DIPInfo,
...
struct BurnDriver BurnDrvCclmbr2a = {
	"cclimbr2a", "cclimbr2", nullptr, nullptr, "1988",
	"Crazy Climber 2 (Japan, Harder)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, cclmbr2aRomInfo, cclmbr2aRomName, nullptr, nullptr, nullptr, nullptr, Cclimbr2InputInfo, Cclimbr2DIPInfo,
	Cclimbr2Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvKozure = {
	"kozure", nullptr, nullptr, nullptr, "1987",
	"Kozure Ookami (Japan)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SCRFIGHT, 0,
	nullptr, kozureRomInfo, kozureRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, KozureDIPInfo,
...
struct BurnDriver BurnDrvLegion = {
	"legion", nullptr, nullptr, nullptr, "1987",
	"Legion - Spinner-87 (World ver 2.03)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, legionRomInfo, legionRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, LegionDIPInfo,
...
struct BurnDriver BurnDrvLegionj = {
	"legionj", "legion", nullptr, nullptr, "1987",
	"Chouji Meikyuu Legion (Japan ver 1.05, set 1)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, legionjRomInfo, legionjRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, LegionDIPInfo,
	LegionInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvLegionj2 = {
	"legionj2", "legion", nullptr, nullptr, "1987",
	"Chouji Meikyuu Legion (Japan ver 1.05, set 2)\0", "fail ROM checksum test", "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, legionj2RomInfo, legionj2RomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, LegionDIPInfo,
	LegionInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvLegionjb = {
	"legionjb", "legion", nullptr, nullptr, "1987",
	"Chouji Meikyuu Legion (Japan ver 1.05, bootleg set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	...
	nullptr, legionjbRomInfo, legionjbRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, LegionDIPInfo,
...
struct BurnDriver BurnDrvTerraf = {
	"terraf", nullptr, nullptr, nullptr, "1987",
	"Terra Force\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, terrafRomInfo, terrafRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, TerrafDIPInfo,
...
struct BurnDriver BurnDrvTerrafu = {
	"terrafu", "terraf", nullptr, nullptr, "1987",
	"Terra Force (US)\0", nullptr, "Nichibutsu USA", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, terrafuRomInfo, terrafuRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, TerrafDIPInfo,
	TerrafInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvterrafua = {
	"terrafua", "terraf", nullptr, nullptr, "1987",
	"Terra Force (US, alternate sound)\0", nullptr, "Nichibutsu USA", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, terrafuaRomInfo, terrafuaRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, TerrafDIPInfo,
	TerrafInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvTerrafj = {
	"terrafj", "terraf", nullptr, nullptr, "1987",
	"Terra Force (Japan)\0", nullptr, "Nichibutsu Japan", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, terrafjRomInfo, terrafjRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, TerrafDIPInfo,
	TerrafInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
...
struct BurnDriver BurnDrvTerrafjb = {
	"terrafjb", "terraf", nullptr, nullptr, "1987",
	...
	nullptr, terrafjbRomInfo, terrafjbRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, TerrafDIPInfo,
...
struct BurnDriver BurnDrvTerrafb = {
	"terrafb", "terraf", nullptr, nullptr, "1987",
	"Terra Force (Japan, bootleg set 2)\0", "imperfect graphics", "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_BOOTLEG | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, terrafbRomInfo, terrafbRomName, nullptr, nullptr, nullptr, nullptr, ArmedfInputInfo, TerrafDIPInfo,
...
struct BurnDriver BurnDrvSkyrobo = {
	"skyrobo", nullptr, nullptr, nullptr, "1989",
	"Sky Robo\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, skyroboRomInfo, skyroboRomName, nullptr, nullptr, nullptr, nullptr, BigfghtrInputInfo, BigfghtrDIPInfo,
...
struct BurnDriver BurnDrvBigfghtr = {
	"bigfghtr", "skyrobo", nullptr, nullptr, "1989",
	"Tatakae! Big Fighter (Japan)\0", nullptr, "Nichibutsu", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_HORSHOOT, 0,
	nullptr, bigfghtrRomInfo, bigfghtrRomName, nullptr, nullptr, nullptr, nullptr, BigfghtrInputInfo, BigfghtrDIPInfo,
	SkyRoboInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
