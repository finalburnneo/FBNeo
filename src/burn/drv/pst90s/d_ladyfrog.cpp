...
{
	DIP_OFFSET(0x09)
	{0x00, 0xff, 0xff, 0xda, nullptr},
	{0x01, 0xff, 0xff, 0xf5, nullptr},
...
static void draw_sprites()
{
	...
	for (INT32 i = 0; i < 0x20; i++)
	{
		...
		Draw16x16MaskTile(pTransDraw, code % gfx->code_mask, sx, (238 - sy) - 16, flipx, flipy, color, gfx->depth, 0xf,
		                  gfx->color_offset, gfx->gfxbase);

		if (sx > 240)
		{
			Draw16x16MaskTile(pTransDraw, code, sx - 256, (238 - sy) - 16, flipx, flipy, color, gfx->depth, 0xf,
			                  gfx->color_offset, gfx->gfxbase);
		}
	}
}
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[2] = {static_cast<INT32>(4000000 / 59.871277), static_cast<INT32>(4000000 / 59.871277)};
...
struct BurnDriver BurnDrvLadyfrog = {
	"ladyfrog", nullptr, nullptr, nullptr, "1990",
	"Lady Frog\0", nullptr, "Mondial Games", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, ladyfrogRomInfo, ladyfrogRomName, nullptr, nullptr, nullptr, nullptr, LadyfrogInputInfo, LadyfrogDIPInfo,
...
struct BurnDriver BurnDrvToucheme = {
	"toucheme", nullptr, nullptr, nullptr, "19??",
	"Touche Me (set 1)\0", nullptr, "<unknown>", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, touchemeRomInfo, touchemeRomName, nullptr, nullptr, nullptr, nullptr, LadyfrogInputInfo, TouchemeDIPInfo,
...
struct BurnDriver BurnDrvTouchemea = {
	"touchemea", "toucheme", nullptr, nullptr, "19??",
	"Touche Me (set 2, harder)\0", nullptr, "<unknown>", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	GBF_MAZE, 0,
	nullptr, touchemeaRomInfo, touchemeaRomName, nullptr, nullptr, nullptr, nullptr, LadyfrogInputInfo, TouchemeDIPInfo,
	TouchemeInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	208, 256, 3, 4
};
