...
// SF1++ (Street Fighter Plus Plus) - by yumeji 2014/08/01
...
struct BurnDriver BurnDrvsfpp = {
	...
	"Street Fighter Plus Plus (Hack)\0", NULL, "yumeji", "Miscellaneous",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK, 2, HARWARE_CAPCOM_MISC, GBF_VSFIGHT, FBF_SF,
	NULL, sfppRomInfo, sfppRomName, NULL, NULL, NULL, NULL, SfusInputInfo, SfusDIPInfo,
	SfppInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 
	&DrvRecalc, 0x401, 384, 224, 4, 3
};
