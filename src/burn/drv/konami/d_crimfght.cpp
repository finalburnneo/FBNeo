...
static struct BurnDIPInfo CrimfghtDIPList[] =
{
	...
	{0x16, 0xff, 0xff, 0x5f, nullptr},
	{0x17, 0xff, 0xff, 0xfb, nullptr},
...
static struct BurnDIPInfo CrimfghtuDIPList[] =
{
	...
	{0x22, 0xff, 0xff, 0x5f, nullptr},
	{0x23, 0xff, 0xff, 0xfb, nullptr},
...
static void K051960Callback(INT32* code, INT32* color, INT32* priority, INT32* shadow)
{
	switch (*color & 0x70)
	{
	case 0x10: *priority = 0;
		break;
	case 0x00: *priority = 1;
		break;
	case 0x40: *priority = 2;
		break;
	case 0x20: *priority = 3;
		break;
	}
...
struct BurnDriver BurnDrvCrimfght = {
	"crimfght", nullptr, nullptr, nullptr, "1989",
	"Crime Fighters (World 2 players)\0", nullptr, "Konami", "GX821",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, crimfghtRomInfo, crimfghtRomName, nullptr, nullptr, nullptr, nullptr, CrimfghtInputInfo, CrimfghtDIPInfo,
...
struct BurnDriver BurnDrvCrimfghtj = {
	"crimfghtj", "crimfght", nullptr, nullptr, "1989",
	"Crime Fighters (Japan 2 Players)\0", nullptr, "Konami", "GX821",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, crimfghtjRomInfo, crimfghtjRomName, nullptr, nullptr, nullptr, nullptr, CrimfghtInputInfo, CrimfghtDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvCrimfghtu = {
	"crimfghtu", "crimfght", nullptr, nullptr, "1989",
	"Crime Fighters (US 4 Players)\0", nullptr, "Konami", "GX821",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, crimfghtuRomInfo, crimfghtuRomName, nullptr, nullptr, nullptr, nullptr, CrimfghtuInputInfo,
	CrimfghtuDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	320, 224, 4, 3
};
