...
static struct BurnInputInfo PleiadsInputList[] = {
	...
	{"P1 Left",			BIT_DIGITAL,	DrvJoy2 + 2,	"p1 left"	},
	{"P1 Right",		BIT_DIGITAL,	DrvJoy2 + 1,	"p1 right"	},
	{"P1 Fire",			BIT_DIGITAL,	DrvJoy2 + 0,	"p1 fire 1"	},
	{"P1 Warp",			BIT_DIGITAL,	DrvJoy2 + 3,	"p1 fire 2"	},
...
static struct BurnDIPInfo PleiadsDIPList[]=
{
	...
	{0x00, 0x01, 0x0c, 0x00, "3K 30K"		},
	{0x00, 0x01, 0x0c, 0x04, "4K 40K"		},
	{0x00, 0x01, 0x0c, 0x08, "5K 50K"		},
	{0x00, 0x01, 0x0c, 0x0c, "6K 60K"		},

	{0   , 0xfe, 0   ,    2, "Coinage"		},
	{0x00, 0x01, 0x10, 0x10, "2 Coins 1 Credits"	},
	{0x00, 0x01, 0x10, 0x00, "1 Coin  1 Credits"	},
	...
	{0   , 0xfe, 0   ,    2, "Cabinet"		},
	{0x01, 0x01, 0x01, 0x00, "Upright"		},
	{0x01, 0x01, 0x01, 0x01, "Cocktail"		},
};
