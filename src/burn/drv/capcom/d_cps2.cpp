...
// Street Fighter II': Prime (Ver 0.55, Hack)
// Modified by Zero800
// https://sf2prime.github.io/

static struct BurnRomInfo Sf2primeRomDesc[] = {
	{ "sf2pr.03",		0x080000, 0x27179418, CPS2_PRG_68K | BRF_ESS | BRF_PRG },
	{ "sf2pr.04",		0x080000, 0xd1c67804, CPS2_PRG_68K | BRF_ESS | BRF_PRG },
	{ "sf2pr.05",		0x080000, 0x69701a6a, CPS2_PRG_68K | BRF_ESS | BRF_PRG },
	{ "sf2pr.06",		0x080000, 0xf0899cc2, CPS2_PRG_68K | BRF_ESS | BRF_PRG },
#if 0
	...
	{ "sf2pr.13m",		0x800000, 0x9c022c5a, CPS2_GFX | BRF_GRA },
	{ "sf2pr.15m",		0x800000, 0x78a40f11, CPS2_GFX | BRF_GRA },
	{ "sf2pr.17m",		0x800000, 0x379b08d6, CPS2_GFX | BRF_GRA },
	{ "sf2pr.19m",		0x800000, 0x23afa1b3, CPS2_GFX | BRF_GRA },
...
struct BurnDriver BurnDrvCpsSf2prime = {
	...
	"Street Fighter II': Prime (Ver 0.55, Hack)\0", NULL, "Zero800", "CPS2",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK | BDF_HISCORE_SUPPORTED, 2, HARDWARE_CAPCOM_CPS2, GBF_VSFIGHT, FBF_SF,
