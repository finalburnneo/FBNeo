...
static INT32 MemIndex()
{
	...
	bgbitmap = Next;
	Next += 256 * 256 * sizeof(UINT8); // background bitmap (RAM section)
		...
		for (INT32 x = 0; x < 32 * 8; x++)
		{
			...
			if (data)
			{
				...
				if (sx > 7 && sy < nScreenHeight && sx < nScreenWidth)
					*(pTransDraw + sy * nScreenWidth + (sx - 8)) = data;
			}
		}
	}
}
...
struct BurnDriver BurnDrvBattlane = {
	"battlane", nullptr, nullptr, nullptr, "1986",
	"Battle Lane! Vol. 5 (set 1)\0", nullptr, "Technos Japan (Taito license)", "Miscellaneous",
	...
	nullptr, battlaneRomInfo, battlaneRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvBattlane2 = {
	"battlane2", "battlane", nullptr, nullptr, "1986",
	"Battle Lane! Vol. 5 (set 2)\0", nullptr, "Technos Japan (Taito license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, battlane2RomInfo, battlane2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	256, 240, 3, 4
};
...
struct BurnDriver BurnDrvBattlane3 = {
	"battlane3", "battlane", nullptr, nullptr, "1986",
	"Battle Lane! Vol. 5 (set 3)\0", nullptr, "Technos Japan (Taito license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_SHOOT, 0,
	nullptr, battlane3RomInfo, battlane3RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x40,
	256, 240, 3, 4
};
