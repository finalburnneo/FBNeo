...
{
	{0x0a, 0xff, 0xff, 0x77, nullptr},
	{0x0b, 0xff, 0xff, 0x3f, nullptr},
	{0x0c, 0xff, 0xff, 0xff, nullptr},
	{0x0d, 0xff, 0xff, 0x16, nullptr},
...
static UINT16 __fastcall f1gpstar_main_read_word(UINT32 address)
{
	...
	case 0x080010:
		return (ProcessAnalog(Analog0, 0, INPUT_DEADZONE, 0x00, 0xff) << 8) | ProcessAnalog(
			Analog1, 1, INPUT_DEADZONE | INPUT_LINEAR | INPUT_MIGHTBEDIGITAL, 0x00, 0xff);
...
static INT32 MemIndex()
{
	...
	DrvGfxROM[0] = Next;
	Next += nDrvGfxROMLen[0] * 2;
	DrvGfxROM[1] = Next;
	Next += nDrvGfxROMLen[1] * 2;
	DrvGfxROM[2] = Next;
	Next += nDrvGfxROMLen[2] * 2;
	DrvGfxROM[3] = Next;
	Next += nDrvGfxROMLen[3] * 2;
	DrvGfxROM[4] = Next;
	Next += nDrvGfxROMLen[4] * 2;
	DrvGfxROM[5] = Next;
	Next += nDrvGfxROMLen[5] * 2;
	...
	Next += 0x8000 * sizeof(UINT32); // x2 for shadows
	...
	scrolly = (UINT16*)Next;
	Next += 0x000004 * sizeof(UINT16);
	scroll_flag = (UINT16*)Next;
	Next += 0x000004 * sizeof(UINT16);
	soundlatch = (UINT16*)Next;
...
static INT32 DrvLoadRoms(bool bLoad)
{
	...
	if (bLoad)
	{
		...
		if (nDrvGfxROMLen[3]) DrvGfxDecode(3, nDrvGfxROMLen[3], nDrv68KROMLen[1] ? 1 : 3);
		// single 68k-based use different format
...
static INT32 BigrunInit()
{
	...
	MSM6295Init(0, 4000000 / MSM6295_PIN7_HIGH, true);
	MSM6295Init(1, 4000000 / MSM6295_PIN7_HIGH, true);
...
static INT32 ScudhammInit()
{
	...
	MSM6295Init(0, 2000000 / MSM6295_PIN7_HIGH, false);
	MSM6295Init(1, 2000000 / MSM6295_PIN7_HIGH, false);
	MSM6295SetRoute(0, 0.25, BURN_SND_ROUTE_BOTH);
	MSM6295SetRoute(1, 0.25, BURN_SND_ROUTE_BOTH);
...
static void RenderZoomedSprite1(UINT16* dest, UINT8* gfx, INT32 code, INT32 color, INT32 sx, INT32 sy, INT32 fx,
                                INT32 fy, INT32 width, INT32 height, INT32 zoomx, INT32 zoomy, UINT8* shadow)
{
...
static void draw_layer(INT32 tmap, INT32 flags, INT32 priority)
{
	...
	for (INT32 row = 0; row < height; row++)
	{
		for (INT32 col = 0; col < width; col++)
		{
			...
			INT32 color = ((BURN_ENDIAN_SWAP_INT16(vidram[ofst]) >> (16 - bits_per_color)) << gfx->depth) + gfx->
				color_offset;
...
#define TILE_SIZE (64)
	...
	auto roadram = (UINT16*)DrvRoadRAM[road_num & 1];
	...
	for (INT32 sy = screen_adjust_y; sy < nScreenHeight + screen_adjust_y; sy++)
	{
		...
		{
			DrawCustomMaskTile(pTransDraw, gfx->width, gfx->height, curr_code % gfx->code_mask, sx,
			                   sy - screen_adjust_y, 0, 0, attr & gfx->color_mask, gfx->depth, transparency ? 15 : -1,
...
#define TILE_SIZE (64)
	...
	for (sy = min_y + screen_adjust_y; sy < max_y + screen_adjust_y; sy++)
	{
		...
		{
			RenderZoomedTile(pTransDraw, gfx->gfxbase, code % gfx->code_mask, color, transparency ? 15 : -1,
			                 sx / 0x10000, sy - screen_adjust_y, 0, 0, gfx->width, gfx->height, xscale, 1 << 16);
...
static void bigrun_draw_sprites(int priority1, int priority2)
{
	...
	for (; source < finish; source += 0x10 / 2)
	{
		...
		for (y = ystart; y != yend; y += yinc)
		{
			...
			{
				RenderZoomedSprite1(pTransDraw, gfx->gfxbase, code % gfx->code_mask, color, (sx + x * xdim) / 0x10000,
				                    ((sy + y * ydim) / 0x10000) - screen_adjust_y, flipx, flipy, 16, 16, xscale, yscale,
				                    shadows);
				code++;
			}
		}
...
static void cischeat_draw_sprites(int priority1, int priority2)
{
	...
	for (; source < finish; source += 0x10 / 2)
	{
		...
		for (y = ystart; y != yend; y += yinc)
		{
			for (x = xstart; x != xend; x += xinc)
			{
				RenderZoomedSprite1(pTransDraw, gfx->gfxbase, code % gfx->code_mask,
				                    ((color & gfx->color_mask) << gfx->depth) + gfx->color_offset,
				                    (sx + x * xdim) / 0x10000, ((sy + y * ydim) / 0x10000) - screen_adjust_y, flipx,
				                    flipy, 16, 16, xscale, yscale, shadows);
				code++;
			}
		}
	} /* end sprite loop */
...
struct BurnDriver BurnDrvBigrun = {
	"bigrun", nullptr, nullptr, nullptr, "1989",
	"Big Run (11th Rallye version, Europe?)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, bigrunRomInfo, bigrunRomName, nullptr, nullptr, nullptr, nullptr, BigrunInputInfo, BigrunDIPInfo,
...
struct BurnDriver BurnDrvBigrunu = {
	"bigrunu", "bigrun", nullptr, nullptr, "1989",
	"Big Run (11th Rallye version, US?)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, bigrunuRomInfo, bigrunuRomName, nullptr, nullptr, nullptr, nullptr, BigrunInputInfo, BigrunDIPInfo,
	BigrunInit, DrvExit, BigrunFrame, BigrunDraw, DrvScan, &DrvRecalc, 0x2000,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvCischeat = {
	"cischeat", nullptr, nullptr, nullptr, "1990",
	...
	nullptr, cischeatRomInfo, cischeatRomName, nullptr, nullptr, nullptr, nullptr, CischeatInputInfo, CischeatDIPInfo,
...
struct BurnDriver BurnDrvF1gpstar = {
	"f1gpstar", nullptr, nullptr, nullptr, "1992",
	"Grand Prix Star (ver 4.0)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_RACING, 0,
	nullptr, f1gpstarRomInfo, f1gpstarRomName, nullptr, nullptr, nullptr, nullptr, F1gpstarInputInfo, F1gpstarDIPInfo,
...
struct BurnDriver BurnDrvF1gpstar3 = {
	"f1gpstar3", "f1gpstar", nullptr, nullptr, "1991",
	"Grand Prix Star (ver 3.0)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_RACING, 0,
	nullptr, f1gpstar3RomInfo, f1gpstar3RomName, nullptr, nullptr, nullptr, nullptr, F1gpstarInputInfo, F1gpstarDIPInfo,
	F1gpstarInit, DrvExit, BigrunFrame, F1gpstarDraw, DrvScan, &DrvRecalc, 0x4000,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvF1gpstar2 = {
	"f1gpstar2", "f1gpstar", nullptr, nullptr, "1991",
	"Grand Prix Star (ver 2.0)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_RACING, 0,
	nullptr, f1gpstar2RomInfo, f1gpstar2RomName, nullptr, nullptr, nullptr, nullptr, F1gpstarInputInfo, F1gpstarDIPInfo,
	F1gpstarInit, DrvExit, BigrunFrame, F1gpstarDraw, DrvScan, &DrvRecalc, 0x4000,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvF1gpstr2 = {
	"f1gpstr2", nullptr, nullptr, nullptr, "1993",
	"F-1 Grand Prix Star II\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_RACING, 0,
	nullptr, f1gpstr2RomInfo, f1gpstr2RomName, nullptr, nullptr, nullptr, nullptr, F1gpstarInputInfo, F1gpstr2DIPInfo,
	F1gpstarInit, DrvExit, BigrunFrame, F1gpstarDraw, DrvScan, &DrvRecalc, 0x4000,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvWildplt = {
	"wildplt", nullptr, nullptr, nullptr, "1992",
	"Wild Pilot\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, wildpltRomInfo, wildpltRomName, nullptr, nullptr, nullptr, nullptr, WildpltInputInfo, WildpltDIPInfo,
...
struct BurnDriver BurnDrvScudhamm = {
	"scudhamm", nullptr, nullptr, nullptr, "1994",
	"Scud Hammer (ver 1.4)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, scudhammRomInfo, scudhammRomName, nullptr, nullptr, nullptr, nullptr, ScudhammInputInfo, ScudhammDIPInfo,
...
struct BurnDriver BurnDrvScudhamma = {
	"scudhamma", "scudhamm", nullptr, nullptr, "1994",
	"Scud Hammer (older version?)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, scudhammaRomInfo, scudhammaRomName, nullptr, nullptr, nullptr, nullptr, ScudhammInputInfo,
	ScudhammaDIPInfo,
	ScudhammInit, DrvExit, Single68KFrame, ScudhammDraw, DrvScan, &DrvRecalc, 0x4000,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvArmchmp2 = {
	"armchmp2", nullptr, nullptr, nullptr, "1992",
	"Arm Champs II (ver 2.7)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, armchmp2RomInfo, armchmp2RomName, nullptr, nullptr, nullptr, nullptr, Armchmp2InputInfo, Armchmp2DIPInfo,
...
struct BurnDriver BurnDrvArmchmp2o2 = {
	"armchmp2o2", "armchmp2", nullptr, nullptr, "1992",
	"Arm Champs II (ver 2.6)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, armchmp2o2RomInfo, armchmp2o2RomName, nullptr, nullptr, nullptr, nullptr, Armchmp2InputInfo,
	Armchmp2DIPInfo,
	Armchmp2Init, DrvExit, Single68KFrame, ScudhammDraw, DrvScan, &DrvRecalc, 0x4000,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvArmchmp2o = {
	"armchmp2o", "armchmp2", nullptr, nullptr, "1992",
	"Arm Champs II (ver 1.7)\0", nullptr, "Jaleco", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_NOT_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_POST90S, GBF_MISC, 0,
	nullptr, armchmp2oRomInfo, armchmp2oRomName, nullptr, nullptr, nullptr, nullptr, Armchmp2InputInfo, Armchmp2DIPInfo,
	Armchmp2Init, DrvExit, Single68KFrame, ScudhammDraw, DrvScan, &DrvRecalc, 0x4000,
	224, 256, 3, 4
};
