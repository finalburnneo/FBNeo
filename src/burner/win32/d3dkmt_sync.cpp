...
using D3DKMT_OPENADAPTERFROMHDC = struct _D3DKMT_OPENADAPTERFROMHDC
{
	HDC hDc;
	UINT32 hAdapter;
	LUID AdapterLuid;
...
using D3DKMT_CLOSEADAPTER = struct _D3DKMT_CLOSEADAPTER
{
	UINT32 hAdapter;
};

using D3DKMT_WAITFORVERTICALBLANKEVENT = struct _D3DKMT_WAITFORVERTICALBLANKEVENT
{
	UINT32 hAdapter;
	UINT32 hDevice;
	UINT32 VidPnSourceId;
...
void SuperWaitVBlankInit()
{
	...
	HDC hDC = CreateDC(nullptr, mi.szDevice, nullptr, nullptr);
