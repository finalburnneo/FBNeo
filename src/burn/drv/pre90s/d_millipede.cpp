...
static struct BurnDIPInfo MazeinvDIPList[] =
{
	...
	{0x01, 0xff, 0xff, 0xc0, nullptr},
	{0x02, 0xff, 0xff, 0x44, nullptr},
	{0x03, 0xff, 0xff, 0x02, nullptr},
...
{
	DIP_OFFSET(0x15)
	{0x00, 0xff, 0xff, 0x30, nullptr}, // dip0
	{0x01, 0xff, 0xff, 0x54, nullptr}, // dip4
	{0x02, 0xff, 0xff, 0x02, nullptr}, // dip5
...
{
	DIP_OFFSET(0x15)
	{0x00, 0xff, 0xff, 0x04, nullptr},
	{0x01, 0xff, 0xff, 0x00, nullptr},
	{0x02, 0xff, 0xff, 0x80, nullptr},
	{0x03, 0xff, 0xff, 0x04, nullptr},
	{0x04, 0xff, 0xff, 0x02, nullptr},
...
static void millipede_write(UINT16 address, UINT8 data)
{
	...
	if (address >= 0x2780 && address <= 0x27bf)
	{
		// EAROM Write
...
static void centipede_write(UINT16 address, UINT8 data)
{
	...
	if (address >= 0x7c0 && address <= 0x7ff)
	{
		// Sprite Ram
		DrvSpriteRAM[address & 0x3f] = data;
		return;
	...
	if (address >= 0x1600 && address <= 0x163f)
	{
		// EAROM Write
		earom_write(address & 0x3f, data);
		return;
...
static UINT8 millipede_read(UINT16 address)
{
	...
	if (mazeinvmode)
	{
		...
		case 0x2020: return ProcessAnalog(Analog[control_select], (control_select == 0 || control_select == 3) ? 1 : 0,
		                                  INPUT_DEADZONE, 0x40, 0xbf);
...
static INT32 DrvLoadRoms(INT32 prg_start)
{
...

	{
		...
		auto DrvTempRom = BurnMalloc(0x10000);
...
void RenderSpriteCentipede(UINT16* dest, UINT8* gfx, INT32 code, INT32 color, INT32 sx, INT32 sy, INT32 fx, INT32 fy,
...
static void DrvDrawBegin()
{
	...
	if (DrvRecalc)
	{
		centipedemode ? centipede_recalcpalette() : warlordsmode ? warlords_recalcpalette() : millipede_recalcpalette();
...
struct BurnDriver BurnDrvMilliped = {
	"milliped", nullptr, nullptr, nullptr, "1982",
	"Millipede\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION, 0,
	nullptr, millipedRomInfo, millipedRomName, nullptr, nullptr, nullptr, nullptr, MillipedInputInfo, MillipedDIPInfo,
...
struct BurnDriver BurnDrvCentiped = {
	"centiped", nullptr, nullptr, nullptr, "1980",
	"Centipede (revision 4)\0", "1 Player version", "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 1, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_ACTION, 0,
	nullptr, centipedRomInfo, centipedRomName, nullptr, nullptr, nullptr, nullptr, CentipedInputInfo, CentipedDIPInfo,
...
struct BurnDriver BurnDrvCentiped3 = {
	"centiped3", "centiped", nullptr, nullptr, "1980",
	...
	GBF_SHOOT | GBF_ACTION, 0,
	nullptr, centiped3RomInfo, centiped3RomName, nullptr, nullptr, nullptr, nullptr, CentipedInputInfo, CentipedDIPInfo,
	DrvInitcentiped, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	240, 256, 3, 4
};
...
struct BurnDriver BurnDrvWarlords = {
	"warlords", nullptr, nullptr, nullptr, "1980",
	"Warlords\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, warlordsRomInfo, warlordsRomName, nullptr, nullptr, nullptr, nullptr, WarlordsInputInfo, WarlordsDIPInfo,
...
struct BurnDriver BurnDrvMazeinv = {
	"mazeinv", nullptr, nullptr, nullptr, "1981",
	"Maze Invaders (prototype)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_ACTION | GBF_MAZE, 0,
	nullptr, mazeinvRomInfo, mazeinvRomName, nullptr, nullptr, nullptr, nullptr, MazeinvInputInfo, MazeinvDIPInfo,
