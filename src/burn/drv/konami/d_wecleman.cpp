...
static tilemap_callback(bg)
{
	...
	INT32 code = BURN_ENDIAN_SWAP_INT16(
		*((UINT16*)(DrvPageRAM + ((offs & 0x3f) + ((offs & 0xf80) >> 1) + (page << 11)) * 2)));
...
static INT32 MemIndex()
{
	...
	DrvGfxROM[0] = Next;
	Next += 0x800000; // sprites
	DrvGfxROM[1] = Next;
	Next += 0x080000; // layers / roz (hotchase)
	DrvGfxROM[2] = Next;
	Next += 0x080000; // roz (hotchase)
	DrvGfxROM[3] = Next;
	Next += 0x080000; // road
	...
	Next += 0x1002 * sizeof(UINT32); // + black & white + gray
...
static void bitswap(UINT8* src, INT32 len, INT32 _14, INT32 _13, INT32 _12, INT32 _11, INT32 _10, INT32 _f, INT32 _e,
                    INT32 _d, INT32 _c, INT32 _b, INT32 _a, INT32 _9, INT32 _8, INT32 _7, INT32 _6, INT32 _5, INT32 _4,
                    INT32 _3, INT32 _2, INT32 _1, INT32 _0)
{
	...
	{
		src[i] = tmp[BITSWAP24(i, 23, 22, 21, _14, _13, _12, _11, _10, _f, _e, _d, _c, _b, _a, _9, _8, _7, _6, _5, _4,
		                       _3, _2, _1, _0)];
...
static void decode_and_unpack_sprites()
{
	...
	{
		UINT8 data = BITSWAP08(tmp[BITSWAP24(i,23,22,21,0,1,20,19,18,17,14,9,16,6,4,7,8,15,10,11,13,5,12,3,2)], 7, 0, 1,
		                       2, 3, 4, 5, 6);
...
static void hotchase_sprite_decode()
{
	...
	auto temp = BurnMalloc(bank_size);
...
static INT32 WeclemanGfxDecode()
{
	...
	INT32 XOffs[64] = {
		STEP8(7, -1), STEP8(15, -1), STEP8(23, -1), STEP8(31, -1), STEP8(39, -1), STEP8(47, -1), STEP8(55, -1),
		STEP8(63, -1)
	};
...
static INT32 HotchaseRoadDecode() // expand to 4bpp & double each pixel (wide)
{
	...
	INT32 XOffs[64] = {
		...
		8 * 4, 8 * 4, 9 * 4, 9 * 4, 10 * 4, 10 * 4, 11 * 4, 11 * 4, 12 * 4, 12 * 4, 13 * 4, 13 * 4, 14 * 4, 14 * 4,
		15 * 4, 15 * 4,
		16 * 4, 16 * 4, 17 * 4, 17 * 4, 18 * 4, 18 * 4, 19 * 4, 19 * 4, 20 * 4, 20 * 4, 21 * 4, 21 * 4, 22 * 4, 22 * 4,
		23 * 4, 23 * 4,
		24 * 4, 24 * 4, 25 * 4, 25 * 4, 26 * 4, 26 * 4, 27 * 4, 27 * 4, 28 * 4, 28 * 4, 29 * 4, 29 * 4, 30 * 4, 30 * 4,
		31 * 4, 31 * 4
	};
	INT32 YOffs[1] = {0};
...
#define TOPCURB_DY 7
	...
	auto roadram = (UINT16*)DrvRoadRAM;
...
struct BurnDriver BurnDrvWecleman = {
	"wecleman", nullptr, nullptr, nullptr, "1986",
	"WEC Le Mans 24 (v2.01)\0", nullptr, "Konami", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RACING, 0,
	nullptr, weclemanRomInfo, weclemanRomName, nullptr, nullptr, nullptr, nullptr, WeclemanInputInfo, WeclemanDIPInfo,
...
struct BurnDriver BurnDrvWeclemana = {
	"weclemana", "wecleman", nullptr, nullptr, "1986",
	"WEC Le Mans 24 (v2.00)\0", nullptr, "Konami", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RACING, 0,
	nullptr, weclemanaRomInfo, weclemanaRomName, nullptr, nullptr, nullptr, nullptr, WeclemanInputInfo, WeclemanDIPInfo,
	WeclemanInit, DrvExit, DrvFrame, WeclemanDraw, DrvScan, &DrvRecalc, 0x800,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvWeclemanb = {
	"weclemanb", "wecleman", nullptr, nullptr, "1988",
	"WEC Le Mans 24 (v2.00, hack)\0", nullptr, "hack", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RACING, 0,
	nullptr, weclemanbRomInfo, weclemanbRomName, nullptr, nullptr, nullptr, nullptr, WeclemanInputInfo, WeclemanDIPInfo,
	WeclemanInit, DrvExit, DrvFrame, WeclemanDraw, DrvScan, &DrvRecalc, 0x800,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvWeclemanc = {
	"weclemanc", "wecleman", nullptr, nullptr, "1986",
	"WEC Le Mans 24 (v1.26)\0", nullptr, "Konami", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RACING, 0,
	nullptr, weclemancRomInfo, weclemancRomName, nullptr, nullptr, nullptr, nullptr, WeclemanInputInfo, WeclemanDIPInfo,
	WeclemanInit, DrvExit, DrvFrame, WeclemanDraw, DrvScan, &DrvRecalc, 0x800,
	320, 224, 4, 3
};
...
struct BurnDriver BurnDrvHotchase = {
	"hotchase", nullptr, nullptr, nullptr, "1988",
	"Hot Chase (set 1)\0", nullptr, "Konami", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_PREFIX_KONAMI, GBF_RACING, 0,
	nullptr, hotchaseRomInfo, hotchaseRomName, nullptr, nullptr, nullptr, nullptr, WeclemanInputInfo, HotchaseDIPInfo,
...
struct BurnDriver BurnDrvHotchasea = {
	"hotchasea", "hotchase", nullptr, nullptr, "1988",
	"Hot Chase (set 2)\0", nullptr, "Konami", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI, GBF_RACING, 0,
	nullptr, hotchaseaRomInfo, hotchaseaRomName, nullptr, nullptr, nullptr, nullptr, WeclemanInputInfo, HotchaseDIPInfo,
