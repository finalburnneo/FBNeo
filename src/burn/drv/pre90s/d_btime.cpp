// BurgerTime emu-layer for FB Neo by dink & iq_132, based on the MAME driver by Zsolt Vasvari.
...
{
	{0x10, 0xff, 0xff, 0x3f, nullptr},
	{0x11, 0xff, 0xff, 0x0b, nullptr},
...
{
	{0x0f, 0xff, 0xff, 0x1f, nullptr},
	{0x10, 0xff, 0xff, 0x89, nullptr},
...
{
	{0x10, 0xff, 0xff, 0x1f, nullptr},
	{0x11, 0xff, 0xff, 0x17, nullptr},
...
{
	{0x0f, 0xff, 0xff, 0x3f, nullptr},
	{0x10, 0xff, 0xff, 0x0f, nullptr},
...
{
	{0x13, 0xff, 0xff, 0x2f | 0x10, nullptr},
	{0x14, 0xff, 0xff, 0x0f, nullptr},
	...
	if (offset == 0)
	{
		...
		if (data == 0)
		{
			...
			case 0: /* score addition */
				...
				RAM[mmonkeyBASE + 0x0d00] = (r % 10);
				r /= 10;
				RAM[mmonkeyBASE + 0x0d00] |= ((r % 10) << 4);
				r /= 10;
				RAM[mmonkeyBASE + 0x0d01] = (r % 10);
				r /= 10;
				RAM[mmonkeyBASE + 0x0d01] |= ((r % 10) << 4);
				r /= 10;
				RAM[mmonkeyBASE + 0x0d02] = (r % 10);
				r /= 10;
...
static void btimepalettewrite(UINT16 offset, UINT8 data)
{
	...
	if (offset == 3 && bnjskew)
	{
		// hack to make some stuff readable in bnj.
		r = 0xff;
		g = 0xb8;
		b = 0x00;
	}
...
{
	if (address >= 0x0000 && address <= 0x3bff)
	{
		// Main RAM
...
static INT32 DrvBnjGfxDecode()
{
	...
	auto tmp = BurnMalloc(gfx0len + gfx1len); // more = more happy-fun. yay!
	if (tmp == nullptr)
	{
		return 1;
	}
...
static INT32 ZoarGfxDecode()
{
	...
	auto tmp = BurnMalloc(gfx0len + gfx1len + 0x3000); // more = more happy-fun. yay!
	if (tmp == nullptr)
	{
		return 1;
	}
...
static INT32 MmonkeyInit() // and lnc
{
	...
	AY8910SetPorts(0, nullptr, nullptr, &ay8910_0_portA_write, nullptr);
...
static void draw_sprites(UINT8 color, UINT8 sprite_y_adjust, UINT8 sprite_y_adjust_flip_screen, UINT8* sprite_ram,
                         INT32 interleave)
{
...
static INT32 BtimeFrame()
{
	...
	INT32 nCyclesTotal[2] = {
		static_cast<INT32>((double)((discomode | bnjskew) ? 750000 : 1500000) / 57.444853),
		static_cast<INT32>((double)((zippysoundinit) ? 6500000 : 500000) / 57.444853)
	};
...
struct BurnDriver BurnDrvBtime = {
	"btime", nullptr, nullptr, nullptr, "1982",
	"Burger Time (Data East set 1)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, btimeRomInfo, btimeRomName, nullptr, nullptr, nullptr, nullptr, BtimeInputInfo, BtimeDIPInfo,
...
struct BurnDriver BurnDrvBtime2 = {
	"btime2", "btime", nullptr, nullptr, "1982",
	"Burger Time (Data East set 2)\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, btime2RomInfo, btime2RomName, nullptr, nullptr, nullptr, nullptr, BtimeInputInfo, BtimeDIPInfo,
	BtimeInit, DrvExit, BtimeFrame, BtimeDraw, DrvScan, &DrvRecalc, 16,
	240, 242, 3, 4
};
...
struct BurnDriver BurnDrvBtime3 = {
	"btime3", "btime", nullptr, nullptr, "1982",
	"Burger Time (Data East USA)\0", "graphics issues, use parent romset!", "Data East USA Inc.", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, btime3RomInfo, btime3RomName, nullptr, nullptr, nullptr, nullptr, BtimeInputInfo, BtimeDIPInfo,
...
struct BurnDriver BurnDrvBtimem = {
	"btimem", "btime", nullptr, nullptr, "1982",
	"Burger Time (Midway)\0", nullptr, "Data East (Bally Midway license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_PLATFORM | GBF_ACTION, 0,
	nullptr, btimemRomInfo, btimemRomName, nullptr, nullptr, nullptr, nullptr, BtimeInputInfo, BtimeDIPInfo,
	Btime3Init, DrvExit, BtimeFrame, BtimeDraw, DrvScan, &DrvRecalc, 16,
	240, 242, 3, 4
};
...
struct BurnDriver BurnDrvMmonkey = {
	"mmonkey", nullptr, nullptr, nullptr, "1982",
	"Minky Monkey\0", nullptr, "Technos Japan / Roller Tron", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, mmonkeyRomInfo, mmonkeyRomName, nullptr, nullptr, nullptr, nullptr, MmonkeyInputInfo, MmonkeyDIPInfo,
...
struct BurnDriver BurnDrvMmonkeyj = {
	"mmonkeyj", "mmonkey", nullptr, nullptr, "1982",
	"Minky Monkey (Japan)\0", nullptr, "Technos Japan / Roller Tron", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION, 0,
	nullptr, mmonkeyjRomInfo, mmonkeyjRomName, nullptr, nullptr, nullptr, nullptr, MmonkeyInputInfo, MmonkeyDIPInfo,
	MmonkeyInit, DrvExit, BtimeFrame, eggsDraw, DrvScan, &DrvRecalc, 16,
	240, 242, 3, 4
};
...
struct BurnDriver BurnDrvBrubber = {
	"brubber", nullptr, nullptr, nullptr, "1982",
	"Burnin' Rubber\0", nullptr, "Data East", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RACING | GBF_ACTION, 0,
	nullptr, brubberRomInfo, brubberRomName, nullptr, nullptr, nullptr, nullptr, BnjInputInfo, BnjDIPInfo,
...
struct BurnDriver BurnDrvBnj = {
	"bnj", "brubber", nullptr, nullptr, "1982",
	"Bump 'n' Jump\0", nullptr, "Data East USA", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_RACING | GBF_ACTION, 0,
	nullptr, bnjRomInfo, bnjRomName, nullptr, nullptr, nullptr, nullptr, BnjInputInfo, BnjDIPInfo,
...
struct BurnDriver BurnDrvDisco = {
	"disco", nullptr, nullptr, nullptr, "1982",
	"Disco No.1\0", nullptr, "Data East", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_ACTION, 0,
	nullptr, discoRomInfo, discoRomName, nullptr, nullptr, nullptr, nullptr, DiscoInputInfo, DiscoDIPInfo,
...
struct BurnDriver BurnDrvDiscof = {
	"discof", "disco", nullptr, nullptr, "1982",
	"Disco No.1 (Rev.F)\0", nullptr, "Data East", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_ACTION, 0,
	nullptr, discofRomInfo, discofRomName, nullptr, nullptr, nullptr, nullptr, DiscoInputInfo, DiscoDIPInfo,
	DiscoInit, DrvExit, BtimeFrame, DiscoDraw, DrvScan, &DrvRecalc, 32,
	240, 242, 3, 4
};
...
struct BurnDriver BurnDrvLnc = {
	"lnc", nullptr, nullptr, nullptr, "1981",
	"Lock'n'Chase\0", nullptr, "Data East Corporation", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_MAZE, 0,
	nullptr, lncRomInfo, lncRomName, nullptr, nullptr, nullptr, nullptr, LncInputInfo, LncDIPInfo,
...
struct BurnDriver BurnDrvZoar = {
	"zoar", nullptr, nullptr, nullptr, "1982",
	"Zoar\0", nullptr, "Data East USA", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, zoarRomInfo, zoarRomName, nullptr, nullptr, nullptr, nullptr, ZoarInputInfo, ZoarDIPInfo,
