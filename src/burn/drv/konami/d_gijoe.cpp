...
{
	{0x2a, 0xff, 0xff, 0x00, nullptr},
	{0x2b, 0xff, 0xff, 0x80, nullptr},
	{0x2c, 0xff, 0xff, 0x80, nullptr},
...
static constexpr eeprom_interface gijoe_eeprom_interface =
{
	7,
	8,
	"011000",
...
static INT32 DrvFrame()
{
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		if (i == 240)
		{
			...
			if (pBurnDraw)
			{
				// draw at vblank (or linemapping flickers @ elevator level)
				DrvDraw();
			}
		}
	}
...
struct BurnDriver BurnDrvGijoe = {
	"gijoe", nullptr, nullptr, nullptr, "1992",
	"G.I. Joe (World, EAB, set 1)\0", nullptr, "Konami", "GX069",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, gijoeRomInfo, gijoeRomName, nullptr, nullptr, nullptr, nullptr, GijoeInputInfo, GijoeDIPInfo,
...
struct BurnDriver BurnDrvGijoeea = {
	"gijoeea", "gijoe", nullptr, nullptr, "1992",
	"G.I. Joe (World, EB8, prototype?)\0", nullptr, "Konami", "GX069",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, gijoeeaRomInfo, gijoeeaRomName, nullptr, nullptr, nullptr, nullptr, GijoeInputInfo, GijoeDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvGijoeu = {
	"gijoeu", "gijoe", nullptr, nullptr, "1992",
	"G.I. Joe (US, UAB)\0", nullptr, "Konami", "GX069",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, gijoeuRomInfo, gijoeuRomName, nullptr, nullptr, nullptr, nullptr, GijoeInputInfo, GijoeDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvGijoeua = {
	"gijoeua", "gijoe", nullptr, nullptr, "1992",
	"G.I. Joe (US, UAA)\0", nullptr, "Konami", "GX069",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, gijoeuaRomInfo, gijoeuaRomName, nullptr, nullptr, nullptr, nullptr, GijoeInputInfo, GijoeDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvGijoej = {
	"gijoej", "gijoe", nullptr, nullptr, "1992",
	"G.I. Joe (Japan, JAA)\0", nullptr, "Konami", "GX069",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, gijoejRomInfo, gijoejRomName, nullptr, nullptr, nullptr, nullptr, GijoeInputInfo, GijoeDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
...
struct BurnDriver BurnDrvGijoea = {
	"gijoea", "gijoe", nullptr, nullptr, "1992",
	"G.I. Joe (Asia, AA)\0", nullptr, "Konami", "GX069",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 4, HARDWARE_PREFIX_KONAMI, GBF_RUNGUN, 0,
	nullptr, gijoeaRomInfo, gijoeaRomName, nullptr, nullptr, nullptr, nullptr, GijoeInputInfo, GijoeDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	288, 224, 4, 3
};
