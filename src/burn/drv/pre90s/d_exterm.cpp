...
static void exterm_main_write(UINT32 address, UINT16 data)
{
	...
	{
		// top 6 address lines not connected? Doesn't cover all mirrors...
...
static void exterm_sub_write(UINT32 address, UINT16 data)
{
	...
	if ((address & 0x4000000) == 0x00000000)
	{
		// ram
...
static INT32 scanline_cb(INT32 scanline, TMS34010Display* params)
{
	...
	auto master_vram = (UINT16*)DrvVidRAM[0];
	auto slave_vram = (UINT16*)DrvVidRAM[1];
	...
	if (fgparams.enabled && scanline >= fgparams.veblnk && scanline < fgparams.vsblnk && fgparams.heblnk < fgparams.
		hsblnk)
	{
...
static INT32 MemIndex()
{
	...
	Next += (0x8000 + 0x800) * sizeof(UINT32);
...
static INT32 DrvInit()
{
	...
	BurnTimerInit(&nmi_timer_cb, nullptr); // for high-freq dac&speech timer
...
static INT32 DrvFrame()
{
	...
	INT32 nCyclesTotal[4] = {
		((40000000 / 8) * 100) / nBurnFPS, ((40000000 / 8) * 100) / nBurnFPS, (2000000 * 100) / nBurnFPS,
		(2000000 * 100) / nBurnFPS
	};
...
struct BurnDriver BurnDrvExterm = {
	"exterm", nullptr, nullptr, nullptr, "1989",
	"Exterminator\0", nullptr, "Gottlieb / Premier Technology", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING, 2, HARDWARE_MISC_PRE90S, GBF_MISC, 0,
	nullptr, extermRomInfo, extermRomName, nullptr, nullptr, nullptr, nullptr, ExtermInputInfo, ExtermDIPInfo,
