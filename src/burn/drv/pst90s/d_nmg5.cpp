// FinalBurn Neo NMG5 driver module
...
static struct BurnDIPInfo Nmg5DIPList[]=
{
	...
	{0x00, 0xfe,    0,    2, "Game Title"			},
	{0x00, 0x01, 0x01, 0x01, "Multi 5"			},
	{0x00, 0x01, 0x01, 0x00, "New Multi Game 5"		},

	{0x00, 0xfe,    0,    4, "Crocodiles (Tong Boy)"	},
	{0x00, 0x01, 0x06, 0x06, "Pattern 1"			},
	{0x00, 0x01, 0x06, 0x02, "Pattern 2"			},
	{0x00, 0x01, 0x06, 0x04, "Pattern 3"			},
	{0x00, 0x01, 0x06, 0x00, "Pattern 4"			},

	{0x00, 0xfe,    0,    4, "License" },
	{0x00, 0x01, 0x18, 0x00, "New Impeuropex Corp. S.R.L."	},
	{0x00, 0x01, 0x18, 0x08, "BNS Enterprises"		},
	{0x00, 0x01, 0x18, 0x10, "Nova Games"			},
	{0x00, 0x01, 0x18, 0x18, "None"				},

	{0x00, 0xfe,    0,    2, "1P Vs 2P Rounds (Bubble Gum)"	},
	{0x00, 0x01, 0x20, 0x20, "Best of 1"			},
	{0x00, 0x01, 0x20, 0x00, "Best of 3"			},

	{0x00, 0xfe,    0,    4, "Difficulty"			},
	{0x00, 0x01, 0xc0, 0x40, "Easy"				},
	{0x00, 0x01, 0xc0, 0xc0, "Normal"			},
	{0x00, 0x01, 0xc0, 0x80, "Hard"				},
	{0x00, 0x01, 0xc0, 0x00, "Hardest"			},

	{0x01, 0xfe,    0,    4, "Coin B"			},
	{0x01, 0x01, 0x03, 0x02, "2C 1C"			},
	{0x01, 0x01, 0x03, 0x03, "1C 1C"			},
	{0x01, 0x01, 0x03, 0x00, "2C 3C"			},
	{0x01, 0x01, 0x03, 0x01, "1C 2C"			},
//	{0x01, 0x01, 0x03, 0x03, "1C 1C"			},
//	{0x01, 0x01, 0x03, 0x01, "1C 3C"			},
//	{0x01, 0x01, 0x03, 0x02, "1C 4C"			},
//	{0x01, 0x01, 0x03, 0x00, "1C 6C"			},

	{0x01, 0xfe,    0,    4, "Coin A"			},
	{0x01, 0x01, 0x0c, 0x08, "2C 1C"			},
	{0x01, 0x01, 0x0c, 0x0c, "1C 1C"			},
	{0x01, 0x01, 0x0c, 0x00, "2C 3C"			},
	{0x01, 0x01, 0x0c, 0x04, "1C 2C"			},
//	{0x01, 0x01, 0x0c, 0x00, "4C 1C"			},
//	{0x01, 0x01, 0x0c, 0x08, "3C 1C"			},
//	{0x01, 0x01, 0x0c, 0x04, "2C 1C"			},
//	{0x01, 0x01, 0x0c, 0x0c, "1C 1C"			},

	{0x01, 0xfe,    0,    2, "Demo Sounds"			},
	{0x01, 0x01, 0x20, 0x20, "Off"				},
	{0x01, 0x01, 0x20, 0x00, "On"				},

	{0x01, 0xfe,    0,    2, "Coin Type"			},
	{0x01, 0x01, 0x40, 0x40, "1"				},
	{0x01, 0x01, 0x40, 0x00, "2"				},

	{0x01, 0xfe,    0,    2, "Service Mode"			},
...
static struct BurnDIPInfo SearcheyDIPList[]=
{
	DIP_OFFSET(0x10)
	{0x00, 0xff, 0xff, 0xff, NULL				},
	{0x01, 0xff, 0xff, 0xdd, NULL				},

	{0   , 0xfe,    0,    4, "Timer Speed"			},
	{0x00, 0x01, 0x03, 0x03, "Slowest"			},
	{0x00, 0x01, 0x03, 0x02, "Slow"				},
	{0x00, 0x01, 0x03, 0x01, "Fast"				},
	{0x00, 0x01, 0x03, 0x00, "Fastest"			},
	...
	{0x00, 0xfe,    0,    4, "Lives"			},
	{0x00, 0x01, 0x30, 0x20, "3"				},
	{0x00, 0x01, 0x30, 0x10, "4"				},
	{0x00, 0x01, 0x30, 0x30, "5"				},
	{0x00, 0x01, 0x30, 0x00, "6"				},

	{0x00, 0xfe,    0,    4, "Coinage"			},
	{0x00, 0x01, 0xc0, 0x00, "3C 1C"			},
	{0x00, 0x01, 0xc0, 0x40, "2C 1C"			},
	{0x00, 0x01, 0xc0, 0xc0, "1C 1C"			},
	{0x00, 0x01, 0xc0, 0x80, "1C 2C"			},
	...
	{0x01, 0xfe,    0,    8, "Language"			},
	{0x01, 0x01, 0x38, 0x00, "Korean Duplicate 1"	},
	{0x01, 0x01, 0x38, 0x08, "Korean Duplicate 2"	},
	{0x01, 0x01, 0x38, 0x10, "Korean Duplicate 3"	},
	{0x01, 0x01, 0x38, 0x18, "Italian"			},
	{0x01, 0x01, 0x38, 0x20, "Korean"			},
	{0x01, 0x01, 0x38, 0x28, "Japanese"			},
	{0x01, 0x01, 0x38, 0x30, "English"			},
	{0x01, 0x01, 0x38, 0x38, "Korean Duplicate 4"	},

	{0x01, 0xfe,    0,    2, "Items to find"		},
	{0x01, 0x01, 0x80, 0x00, "Less"				},
	{0x01, 0x01, 0x80, 0x80, "More"				},
};
...
static struct BurnDIPInfo SearcheyaDIPList[]=
{
	...
	{0x01, 0xfe,    0,    2, "Language"			},
	{0x01, 0x01, 0x20, 0x00, "English"			},
	{0x01, 0x01, 0x20, 0x20, "Korean"			},
...
static struct BurnDIPInfo Searchp2DIPList[]=
{
	...
	{0x01, 0xfe,    0,    4, "Lucky Chance"			},
	{0x01, 0x01, 0x06, 0x06, "Table 1"			},
	{0x01, 0x01, 0x06, 0x04, "Table 2"			},
	{0x01, 0x01, 0x06, 0x02, "Table 3"			},
	{0x01, 0x01, 0x06, 0x00, "Table 4"			},

	{0x01, 0xfe,    0,    8, "Language"			},
	{0x01, 0x01, 0x38, 0x00, "Korean Duplicate 1"	},
	{0x01, 0x01, 0x38, 0x08, "Korean Duplicate 2"	},
	{0x01, 0x01, 0x38, 0x10, "Korean "			},
	{0x01, 0x01, 0x38, 0x18, "Italian"			},
	{0x01, 0x01, 0x38, 0x20, "Chinese"			},
	{0x01, 0x01, 0x38, 0x28, "Japanese"			},
	{0x01, 0x01, 0x38, 0x30, "English"			},
	{0x01, 0x01, 0x38, 0x38, "Korean Duplicate 3"	},

	{0x01, 0xfe,    0,    2, "Lucky Timer"			},
	{0x01, 0x01, 0x40, 0x00, "Less"				},
	{0x01, 0x01, 0x40, 0x40, "More"				},
...
static struct BurnDIPInfo PclubysDIPList[]=
{
	...
	{0x00, 0xfe,    0,    2, "Lives (Mad Ball)"		},
	{0x00, 0x01, 0x01, 0x00, "3"				},
	{0x00, 0x01, 0x01, 0x01, "4"				},

	{0x00, 0xfe,    0,    2, "Demo Sounds"			},
	{0x00, 0x01, 0x02, 0x00, "Off"				},
	{0x00, 0x01, 0x02, 0x02, "On"				},

	{0x00, 0xfe,    0,    2, "1P Vs 2P Rounds"		},
	{0x00, 0x01, 0x04, 0x00, "Best of 1"			},
	{0x00, 0x01, 0x04, 0x04, "Best of 3"			},

	{0x00, 0xfe,    0,    2, "Nudity"			},
	{0x00, 0x01, 0x08, 0x08, "Soft only"			},
	{0x00, 0x01, 0x08, 0x00, "Soft and Hard"		},

	{0x00, 0xfe,    0,    4, "Difficulty"			},
	{0x00, 0x01, 0x30, 0x30, "Easy"				},
	{0x00, 0x01, 0x30, 0x20, "Normal"			},
	...
	{0x01, 0xfe,    0,    4, "Timer Speed (Magic Eye)"	},
	{0x01, 0x01, 0x30, 0x30, "Slowest"			},
	{0x01, 0x01, 0x30, 0x20, "Slow"				},
	{0x01, 0x01, 0x30, 0x10, "Fast"				},
	{0x01, 0x01, 0x30, 0x00, "Fastest"			},

	{0x01, 0xfe,    0,    2, "Lives (Magic Eye)"		},
	{0x01, 0x01, 0x40, 0x00, "3"				},
	{0x01, 0x01, 0x40, 0x40, "4"				},

	{0x01, 0xfe,    0,    2, "Timer Speed (Box Logic)"	},
	{0x01, 0x01, 0x80, 0x80, "Slow"				},
	{0x01, 0x01, 0x80, 0x00, "Fast"				},
};
...
static struct BurnDIPInfo GarogunDIPList[]=
{
	...
	{0x00, 0xfe,    0,    4, "Timer Speed (Bonus Levels)"	},
	{0x00, 0x01, 0x0c, 0x0c, "Slowest"			},
	{0x00, 0x01, 0x0c, 0x08, "Slow"				},
	{0x00, 0x01, 0x0c, 0x04, "Fast"				},
	{0x00, 0x01, 0x0c, 0x00, "Fastest"			},

	{0x00, 0xfe,    0,    4, "Timer Speed (Main Levels)"	},
	{0x00, 0x01, 0x30, 0x30, "Slowest"			},
	{0x00, 0x01, 0x30, 0x20, "Slow"				},
	{0x00, 0x01, 0x30, 0x10, "Fast"				},
	{0x00, 0x01, 0x30, 0x00, "Fastest"			},
...
static struct BurnDIPInfo Ordi7DIPList[]=
{
	...
	{0x00, 0xfe,    0,    2, "High-Low Error"		},
	{0x00, 0x01, 0x01, 0x01, "-500"				},
	{0x00, 0x01, 0x01, 0x00, "Lose All"			},

	{0x00, 0xfe,    0,    2, "Minimum Credits"		},
	{0x00, 0x01, 0x02, 0x02, "300"				},
	{0x00, 0x01, 0x02, 0x00, "500"				},

	{0x00, 0xfe,    0,    4, "Credit Limit"			},
	{0x00, 0x01, 0x0c, 0x0c, "10000"			},
	{0x00, 0x01, 0x0c, 0x08, "30000"			},
	{0x00, 0x01, 0x0c, 0x04, "50000"			},
	{0x00, 0x01, 0x0c, 0x00, "100000"			},

	{0x00, 0xfe,    0,    4, "Bet"				},
	{0x00, 0x01, 0x30, 0x30, "50 Credits"			},
	{0x00, 0x01, 0x30, 0x20, "100 Credits"			},
	{0x00, 0x01, 0x30, 0x10, "150 Credits"			},
	{0x00, 0x01, 0x30, 0x00, "200 Credits"			},

	{0x00, 0xfe,    0,    4, "Coinage"			},
	{0x00, 0x01, 0xc0, 0xc0, "1 Coin 50 Credits"		},
	{0x00, 0x01, 0xc0, 0x80, "1 Coin 100 Credits"		},
	{0x00, 0x01, 0xc0, 0x40, "1 Coin 500 Credits"		},
	{0x00, 0x01, 0xc0, 0x00, "1 Coin 1000 Credits"		},

	{0x01, 0xfe,    0,    2, "Service Mode"			},
	{0x01, 0x01, 0x01, 0x01, "Off"				},
	{0x01, 0x01, 0x01, 0x00, "On"				},

	{0x01, 0xfe,    0,    2, "Winnings"			},
	{0x01, 0x01, 0x04, 0x04, "Medals and Credits"		},
	{0x01, 0x01, 0x04, 0x00, "Credits only"			},

	{0x01, 0xfe,    0,    4, "Medals Table"			},
	{0x01, 0x01, 0x18, 0x18, "x1.0"				},
	{0x01, 0x01, 0x18, 0x10, "x1.4"				},
	{0x01, 0x01, 0x18, 0x08, "x2.0"				},
	{0x01, 0x01, 0x18, 0x00, "x3.0"				},

	{0x01, 0xfe,    0,    8, "Payout %"			},
	{0x01, 0x01, 0xe0, 0xe0, "90%"				},
	{0x01, 0x01, 0xe0, 0xc0, "85%"				},
	{0x01, 0x01, 0xe0, 0xa0, "80%"				},
	{0x01, 0x01, 0xe0, 0x80, "75%"				},
	{0x01, 0x01, 0xe0, 0x60, "70%"				},
	{0x01, 0x01, 0xe0, 0x40, "65%"				},
	{0x01, 0x01, 0xe0, 0x20, "60%"				},
	{0x01, 0x01, 0xe0, 0x00, "55%"				},
};
