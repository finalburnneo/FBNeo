...
static INT32 MemIndex()
{
	...
	DrvScrollx = (UINT16*)Next;
	Next += 0x0001 * sizeof(UINT16);
	DrvScrolly = (UINT16*)Next;
	Next += 0x0001 * sizeof(UINT16);
...
static INT32 DrvGfxDecode()
{
	...
	INT32 XOffs[16] = {
		...
		16 * 16 + 0, 16 * 16 + 1, 16 * 16 + 2, 16 * 16 + 3, 16 * 16 + 8 + 0, 16 * 16 + 8 + 1, 16 * 16 + 8 + 2,
		16 * 16 + 8 + 3
	};
	INT32 YOffs[16] = {
...
static void draw_text_layer()
{
	for (INT32 offs = 0x40; offs < 0x3c0; offs++)
	{
		...
		if (*flipscreen)
		{
			Render8x8Tile_Mask_FlipXY(pTransDraw, code, 248 - sx, 216 - (sy - 16), (attr & 0x1f)/*color*/, 2, 3, 0x300,
			                          DrvGfxROM0);
		}
		else
		{
...
static INT32 DrvFrame()
{
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		if (i == 240)
		{
			if (pBurnDraw)
			{
				// draw here gets rid of artefacts when starting game
				DrvDraw();
			}
...
struct BurnDriver BurnDrvBlktiger = {
	"blktiger", nullptr, nullptr, nullptr, "1987",
	"Black Tiger\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, blktigerRomInfo, blktigerRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvBlktigera = {
	"blktigera", "blktiger", nullptr, nullptr, "1987",
	"Black Tiger (older)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, blktigeraRomInfo, blktigeraRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInitMCU, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvBlktigerb1 = {
	"blktigerb1", "blktiger", nullptr, nullptr, "1987",
	"Black Tiger (bootleg set 1)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, blktigerb1RomInfo, blktigerb1RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvblktigerb2 = {
	"blktigerb2", "blktiger", nullptr, nullptr, "1987",
	"Black Tiger (bootleg set 2)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, blktigerb2RomInfo, blktigerb2RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvBlktigerb3 = {
	"blktigerb3", "blktiger", nullptr, nullptr, "1987",
	"Black Tiger / Black Dragon (mixed bootleg?)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, blktigerb3RomInfo, blktigerb3RomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvBlkdrgon = {
	"blkdrgon", "blktiger", nullptr, nullptr, "1987",
	"Black Dragon (Japan)\0", nullptr, "Capcom", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, blkdrgonRomInfo, blkdrgonRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInitMCU, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 224, 4, 3
};
...
struct BurnDriver BurnDrvBlkdrgonb = {
	"blkdrgonb", "blktiger", nullptr, nullptr, "1987",
	"Black Dragon (bootleg)\0", nullptr, "bootleg", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARWARE_CAPCOM_MISC, GBF_PLATFORM | GBF_SCRFIGHT, 0,
	nullptr, blkdrgonbRomInfo, blkdrgonbRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x400,
	256, 224, 4, 3
};
