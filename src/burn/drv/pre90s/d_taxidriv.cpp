...
static INT32 DrvInit()
{
	...
	ppi8255_init(5);
	ppi8255_set_read_ports(0, ppi0_port_A_read, nullptr, ppi0_port_C_read);
	ppi8255_set_write_ports(0, nullptr, ppi0_port_B_write, ppi0_port_C_write);
	ppi8255_set_read_ports(1, nullptr, ppi1_port_B_read, ppi1_port_C_read);
	ppi8255_set_write_ports(1, ppi1_port_A_write, nullptr, ppi1_port_C_write);
	...
	AY8910SetPorts(0, &AY8910_0_port_A_read, nullptr, nullptr, &ay8910_0_port_B_write);
	AY8910SetPorts(1, &AY8910_1_port_A_read, nullptr, nullptr, nullptr);
...
static INT32 DrvFrame()
{
	...
	if (bgdisable)
	{
		// needs to happen even if drawing is disabled! (runahead, etc)
		memset(scroll, 0, 4);
...
struct BurnDriver BurnDrvTaxidriv = {
	"taxidriv", nullptr, nullptr, nullptr, "1984",
	"Taxi Driver\0", nullptr, "Graphic Techno", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S, GBF_RACING, 0,
	nullptr, taxidrivRomInfo, taxidrivRomName, nullptr, nullptr, nullptr, nullptr, TaxidrivInputInfo, TaxidrivDIPInfo,
