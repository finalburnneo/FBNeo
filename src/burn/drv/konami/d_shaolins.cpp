...
static void DrvPaletteInit()
{
...

	{
		...
		for (INT32 i = 0; i < 4; i++)
		{
			weights[i] = ((((weights[i] * 10000) / total) * 255) + 5000) / 10000;
		}
	}
...
struct BurnDriver BurnDrvKicker = {
	"kicker", nullptr, nullptr, nullptr, "1985",
	"Kicker\0", nullptr, "Konami", "GX477",
	...
	nullptr, kickerRomInfo, kickerRomName, nullptr, nullptr, nullptr, nullptr, ShaolinsInputInfo, ShaolinsDIPInfo,
...
struct BurnDriver BurnDrvShaolins = {
	"shaolins", "kicker", nullptr, nullptr, "1985",
	"Shao-lin's Road (set 1)\0", nullptr, "Konami", "GX477",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, shaolinsRomInfo, shaolinsRomName, nullptr, nullptr, nullptr, nullptr, ShaolinsInputInfo, ShaolinsDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvShaolinb = {
	"shaolinb", "kicker", nullptr, nullptr, "1985",
	"Shao-lin's Road (set 2)\0", nullptr, "Konami", "GX477",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_SCRFIGHT, 0,
	nullptr, shaolinbRomInfo, shaolinbRomName, nullptr, nullptr, nullptr, nullptr, ShaolinsInputInfo, ShaolinsDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x1000,
	224, 256, 3, 4
};
