...
{
	{DO + 0, 0xff, 0xff, 0x00, nullptr},
	{DO + 1, 0xff, 0xff, 0x11, nullptr},
	{DO + 2, 0xff, 0xff, 0x00, nullptr}, // unused
	{DO + 3, 0xff, 0xff, 0x10, nullptr}, // service mode
...
{
	{DO + 0, 0xff, 0xff, 0x04, nullptr},
	{DO + 1, 0xff, 0xff, 0x00, nullptr},
	{DO + 2, 0xff, 0xff, 0x00, nullptr}, // unused
	{DO + 3, 0xff, 0xff, 0x10, nullptr}, // service mode
...
{
	{DO + 0, 0xff, 0xff, 0x01, nullptr},
	{DO + 1, 0xff, 0xff, 0x00, nullptr},
	{DO + 2, 0xff, 0xff, 0x07, nullptr},
	{DO + 3, 0xff, 0xff, 0x10, nullptr}, // service mode
...
static INT32 MemIndex()
{
	...
	DrvVectorROM = Next;
	Next += 0x004000; // must(!) come after Vector RAM!
...
static INT32 DrvFrame()
{
	...
	for (INT32 i = 0; i < nInterleave; i++)
	{
		...
		if (irqcnt >= (62 + irqflip))
		{
			// 6.1something irq's per frame logic
...
struct BurnDriver BurnDrvBwidow = {
	"bwidow", nullptr, nullptr, nullptr, "1982",
	"Black Widow\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, bwidowRomInfo, bwidowRomName, nullptr, nullptr, nullptr, nullptr, BwidowInputInfo, BwidowDIPInfo,
...
struct BurnDriverD BurnDrvBwidowp = {
	"bwidowp", "bwidow", nullptr, nullptr, "1982",
	"Black Widow (prototype)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_PROTOTYPE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_ACTION | GBF_VECTOR, 0,
	nullptr, bwidowpRomInfo, bwidowpRomName, nullptr, nullptr, nullptr, nullptr, BwidowInputInfo, BwidowDIPInfo,
...
struct BurnDriver BurnDrvGravitar = {
	"gravitar", nullptr, nullptr, nullptr, "1982",
	"Gravitar (version 3)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, gravitarRomInfo, gravitarRomName, nullptr, nullptr, nullptr, nullptr, GravitarInputInfo, GravitarDIPInfo,
...
struct BurnDriver BurnDrvGravitar2 = {
	"gravitar2", "gravitar", nullptr, nullptr, "1982",
	"Gravitar (version 2)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, gravitar2RomInfo, gravitar2RomName, nullptr, nullptr, nullptr, nullptr, GravitarInputInfo, GravitarDIPInfo,
	GravitarInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	800, 600, 4, 3
};
...
struct BurnDriver BurnDrvGravitar1 = {
	"gravitar1", "gravitar", nullptr, nullptr, "1982",
	"Gravitar (version 1)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, gravitar1RomInfo, gravitar1RomName, nullptr, nullptr, nullptr, nullptr, GravitarInputInfo, GravitarDIPInfo,
	GravitarInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	800, 600, 4, 3
};
...
struct BurnDriver BurnDrvLunarbat = {
	"lunarbat", "gravitar", nullptr, nullptr, "1982",
	"Lunar Battle (prototype, later)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, lunarbatRomInfo, lunarbatRomName, nullptr, nullptr, nullptr, nullptr, GravitarInputInfo, GravitarDIPInfo,
	GravitarInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	800, 600, 4, 3
};
...
struct BurnDriver BurnDrvLunarba1 = {
	"lunarba1", "gravitar", nullptr, nullptr, "1982",
	"Lunar Battle (prototype, earlier)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, lunarba1RomInfo, lunarba1RomName, nullptr, nullptr, nullptr, nullptr, LunarbatInputInfo, nullptr,
...
struct BurnDriver BurnDrvSpacduel = {
	"spacduel", nullptr, nullptr, nullptr, "1980",
	"Space Duel (version 2)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, spacduelRomInfo, spacduelRomName, nullptr, nullptr, nullptr, nullptr, SpacduelInputInfo, SpacduelDIPInfo,
	SpacduelInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	800, 600, 4, 3
};
...
struct BurnDriver BurnDrvSpacduel1 = {
	"spacduel1", "spacduel", nullptr, nullptr, "1980",
	"Space Duel (version 1)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, spacduel1RomInfo, spacduel1RomName, nullptr, nullptr, nullptr, nullptr, SpacduelInputInfo, SpacduelDIPInfo,
	SpacduelInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	800, 600, 4, 3
};
...
struct BurnDriver BurnDrvSpacduel0 = {
	"spacduel0", "spacduel", nullptr, nullptr, "1980",
	"Space Duel (prototype)\0", nullptr, "Atari", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_PROTOTYPE | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_SHOOT | GBF_VECTOR, 0,
	nullptr, spacduel0RomInfo, spacduel0RomName, nullptr, nullptr, nullptr, nullptr, SpacduelInputInfo, SpacduelDIPInfo,
	SpacduelInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x2000,
	800, 600, 4, 3
};
