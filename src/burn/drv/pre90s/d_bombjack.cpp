		...
		if (size)
		{
			...
			if (flipy)
			{
				if (flipx)
				{
					...
					Render16x16Tile_Mask_FlipXY_Clip(pTransDraw, code + 0, sx + 16, sy + 16, color, 3, 0, 0,
					                                 DrvGfxROM2);
				}
				else
				{
...
struct BurnDriver BurnDrvBombjack = {
	"bombjack", nullptr, nullptr, nullptr, "1984",
	"Bomb Jack (set 1)\0", nullptr, "Tehkan", "Miscellaneous",
	...
	nullptr, bombjackRomInfo, bombjackRomName, nullptr, nullptr, nullptr, nullptr, BombjackInputInfo, BombjackDIPInfo,
...
struct BurnDriver BurnDrvBombjack2 = {
	"bombjack2", "bombjack", nullptr, nullptr, "1984",
	"Bomb Jack (set 2)\0", nullptr, "Tehkan", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, bombjack2RomInfo, bombjack2RomName, nullptr, nullptr, nullptr, nullptr, BombjackInputInfo, BombjackDIPInfo,
	BombjackInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x80,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvBombjackt = {
	"bombjackt", "bombjack", nullptr, nullptr, "1984",
	"Bomb Jack (Tecfri, Spain)\0", nullptr, "Tehkan (Tecfri licence)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_MISC_PRE90S, GBF_PLATFORM, 0,
	nullptr, bombjacktRomInfo, bombjacktRomName, nullptr, nullptr, nullptr, nullptr, BombjackInputInfo, BombjackDIPInfo,
