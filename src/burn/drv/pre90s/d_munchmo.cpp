	...
	for (INT32 offs = 0; offs < 16 * 16; offs++)
	{
		...
		for (INT32 row = 0; row < 4; row++)
		{
			for (INT32 col = 0; col < 4; col++)
			{
				...
				Render8x8Tile_Clip(DrvBGBitmap, code, (sx + (col * 8)), sy + (row * 8), palette_bank + 0x04, 4, 0,
				                   DrvGfxROM1);
			}
		}
	}
	...
	for (INT32 i = firstsprite; i < firstsprite + 0x40; i++)
	{
		for (INT32 j = 0; j < 8; j++)
		{
			...
			if (attributes & 0x80)
			{
				...
				Render32x32Tile_Mask_Clip(pTransDraw, (tile_number & 0x7f) + bank, sx, sy, color, 3, 7, 0x80,
				                          DrvGfxROM2);
			}
		}
	}
...
struct BurnDriver BurnDrvJoyfulr = {
	"joyfulr", nullptr, nullptr, nullptr, "1983",
	"Joyful Road (Japan)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 4, HARDWARE_MISC_PRE90S,
	GBF_RACING | GBF_ACTION, 0,
	nullptr, joyfulrRomInfo, joyfulrRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
...
struct BurnDriver BurnDrvMnchmobl = {
	"mnchmobl", "joyfulr", nullptr, nullptr, "1983",
	"Munch Mobile (US)\0", nullptr, "SNK (Centuri license)", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 4, HARDWARE_MISC_PRE90S,
	GBF_RACING | GBF_ACTION, 0,
	nullptr, mnchmoblRomInfo, mnchmoblRomName, nullptr, nullptr, nullptr, nullptr, DrvInputInfo, DrvDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x100,
	240, 320, 3, 4
};
