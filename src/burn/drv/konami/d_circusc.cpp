...
static void draw_sprites()
{
	...
	for (INT32 offs = 0; offs < 0x100; offs += 4)
	{
		...
		RenderTileTranstab(pTransDraw, DrvGfxROM1, code, color * 16 + 0x100, 0, sx, sy - 16, flipx, flipy, 16, 16,
		                   DrvTransTable);
	}
}
...
struct BurnDriver BurnDrvCircusc = {
	"circusc", nullptr, nullptr, nullptr, "1984",
	"Circus Charlie (level select, set 1)\0", nullptr, "Konami", "GX380",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_ACTION, 0,
	nullptr, circuscRomInfo, circuscRomName, nullptr, nullptr, nullptr, nullptr, CircuscInputInfo, CircuscDIPInfo,
...
struct BurnDriver BurnDrvCircusc2 = {
	"circusc2", "circusc", nullptr, nullptr, "1984",
	"Circus Charlie (level select, set 2)\0", nullptr, "Konami", "GX380",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_ACTION, 0,
	nullptr, circusc2RomInfo, circusc2RomName, nullptr, nullptr, nullptr, nullptr, CircuscInputInfo, CircuscDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCircusc3 = {
	"circusc3", "circusc", nullptr, nullptr, "1984",
	"Circus Charlie (level select, set 3)\0", nullptr, "Konami", "GX380",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_ACTION, 0,
	nullptr, circusc3RomInfo, circusc3RomName, nullptr, nullptr, nullptr, nullptr, CircuscInputInfo, CircuscDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCircusc4 = {
	"circusc4", "circusc", nullptr, nullptr, "1984",
	"Circus Charlie (no level select)\0", nullptr, "Konami", "GX380",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_ACTION, 0,
	nullptr, circusc4RomInfo, circusc4RomName, nullptr, nullptr, nullptr, nullptr, CircuscInputInfo, CircuscDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCircuscc = {
	"circuscc", "circusc", nullptr, nullptr, "1984",
	"Circus Charlie (Centuri)\0", nullptr, "Konami (Centuri license)", "GX380",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_ACTION, 0,
	nullptr, circusccRomInfo, circusccRomName, nullptr, nullptr, nullptr, nullptr, CircuscInputInfo, CircuscDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 256, 3, 4
};
...
struct BurnDriver BurnDrvCircusce = {
	"circusce", "circusc", nullptr, nullptr, "1984",
	"Circus Charlie (Centuri, earlier)\0", nullptr, "Konami (Centuri license)", "GX380",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED | BDF_HISCORE_SUPPORTED, 2,
	HARDWARE_PREFIX_KONAMI, GBF_ACTION, 0,
	nullptr, circusceRomInfo, circusceRomName, nullptr, nullptr, nullptr, nullptr, CircuscInputInfo, CircuscDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 0x200,
	224, 256, 3, 4
};
