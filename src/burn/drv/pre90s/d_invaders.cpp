		...
		if (x == 0)
		{
			for (INT32 i = 0; i < 4; i++)
			{
				pTransDraw[((y - 0x20) * nScreenWidth) + (256 + i)] = (video_data & 0x01)
					                                                      ? get_overlay_color((256 + i), (y - 0x20))
					                                                      : 0;
				video_data >>= 1;
			}
...
struct BurnDriver BurnDrvInvaders = {
	"invaders", nullptr, nullptr, "invaders", "1978",
	"Space Invaders / Space Invaders M\0", nullptr, "Taito / Midway", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, invadersRomInfo, invadersRomName, nullptr, nullptr, InvadersSampleInfo, InvadersSampleName,
	InvadersInputInfo, InvadersDIPInfo,
...
struct BurnDriver BurnDrvSisv1 = {
	"sisv1", "invaders", nullptr, "invaders", "1978",
	"Space Invaders (SV Version rev 1)\0", nullptr, "Taito", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_CLONE | BDF_ORIENTATION_VERTICAL, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, sisv1RomInfo, sisv1RomName, nullptr, nullptr, InvadersSampleInfo, InvadersSampleName, InvadersInputInfo,
	InvadersDIPInfo,
...
struct BurnDriver BurnDrvSisv2 = {
	"sisv2", "invaders", nullptr, "invaders", "1978",
	"Space Invaders (SV Version rev 2)\0", nullptr, "Taito", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, sisv2RomInfo, sisv2RomName, nullptr, nullptr, InvadersSampleInfo, InvadersSampleName, InvadersInputInfo,
	InvadersDIPInfo,
	Sisv1Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 2,
	224, 260, 3, 4
};
...
struct BurnDriver BurnDrvSisv3 = {
	"sisv3", "invaders", nullptr, "invaders", "1978",
	"Space Invaders (SV Version rev 3)\0", nullptr, "Taito", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, sisv3RomInfo, sisv3RomName, nullptr, nullptr, InvadersSampleInfo, InvadersSampleName, InvadersInputInfo,
	InvadersDIPInfo,
	Sisv1Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 2,
	224, 260, 3, 4
};
...
struct BurnDriver BurnDrvSisv = {
	"sisv", "invaders", nullptr, "invaders", "1978",
	"Space Invaders (SV Version rev 4)\0", nullptr, "Taito", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, sisvRomInfo, sisvRomName, nullptr, nullptr, InvadersSampleInfo, InvadersSampleName, InvadersInputInfo,
	InvadersDIPInfo,
	Sisv1Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 2,
	224, 260, 3, 4
};
...
struct BurnDriver BurnDrvSitv1 = {
	"sitv1", "invaders", nullptr, "invaders", "1978",
	"Space Invaders (TV Version rev 1)\0", nullptr, "Taito", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, sitv1RomInfo, sitv1RomName, nullptr, nullptr, InvadersSampleInfo, InvadersSampleName, SitvInputInfo,
	SitvDIPInfo,
...
struct BurnDriver BurnDrvSitv = {
	"sitv", "invaders", nullptr, "invaders", "1978",
	"Space Invaders (TV Version rev 2)\0", nullptr, "Taito", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, sitvRomInfo, sitvRomName, nullptr, nullptr, InvadersSampleInfo, InvadersSampleName, SitvInputInfo,
	SitvDIPInfo,
	Sitv1Init, DrvExit, DrvFrame, DrvDraw, DrvScan, &DrvRecalc, 2,
	224, 260, 3, 4
};
...
struct BurnDriver BurnDrvOzmawars = {
	"ozmawars", nullptr, nullptr, "invaders", "1979",
	"Ozma Wars (set 1)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S, GBF_VERSHOOT, 0,
	nullptr, ozmawarsRomInfo, ozmawarsRomName, nullptr, nullptr, OzmawarsSampleInfo, OzmawarsSampleName,
	InvadersInputInfo, OzmawarsDIPInfo,
...
struct BurnDriver BurnDrvOzmawars2 = {
	"ozmawars2", "ozmawars", nullptr, "invaders", "1979",
	"Ozma Wars (set 2)\0", nullptr, "SNK", "Miscellaneous",
	nullptr, nullptr, nullptr, nullptr,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_HISCORE_SUPPORTED, 2, HARDWARE_MISC_PRE90S,
	GBF_VERSHOOT, 0,
	nullptr, ozmawars2RomInfo, ozmawars2RomName, nullptr, nullptr, OzmawarsSampleInfo, OzmawarsSampleName,
	InvadersInputInfo, OzmawarsDIPInfo,
